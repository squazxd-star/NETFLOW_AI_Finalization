...
const VOICE_DISCIPLINE_DIRECTIVE = "VOICE DISCIPLINE: Character speaks ONLY the provided dialogue text — NO filler sounds, NO random gasps, NO surprised exclamations (NO 'ยะ!', 'ฮ๊า!', 'อ้าว!', 'ว้าว!', 'โอ้!'), NO giggling, NO humming between lines. When revealing or presenting the product, character uses a CONFIDENT smooth presenter tone (like a polished 'ท๊าดา!' reveal) — NOT a shocked/gasping reaction. Between spoken lines, the character's mouth MUST be fully closed with composed silence — do NOT let the character mouth words that are not in the script. Natural breathing only. The character is a PROFESSIONAL PRESENTER, not a surprised audience member.";
...
const buildVideoPrompt = (
    ...
    const characterAnchor = [
        ...
        `STRICT FACE & HEAD LOCK: Preserve EXACT facial bone structure, face width, jawline shape, eye shape, nose shape, natural skin texture, and EXACT skin tone/complexion from the reference. Do NOT lighten or wash out the skin. The character's face MUST remain IDENTICAL to frame 1 across the entire video. Do NOT let the face morph, stretch, or change identity between shots. Zero face changes between scenes.`,
