...
2. อ้างอิงข้อมูลจาก "ข้อมูลสินค้าจริง" ที่ให้มาเป็นหลัก ดึงจุดเด่นที่เฉพาะเจาะจง (เช่น ตัวเลขสเปค, ราคา, เทคโนโลยีเฉพาะ) มานำเสนอให้ว้าว
3. ห้ามแต่งเติมฟีเจอร์ที่ไม่มีอยู่จริงเด็ดขาด! (เช่น ห้ามมั่วว่ามีแอปพลิเคชัน, บลูทูธ, สายชาร์จ, แบตเตอรี่, หรือพับเก็บได้ หากข้อมูลไม่ได้ระบุไว้)
...
5. แต่ละฉากต้องมี videoAction (ภาษาอังกฤษ) คือสิ่งที่ตัวละครทำจริงๆ ในวิดีโอ`;
            ...
            const realDataSection = productDataText
                ? `\n\nข้อมูลสินค้าจริง (ใช้ข้อมูลนี้เป็นแกนหลักในการเขียนสคริปต์ ดึงจุดเด่นและตัวเลขมาใช้ ห้ามมั่วฟีเจอร์เพิ่ม):\n${productDataText}`
                : `\n\nไม่มีข้อมูลเพิ่มเติม — ให้ใช้ความรู้ของคุณเกี่ยวกับสินค้า "${productName}" เขียนสคริปต์ที่มีสเปคจริง ฟีเจอร์จริง ราคาจริง ห้ามเขียนกว้างๆ และห้ามมั่วฟีเจอร์ที่สินค้านี้ไม่น่าจะมี`;
