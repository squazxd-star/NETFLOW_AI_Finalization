...
const ANTI_STREAK_VISUAL_DIRECTIVE = "VISUAL CLEANLINESS: No white streak lines, no speed lines, no comic action streaks, no radial zoom rays, no dramatic light beams, no god rays, no stylized light shafts, no lens streak artifacts, no motion-trail streaks, no glowing white outlines, no light bursts, and no artificial blur rays anywhere in frame.";
...
const CAMERA_MOVEMENT: Record<string, string> = {
    "product-review": "Smooth and subtle camera movement, stable composition",
    "brainrot-product": "Handheld smartphone style, dynamic but clear framing",
    "food-review": "Slow cinematic push-in, stable macro focus",
    "fashion-review": "Smooth vertical tilt or subtle tracking shot",
    "gadget-review": "Locked-off camera with very slow zoom in",
    "unboxing": "Stable top-down or slight angled steady shot",
    "comparison": "Fixed symmetrical locked-off camera",
    "testimonial": "Subtle documentary-style handheld, mostly stable",
    "flash-sale": "Dynamic but controlled camera, quick clear focus",
    "tutorial": "Locked-off steady camera, clear visibility",
    "lifestyle": "Smooth steadicam follow shot, natural pacing",
    "trending": "Vertical fixed framing, slight natural sway",
    "mini-drama": "Cinematic steady composition, slow deliberate push-in",
    "before-after": "Locked-off stable comparison shot"
};
...
const SCENE_TRANSITION: Record<string, string> = {
    "product-review": "Hard cut transition, ZERO object morphing, strict solid continuity, no clipping, product remains perfectly solid",
    "brainrot-product": "Hard jump cut style, matching energy between shots, continuous chaotic flow, solid objects",
    "food-review": "Clean hard cut, consistent warm color grading, solid food presentation, no shape shifting",
    "fashion-review": "Hard match cut on movement, consistent styling and lighting, solid fabric flow, no morphing",
    "gadget-review": "Clean hard cut on action, solid device geometry, absolutely NO morphing or clipping, consistent tech-clean grading",
    "unboxing": "Continuous single-take feel, solid object continuity, zero structural morphing",
    "comparison": "Hard cut split-screen capable transition, solid shapes, no blending between objects",
    "testimonial": "Clean hard cut, consistent warm intimate tone, solid character continuity",
    "flash-sale": "Fast hard cut on beat, solid product geometry, no transition warping",
    "tutorial": "Hard cut step-numbered transition, logical progression flow, solid physical objects",
    "lifestyle": "Clean hard cut, solid spatial awareness, zero object distortion",
    "trending": "Hard snap transition, solid dimensional structure, no morphing",
    "mini-drama": "Cinematic hard cut on emotion beat, solid actor/object continuity",
    "before-after": "Hard wipe or match cut, solid physical forms, no unnatural melting"
};
...
const PRODUCT_USAGE_REALISM: Partial<Record<ProductCategory, string>> = {
    ...
    underwear: "REALISTIC USAGE: Remove from packaging. Show holding up item to display fit and fabric quality. For review — show material close-up, elasticity, and tag with size info. Keep presentation highly tasteful, professional, and product-focused.",
    swimwear: "REALISTIC USAGE: Show product neatly held up or displayed. Demonstrate stretch and fit by holding the fabric. Show in appropriate pool/beach setting. Keep presentation tasteful and non-explicit.",
...
const buildVideoPrompt = (
    ...
    const scene1ProductBlock = isScene1TalkOnly
        ? `This first scene focuses entirely on the character speaking. NO products should be visible in the frame. The character uses natural body language without holding anything.`
...
export const buildSceneVideoPromptJSON = (
    ...
    // ── SEAMLESS TRANSITION ──
    const transitionDirective = `${meta.sceneTransition}. Continue the same action, screen direction, and eyeline from scene ${sceneNumber - 1} with a clean editorial hard cut. DO NOT use any cross-dissolve, morphing, light-leak, or blur transitions.`;
    ...
    const productBlock = isTalkOnly
        ? `This scene focuses entirely on the character speaking. NO products should be visible in the frame. The character uses natural body language without holding anything.`
