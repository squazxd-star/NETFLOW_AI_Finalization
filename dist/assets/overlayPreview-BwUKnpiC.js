import"./modulepreload-polyfill-B5Qt9EMX.js";const A={green:{rgb:"0, 255, 65",hex:"#00ff41",accentRgb:"0, 255, 180",accentHex:"#00ffb4",doneRgb:"34, 197, 94",doneHex:"#22c55e"},red:{rgb:"220, 38, 38",hex:"#dc2626",accentRgb:"251, 146, 60",accentHex:"#fb923c",doneRgb:"34, 197, 94",doneHex:"#22c55e"},blue:{rgb:"43, 125, 233",hex:"#2b7de9",accentRgb:"6, 182, 212",accentHex:"#06b6d4",doneRgb:"34, 197, 94",doneHex:"#22c55e"},yellow:{rgb:"234, 179, 8",hex:"#eab308",accentRgb:"245, 158, 11",accentHex:"#f59e0b",doneRgb:"34, 197, 94",doneHex:"#22c55e"},purple:{rgb:"139, 92, 246",hex:"#8b5cf6",accentRgb:"168, 85, 247",accentHex:"#a855f7",doneRgb:"34, 197, 94",doneHex:"#22c55e"}};let v=A.blue,O=null;function we(n){A[n]&&(O=n,v=A[n],le(),y&&(y.remove(),y=null),j(),requestAnimationFrame(()=>ue()))}function ye(){if(O&&A[O])return A[O];try{const n=localStorage.getItem("netflow_app_theme");if(n&&A[n])return A[n]}catch{}return A.blue}let C=43,E=125,S=233;function le(){const n=v.hex.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);n&&(C=parseInt(n[1],16),E=parseInt(n[2],16),S=parseInt(n[3],16))}const de='<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',ce='<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';let u=null,M=null,y=null,Q=0,Y=0,_=!1,L=null,H=null;performance.now();let B=1,$=[];function D(n){const e=[{stepId:"open-flow",label:"เปิด Google Flow",status:"waiting"},{stepId:"new-project",label:"สร้างโปรเจคใหม่",status:"waiting"},{stepId:"settings",label:"กำหนดค่าเริ่มต้น",status:"waiting"},{stepId:"upload-char",label:"อัปโหลดภาพตัวละคร",status:"waiting"},{stepId:"upload-prod",label:"อัปโหลดภาพสินค้า",status:"waiting"},{stepId:"img-prompt",label:"ใส่คำสั่งสร้างภาพ",status:"waiting"},{stepId:"img-generate",label:"สั่งสร้างภาพ",status:"waiting"},{stepId:"img-wait",label:"รอผลลัพธ์การสร้างภาพ",status:"waiting",progress:0},{stepId:"animate",label:"แปลงเป็นภาพเคลื่อนไหว",status:"waiting"}];if(n<=1)e.push({stepId:"vid-prompt",label:"ใส่คำสั่งสร้างวิดีโอ",status:"waiting"},{stepId:"vid-generate",label:"สั่งสร้างวิดีโอ",status:"waiting"},{stepId:"vid-wait",label:"กำลังสร้างวิดีโอ",status:"waiting",progress:0},{stepId:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{stepId:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{stepId:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"});else{e.push({stepId:"vid-prompt",label:"ฉาก 1 — ใส่คำสั่ง",status:"waiting"},{stepId:"vid-generate",label:"ฉาก 1 — สั่งสร้าง",status:"waiting"},{stepId:"vid-wait",label:"ฉาก 1 — กำลังสร้าง",status:"waiting",progress:0});for(let a=2;a<=n;a++)e.push({stepId:`scene${a}-prompt`,label:`ฉาก ${a} — ใส่คำสั่ง`,status:"waiting"},{stepId:`scene${a}-gen`,label:`ฉาก ${a} — สั่งสร้าง`,status:"waiting"},{stepId:`scene${a}-wait`,label:`ฉาก ${a} — กำลังสร้าง`,status:"waiting",progress:0});e.push({stepId:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{stepId:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{stepId:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"})}return e}const I=[{id:"ingest",title:"ASSET_INGEST",steps:[{id:"open-flow",label:"เปิด Google Flow",status:"waiting"},{id:"new-project",label:"สร้างโปรเจคใหม่",status:"waiting"},{id:"settings",label:"กำหนดค่าเริ่มต้น",status:"waiting"},{id:"upload-char",label:"อัปโหลดภาพตัวละคร",status:"waiting"},{id:"upload-prod",label:"อัปโหลดภาพสินค้า",status:"waiting"}]},{id:"image",title:"AI_IMAGE_SYNTHESIS",steps:[{id:"img-prompt",label:"ใส่คำสั่งสร้างภาพ",status:"waiting"},{id:"img-generate",label:"สั่งสร้างภาพ",status:"waiting"},{id:"img-wait",label:"รอผลลัพธ์การสร้างภาพ",status:"waiting",progress:0}]},{id:"video",title:"VIDEO_PRODUCTION",steps:[{id:"animate",label:"แปลงเป็นภาพเคลื่อนไหว",status:"waiting"},{id:"vid-prompt",label:"ใส่คำสั่งสร้างวิดีโอ",status:"waiting"},{id:"vid-generate",label:"สั่งสร้างวิดีโอ",status:"waiting"},{id:"vid-wait",label:"กำลังสร้างวิดีโอ",status:"waiting",progress:0}]},{id:"render",title:"FINAL_RENDER_OUTPUT",steps:[{id:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{id:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{id:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"}]}];$=D(1);function $e(n){const e=n.rgb,a=n.accentRgb,r=n.doneRgb,o=n.hex,l=n.accentHex,x=n.doneHex,i=(()=>{const f=o.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);if(!f)return"#4ade80";const t=g=>Math.min(255,g+80);return`#${[1,2,3].map(g=>t(parseInt(f[g],16)).toString(16).padStart(2,"0")).join("")}`})(),p=(()=>{const f=x.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);if(!f)return"#4ade80";const t=g=>Math.min(255,g+60);return`#${[1,2,3].map(g=>t(parseInt(f[g],16)).toString(16).padStart(2,"0")).join("")}`})(),s=o.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i),m=s?Math.max(parseInt(s[1],16),parseInt(s[2],16),parseInt(s[3],16),1):255,d=s?parseInt(s[1],16)/m:0,h=s?parseInt(s[2],16)/m:1,k=s?parseInt(s[3],16)/m:.25,w=f=>`${Math.round(d*f)}, ${Math.round(h*f)}, ${Math.round(k*f)}`;return`
/* ─── Google Font ─── */
...
.nf-step-done .nf-progress-fill {
    background: linear-gradient(90deg, ${x}, ${p});
}
...
@media (max-height: 600px) {
    ...
    `}function j(){y||(y=document.createElement("style"),y.id="netflow-overlay-styles",y.textContent=$e(v),document.head.appendChild(y))}function fe(n){n.innerHTML="",$.forEach((e,a)=>{const r=document.createElement("div");r.className="nf-proc-row nf-proc-waiting",r.id=`nf-proc-${e.stepId}`,r.innerHTML=`
            <span class="nf-proc-num">${a+1}</span>
            <span class="nf-proc-dot"></span>
            <span class="nf-proc-label">${e.label}</span>
            <span class="nf-proc-badge">(queued)</span>
        `,n.appendChild(r)})}function ge(){const n=document.getElementById("nf-terminal");if(!n)return;fe(n);const e=document.getElementById("nf-step-counter");e&&(e.textContent=`0/${$.length}`)}function ee(n,e){let i="";for(let h=0;h<20;h++){const k=h/20*Math.PI*2,w=(h+.2)/20*Math.PI*2,f=(h+.5)/20*Math.PI*2,t=(h+.8)/20*Math.PI*2,g=(h+1)/20*Math.PI*2;i+=`${h===0?"M":"L"}${(120+100*Math.cos(k)).toFixed(1)},${(120+100*Math.sin(k)).toFixed(1)} `,i+=`L${(120+100*Math.cos(w)).toFixed(1)},${(120+100*Math.sin(w)).toFixed(1)} `,i+=`L${(120+112*Math.cos(f)).toFixed(1)},${(120+112*Math.sin(f)).toFixed(1)} `,i+=`L${(120+100*Math.cos(t)).toFixed(1)},${(120+100*Math.sin(t)).toFixed(1)} `,i+=`L${(120+100*Math.cos(g)).toFixed(1)},${(120+100*Math.sin(g)).toFixed(1)} `}i+="Z";const p=14,s=72,m=62;let d="";for(let h=0;h<p;h++){const k=h/p*Math.PI*2,w=(h+.25)/p*Math.PI*2,f=(h+.75)/p*Math.PI*2,t=(h+1)/p*Math.PI*2;d+=`${h===0?"M":"L"}${(120+m*Math.cos(k)).toFixed(1)},${(120+m*Math.sin(k)).toFixed(1)} `,d+=`L${(120+s*Math.cos(w)).toFixed(1)},${(120+s*Math.sin(w)).toFixed(1)} `,d+=`L${(120+s*Math.cos(f)).toFixed(1)},${(120+s*Math.sin(f)).toFixed(1)} `,d+=`L${(120+m*Math.cos(t)).toFixed(1)},${(120+m*Math.sin(t)).toFixed(1)} `}return d+="Z",`<svg width="72" height="72" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    </svg>`}function ve(){const n=document.createElement("div");n.id="netflow-engine-overlay",L=document.createElement("canvas"),L.id="nf-matrix-canvas",n.appendChild(L);const e=document.createElement("div");e.className="nf-pat-plasma",n.appendChild(e);for(let c=1;c<=2;c++){const b=document.createElement("div");b.className=`nf-ambient-orb nf-orb-${c}`,n.appendChild(b)}const a=document.createElement("div");a.className="nf-pat-diag-a",n.appendChild(a);const r=document.createElement("div");r.className="nf-pat-noise",n.appendChild(r);const o=document.createElement("div");o.className="nf-crt-scanlines",n.appendChild(o);const l=document.createElement("div");l.className="nf-vignette",n.appendChild(l);for(let c=0;c<2;c++){const b=document.createElement("div");b.className="nf-pulse-ring",n.appendChild(b)}["nf-deco-tl","nf-deco-tr","nf-deco-bl","nf-deco-br"].forEach(c=>{const b=document.createElement("div");b.className=`nf-corner-deco ${c}`,n.appendChild(b)});const x=document.createElement("button");x.className="nf-stop-btn",x.innerHTML='<span class="nf-stop-icon"></span> หยุด',x.style.cssText="position:absolute !important;top:14px !important;right:110px !important;z-index:2147483646 !important;cursor:pointer !important;pointer-events:auto !important;background:rgba(255,60,60,0.08) !important;border:1px solid rgba(255,60,60,0.25) !important;border-radius:8px !important;color:rgba(255,100,100,0.8) !important;font-size:13px !important;padding:6px 14px !important;font-family:inherit !important;display:flex !important;align-items:center !important;gap:6px !important;",x.onclick=()=>{var c;window.__NETFLOW_STOP__=!0;try{P("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{typeof chrome<"u"&&((c=chrome.runtime)!=null&&c.sendMessage)&&chrome.runtime.sendMessage({action:"AUTOMATION_STOPPED"})}catch{}},n.appendChild(x);const i=document.createElement("div");i.className="nf-layout";const p=document.createElement("div");p.className="nf-core-monitor",p.id="nf-core-monitor";const s=document.createElement("div");s.className="nf-core-header",s.innerHTML=`
        <div class="nf-core-title">
            <span class="nf-core-title-label">NETFLOW CORE:</span>
            <span class="nf-core-title-val">ACTIVE</span>
            <span class="nf-status-dot"></span>
        </div>
        <div class="nf-core-counter" id="nf-step-counter">0/${$.length}</div>
    `,p.appendChild(s);const m=document.createElement("div");m.className="nf-terminal",m.id="nf-terminal",fe(m),p.appendChild(m);const d=document.createElement("div");d.className="nf-engine-core",d.id="nf-engine-core";const h=document.createElement("div");h.className="nf-engine-frame",["nf-fc-tl","nf-fc-tr","nf-fc-bl","nf-fc-br"].forEach(c=>{const b=document.createElement("div");b.className=`nf-frame-corner ${c}`,h.appendChild(b)}),d.appendChild(h);const k="http://www.w3.org/2000/svg",w=document.createElementNS(k,"svg");w.setAttribute("class","nf-engine-waves"),w.setAttribute("viewBox","0 0 560 140"),w.setAttribute("preserveAspectRatio","none"),w.id="nf-engine-waves";for(let c=0;c<4;c++){const b=document.createElementNS(k,"path");b.setAttribute("fill","none"),b.setAttribute("stroke-width",c<2?"1.5":"1"),b.setAttribute("stroke",c<2?`rgba(${v.rgb},${.14+c*.1})`:`rgba(${v.accentRgb},${.1+(c-2)*.08})`),b.setAttribute("data-wave-idx",String(c)),w.appendChild(b)}d.appendChild(w);const f=document.createElement("div");f.className="nf-engine-brand-inner",f.innerHTML=`
        <div class="nf-brand-gear-icon nf-brand-gear-left">
            ${ee(v.rgb,v.accentRgb)}
        </div>
        <div class="nf-brand-inner-text">NETFLOW AI ENGINE V1.0</div>
        <div class="nf-brand-gear-icon nf-brand-gear-right">
            ${ee(v.rgb,v.accentRgb)}
        </div>
    `,d.appendChild(f);const t=document.createElement("div");t.className="nf-engine-stats",t.id="nf-engine-stats",t.innerHTML=[["SCENES","nf-stat-scenes","1/1"],["ELAPSED","nf-stat-elapsed","00:00"],["STEP","nf-stat-step","0/0"],["STATUS","nf-stat-status","READY"],["PROGRESS","nf-stat-progress","—"]].map(([c,b,z])=>`<div class="nf-stat-item"><span class="nf-stat-label">${c}</span><span class="nf-stat-val" id="${b}">${z}</span></div>`).join(""),d.appendChild(t),p.appendChild(d),i.appendChild(p);const g=["nf-mod-tl","nf-mod-tr","nf-mod-bl","nf-mod-br"];I.forEach((c,b)=>{const z=ke(c);z.classList.add(g[b]),z.id=`nf-mod-${c.id}`,i.appendChild(z)}),n.appendChild(i);for(let c=0;c<10;c++){const b=document.createElement("div");b.className="nf-particle",b.style.left=`${5+Math.random()*90}%`,b.style.bottom=`${Math.random()*40}%`,b.style.animationDuration=`${3+Math.random()*5}s`,b.style.animationDelay=`${Math.random()*4}s`;const z=.3+Math.random()*.4,R=.7+Math.random()*.3;b.style.background=`rgba(${Math.floor(C*R)}, ${Math.floor(E*R)}, ${Math.floor(S*R)}, ${z})`,b.style.width=`${1+Math.random()*2}px`,b.style.height=b.style.width,n.appendChild(b)}return n}function ke(n){const e=document.createElement("div");e.className="nf-module";const a=document.createElement("div");a.className="nf-mod-header",a.innerHTML=`
        <div class="nf-mod-title">${n.title}</div>
        <span class="nf-mod-pct" id="nf-pct-${n.id}">0%</span>
    `,e.appendChild(a),n.steps.forEach(o=>{const l=document.createElement("div");l.className="nf-step",l.id=`nf-step-${o.id}`;let x="";o.progress!==void 0&&(x=`
            ...
            ${x}
        `,e.appendChild(l)});const r=document.createElement("div");return r.className="nf-mod-progress",r.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${n.id}"></div>`,e.appendChild(r),e}function Me(){Q=Date.now(),setInterval(()=>{const n=Math.floor((Date.now()-Q)/1e3),e=String(Math.floor(n/60)).padStart(2,"0"),a=String(n%60).padStart(2,"0"),r=document.getElementById("nf-timer");r&&(r.textContent=`${e}:${a}`);const o=document.getElementById("nf-stat-elapsed");o&&(o.textContent=`${e}:${a}`)},1e3)}const Ce=50,te=120,ne=.4;let N=null,ae=0,re=0,oe=0,V=[];function Ee(n,e){V=[];for(let a=0;a<Ce;a++){const r=Math.random();let o;r<.22?o=0:r<.4?o=1:r<.55?o=2:r<.68?o=3:r<.84?o=4:o=5;const l=Math.random()*n,x=Math.random()*e,i=50+Math.random()*220,p=Math.random()*Math.PI*2,s=(.003+Math.random()*.008)*(Math.random()>.5?1:-1);V.push({x:o===0?Math.random()*n:l+Math.cos(p)*i,y:o===0?Math.random()*e:x+Math.sin(p)*i,vx:(Math.random()-.5)*ne,vy:(Math.random()-.5)*ne,radius:1.2+Math.random()*2.5,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03,motion:o,oCx:l,oCy:x,oRadius:i,oAngle:p,oSpeed:s})}}function Se(){if(!L)return;const n=L;if(H=n.getContext("2d"),!H)return;const e=()=>{n.width=window.innerWidth,n.height=window.innerHeight,V.length===0&&Ee(n.width,n.height)};e(),window.addEventListener("resize",e);let a=null,r=0,o=0,l=!1;function x(){if(!H||!L||(requestAnimationFrame(x),l=!l,l))return;const i=H,p=L.width,s=L.height;i.fillStyle=`rgba(${C*.04|0},${E*.04|0},${S*.06|0},1)`,i.fillRect(0,0,p,s),(!a||r!==p||o!==s)&&(r=p,o=s,a=i.createRadialGradient(p*.5,s*.5,0,p*.5,s*.5,Math.max(p,s)*.6),a.addColorStop(0,`rgba(${C*.08|0},${E*.08|0},${S*.1|0},0.4)`),a.addColorStop(1,"rgba(0,0,0,0)")),i.fillStyle=a,i.fillRect(0,0,p,s);const m=V,d=m.length,h=te*te;for(let f=0;f<d;f++){const t=m[f];if(t.pulsePhase+=t.pulseSpeed,t.motion===0)t.x+=t.vx,t.y+=t.vy,t.x<0?(t.x=0,t.vx=Math.abs(t.vx)*(.8+Math.random()*.4)):t.x>p&&(t.x=p,t.vx=-Math.abs(t.vx)*(.8+Math.random()*.4)),t.y<0?(t.y=0,t.vy=Math.abs(t.vy)*(.8+Math.random()*.4)):t.y>s&&(t.y=s,t.vy=-Math.abs(t.vy)*(.8+Math.random()*.4));else if(t.motion===1)t.oAngle+=t.oSpeed,t.x=t.oCx+Math.cos(t.oAngle)*t.oRadius,t.y=t.oCy+Math.sin(t.oAngle)*t.oRadius,t.oCx+=Math.sin(t.oAngle*.3)*.15,t.oCy+=Math.cos(t.oAngle*.3)*.15;else if(t.motion===2)t.oAngle+=t.oSpeed,t.x=t.oCx+Math.cos(t.oAngle)*t.oRadius,t.y=t.oCy+Math.sin(t.oAngle)*t.oRadius*.5,t.oCx+=Math.sin(t.oAngle*.2)*.1,t.oCy+=Math.cos(t.oAngle*.2)*.1;else if(t.motion===3){t.oAngle+=t.oSpeed;const g=t.oAngle,c=t.oRadius*.7;t.x=t.oCx+c*Math.cos(g),t.y=t.oCy+c*Math.sin(g)*Math.cos(g),t.oCx+=Math.sin(g*.15)*.12,t.oCy+=Math.cos(g*.15)*.12}else if(t.motion===4){t.oAngle+=t.oSpeed*1.2;const g=t.oRadius*(.5+.5*Math.abs(Math.sin(t.oAngle*.15)));t.x=t.oCx+Math.cos(t.oAngle)*g,t.y=t.oCy+Math.sin(t.oAngle)*g,t.oCx+=Math.sin(t.oAngle*.1)*.18,t.oCy+=Math.cos(t.oAngle*.1)*.18}else t.oAngle+=t.oSpeed,t.x+=t.vx*.8,t.y=t.oCy+Math.sin(t.oAngle+t.x*.008)*t.oRadius*.35,t.x<-30?t.x=p+30:t.x>p+30&&(t.x=-30),t.oCy+=Math.sin(t.oAngle*.1)*.08;if(t.motion>0){const g=t.oRadius+50;t.oCx<-g?t.oCx=p+g:t.oCx>p+g&&(t.oCx=-g),t.oCy<-g?t.oCy=s+g:t.oCy>s+g&&(t.oCy=-g)}}i.beginPath(),i.strokeStyle=`rgba(${C},${E},${S},0.06)`,i.lineWidth=.4;const k=new Path2D;for(let f=0;f<d;f++){const t=m[f];for(let g=f+1;g<d;g++){const c=m[g],b=t.x-c.x,z=t.y-c.y,R=b*b+z*z;R<h&&(1-R/h<.4?(i.moveTo(t.x,t.y),i.lineTo(c.x,c.y)):(k.moveTo(t.x,t.y),k.lineTo(c.x,c.y)))}}if(i.stroke(),i.strokeStyle=`rgba(${C},${E},${S},0.18)`,i.lineWidth=.8,i.stroke(k),!N||ae!==C||re!==E||oe!==S){N=document.createElement("canvas");const f=48;N.width=f,N.height=f;const t=N.getContext("2d"),g=t.createRadialGradient(f/2,f/2,0,f/2,f/2,f/2);g.addColorStop(0,`rgba(${C},${E},${S},0.9)`),g.addColorStop(.3,`rgba(${C},${E},${S},0.35)`),g.addColorStop(1,`rgba(${C},${E},${S},0)`),t.fillStyle=g,t.fillRect(0,0,f,f),ae=C,re=E,oe=S}const w=N;for(let f=0;f<d;f++){const t=m[f],g=.6+.4*Math.sin(t.pulsePhase),c=t.radius*5*(.8+g*.4);i.globalAlpha=.5+g*.4,i.drawImage(w,t.x-c/2,t.y-c/2,c,c)}i.globalAlpha=1,i.fillStyle="rgba(255,255,255,0.45)",i.beginPath();for(let f=0;f<d;f++){const t=m[f];if(t.radius>2){const g=.6+.4*Math.sin(t.pulsePhase),c=t.radius*(.8+g*.4)*.35;i.moveTo(t.x+c,t.y),i.arc(t.x,t.y,c,0,Math.PI*2)}}i.fill()}x()}let F=null;const U=560,ze=140,ie=U/2,se=ze/2,xe=[];for(let n=0;n<=U;n+=8){const e=Math.abs(n-ie)/ie;xe.push(Math.pow(Math.min(1,e*1.6),.6))}const Ie=[0,1,2,3].map(n=>({amp:10+n*5,freq:(1.2+n*.35)*Math.PI*2/U,off:n*.6,spd:.7+n*.12}));let W=!1;function me(){if(requestAnimationFrame(me),W=!W,W)return;if(Y+=.07,!F){const e=document.getElementById("nf-engine-waves");if(!e)return;F=Array.from(e.querySelectorAll("path"))}const n=[];for(let e=0;e<F.length;e++){const a=Ie[e],r=Y*a.spd+a.off;n.length=0,n.push(`M 0 ${se}`);let o=0;for(let l=0;l<=U;l+=8){const x=se+a.amp*xe[o++]*Math.sin(l*a.freq+r);n.push(`L${l} ${x*10+.5|0}`)}F[e].setAttribute("d",n.join(" "))}}function Te(){Y=0,me(),Se(),setInterval(()=>{const n=document.getElementById("nf-stat-freq"),e=document.getElementById("nf-stat-lat1"),a=document.getElementById("nf-stat-lat2"),r=document.getElementById("nf-stat-buf");n&&(n.textContent=`${(4.5+Math.random()*.5).toFixed(1)} GHz`),e&&(e.textContent=`${Math.floor(12+Math.random()*10)}ms`),a&&(a.textContent=`${Math.floor(12+Math.random()*10)}ms`),r&&(r.textContent=`${Math.floor(90+Math.random()*9)}%`)},2e3)}function X(){let n=0;const e=$.filter(s=>s.status!=="skipped").length;for(const s of $){const m=document.getElementById(`nf-proc-${s.stepId}`);if(!m)continue;m.className="nf-proc-row";const d=m.querySelector(".nf-proc-badge");switch(s.status){case"done":m.classList.add("nf-proc-done"),d&&(d.textContent="✅ done"),n++;break;case"active":m.classList.add("nf-proc-active"),d&&(d.textContent=s.progress!==void 0&&s.progress>0?`⏳ ${s.progress}%`:"⏳ active");break;case"error":m.classList.add("nf-proc-error"),d&&(d.textContent="❌ error");break;case"skipped":m.classList.add("nf-proc-skipped"),d&&(d.textContent="— skip");break;default:m.classList.add("nf-proc-waiting"),d&&(d.textContent="(queued)")}}const a=$.findIndex(s=>s.status==="active"),r=a>=0?a+1:n>=e&&e>0?$.length:n,o=document.getElementById("nf-step-counter");o&&(o.textContent=`${r}/${$.length}`);const l=document.querySelector(".nf-core-title-val"),x=document.querySelector(".nf-status-dot");n>=e&&e>0?(l&&(l.textContent="COMPLETE",l.style.color=v.doneHex),x&&(x.style.background=v.doneHex,x.style.boxShadow=`0 0 8px rgba(${v.doneRgb},0.7)`)):$.some(m=>m.status==="error")?(l&&(l.textContent="ERROR",l.style.color="#f87171"),x&&(x.style.background="#ef4444",x.style.boxShadow="0 0 8px rgba(239,68,68,0.7)")):$.some(m=>m.status==="active")&&l&&(l.textContent="ACTIVE",l.style.color=v.hex,l.style.textShadow=`0 0 10px rgba(${v.rgb},0.5)`);const i=document.getElementById("nf-terminal"),p=i==null?void 0:i.querySelector(".nf-proc-active");p&&i&&p.scrollIntoView({behavior:"smooth",block:"center"})}function be(){M&&M.isConnected||(j(),M=document.createElement("button"),M.id="nf-toggle-btn",M.className="nf-toggle-visible",M.innerHTML=_?de:ce,M.title="ซ่อน/แสดง Netflow Overlay",M.style.cssText="position:fixed !important;top:20px !important;right:20px !important;z-index:2147483647 !important;width:48px !important;height:48px !important;border-radius:50% !important;border:2px solid rgba(255,255,255,0.5) !important;background:rgba(0,0,0,0.85) !important;color:#fff !important;font-size:23px !important;cursor:pointer !important;display:flex !important;align-items:center !important;justify-content:center !important;pointer-events:auto !important;",M.onclick=()=>he(),document.body.appendChild(M))}function he(){u&&(be(),_?(u.classList.remove("nf-hidden"),u.classList.add("nf-visible"),u.style.opacity="1",u.style.pointerEvents="auto",M&&(M.innerHTML=ce),_=!1):(u.classList.remove("nf-visible"),u.classList.add("nf-hidden"),u.style.opacity="0",u.style.pointerEvents="none",M&&(M.innerHTML=de),_=!0))}const pe={red:"themes/theme-red.jpg",yellow:"themes/theme-yellow.jpg",blue:"themes/theme-blue.jpg",purple:"themes/theme-purple.jpg",green:"themes/theme-green.jpg"};function ue(){const n=document.getElementById("nf-core-monitor");if(!n)return;let e=O;if(!e)try{e=localStorage.getItem("netflow_app_theme")||"blue"}catch{e="blue"}const a=pe[e]||pe.blue;let r;try{r=chrome.runtime.getURL(a)}catch{r=`/${a}`}const o=v.rgb;n.style.backgroundImage=["linear-gradient(180deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 45%, rgba(0,0,0,0.90) 100%)",`linear-gradient(180deg, rgba(${o},0.25) 0%, rgba(${o},0.12) 50%, rgba(${o},0.20) 100%)`,`url('${r}')`].join(", "),n.style.backgroundSize="auto, auto, 50%",n.style.backgroundPosition="center, center, center",n.style.backgroundRepeat="no-repeat, no-repeat, no-repeat",n.style.setProperty("--nf-bg-set","1"),n.style.border=`1.5px solid rgba(${o},0.45)`,n.style.boxShadow=`0 0 70px rgba(${o},0.22), 0 0 140px rgba(${o},0.1), inset 0 1px 0 rgba(${o},0.15)`}function Pe(n=1){if(v=ye(),le(),u&&u.isConnected){u.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;background:#0a0a0f !important;overflow:hidden !important;font-family:Inter,system-ui,-apple-system,sans-serif !important;",(!y||!y.isConnected)&&(y=null,j()),setTimeout(()=>{if(u)try{y!=null&&y.sheet&&y.sheet.cssRules.length>0&&(u.style.removeProperty("background"),u.style.removeProperty("font-family"),u.style.removeProperty("overflow"))}catch{}},200);for(const e of I)for(const a of e.steps)a.status="waiting",a.progress=a.progress!==void 0?0:void 0;B=n,$=D(n),ge();for(const e of I)q(e);if(K(),X(),!u.querySelector(".nf-stop-btn")){const e=document.createElement("button");e.className="nf-stop-btn",e.innerHTML='<span class="nf-stop-icon"></span> หยุด',e.style.cssText="position:absolute !important;top:14px !important;right:110px !important;z-index:2147483646 !important;cursor:pointer !important;pointer-events:auto !important;background:rgba(255,60,60,0.08) !important;border:1px solid rgba(255,60,60,0.25) !important;border-radius:8px !important;color:rgba(255,100,100,0.8) !important;font-size:13px !important;padding:6px 14px !important;font-family:inherit !important;display:flex !important;align-items:center !important;gap:6px !important;",e.onclick=()=>{var a;window.__NETFLOW_STOP__=!0;try{P("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{typeof chrome<"u"&&((a=chrome.runtime)!=null&&a.sendMessage)&&chrome.runtime.sendMessage({action:"AUTOMATION_STOPPED"})}catch{}},u.appendChild(e)}_&&he();return}u&&!u.isConnected&&(u=null),y&&(y.remove(),y=null),j();for(const e of I)for(const a of e.steps)a.status="waiting",a.progress=a.progress!==void 0?0:void 0;if(B=n,$=D(n),n>1){const e=I.find(r=>r.id==="video");if(e){const r=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:"waiting",progress:0}];for(let o=2;o<=n;o++)r.push({id:`scene${o}-prompt`,label:`Scene ${o} Prompt`,status:"waiting"}),r.push({id:`scene${o}-gen`,label:`Scene ${o} Generate`,status:"waiting"}),r.push({id:`scene${o}-wait`,label:`Scene ${o} รอผล`,status:"waiting",progress:0});e.steps=r}const a=I.find(r=>r.id==="render");if(a){const r=a.steps.find(l=>l.id==="download");r&&(r.label="ดาวน์โหลด 720p");const o=a.steps.find(l=>l.id==="upscale");o&&(o.label="Full Video")}}u=ve(),u.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;background:#0a0a0f !important;overflow:hidden !important;font-family:Inter,system-ui,-apple-system,sans-serif !important;",document.body.appendChild(u),u.classList.add("nf-visible"),_=!1,be(),Me(),Te(),requestAnimationFrame(()=>ue()),setTimeout(()=>{if(u)try{y!=null&&y.sheet&&y.sheet.cssRules.length>0&&(u.style.removeProperty("background"),u.style.removeProperty("font-family"),u.style.removeProperty("overflow"))}catch{}},200)}const Ae={settings:"SETTINGS","upload-char":"UPLOAD","upload-prod":"UPLOAD","img-prompt":"PROMPT","img-generate":"GENERATE","img-wait":"IMG WAIT",animate:"ANIMATE","vid-prompt":"VID PROMPT","vid-generate":"VID GEN","vid-wait":"VID WAIT",download:"DOWNLOAD",upscale:"UPSCALE",open:"OPENING"};function Le(n,e,a){const r=$.findIndex(d=>d.status==="active"),o=$.filter(d=>d.status==="done").length,l=$.length,x=r>=0?r+1:o>=l?l:o,i=document.getElementById("nf-stat-step");i&&(i.textContent=`${x}/${l}`);let p=1;for(const d of $)if(d.status==="active"||d.status==="done")if(d.stepId.startsWith("scene")){const h=d.stepId.match(/^scene(\d+)-/);h&&(p=Math.max(p,parseInt(h[1],10)))}else(d.stepId==="download"||d.stepId==="upscale"||d.stepId==="open")&&(p=B);const s=document.getElementById("nf-stat-scenes");if(s&&(s.textContent=B>1?`${p}/${B}`:"1/1"),e==="active"){const d=document.getElementById("nf-stat-status"),h=Ae[n]||n.toUpperCase();d&&(d.textContent=h)}else if(e==="done"&&o>=l){const d=document.getElementById("nf-stat-status");d&&(d.textContent="COMPLETE")}else if(e==="error"){const d=document.getElementById("nf-stat-status");d&&(d.textContent="ERROR")}const m=document.getElementById("nf-stat-progress");m&&e==="active"&&(m.textContent="—")}function T(n,e,a){if(!u)return;for(const o of I)for(const l of o.steps)l.id===n&&(l.status=e);for(const o of $)o.stepId===n&&(o.status=e);const r=document.getElementById(`nf-step-${n}`);r&&(r.className="nf-step",e==="active"?r.classList.add("nf-step-active"):e==="done"?r.classList.add("nf-step-done"):e==="error"&&r.classList.add("nf-step-error")),Le(n,e),K(),X()}function K(){for(const n of I){const e=n.steps.filter(p=>p.status!=="skipped").length,a=n.steps.filter(p=>p.status==="done").length,r=n.steps.some(p=>p.status==="active"),o=e>0?Math.round(a/e*100):0,l=document.getElementById(`nf-pct-${n.id}`);l&&(l.textContent=`${o}%`);const x=document.getElementById(`nf-modbar-${n.id}`);x&&(x.style.width=`${o}%`);const i=document.getElementById(`nf-mod-${n.id}`);i&&(i.classList.remove("nf-active","nf-done"),o>=100?i.classList.add("nf-done"):r&&i.classList.add("nf-active"))}}function Re(n){var r,o,l,x;B=n;const e=new Map;for(const i of $)e.set(i.stepId,{status:i.status,progress:i.progress});$=D(n);for(const i of $){const p=e.get(i.stepId);p&&(i.status=p.status,p.progress!==void 0&&(i.progress=p.progress))}ge();{const i=I.find(p=>p.id==="video");if(i){const p=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:((r=i.steps.find(s=>s.id==="animate"))==null?void 0:r.status)||"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:((o=i.steps.find(s=>s.id==="vid-prompt"))==null?void 0:o.status)||"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:((l=i.steps.find(s=>s.id==="vid-generate"))==null?void 0:l.status)||"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:((x=i.steps.find(s=>s.id==="vid-wait"))==null?void 0:x.status)||"waiting",progress:0}];for(let s=2;s<=n;s++)p.push({id:`scene${s}-prompt`,label:`Scene ${s} Prompt`,status:"waiting"}),p.push({id:`scene${s}-gen`,label:`Scene ${s} Generate`,status:"waiting"}),p.push({id:`scene${s}-wait`,label:`Scene ${s} รอผล`,status:"waiting",progress:0});i.steps=p,q(i)}}const a=I.find(i=>i.id==="render");if(a&&n>1){const i=a.steps.find(s=>s.id==="download");i&&(i.label="ดาวน์โหลด 720p");const p=a.steps.find(s=>s.id==="upscale");p&&(p.label="Full Video"),q(a)}K(),X()}function q(n){const e=document.getElementById(`nf-mod-${n.id}`);if(!e)return;e.querySelectorAll(".nf-step, .nf-mod-progress").forEach(o=>o.remove()),n.steps.forEach(o=>{const l=document.createElement("div");l.className="nf-step",l.id=`nf-step-${o.id}`;let x="";o.progress!==void 0&&(x=`
                <div class="nf-progress-bar">
                    <div class="nf-progress-fill" id="nf-bar-${o.id}" style="width: 0%"></div>
                </div>
            `),l.innerHTML=`
            ...
            <span class="nf-step-label">${o.label}</span>
            ${x}
        `,e.appendChild(l)});const r=document.createElement("div");r.className="nf-mod-progress",r.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${n.id}"></div>`,e.appendChild(r)}function P(n){n.replace(/^\[Netflow AI\]\s*/,"")}window.chrome={runtime:{sendMessage:()=>{},lastError:null},storage:{local:{get:(n,e)=>e==null?void 0:e({}),set:()=>{}}}};const J=new URLSearchParams(location.search).get("theme")||"red";we(J);Re(2);Pe();setTimeout(()=>{P("🚀 Overlay preview started — theme: "+J),T("settings","active")},400);setTimeout(()=>{T("settings","done"),T("upload","active"),P("✅ Settings configured")},1600);setTimeout(()=>{T("upload","done"),T("prompt","active"),P("✅ Images uploaded (2 refs)")},3e3);setTimeout(()=>{T("prompt","done"),T("generate","active"),P("✅ Prompt injected"),P("⏳ Waiting for Scene 1 generation...")},4500);setTimeout(()=>{T("generate","done"),T("scene2","active"),P("✅ Scene 1 generated"),P("⏳ Generating Scene 2...")},7e3);const Z=document.createElement("div");Z.style.cssText=`
    position: fixed; bottom: 16px; right: 16px; z-index: 99999999;
    display: flex; gap: 8px; align-items: center;
`;const Ne=["red","blue","green","yellow","purple"],G={red:"#ef4444",blue:"#3b82f6",green:"#00ff41",yellow:"#eab308",purple:"#8b5cf6"};Ne.forEach(n=>{const e=document.createElement("button");e.textContent=n,e.style.cssText=`
        background: ${G[n]}22; border: 1.5px solid ${G[n]};
        color: ${G[n]}; padding: 4px 10px; border-radius: 6px;
        cursor: pointer; font-size: 11px; font-family: monospace; font-weight: 700;
        ${n===J?"opacity:1; box-shadow: 0 0 8px "+G[n]:"opacity:0.5"};
    `,e.onclick=()=>location.search="?theme="+n,Z.appendChild(e)});document.body.appendChild(Z);
