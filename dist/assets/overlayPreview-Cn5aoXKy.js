...
.nf-proc-skipped {
    ...
    </g>`);for(let c=0;c<8;c++){const m=c/8*Math.PI*2,h=120+k*Math.cos(m),u=120+k*Math.sin(m),v=b(h,u,10,14,10),F=c%2===0?"":"animation-direction:reverse;";S.push(`<g class="nf-kinetic-sub" style="transform-origin:${h.toFixed(1)}px ${u.toFixed(1)}px;${F}">
