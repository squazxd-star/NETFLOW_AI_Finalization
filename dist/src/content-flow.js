(function(){"use strict";const de={green:{rgb:"0, 255, 65",hex:"#00ff41",accentRgb:"0, 255, 180",accentHex:"#00ffb4",doneRgb:"34, 197, 94",doneHex:"#22c55e"},red:{rgb:"220, 38, 38",hex:"#dc2626",accentRgb:"251, 146, 60",accentHex:"#fb923c",doneRgb:"34, 197, 94",doneHex:"#22c55e"},blue:{rgb:"43, 125, 233",hex:"#2b7de9",accentRgb:"6, 182, 212",accentHex:"#06b6d4",doneRgb:"34, 197, 94",doneHex:"#22c55e"},yellow:{rgb:"234, 179, 8",hex:"#eab308",accentRgb:"245, 158, 11",accentHex:"#f59e0b",doneRgb:"34, 197, 94",doneHex:"#22c55e"},purple:{rgb:"139, 92, 246",hex:"#8b5cf6",accentRgb:"168, 85, 247",accentHex:"#a855f7",doneRgb:"34, 197, 94",doneHex:"#22c55e"}};let Q=de.green,ke=null;function Ge(t){t&&de[t]&&(ke=t,Q=de[t],tt(),requestAnimationFrame(()=>Et()))}function Ft(){if(ke&&de[ke])return de[ke];try{const t=localStorage.getItem("netflow_app_theme");if(t&&de[t])return de[t]}catch{}return de.green}let te=0,ne=255,oe=65;function tt(){const t=Q.hex.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);t&&(te=parseInt(t[1],16),ne=parseInt(t[2],16),oe=parseInt(t[3],16))}const nt='<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',ot='<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';let W=null,K=null,pe=null,it=0,De=null,Ce=null,Fe=null,He=0,fe=!1,le=null,Te=null,Me=null,he=1,Y=[];function Oe(t){const e=[{stepId:"settings",label:"กำหนดค่าเริ่มต้น",status:"waiting"},{stepId:"upload-char",label:"อัปโหลดภาพตัวละคร",status:"waiting"},{stepId:"upload-prod",label:"อัปโหลดภาพสินค้า",status:"waiting"},{stepId:"img-prompt",label:"ใส่คำสั่งสร้างภาพ",status:"waiting"},{stepId:"img-generate",label:"สั่งสร้างภาพ",status:"waiting"},{stepId:"img-wait",label:"รอผลลัพธ์การสร้างภาพ",status:"waiting",progress:0},{stepId:"animate",label:"แปลงเป็นภาพเคลื่อนไหว",status:"waiting"}];if(t<=1)e.push({stepId:"vid-prompt",label:"ใส่คำสั่งสร้างวิดีโอ",status:"waiting"},{stepId:"vid-generate",label:"สั่งสร้างวิดีโอ",status:"waiting"},{stepId:"vid-wait",label:"กำลังสร้างวิดีโอ",status:"waiting",progress:0},{stepId:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{stepId:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{stepId:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"});else{e.push({stepId:"vid-prompt",label:"ฉาก 1 — ใส่คำสั่ง",status:"waiting"},{stepId:"vid-generate",label:"ฉาก 1 — สั่งสร้าง",status:"waiting"},{stepId:"vid-wait",label:"ฉาก 1 — กำลังสร้าง",status:"waiting",progress:0});for(let r=2;r<=t;r++)e.push({stepId:`scene${r}-prompt`,label:`ฉาก ${r} — ใส่คำสั่ง`,status:"waiting"},{stepId:`scene${r}-gen`,label:`ฉาก ${r} — สั่งสร้าง`,status:"waiting"},{stepId:`scene${r}-wait`,label:`ฉาก ${r} — กำลังสร้าง`,status:"waiting",progress:0});e.push({stepId:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{stepId:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{stepId:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"})}return e}const re=[{id:"ingest",title:"ASSET_INGEST",steps:[{id:"settings",label:"กำหนดค่าเริ่มต้น",status:"waiting"},{id:"upload-char",label:"อัปโหลดภาพตัวละคร",status:"waiting"},{id:"upload-prod",label:"อัปโหลดภาพสินค้า",status:"waiting"}]},{id:"image",title:"AI_IMAGE_SYNTHESIS",steps:[{id:"img-prompt",label:"ใส่คำสั่งสร้างภาพ",status:"waiting"},{id:"img-generate",label:"สั่งสร้างภาพ",status:"waiting"},{id:"img-wait",label:"รอผลลัพธ์การสร้างภาพ",status:"waiting",progress:0}]},{id:"video",title:"VIDEO_PRODUCTION",steps:[{id:"animate",label:"แปลงเป็นภาพเคลื่อนไหว",status:"waiting"},{id:"vid-prompt",label:"ใส่คำสั่งสร้างวิดีโอ",status:"waiting"},{id:"vid-generate",label:"สั่งสร้างวิดีโอ",status:"waiting"},{id:"vid-wait",label:"กำลังสร้างวิดีโอ",status:"waiting",progress:0}]},{id:"render",title:"FINAL_RENDER_OUTPUT",steps:[{id:"download",label:"ดาวน์โหลดวิดีโอ",status:"waiting"},{id:"upscale",label:"อัปสเกลความละเอียด",status:"waiting",progress:0},{id:"open",label:"เปิดดูตัวอย่างวิดีโอ",status:"waiting"}]}];Y=Oe(1);function Ot(t){const e=t.rgb,r=t.accentRgb,a=t.doneRgb,i=t.hex,p=t.accentHex,l=t.doneHex,c=(()=>{const g=i.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);if(!g)return"#4ade80";const o=f=>Math.min(255,f+80);return`#${[1,2,3].map(f=>o(parseInt(g[f],16)).toString(16).padStart(2,"0")).join("")}`})(),s=(()=>{const g=l.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i);if(!g)return"#4ade80";const o=f=>Math.min(255,f+60);return`#${[1,2,3].map(f=>o(parseInt(g[f],16)).toString(16).padStart(2,"0")).join("")}`})(),d=i.match(/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i),w=d?Math.max(parseInt(d[1],16),parseInt(d[2],16),parseInt(d[3],16),1):255,v=d?parseInt(d[1],16)/w:0,S=d?parseInt(d[2],16)/w:1,F=d?parseInt(d[3],16)/w:.25,P=g=>`${Math.round(v*g)}, ${Math.round(S*g)}, ${Math.round(F*g)}`;return`
/* ─── Google Font ─── */
...
@media (max-height: 600px) {
    ...
    `}function at(){pe||(pe=document.createElement("style"),pe.id="netflow-overlay-styles",pe.textContent=Ot(Q),document.head.appendChild(pe))}function rt(t){t.innerHTML="",Y.forEach((e,r)=>{const a=document.createElement("div");a.className="nf-proc-row nf-proc-waiting",a.id=`nf-proc-${e.stepId}`,a.innerHTML=`
            <span class="nf-proc-num">${r+1}</span>
            <span class="nf-proc-dot"></span>
            <span class="nf-proc-label">${e.label}</span>
            <span class="nf-proc-badge">(queued)</span>
        `,t.appendChild(a)})}function st(){const t=document.getElementById("nf-terminal");if(!t)return;rt(t);const e=document.getElementById("nf-step-counter");e&&(e.textContent=`0/${Y.length}`)}function lt(t,e){let c="";for(let S=0;S<20;S++){const F=S/20*Math.PI*2,P=(S+.2)/20*Math.PI*2,g=(S+.5)/20*Math.PI*2,o=(S+.8)/20*Math.PI*2,f=(S+1)/20*Math.PI*2;c+=`${S===0?"M":"L"}${(120+100*Math.cos(F)).toFixed(1)},${(120+100*Math.sin(F)).toFixed(1)} `,c+=`L${(120+100*Math.cos(P)).toFixed(1)},${(120+100*Math.sin(P)).toFixed(1)} `,c+=`L${(120+112*Math.cos(g)).toFixed(1)},${(120+112*Math.sin(g)).toFixed(1)} `,c+=`L${(120+100*Math.cos(o)).toFixed(1)},${(120+100*Math.sin(o)).toFixed(1)} `,c+=`L${(120+100*Math.cos(f)).toFixed(1)},${(120+100*Math.sin(f)).toFixed(1)} `}c+="Z";const s=14,d=72,w=62;let v="";for(let S=0;S<s;S++){const F=S/s*Math.PI*2,P=(S+.25)/s*Math.PI*2,g=(S+.75)/s*Math.PI*2,o=(S+1)/s*Math.PI*2;v+=`${S===0?"M":"L"}${(120+w*Math.cos(F)).toFixed(1)},${(120+w*Math.sin(F)).toFixed(1)} `,v+=`L${(120+d*Math.cos(P)).toFixed(1)},${(120+d*Math.sin(P)).toFixed(1)} `,v+=`L${(120+d*Math.cos(g)).toFixed(1)},${(120+d*Math.sin(g)).toFixed(1)} `,v+=`L${(120+w*Math.cos(o)).toFixed(1)},${(120+w*Math.sin(o)).toFixed(1)} `}return v+="Z",`<svg width="72" height="72" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    </svg>`}function zt(){const t=document.createElement("div");t.id="netflow-engine-overlay",le=document.createElement("canvas"),le.id="nf-matrix-canvas",t.appendChild(le);const e=document.createElement("div");e.className="nf-pat-plasma",t.appendChild(e);for(let u=1;u<=5;u++){const b=document.createElement("div");b.className=`nf-ambient-orb nf-orb-${u}`,t.appendChild(b)}const r=document.createElement("div");r.className="nf-pat-data",t.appendChild(r);const a=document.createElement("div");a.className="nf-pat-diag-a",t.appendChild(a);const i=document.createElement("div");i.className="nf-pat-diag-b",t.appendChild(i);const p=document.createElement("div");p.className="nf-pat-circuit",t.appendChild(p);const l=document.createElement("div");l.className="nf-pat-honeycomb",t.appendChild(l);const c=document.createElement("div");c.className="nf-pat-binary",t.appendChild(c);const s=document.createElement("div");s.className="nf-pat-crosshatch",t.appendChild(s);const d=document.createElement("div");d.className="nf-pat-diamond",t.appendChild(d);const w=document.createElement("div");w.className="nf-pat-wave-h",t.appendChild(w);const v=document.createElement("div");v.className="nf-pat-radar",t.appendChild(v);const S=document.createElement("div");S.className="nf-pat-ripple-1",t.appendChild(S);const F=document.createElement("div");F.className="nf-pat-ripple-2",t.appendChild(F);const P=document.createElement("div");P.className="nf-pat-techscan",t.appendChild(P);const g=document.createElement("div");g.className="nf-center-glow",t.appendChild(g);const o=document.createElement("div");o.className="nf-pat-noise",t.appendChild(o);const f=document.createElement("div");f.className="nf-crt-scanlines",t.appendChild(f);const E=document.createElement("div");E.className="nf-vignette",t.appendChild(E);for(let u=0;u<3;u++){const b=document.createElement("div");b.className="nf-pulse-ring",t.appendChild(b)}["nf-deco-tl","nf-deco-tr","nf-deco-bl","nf-deco-br"].forEach(u=>{const b=document.createElement("div");b.className=`nf-corner-deco ${u}`,t.appendChild(b)});const V=document.createElement("button");V.className="nf-stop-btn",V.innerHTML='<span class="nf-stop-icon"></span> หยุด',V.style.cssText="position:absolute !important;top:14px !important;right:110px !important;z-index:2147483646 !important;cursor:pointer !important;pointer-events:auto !important;background:rgba(255,60,60,0.08) !important;border:1px solid rgba(255,60,60,0.25) !important;border-radius:8px !important;color:rgba(255,100,100,0.8) !important;font-size:13px !important;padding:6px 14px !important;font-family:inherit !important;display:flex !important;align-items:center !important;gap:6px !important;",V.onclick=()=>{var u;window.__NETFLOW_STOP__=!0;try{Ve("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{typeof chrome<"u"&&((u=chrome.runtime)!=null&&u.sendMessage)&&chrome.runtime.sendMessage({action:"AUTOMATION_STOPPED"})}catch{}},t.appendChild(V);const I=document.createElement("div");I.className="nf-layout";const A=document.createElement("div");A.className="nf-core-monitor",A.id="nf-core-monitor";const y=document.createElement("div");y.className="nf-core-header",y.innerHTML=`
    ...
    `,A.appendChild(y);const h=document.createElement("div");h.className="nf-terminal",h.id="nf-terminal",rt(h),A.appendChild(h);const x=document.createElement("div");x.className="nf-engine-core",x.id="nf-engine-core";const T=document.createElement("div");T.className="nf-engine-frame",["nf-fc-tl","nf-fc-tr","nf-fc-bl","nf-fc-br"].forEach(u=>{const b=document.createElement("div");b.className=`nf-frame-corner ${u}`,T.appendChild(b)}),x.appendChild(T);const O="http://www.w3.org/2000/svg",k=document.createElementNS(O,"svg");k.setAttribute("class","nf-engine-waves"),k.setAttribute("viewBox","0 0 560 140"),k.setAttribute("preserveAspectRatio","none"),k.id="nf-engine-waves";for(let u=0;u<4;u++){const b=document.createElementNS(O,"path");b.setAttribute("fill","none"),b.setAttribute("stroke-width",u<2?"1.5":"1"),b.setAttribute("stroke",u<2?`rgba(${Q.rgb},${.14+u*.1})`:`rgba(${Q.accentRgb},${.1+(u-2)*.08})`),b.setAttribute("data-wave-idx",String(u)),k.appendChild(b)}x.appendChild(k);const $=document.createElement("div");$.className="nf-engine-brand-inner",$.innerHTML=`
    ...
    `,x.appendChild($);const D=document.createElement("div");D.className="nf-engine-stats",D.id="nf-engine-stats",D.innerHTML=[["SCENES","nf-stat-scenes","1/1"],["ELAPSED","nf-stat-elapsed","00:00"],["STEP","nf-stat-step","0/0"],["STATUS","nf-stat-status","READY"],["PROGRESS","nf-stat-progress","—"]].map(([u,b,R])=>`<div class="nf-stat-item"><span class="nf-stat-label">${u}</span><span class="nf-stat-val" id="${b}">${R}</span></div>`).join(""),x.appendChild(D),A.appendChild(x),I.appendChild(A);const M=["nf-mod-tl","nf-mod-tr","nf-mod-bl","nf-mod-br"];re.forEach((u,b)=>{const R=Nt(u);R.classList.add(M[b]),R.id=`nf-mod-${u.id}`,I.appendChild(R)}),t.appendChild(I);for(let u=0;u<30;u++){const b=document.createElement("div");b.className="nf-particle",b.style.left=`${5+Math.random()*90}%`,b.style.bottom=`${Math.random()*40}%`,b.style.animationDuration=`${3+Math.random()*5}s`,b.style.animationDelay=`${Math.random()*4}s`;const R=.3+Math.random()*.4,G=.7+Math.random()*.3;b.style.background=`rgba(${Math.floor(te*G)}, ${Math.floor(ne*G)}, ${Math.floor(oe*G)}, ${R})`,b.style.width=`${1+Math.random()*2}px`,b.style.height=b.style.width,t.appendChild(b)}return t}function Nt(t){const e=document.createElement("div");e.className="nf-module";const r=document.createElement("div");r.className="nf-mod-header",r.innerHTML=`
    ...
    `,e.appendChild(r),t.steps.forEach(i=>{const p=document.createElement("div");p.className="nf-step",p.id=`nf-step-${i.id}`;let l="";i.progress!==void 0&&(l=`
        ...
        `,e.appendChild(p)});const a=document.createElement("div");return a.className="nf-mod-progress",a.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(a),e}function Lt(){it=Date.now(),De=setInterval(()=>{const t=Math.floor((Date.now()-it)/1e3),e=String(Math.floor(t/60)).padStart(2,"0"),r=String(t%60).padStart(2,"0"),a=document.getElementById("nf-timer");a&&(a.textContent=`${e}:${r}`);const i=document.getElementById("nf-stat-elapsed");i&&(i.textContent=`${e}:${r}`)},1e3)}function ct(){De&&(clearInterval(De),De=null)}const Vt=120,dt=160,pt=.4;let be=null,ft=0,ut=0,gt=0,Se=[];function qt(t,e){Se=[];for(let r=0;r<Vt;r++){const a=Math.random();let i;a<.22?i=0:a<.4?i=1:a<.55?i=2:a<.68?i=3:a<.84?i=4:i=5;const p=Math.random()*t,l=Math.random()*e,c=50+Math.random()*220,s=Math.random()*Math.PI*2,d=(.003+Math.random()*.008)*(Math.random()>.5?1:-1);Se.push({x:i===0?Math.random()*t:p+Math.cos(s)*c,y:i===0?Math.random()*e:l+Math.sin(s)*c,vx:(Math.random()-.5)*pt,vy:(Math.random()-.5)*pt,radius:1.2+Math.random()*2.5,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03,motion:i,oCx:p,oCy:l,oRadius:c,oAngle:s,oSpeed:d})}}function Gt(){if(!le)return;const t=le;if(Te=t.getContext("2d"),!Te)return;const e=()=>{t.width=window.innerWidth,t.height=window.innerHeight,Se.length===0&&qt(t.width,t.height)};e(),window.addEventListener("resize",e);let r=null,a=0,i=0,p=!1;function l(){if(!Te||!le){Me=null;return}if(Me=requestAnimationFrame(l),p=!p,p)return;const c=Te,s=le.width,d=le.height;c.fillStyle=`rgba(${te*.04|0},${ne*.04|0},${oe*.06|0},1)`,c.fillRect(0,0,s,d),(!r||a!==s||i!==d)&&(a=s,i=d,r=c.createRadialGradient(s*.5,d*.5,0,s*.5,d*.5,Math.max(s,d)*.6),r.addColorStop(0,`rgba(${te*.08|0},${ne*.08|0},${oe*.1|0},0.4)`),r.addColorStop(1,"rgba(0,0,0,0)")),c.fillStyle=r,c.fillRect(0,0,s,d);const w=Se,v=w.length,S=dt*dt;for(let g=0;g<v;g++){const o=w[g];if(o.pulsePhase+=o.pulseSpeed,o.motion===0)o.x+=o.vx,o.y+=o.vy,o.x<0?(o.x=0,o.vx=Math.abs(o.vx)*(.8+Math.random()*.4)):o.x>s&&(o.x=s,o.vx=-Math.abs(o.vx)*(.8+Math.random()*.4)),o.y<0?(o.y=0,o.vy=Math.abs(o.vy)*(.8+Math.random()*.4)):o.y>d&&(o.y=d,o.vy=-Math.abs(o.vy)*(.8+Math.random()*.4));else if(o.motion===1)o.oAngle+=o.oSpeed,o.x=o.oCx+Math.cos(o.oAngle)*o.oRadius,o.y=o.oCy+Math.sin(o.oAngle)*o.oRadius,o.oCx+=Math.sin(o.oAngle*.3)*.15,o.oCy+=Math.cos(o.oAngle*.3)*.15;else if(o.motion===2)o.oAngle+=o.oSpeed,o.x=o.oCx+Math.cos(o.oAngle)*o.oRadius,o.y=o.oCy+Math.sin(o.oAngle)*o.oRadius*.5,o.oCx+=Math.sin(o.oAngle*.2)*.1,o.oCy+=Math.cos(o.oAngle*.2)*.1;else if(o.motion===3){o.oAngle+=o.oSpeed;const f=o.oAngle,E=o.oRadius*.7;o.x=o.oCx+E*Math.cos(f),o.y=o.oCy+E*Math.sin(f)*Math.cos(f),o.oCx+=Math.sin(f*.15)*.12,o.oCy+=Math.cos(f*.15)*.12}else if(o.motion===4){o.oAngle+=o.oSpeed*1.2;const f=o.oRadius*(.5+.5*Math.abs(Math.sin(o.oAngle*.15)));o.x=o.oCx+Math.cos(o.oAngle)*f,o.y=o.oCy+Math.sin(o.oAngle)*f,o.oCx+=Math.sin(o.oAngle*.1)*.18,o.oCy+=Math.cos(o.oAngle*.1)*.18}else o.oAngle+=o.oSpeed,o.x+=o.vx*.8,o.y=o.oCy+Math.sin(o.oAngle+o.x*.008)*o.oRadius*.35,o.x<-30?o.x=s+30:o.x>s+30&&(o.x=-30),o.oCy+=Math.sin(o.oAngle*.1)*.08;if(o.motion>0){const f=o.oRadius+50;o.oCx<-f?o.oCx=s+f:o.oCx>s+f&&(o.oCx=-f),o.oCy<-f?o.oCy=d+f:o.oCy>d+f&&(o.oCy=-f)}}c.beginPath(),c.strokeStyle=`rgba(${te},${ne},${oe},0.06)`,c.lineWidth=.4;const F=new Path2D;for(let g=0;g<v;g++){const o=w[g];for(let f=g+1;f<v;f++){const E=w[f],V=o.x-E.x,I=o.y-E.y,A=V*V+I*I;A<S&&(1-A/S<.4?(c.moveTo(o.x,o.y),c.lineTo(E.x,E.y)):(F.moveTo(o.x,o.y),F.lineTo(E.x,E.y)))}}if(c.stroke(),c.strokeStyle=`rgba(${te},${ne},${oe},0.18)`,c.lineWidth=.8,c.stroke(F),!be||ft!==te||ut!==ne||gt!==oe){be=document.createElement("canvas");const g=48;be.width=g,be.height=g;const o=be.getContext("2d"),f=o.createRadialGradient(g/2,g/2,0,g/2,g/2,g/2);f.addColorStop(0,`rgba(${te},${ne},${oe},0.9)`),f.addColorStop(.3,`rgba(${te},${ne},${oe},0.35)`),f.addColorStop(1,`rgba(${te},${ne},${oe},0)`),o.fillStyle=f,o.fillRect(0,0,g,g),ft=te,ut=ne,gt=oe}const P=be;for(let g=0;g<v;g++){const o=w[g],f=.6+.4*Math.sin(o.pulsePhase),E=o.radius*5*(.8+f*.4);c.globalAlpha=.5+f*.4,c.drawImage(P,o.x-E/2,o.y-E/2,E,E)}c.globalAlpha=1,c.fillStyle="rgba(255,255,255,0.45)",c.beginPath();for(let g=0;g<v;g++){const o=w[g];if(o.radius>2){const f=.6+.4*Math.sin(o.pulsePhase),E=o.radius*(.8+f*.4)*.35;c.moveTo(o.x+E,o.y),c.arc(o.x,o.y,E,0,Math.PI*2)}}c.fill()}l()}function Ht(){Me!==null&&(cancelAnimationFrame(Me),Me=null),le=null,Te=null,Se=[]}let _e=null;const ze=560,Ut=140,mt=ze/2,ht=Ut/2,bt=[];for(let t=0;t<=ze;t+=8){const e=Math.abs(t-mt)/mt;bt.push(Math.pow(Math.min(1,e*1.6),.6))}const Wt=[0,1,2,3].map(t=>({amp:10+t*5,freq:(1.2+t*.35)*Math.PI*2/ze,off:t*.6,spd:.7+t*.12}));let Ue=!1;function wt(){if(Ce=requestAnimationFrame(wt),Ue=!Ue,Ue)return;if(He+=.07,!_e){const e=document.getElementById("nf-engine-waves");if(!e){Ce=null;return}_e=Array.from(e.querySelectorAll("path"))}const t=[];for(let e=0;e<_e.length;e++){const r=Wt[e],a=He*r.spd+r.off;t.length=0,t.push(`M 0 ${ht}`);let i=0;for(let p=0;p<=ze;p+=8){const l=ht+r.amp*bt[i++]*Math.sin(p*r.freq+a);t.push(`L${p} ${l*10+.5|0}`)}_e[e].setAttribute("d",t.join(" "))}}function Yt(){He=0,wt(),Gt(),Fe=setInterval(()=>{const t=document.getElementById("nf-stat-freq"),e=document.getElementById("nf-stat-lat1"),r=document.getElementById("nf-stat-lat2"),a=document.getElementById("nf-stat-buf");t&&(t.textContent=`${(4.5+Math.random()*.5).toFixed(1)} GHz`),e&&(e.textContent=`${Math.floor(12+Math.random()*10)}ms`),r&&(r.textContent=`${Math.floor(12+Math.random()*10)}ms`),a&&(a.textContent=`${Math.floor(90+Math.random()*9)}%`)},2e3)}function xt(){Ce!==null&&(cancelAnimationFrame(Ce),Ce=null),Fe&&(clearInterval(Fe),Fe=null),_e=null,Ht()}function Ne(){let t=0;const e=Y.filter(d=>d.status!=="skipped").length;for(const d of Y){const w=document.getElementById(`nf-proc-${d.stepId}`);if(!w)continue;w.className="nf-proc-row";const v=w.querySelector(".nf-proc-badge");switch(d.status){case"done":w.classList.add("nf-proc-done"),v&&(v.textContent="✅ done"),t++;break;case"active":w.classList.add("nf-proc-active"),v&&(v.textContent=d.progress!==void 0&&d.progress>0?`⏳ ${d.progress}%`:"⏳ active");break;case"error":w.classList.add("nf-proc-error"),v&&(v.textContent="❌ error");break;case"skipped":w.classList.add("nf-proc-skipped"),v&&(v.textContent="— skip");break;default:w.classList.add("nf-proc-waiting"),v&&(v.textContent="(queued)")}}const r=Y.findIndex(d=>d.status==="active"),a=r>=0?r+1:t>=e&&e>0?Y.length:t,i=document.getElementById("nf-step-counter");i&&(i.textContent=`${a}/${Y.length}`);const p=document.querySelector(".nf-core-title-val"),l=document.querySelector(".nf-status-dot");t>=e&&e>0?(p&&(p.textContent="COMPLETE",p.style.color=Q.doneHex),l&&(l.style.background=Q.doneHex,l.style.boxShadow=`0 0 8px rgba(${Q.doneRgb},0.7)`)):Y.some(w=>w.status==="error")?(p&&(p.textContent="ERROR",p.style.color="#f87171"),l&&(l.style.background="#ef4444",l.style.boxShadow="0 0 8px rgba(239,68,68,0.7)")):Y.some(w=>w.status==="active")&&p&&(p.textContent="ACTIVE",p.style.color=Q.hex,p.style.textShadow=`0 0 10px rgba(${Q.rgb},0.5)`);const c=document.getElementById("nf-terminal"),s=c==null?void 0:c.querySelector(".nf-proc-active");s&&c&&s.scrollIntoView({behavior:"smooth",block:"center"})}function yt(){K&&K.isConnected||(at(),K=document.createElement("button"),K.id="nf-toggle-btn",K.className="nf-toggle-visible",K.innerHTML=fe?nt:ot,K.title="ซ่อน/แสดง Netflow Overlay",K.style.cssText="position:fixed !important;top:20px !important;right:20px !important;z-index:2147483647 !important;width:48px !important;height:48px !important;border-radius:50% !important;border:2px solid rgba(255,255,255,0.5) !important;background:rgba(0,0,0,0.85) !important;color:#fff !important;font-size:23px !important;cursor:pointer !important;display:flex !important;align-items:center !important;justify-content:center !important;pointer-events:auto !important;",K.onclick=()=>vt(),document.body.appendChild(K))}function vt(){W&&(yt(),fe?(W.classList.remove("nf-hidden"),W.classList.add("nf-visible"),W.style.opacity="1",W.style.pointerEvents="auto",K&&(K.innerHTML=ot),fe=!1):(W.classList.remove("nf-visible"),W.classList.add("nf-hidden"),W.style.opacity="0",W.style.pointerEvents="none",K&&(K.innerHTML=nt),fe=!0))}const $t={red:"themes/theme-red.jpg",yellow:"themes/theme-yellow.jpg",blue:"themes/theme-blue.jpg",purple:"themes/theme-purple.jpg",green:"themes/theme-green.jpg"};function Et(){const t=document.getElementById("nf-core-monitor");if(!t)return;let e=ke;if(!e)try{e=localStorage.getItem("netflow_app_theme")||"green"}catch{e="green"}const r=$t[e]||$t.green;let a;try{a=chrome.runtime.getURL(r)}catch{a=`/${r}`}const i=Q.rgb;t.style.backgroundImage=["linear-gradient(180deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 45%, rgba(0,0,0,0.90) 100%)",`linear-gradient(180deg, rgba(${i},0.25) 0%, rgba(${i},0.12) 50%, rgba(${i},0.20) 100%)`,`url('${a}')`].join(", "),t.style.backgroundSize="auto, auto, 50%",t.style.backgroundPosition="center, center, center",t.style.backgroundRepeat="no-repeat, no-repeat, no-repeat",t.style.setProperty("--nf-bg-set","1"),t.style.border=`1.5px solid rgba(${i},0.45)`,t.style.boxShadow=`0 0 70px rgba(${i},0.22), 0 0 140px rgba(${i},0.1), inset 0 1px 0 rgba(${i},0.15)`}function We(t=1){if(Q=Ft(),tt(),W&&W.isConnected){for(const e of re)for(const r of e.steps)r.status="waiting",r.progress=r.progress!==void 0?0:void 0;he=t,Y=Oe(t),st();for(const e of re)Ye(e);Le(),Ne(),fe&&vt();return}W&&!W.isConnected&&(W=null),pe&&(pe.remove(),pe=null),at();for(const e of re)for(const r of e.steps)r.status="waiting",r.progress=r.progress!==void 0?0:void 0;if(he=t,Y=Oe(t),t>1){const e=re.find(a=>a.id==="video");if(e){const a=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:"waiting",progress:0}];for(let i=2;i<=t;i++)a.push({id:`scene${i}-prompt`,label:`Scene ${i} Prompt`,status:"waiting"}),a.push({id:`scene${i}-gen`,label:`Scene ${i} Generate`,status:"waiting"}),a.push({id:`scene${i}-wait`,label:`Scene ${i} รอผล`,status:"waiting",progress:0});e.steps=a}const r=re.find(a=>a.id==="render");if(r){const a=r.steps.find(p=>p.id==="download");a&&(a.label="ดาวน์โหลด 720p");const i=r.steps.find(p=>p.id==="upscale");i&&(i.label="Full Video")}}W=zt(),W.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;",document.body.appendChild(W),W.classList.add("nf-visible"),fe=!1,yt(),Lt(),Yt(),requestAnimationFrame(()=>Et())}function kt(){ct(),xt(),fe=!1,W&&(W.classList.add("nf-fade-out"),setTimeout(()=>{W==null||W.remove(),W=null},500)),K&&(K.remove(),K=null)}const Xt={settings:"SETTINGS","upload-char":"UPLOAD","upload-prod":"UPLOAD","img-prompt":"PROMPT","img-generate":"GENERATE","img-wait":"IMG WAIT",animate:"ANIMATE","vid-prompt":"VID PROMPT","vid-generate":"VID GEN","vid-wait":"VID WAIT",download:"DOWNLOAD",upscale:"UPSCALE",open:"OPENING"};function jt(t,e,r){const a=Y.findIndex(v=>v.status==="active"),i=Y.filter(v=>v.status==="done").length,p=Y.length,l=a>=0?a+1:i>=p?p:i,c=document.getElementById("nf-stat-step");c&&(c.textContent=`${l}/${p}`);let s=1;for(const v of Y)if(v.status==="active"||v.status==="done")if(v.stepId.startsWith("scene")){const S=v.stepId.match(/^scene(\d+)-/);S&&(s=Math.max(s,parseInt(S[1],10)))}else(v.stepId==="download"||v.stepId==="upscale"||v.stepId==="open")&&(s=he);const d=document.getElementById("nf-stat-scenes");if(d&&(d.textContent=he>1?`${s}/${he}`:"1/1"),e==="active"){const v=document.getElementById("nf-stat-status"),S=Xt[t]||t.toUpperCase();v&&(v.textContent=S)}else if(e==="done"&&i>=p){const v=document.getElementById("nf-stat-status");v&&(v.textContent="COMPLETE")}else if(e==="error"){const v=document.getElementById("nf-stat-status");v&&(v.textContent="ERROR")}const w=document.getElementById("nf-stat-progress");w&&(r!==void 0&&r>0?w.textContent=`${Math.min(100,r)}%`:e==="active"&&(w.textContent="—"))}function C(t,e,r){if(!W)return;for(const i of re)for(const p of i.steps)p.id===t&&(p.status=e,r!==void 0&&(p.progress=r));for(const i of Y)i.stepId===t&&(i.status=e,r!==void 0&&(i.progress=r));const a=document.getElementById(`nf-step-${t}`);if(a&&(a.className="nf-step",e==="active"?a.classList.add("nf-step-active"):e==="done"?a.classList.add("nf-step-done"):e==="error"&&a.classList.add("nf-step-error")),jt(t,e,r),r!==void 0){const i=document.getElementById(`nf-bar-${t}`);i&&(i.style.width=`${Math.min(100,r)}%`)}Le(),Ne()}function we(t){C(t,"skipped");const e=document.getElementById(`nf-step-${t}`);e&&(e.style.opacity="0.2")}function Ie(t=4e3){ct(),xt(),Le(),Ne(),setTimeout(()=>kt(),t)}function Le(){for(const t of re){const e=t.steps.filter(s=>s.status!=="skipped").length,r=t.steps.filter(s=>s.status==="done").length,a=t.steps.some(s=>s.status==="active"),i=e>0?Math.round(r/e*100):0,p=document.getElementById(`nf-pct-${t.id}`);p&&(p.textContent=`${i}%`);const l=document.getElementById(`nf-modbar-${t.id}`);l&&(l.style.width=`${i}%`);const c=document.getElementById(`nf-mod-${t.id}`);c&&(c.classList.remove("nf-active","nf-done"),i>=100?c.classList.add("nf-done"):a&&c.classList.add("nf-active"))}}function Kt(t){var a,i,p,l;he=t;const e=new Map;for(const c of Y)e.set(c.stepId,{status:c.status,progress:c.progress});Y=Oe(t);for(const c of Y){const s=e.get(c.stepId);s&&(c.status=s.status,s.progress!==void 0&&(c.progress=s.progress))}if(st(),t>1){const c=re.find(s=>s.id==="video");if(c){const s=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:((a=c.steps.find(d=>d.id==="animate"))==null?void 0:a.status)||"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:((i=c.steps.find(d=>d.id==="vid-prompt"))==null?void 0:i.status)||"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:((p=c.steps.find(d=>d.id==="vid-generate"))==null?void 0:p.status)||"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:((l=c.steps.find(d=>d.id==="vid-wait"))==null?void 0:l.status)||"waiting",progress:0}];for(let d=2;d<=t;d++)s.push({id:`scene${d}-prompt`,label:`Scene ${d} Prompt`,status:"waiting"}),s.push({id:`scene${d}-gen`,label:`Scene ${d} Generate`,status:"waiting"}),s.push({id:`scene${d}-wait`,label:`Scene ${d} รอผล`,status:"waiting",progress:0});c.steps=s,Ye(c)}}const r=re.find(c=>c.id==="render");if(r&&t>1){const c=r.steps.find(d=>d.id==="download");c&&(c.label="ดาวน์โหลด 720p");const s=r.steps.find(d=>d.id==="upscale");s&&(s.label="Full Video"),Ye(r)}Le(),Ne()}function Ye(t){const e=document.getElementById(`nf-mod-${t.id}`);if(!e)return;e.querySelectorAll(".nf-step, .nf-mod-progress").forEach(i=>i.remove()),t.steps.forEach(i=>{const p=document.createElement("div");p.className="nf-step",p.id=`nf-step-${i.id}`;let l="";i.progress!==void 0&&(l=`
            ...
            <span class="nf-step-label">${i.label}</span>
            ${l}
        `,e.appendChild(p)});const a=document.createElement("div");a.className="nf-mod-progress",a.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(a)}function Ve(t){t.replace(/^\[Netflow AI\]\s*/,"")}let xe=null,ue=null;const Qt=new Promise(t=>{ue=t,setTimeout(()=>t(null),2e3)});try{chrome.runtime.sendMessage({type:"GET_TAB_ID"},t=>{!chrome.runtime.lastError&&(t!=null&&t.tabId)&&(xe=t.tabId,console.log(`[Netflow AI] Tab ID: ${xe}`)),ue&&(ue(xe),ue=null)})}catch{ue&&(ue(null),ue=null)}function ce(){return xe?`netflow_pending_action_${xe}`:"netflow_pending_action"}function Ct(){try{chrome.runtime.sendMessage({type:"AUTOMATION_FINISHED"})}catch{}}const n=t=>{console.log(`[Netflow AI] ${t}`);try{Ve(t)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"info",msg:t})}catch{}},_=t=>{console.warn(`[Netflow AI] ${t}`);try{Ve(`⚠️ ${t}`)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"warn",msg:`⚠️ ${t}`})}catch{}};function Xe(t=3e3){n(`🔒 จะปิดแท็บ automation ใน ${t/1e3} วินาที...`),setTimeout(()=>{try{chrome.runtime.sendMessage({action:"CLOSE_AUTOMATION_TAB"},e=>{chrome.runtime.lastError?_(`ปิดแท็บไม่ได้: ${chrome.runtime.lastError.message}`):n(`✅ ปิดแท็บแล้ว: ${e==null?void 0:e.message}`)})}catch(e){_(`ปิดแท็บผิดพลาด: ${e.message}`)}},t)}async function je(){try{if(await new Promise(i=>{try{chrome.runtime.sendMessage({type:"PEEK_CACHED_VIDEO"},p=>{if(chrome.runtime.lastError){i(!1);return}i(!!(p!=null&&p.cached))})}catch{i(!1)}})){n("[TikTok] ✅ Background มี video cached อยู่แล้ว (จาก download) — ข้าม page capture เพื่อไม่ overwrite");const i=document.querySelectorAll("video");for(const p of i){const l=p.src||p.currentSrc||"";if(l)return l}return null}n("[TikTok] ไม่มี cached video — จะ capture จากหน้า...");const e=document.querySelectorAll("video");let r=null,a=0;for(const i of e){let p=i.src||"";if(!p){const s=i.querySelector("source");s&&(p=s.getAttribute("src")||"")}if(!p&&i.currentSrc&&(p=i.currentSrc),!p)continue;if(J()){r||(r=p,a=1);continue}const l=i.getBoundingClientRect(),c=l.width*l.height;l.width>50&&c>a&&(a=c,r=p)}if(!r)return n("[TikTok] ไม่พบ video URL บนหน้า"),null;n(`[TikTok] พบ video URL: ${r.substring(0,80)}... (area=${a.toFixed(0)})`);try{n("[TikTok] กำลัง fetch video blob จาก content script (มี auth)...");const i=await fetch(r);if(!i.ok)return n(`[TikTok] fetch failed: HTTP ${i.status}`),await Tt(r),r;const p=await i.blob(),l=(p.size/1024/1024).toFixed(1);n(`[TikTok] Video blob fetched: ${l} MB, type: ${p.type}`),p.size<1e5&&n(`[TikTok] ⚠️ Blob เล็กเกินไป (${p.size} bytes) — อาจเป็น thumbnail`);const c=await new Promise((s,d)=>{const w=new FileReader;w.onloadend=()=>s(w.result),w.onerror=()=>d(new Error("FileReader error")),w.readAsDataURL(p)});n(`[TikTok] Data URL พร้อม: ${(c.length/1024/1024).toFixed(1)} MB`),await new Promise(s=>{chrome.runtime.sendMessage({type:"CACHE_VIDEO_DATA",data:c},d=>{chrome.runtime.lastError?n(`[TikTok] CACHE_VIDEO_DATA error: ${chrome.runtime.lastError.message}`):d!=null&&d.success?n("[TikTok] ✅ Video cached in background service worker"):n(`[TikTok] CACHE_VIDEO_DATA failed: ${d==null?void 0:d.error}`),s()})})}catch(i){n(`[TikTok] Content script fetch error: ${i.message}`),await Tt(r)}return r}catch(t){return n(`[TikTok] captureVideoUrl error: ${t.message}`),null}}async function Tt(t){if(t.startsWith("https://"))try{await new Promise(e=>{chrome.runtime.sendMessage({type:"PRE_FETCH_VIDEO",url:t},r=>{chrome.runtime.lastError?n(`[TikTok] PRE_FETCH_VIDEO error: ${chrome.runtime.lastError.message}`):r!=null&&r.success?n(`[TikTok] Video pre-fetched via background: ${((r.size||0)/1024/1024).toFixed(1)} MB`):n(`[TikTok] PRE_FETCH_VIDEO failed: ${r==null?void 0:r.error}`),e()})})}catch{}}function Ke(t){if(t){if(window.__VIDEO_COMPLETE_SENT__){n("[TikTok] ⚠️ VIDEO_GENERATION_COMPLETE already sent, skipping duplicate");return}window.__VIDEO_COMPLETE_SENT__=!0;try{chrome.runtime.sendMessage({type:"VIDEO_GENERATION_COMPLETE",videoUrl:t,source:"veo"}),n("[TikTok] Sent VIDEO_GENERATION_COMPLETE (source=veo)")}catch{}}}const Qe=/Mac|iPhone|iPad|iPod/i.test(navigator.userAgent),Je=/Win/i.test(navigator.userAgent),ye=Qe?"🍎 Mac":Je?"🪟 Win":"🐧 Other";n(`สคริปต์โหลดบนหน้า Google Flow แล้ว ${ye}`),window.__VIDEO_COMPLETE_SENT__=!1;class Ze extends Error{constructor(){super("AUTOMATION_STOPPED"),this.name="NetflowAbortError"}}let Pe=null,ge=null,Mt=!1;const ve=new Map;let St=0;function Jt(){if(Pe)return Pe;try{const t=new Blob(["self.onmessage=function(e){var d=e.data;setTimeout(function(){self.postMessage(d.id)},d.ms)};"],{type:"application/javascript"});return Pe=new Worker(URL.createObjectURL(t)),Pe.onmessage=e=>{const r=ve.get(e.data);r&&(ve.delete(e.data),r())},console.log("[Netflow AI] ⚡ Web Worker timer created — background tab throttling defeated"),Pe}catch{return console.warn("[Netflow AI] Web Worker timer unavailable (CSP?) — trying port relay"),null}}function Zt(){if(ge)return ge;if(Mt)return null;try{return ge=chrome.runtime.connect({name:"timer"}),ge.onMessage.addListener(t=>{const e=ve.get(t.id);e&&(ve.delete(t.id),e())}),ge.onDisconnect.addListener(()=>{ge=null}),console.log("[Netflow AI] ⚡ Port relay timer connected — background tab throttling defeated"),ge}catch{return Mt=!0,console.warn("[Netflow AI] Port relay unavailable — falling back to setTimeout"),null}}const m=t=>new Promise((e,r)=>{if(window.__NETFLOW_STOP__)return r(new Ze);let a=!1;const i=()=>{if(!a){if(a=!0,window.__NETFLOW_STOP__)return r(new Ze);e()}},p=Jt();if(p){const s=++St;ve.set(s,i),p.postMessage({id:s,ms:t});try{chrome.runtime.sendMessage({type:"TIMER_DELAY",ms:t+2e3},()=>{chrome.runtime.lastError||i()})}catch{}return}try{chrome.runtime.sendMessage({type:"TIMER_DELAY",ms:t},()=>{chrome.runtime.lastError?setTimeout(i,t):i()});return}catch{}const l=Zt();if(l){const s=++St;ve.set(s,i),l.postMessage({cmd:"delay",id:s,ms:t});return}const c=setTimeout(i,t);m._lastId=c});function me(){return!!window.__NETFLOW_STOP__}const J=()=>document.hidden;let _t=0;async function $e(){if(!document.hidden)return!1;const t=Date.now();if(t-_t<15e3)return!1;_t=t;try{return n("🔄 Tab ซ่อนอยู่ — ขอ background สลับ tab ชั่วคราวเพื่ออัพเดท DOM"),chrome.runtime.sendMessage({type:"BRIEF_ACTIVATE_TAB"}),await m(1500),!0}catch{return!1}}function It(){var r;const t=["couldn't generate","could not generate","failed to generate","generation failed","ไม่สามารถสร้าง","สร้างไม่สำเร็จ","try again later","ลองอีกครั้งภายหลัง","ลองใหม่อีกครั้ง","something went wrong","เกิดข้อผิดพลาด","safety filter","policy violation","content policy","unable to generate","ไม่สามารถสร้างวิดีโอ","couldn't generate video","couldn't generate image"],e=document.querySelectorAll("div, span, p, h1, h2, h3, li");for(const a of e){if(a.closest("#netflow-engine-overlay"))continue;const i=(a.textContent||"").trim().toLowerCase();if(!(i.length>200||i.length<5)){for(const p of t)if(i.includes(p))return((r=a.textContent)==null?void 0:r.trim())||p}}return null}async function Z(t){if(J()){t.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0})),t.click();return}const e=t.getBoundingClientRect(),r=e.left+e.width/2,a=e.top+e.height/2,i={bubbles:!0,cancelable:!0,clientX:r,clientY:a,button:0};t.dispatchEvent(new PointerEvent("pointerdown",{...i,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousedown",i)),await m(80),t.dispatchEvent(new PointerEvent("pointerup",{...i,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseup",i)),t.dispatchEvent(new MouseEvent("click",i)),await m(50),t.click()}function en(t){const e=t.getBoundingClientRect(),r=e.left+e.width/2,a=e.top+e.height/2,i={bubbles:!0,cancelable:!0,clientX:r,clientY:a};t.dispatchEvent(new PointerEvent("pointerenter",{...i,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseenter",i)),t.dispatchEvent(new PointerEvent("pointerover",{...i,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseover",i)),t.dispatchEvent(new PointerEvent("pointermove",{...i,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousemove",i))}function tn(t){const e=[],r=document.querySelectorAll("i");for(const a of r){if((a.textContent||"").trim()!==t)continue;let p=a,l=null,c=1/0;for(let s=0;s<20&&p&&(p=p.parentElement,!(!p||p===document.body));s++){if(J()){s>=3&&p.children.length>0&&!l&&(l=p);continue}const d=p.getBoundingClientRect();if(d.width>100&&d.height>80&&d.width<window.innerWidth*.6&&d.top>=-10&&d.bottom<=window.innerHeight+10){const w=d.width*d.height;w<c&&(l=p,c=w)}}l&&!e.includes(l)&&e.push(l)}return e.sort((a,i)=>{const p=a.getBoundingClientRect(),l=i.getBoundingClientRect();return p.left-l.left}),e}function et(t=!1){const e=[],r=document.querySelectorAll("video");for(const l of r){let c=l.parentElement;for(let s=0;s<10&&c;s++){if(J()){if(s>=3&&c.children.length>0){e.push({el:c,left:0});break}c=c.parentElement;continue}const d=c.getBoundingClientRect();if(d.width>120&&d.height>80&&d.width<window.innerWidth*.7&&d.top>=-50&&d.left<window.innerWidth*.75){e.push({el:c,left:d.left});break}c=c.parentElement}}const a=document.querySelectorAll("i, span.material-symbols-outlined, span.google-symbols, .google-symbols");for(const l of a){const c=(l.textContent||"").trim();if(c==="play_arrow"||c==="play_circle"||c==="videocam"){let s=l.parentElement;for(let d=0;d<10&&s;d++){if(J()){if(d>=3&&s.children.length>0){e.push({el:s,left:0});break}s=s.parentElement;continue}const w=s.getBoundingClientRect();if(w.width>120&&w.height>80&&w.width<window.innerWidth*.7&&w.top>=-50&&w.left<window.innerWidth*.75){e.push({el:s,left:w.left});break}s=s.parentElement}}}const i=document.querySelectorAll("img");for(const l of i){const c=(l.alt||"").toLowerCase();if(c.includes("video")||c.includes("วิดีโอ")){let s=l.parentElement;for(let d=0;d<10&&s;d++){if(J()){if(d>=3&&s.children.length>0){e.push({el:s,left:0});break}s=s.parentElement;continue}const w=s.getBoundingClientRect();if(w.width>120&&w.height>80&&w.width<window.innerWidth*.7&&w.top>=-50&&w.left<window.innerWidth*.75){e.push({el:s,left:w.left});break}s=s.parentElement}}}const p=Array.from(new Set(e.map(l=>l.el))).map(l=>e.find(c=>c.el===l));if(p.sort((l,c)=>l.left-c.left),p.length>0){const l=p[0].el,c=l.getBoundingClientRect();return t||n(`🎬 พบการ์ดวิดีโอที่ (${c.left.toFixed(0)},${c.top.toFixed(0)}) ขนาด ${c.width.toFixed(0)}x${c.height.toFixed(0)}`),l}return t||n("🎬 ไม่พบการ์ดวิดีโอ"),null}function nn(){const t=tn("image");if(t.length>0){const r=t[0].getBoundingClientRect();return n(`🖼️ พบการ์ดรูปภาพ ${t.length} ใบ — ใบแรกที่ (${r.left.toFixed(0)},${r.top.toFixed(0)}) ขนาด ${r.width.toFixed(0)}x${r.height.toFixed(0)}`),t[0]}const e=document.querySelectorAll("canvas");for(const r of e){let a=r.parentElement;for(let i=0;i<10&&a;i++){if(J()){if(i>=3&&a.children.length>0)return n("🖼️ พบการ์ดรูปภาพจาก <canvas> (minimized mode)"),a;a=a.parentElement;continue}const p=a.getBoundingClientRect();if(p.width>100&&p.height>80&&p.width<window.innerWidth*.6)return n(`🖼️ พบการ์ดรูปภาพจาก <canvas> สำรองที่ (${p.left.toFixed(0)},${p.top.toFixed(0)})`),a;a=a.parentElement}}return n("🖼️ ไม่พบการ์ดรูปภาพ"),null}function on(t,e){var c;const[r,a]=t.split(","),i=((c=r.match(/:(.*?);/))==null?void 0:c[1])||"image/png",p=atob(a),l=new Uint8Array(p.length);for(let s=0;s<p.length;s++)l[s]=p.charCodeAt(s);return new File([l],e,{type:i})}function qe(t){var a;const e=[],r=document.querySelectorAll("i.google-symbols, i[class*='google-symbols'], .material-symbols-outlined, .material-icons");for(const i of r)if(((a=i.textContent)==null?void 0:a.trim())===t){const p=i.closest("button");p&&e.push(p)}return e}function an(){const t=[...qe("add"),...qe("add_2")];if(t.length===0){n("ไม่พบปุ่มเพิ่มจากไอคอน — ลองค้นหาจากข้อความ");const a=document.querySelectorAll("button");for(const i of a){const p=(i.textContent||"").trim();if(p!=="+"&&p!=="add")continue;if(J())return i;const l=i.getBoundingClientRect();if(l.bottom>window.innerHeight*.7&&l.width<60&&l.height<60)return i}return null}let e=null,r=0;for(const a of t){const i=a.getBoundingClientRect();i.y>r&&(r=i.y,e=a)}return e&&n(`พบปุ่ม "+" ของ Prompt Bar ที่ y=${r.toFixed(0)}`),e}function Pt(){for(const a of["arrow_forward","send","arrow_upward","navigate_next","arrow_right"]){const i=qe(a);let p=null,l=0;for(const c of i){const s=c.getBoundingClientRect();s.y>l&&(l=s.y,p=c)}if(p)return n(`พบปุ่ม Generate จากไอคอน "${a}" ที่ y=${l.toFixed(0)}`),p}const t=document.querySelectorAll("button");let e=null,r=0;for(const a of t){if(J())break;const i=a.getBoundingClientRect();if(i.bottom>window.innerHeight*.7&&i.right>window.innerWidth*.5){const p=Math.abs(i.width-i.height)<10&&i.width<60,l=i.y+i.x+(p?1e3:0);l>r&&(r=l,e=a)}}if(e)return n("พบปุ่ม Generate จากตำแหน่งขวาล่าง"),e;for(const a of t){const i=(a.getAttribute("aria-label")||"").toLowerCase();if(i.includes("generate")||i.includes("submit")||i.includes("send")||i.includes("สร้าง"))return a}return null}function At(){const t=document.querySelectorAll("textarea");for(const a of t)if(J()||a.getBoundingClientRect().bottom>window.innerHeight*.5)return a;const e=document.querySelectorAll('[contenteditable="true"]');for(const a of e)if(J()||a.getBoundingClientRect().bottom>window.innerHeight*.5)return a;const r=document.querySelectorAll("input[type='text'], input:not([type])");for(const a of r){const i=a.placeholder||"";if(i.includes("สร้าง")||i.includes("prompt")||i.includes("describe"))return a}return t.length>0?t[t.length-1]:null}async function Ae(t,e){var r,a,i,p;t.focus(),await m(300),n("วางข้อความ: วิธี 1 — Slate beforeinput insertFromPaste");try{const l=new DataTransfer;l.setData("text/plain",e),l.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const c=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertFromPaste",dataTransfer:l});t.dispatchEvent(c),n("วางข้อความ: ส่ง beforeinput insertFromPaste แล้ว");const s=new InputEvent("input",{bubbles:!0,inputType:"insertFromPaste",dataTransfer:l});t.dispatchEvent(s),await m(800);const d=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(d.length>20){n(`วางข้อความ: ✅ วิธี 1 สำเร็จ (${d.length} ตัวอักษร)`);return}n(`วางข้อความ: วิธี 1 — ไม่พบข้อความ (ได้ ${d.length} ตัวอักษร)`)}catch(l){n(`วางข้อความ: วิธี 1 ล้มเหลว: ${l.message}`)}n("วางข้อความ: วิธี 2 — Slate beforeinput insertText");try{t.focus(),await m(100);const l=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertText",data:e});t.dispatchEvent(l);const c=new InputEvent("input",{bubbles:!0,inputType:"insertText",data:e});t.dispatchEvent(c),await m(800);const s=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(s.length>20){n(`วางข้อความ: ✅ วิธี 2 สำเร็จ (${s.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 2 — ไม่พบข้อความ")}catch(l){n(`วางข้อความ: วิธี 2 ล้มเหลว: ${l.message}`)}n("วางข้อความ: วิธี 3 — ClipboardEvent paste");try{t.focus(),await m(200);const l=new DataTransfer;l.setData("text/plain",e),l.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const c=new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:l});t.dispatchEvent(c),await m(800);const s=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(s.length>20){n(`วางข้อความ: ✅ วิธี 3 สำเร็จ (${s.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 3 — ไม่พบข้อความ")}catch(l){n(`วางข้อความ: วิธี 3 ล้มเหลว: ${l.message}`)}n("วางข้อความ: วิธี 4 — navigator.clipboard + execCommand paste");try{if((r=navigator.clipboard)!=null&&r.writeText)await navigator.clipboard.writeText(e),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน navigator.clipboard");else{const c=document.createElement("textarea");c.value=e,c.style.cssText="position:fixed;left:-9999px;top:-9999px;opacity:0",document.body.appendChild(c),c.focus(),c.select(),document.execCommand("copy"),document.body.removeChild(c),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน execCommand")}t.focus(),await m(200),document.execCommand("paste"),await m(500);const l=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(l.length>20){n(`วางข้อความ: ✅ วิธี 4 สำเร็จ (${l.length} ตัวอักษร)`);return}}catch(l){n(`วางข้อความ: วิธี 4 ล้มเหลว: ${l.message}`)}n("วางข้อความ: วิธี 5 — React fiber Slate editor");try{const l=Object.keys(t).find(c=>c.startsWith("__reactFiber$")||c.startsWith("__reactInternalInstance$"));if(l){let c=t[l];for(let s=0;s<30&&c;s++){const d=c.memoizedProps,w=c.memoizedState;if((a=d==null?void 0:d.editor)!=null&&a.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber props");const v=d.editor;v.selection,v.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน editor.insertText");return}if((p=(i=w==null?void 0:w.memoizedState)==null?void 0:i.editor)!=null&&p.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber state"),w.memoizedState.editor.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน state editor");return}c=c.return}n("วางข้อความ: พบ Fiber แต่ไม่พบ Slate editor ใน tree")}else n("วางข้อความ: ไม่พบ React fiber บน element")}catch(l){n(`วางข้อความ: วิธี 5 ล้มเหลว: ${l.message}`)}n("วางข้อความ: ⚠️ ลองครบทั้ง 5 วิธีแล้ว — ตรวจสอบผลใน Console")}function rn(){const t=[],e=document.querySelectorAll('input[type="file"]');for(const r of e)t.push({input:r,origType:"file"}),r.type="text";return t.length>0&&n(`ปิดกั้น file input ${t.length} ตัว (type → text)`),t}function sn(){const t=HTMLInputElement.prototype.click;return HTMLInputElement.prototype.click=function(){if(this.type==="file"){n(`🚫 บล็อกการเปิด file dialog (${ye})`);return}return t.call(this)},n(`🔒 ติดตั้งตัวบล็อก file dialog แล้ว (${ye})`),()=>{HTMLInputElement.prototype.click=t,n("🔓 ถอดตัวบล็อก file dialog แล้ว")}}function ln(t,e,r){var d;const a=document.querySelectorAll('input[type="text"][style*="display: none"], input[type="text"][hidden], input[type="text"]'),i=[...t.map(w=>w.input)];for(const w of a)!i.includes(w)&&w.offsetParent===null&&i.push(w);for(const w of i)w.type="file";n(`คืนค่า input ${i.length} ตัวเป็น type=file`);const p=document.querySelectorAll('input[type="file"]');if(p.length===0)return n(`⚠️ ไม่พบ file input หลังคืนค่า (${ye})`),!1;let l;if(r&&r.size>0){const w=Array.from(p).filter(v=>!r.has(v));w.length>0?(l=w[w.length-1],n(`เล็งเป้า file input ใหม่ (${w.length} ใหม่, ${p.length} ทั้งหมด)`)):(l=p[p.length-1],n(`ไม่พบ file input ใหม่ — ใช้ตัวสุดท้ายจาก ${p.length} ตัว`))}else l=p[p.length-1];const c=new DataTransfer;c.items.add(e);try{l.files=c.files,n(`ฉีดไฟล์ผ่าน target.files (${((d=l.files)==null?void 0:d.length)??0} ไฟล์)`)}catch(w){n(`กำหนด target.files ล้มเหลว: ${w.message} — ลอง defineProperty`);try{Object.defineProperty(l,"files",{value:c.files,writable:!0,configurable:!0}),n("ฉีดไฟล์ผ่าน Object.defineProperty")}catch(v){return _(`การฉีดไฟล์ล้มเหลวทั้ง 2 วิธี: ${v.message}`),!1}}const s=l._valueTracker;s&&(s.setValue(""),n("รีเซ็ต React _valueTracker บน file input")),l.dispatchEvent(new Event("change",{bubbles:!0})),l.dispatchEvent(new Event("input",{bubbles:!0}));try{const w=new DataTransfer;w.items.add(e);const v=new DragEvent("drop",{bubbles:!0,cancelable:!0,dataTransfer:w});l.dispatchEvent(v),n("ส่ง drop event บน file input ด้วย")}catch{}return n(`✅ ฉีดไฟล์เสร็จ: ${e.name} (${(e.size/1024).toFixed(1)} KB) → <input> ${ye}`),!0}function Be(){let t=0;const e=document.querySelectorAll("img");for(const a of e){if(a.closest("#netflow-engine-overlay")||!a.src)continue;if(J()){t++;continue}const i=a.getBoundingClientRect();i.bottom>window.innerHeight*.6&&i.width>20&&i.width<200&&i.height>20&&i.height<200&&a.offsetParent!==null&&t++}const r=document.querySelectorAll('[style*="background-image"], [class*="thumb"], [class*="preview"]');for(const a of r){if(a.closest("#netflow-engine-overlay"))continue;if(J()){t++;continue}const i=a.getBoundingClientRect();i.bottom>window.innerHeight*.6&&i.width>20&&i.width<200&&i.height>20&&i.height<200&&a.offsetParent!==null&&t++}return t}async function Bt(t,e){var w;n(`── กำลังอัพโหลด ${e} ไปยัง Prompt Bar ──`);const r=on(t,e);n(`ขนาดไฟล์: ${(r.size/1024).toFixed(1)} KB`);const a=Be();n(`รูปย่อปัจจุบันใน Prompt Bar: ${a} รูป`);const i=async(v,S=8e3)=>{const F=Date.now();for(;Date.now()-F<S;){const P=Be();if(P>a)return n(`✅ [${v}] ยืนยัน: รูปย่อเพิ่มจาก ${a} → ${P}`),!0;await m(500)}return n(`⚠️ [${v}] รูปย่อไม่เพิ่ม (ยังคง ${Be()} รูป)`),!1};n("── ขั้น 1: คลิกปุ่ม '+' (สร้าง) ──");const p=an();if(!p)return _("ไม่พบปุ่ม '+' บน Prompt Bar"),!1;const l=new Set(document.querySelectorAll('input[type="file"]'));n(`file input ที่มีอยู่เดิม: ${l.size} ตัว`);const c=sn();let s=rn();const d=new MutationObserver(v=>{for(const S of v)for(const F of S.addedNodes)if(F instanceof HTMLInputElement&&F.type==="file"&&(F.type="text",s.push({input:F,origType:"file"}),n("🎯 Observer ปิดกั้น file input ใหม่")),F instanceof HTMLElement){const P=F.querySelectorAll('input[type="file"]');for(const g of P)g.type="text",s.push({input:g,origType:"file"}),n("🎯 Observer ปิดกั้น file input ซ้อน")}});d.observe(document.body,{childList:!0,subtree:!0});try{p.click(),n("คลิกปุ่ม '+' (สร้าง) แล้ว ✅"),await m(1500),n("── ขั้น 2: คลิกปุ่ม 'อัปโหลดรูปภาพ' ──");let v=!1;const S=Date.now();for(;!v&&Date.now()-S<8e3;){const P=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button'], [role='menuitemradio'], a[role='button']");for(const g of P){if(g===p)continue;const o=g.querySelectorAll("i, .material-icons, .material-symbols-outlined, [class*='icon']");for(const f of o){const E=((w=f.textContent)==null?void 0:w.trim())||"";if(E==="upload"||E==="upload_file"||E==="add_photo_alternate"){const V=Array.from(g.querySelectorAll("i")).map(I=>{var A;return(A=I.textContent)==null?void 0:A.trim()});if(!V.includes("drive_folder_upload")&&!V.includes("photo_library")){g.click(),v=!0,n(`คลิกปุ่มอัปโหลด (ไอคอน: ${E}) ✅`);break}}}if(v)break}if(!v)for(const g of P){if(g===p)continue;const o=g.childNodes.length<=8?(g.textContent||"").trim():"";if(o.length>0&&o.length<60){const f=o.toLowerCase();if(f.includes("ไลบรารี")||f.includes("library")||f.includes("drive")||f.includes("ไดรฟ์"))continue;if(f==="upload"||f==="อัปโหลด"||f==="อัพโหลด"||f.includes("upload image")||f.includes("upload photo")||f.includes("upload a file")||f.includes("upload file")||f.includes("อัปโหลดรูปภาพ")||f.includes("อัพโหลดรูปภาพ")||f.includes("อัปโหลดไฟล์")||f.includes("อัพโหลดไฟล์")||f.includes("from computer")||f.includes("จากคอมพิวเตอร์")||f.includes("from device")||f.includes("จากอุปกรณ์")||f.includes("my computer")||f.includes("คอมพิวเตอร์ของฉัน")){g.click(),v=!0,n(`คลิกปุ่มอัปโหลด (ข้อความ: "${o}") ✅`);break}}}if(!v)for(const g of P){if(g===p)continue;const o=(g.textContent||"").trim().toLowerCase();if(o.length>0&&o.length<60){if(o.includes("drive")||o.includes("ไดรฟ์")||o.includes("google")||o.includes("สร้าง")||o.includes("create")||o.includes("cancel")||o.includes("ยกเลิก")||o.includes("ไลบรารี")||o.includes("library"))continue;if(o.includes("upload")||o.includes("อัป")||o.includes("อัพ")||o.includes("file")||o.includes("ไฟล์")||o.includes("รูปภาพ")||o.includes("image")||o.includes("photo")){const f=g.getBoundingClientRect();if(f.width>0&&f.height>0){g.click(),v=!0,n(`คลิกปุ่มอัปโหลด (broad match: "${o.substring(0,40)}") ✅`);break}}}}v||await m(500)}return v?(await m(1e3),n("── ขั้น 3: ฉีดไฟล์ base64 เข้า file input ──"),ln(s,r,l)?(n(`ฉีดไฟล์ ${e} เสร็จ ✅`),n("── ขั้น 4: ตรวจสอบว่ารูปอัพโหลดเสร็จ ──"),await i("FileInput",1e4)||n("⚠️ ยังไม่พบรูปย่อใหม่ — อาจกำลังอัพโหลด (%)"),!0):(_(`ฉีดไฟล์ ${e} ล้มเหลว`),!1)):(_("ไม่พบปุ่มอัปโหลดในเมนูหลังรอ 8 วินาที"),!1)}finally{d.disconnect(),c();for(const v of s)v.input.type!=="file"&&(v.input.type="file")}}async function cn(t,e){var P;n("=== ขั้น 0: ตั้งค่า Flow ===");const r=document.querySelectorAll("button, div, span, [role='button']");let a=null;for(const g of r){const o=(g.textContent||"").trim();if(!(o.length>80)&&(o.includes("Nano Banana")||o.includes("Imagen")||o.includes("วิดีโอ")||o.includes("รูปภาพ")||o.includes("Image")||o.includes("Video"))){const f=g.getBoundingClientRect();f.bottom>window.innerHeight*.7&&f.width>30&&f.height>10&&(!a||(g.textContent||"").length<(a.textContent||"").length)&&(a=g)}}if(a&&n(`พบปุ่มตั้งค่าจากข้อความ: "${(a.textContent||"").substring(0,40).trim()}"`),!a){const g=document.querySelectorAll("i.google-symbols, i[class*='google-symbols'], .material-symbols-outlined, .material-icons");for(const o of g){const f=((P=o.textContent)==null?void 0:P.trim())||"";if(f.includes("crop")||f==="aspect_ratio"||f==="photo_size_select_large"){const E=o.closest("button, div[role='button'], [role='button']")||o.parentElement;if(E){const V=E.getBoundingClientRect();if(V.bottom>window.innerHeight*.7&&V.width>0){a=E,n(`พบปุ่มตั้งค่าจากไอคอน: ${f}`);break}}}}}if(!a)for(const g of r){const o=(g.textContent||"").trim();if(!(o.length>40)&&/x[1-4]/.test(o)&&(o.includes("วิดีโอ")||o.includes("รูปภาพ")||o.includes("Video")||o.includes("Image"))){const f=g.getBoundingClientRect();if(f.bottom>window.innerHeight*.7&&f.width>30){a=g,n(`พบปุ่มตั้งค่าจาก x-count + mode text: "${o.substring(0,40)}"`);break}}}if(!a)return _("ไม่พบปุ่มตั้งค่า"),!1;const i=a.getBoundingClientRect(),p=i.left+i.width/2,l=i.top+i.height/2,c={bubbles:!0,cancelable:!0,clientX:p,clientY:l,button:0};a.dispatchEvent(new PointerEvent("pointerdown",{...c,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",c)),await m(80),a.dispatchEvent(new PointerEvent("pointerup",{...c,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",c)),a.dispatchEvent(new MouseEvent("click",c)),n("คลิกปุ่มตั้งค่าแล้ว"),await m(1500);let s=!1,d=null;const w=document.querySelectorAll('.flow_tab_slider_trigger[role="tab"]');for(const g of w){const o=g.getAttribute("aria-controls")||"",f=g.id||"";if(o.toUpperCase().includes("IMAGE")||f.toUpperCase().includes("IMAGE")){d=g,n(`พบแท็บ Image ผ่าน flow_tab_slider_trigger (aria-controls: ${o})`);break}}if(!d)for(const g of document.querySelectorAll('[role="tab"]')){const o=g.id||"";if(o.toUpperCase().includes("TRIGGER-IMAGE")){d=g,n(`พบแท็บ Image ผ่าน id: ${o}`);break}}if(!d)for(const g of document.querySelectorAll("button, div, span, [role='menuitem'], [role='option'], [role='tab'], [role='button']")){const o=(g.textContent||"").trim();if(!(o.length>30)&&(o==="Image"||o.endsWith("Image")||o==="รูปภาพ"||o==="ภาพ"||o.includes("รูปภาพ"))&&!o.includes("Video")&&!o.includes("วิดีโอ")){const f=g.getBoundingClientRect();if(f.width>0&&f.height>0){d=g,n(`พบแท็บ Image ผ่านข้อความ: "${o}"`);break}}}if(d){const g=d.getAttribute("data-state")||"",o=d.getAttribute("aria-selected")||"";if(g==="active"||o==="true")s=!0,n("แท็บ Image เปิดอยู่แล้ว — ไม่ต้องคลิก");else{const f=d.getBoundingClientRect(),E={bubbles:!0,cancelable:!0,clientX:f.left+f.width/2,clientY:f.top+f.height/2,button:0};d.dispatchEvent(new PointerEvent("pointerdown",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mousedown",E)),await m(80),d.dispatchEvent(new PointerEvent("pointerup",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mouseup",E)),d.dispatchEvent(new MouseEvent("click",E)),s=!0,n("✅ คลิกแท็บ Image — สลับเป็นโหมดรูปภาพแล้ว"),await m(400)}}s||n("⚠️ ไม่พบปุ่มโหมด Image — อาจอยู่ในโหมดนี้แล้ว");const v=t==="horizontal"?"แนวนอน":"แนวตั้ง",S=t==="horizontal"?"landscape":"portrait";for(const g of document.querySelectorAll("button, div, span, [role='tab'], [role='option'], [role='button']")){const o=(g.textContent||"").trim();if(!(o.length>30)&&(o===v||o.includes(v)||o.toLowerCase()===S||o.toLowerCase().includes(S))){const f=g.getBoundingClientRect(),E={bubbles:!0,cancelable:!0,clientX:f.left+f.width/2,clientY:f.top+f.height/2,button:0};g.dispatchEvent(new PointerEvent("pointerdown",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mousedown",E)),await m(80),g.dispatchEvent(new PointerEvent("pointerup",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mouseup",E)),g.dispatchEvent(new MouseEvent("click",E)),n(`เลือกทิศทาง: ${v}`),await m(400);break}}const F=`x${e}`;for(const g of document.querySelectorAll("button, div, span, [role='tab'], [role='option'], [role='button']")){const o=(g.textContent||"").trim();if(!(o.length>10)&&(o===F||o===`${e}`)){const f=g.getBoundingClientRect(),E={bubbles:!0,cancelable:!0,clientX:f.left+f.width/2,clientY:f.top+f.height/2,button:0};g.dispatchEvent(new PointerEvent("pointerdown",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mousedown",E)),await m(80),g.dispatchEvent(new PointerEvent("pointerup",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mouseup",E)),g.dispatchEvent(new MouseEvent("click",E)),n(`เลือกจำนวน: ${F}`),await m(400);break}}return await m(300),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(300),a.dispatchEvent(new PointerEvent("pointerdown",{...c,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",c)),await m(80),a.dispatchEvent(new PointerEvent("pointerup",{...c,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",c)),a.dispatchEvent(new MouseEvent("click",c)),n("ปิดหน้าตั้งค่าแล้ว"),await m(600),!0}async function dn(t){const e=t==="quality"?"Veo 3.1 - Quality":"Veo 3.1 - Fast",r=t==="quality"?"Quality":"Fast",a=t==="quality"?"Fast":"Quality",i=t==="quality"?"คุณภาพ":"เร็ว",p=t==="quality"?"เร็ว":"คุณภาพ";n(`=== เลือกคุณภาพ Veo: ${e} (${i}) ===`);let l=null;const c=Date.now()+1e4;for(;!l&&Date.now()<c;){const g=document.querySelectorAll("button, [role='button'], [role='combobox'], [aria-haspopup], div[class*='dropdown'], [class*='select'], [class*='picker']");for(const o of g){const f=(o.textContent||"").trim();if(!(f.length>80)&&(f.includes("Veo")||f.includes("veo"))&&(o.hasAttribute("aria-haspopup")||o.hasAttribute("aria-expanded")||o.getAttribute("role")==="combobox"||f.includes("arrow_drop_down")||o.querySelector("svg"))){l=o,n(`พบปุ่ม Veo dropdown (Strategy A): "${f.substring(0,50).trim()}"`);break}}if(!l)for(const o of g){const f=(o.textContent||"").trim();if(!(f.length>80)&&(f.includes("Veo")||f.includes("veo"))){const E=o.getBoundingClientRect();if(E.width>0&&E.height>0){l=o,n(`พบปุ่ม Veo dropdown (Strategy B): "${f.substring(0,50).trim()}"`);break}}}if(!l)for(const o of g){const f=(o.textContent||"").trim();if(!(f.length>50)&&(f.includes("Fast")||f.includes("Quality")||f.includes("เร็ว")||f.includes("คุณภาพ"))&&(o.hasAttribute("aria-haspopup")||o.hasAttribute("aria-expanded")||o.querySelector("svg"))){l=o,n(`พบปุ่ม dropdown จากคำว่า Fast/Quality/TH (Strategy C): "${f.substring(0,50).trim()}"`);break}}if(!l){const o=document.querySelectorAll("div, span, button, [role='button']");for(const f of o){const E=(f.textContent||"").trim();if(E==="Veo 3.1 - Fast"||E==="Veo 3.1 - Quality"||E==="Fast"||E==="Quality"||E==="Veo 3.1 - เร็ว"||E==="Veo 3.1 - คุณภาพสูง"||E==="Veo 3.1 - คุณภาพ"||E==="Veo 2 - Fast"||E==="Veo 2 - Quality"){const V=f.getBoundingClientRect();if(V.width>0&&V.height>0){l=f,n(`พบปุ่มโดยข้อความเป๊ะๆ (Strategy D): "${E}"`);break}}}}if(!l){const o=document.querySelectorAll("button, [role='button'], div[tabindex], span[tabindex]");for(const f of o){const E=(f.textContent||"").trim();if(!(E.length>60)&&(E.includes("3.1")||E.includes("model")||E.includes("โมเดล"))){const V=f.getBoundingClientRect();if(V.bottom>window.innerHeight*.4&&V.width>0&&V.height>0){l=f,n(`พบปุ่ม model selector (Strategy E): "${E.substring(0,50).trim()}"`);break}}}}l||await m(1e3)}if(!l)return _("ไม่พบปุ่ม Veo quality dropdown หลังรอ 10 วินาที — ข้ามขั้นตอน (ใช้ค่าเดิม)"),!0;const s=(l.textContent||"").trim();if(s.includes(e)||s.includes(r)&&!s.includes(a)||s.includes(i)&&!s.includes(p))return n(`✅ Veo quality เป็น "${s}" อยู่แล้ว — ไม่ต้องเปลี่ยน`),!0;const d=l.getBoundingClientRect(),w=d.left+d.width/2,v=d.top+d.height/2,S={bubbles:!0,cancelable:!0,clientX:w,clientY:v,button:0};l.dispatchEvent(new PointerEvent("pointerdown",{...S,pointerId:1,isPrimary:!0,pointerType:"mouse"})),l.dispatchEvent(new MouseEvent("mousedown",S)),await m(80),l.dispatchEvent(new PointerEvent("pointerup",{...S,pointerId:1,isPrimary:!0,pointerType:"mouse"})),l.dispatchEvent(new MouseEvent("mouseup",S)),l.dispatchEvent(new MouseEvent("click",S)),n("คลิกเปิด Veo quality dropdown"),await m(1e3);let F=!1;const P=document.querySelectorAll("button, [role='menuitem'], [role='option'], [role='listitem'], li, div[role='button']");for(const g of P){const o=(g.textContent||"").trim();if((o===e||o===r||o.includes(e)||o.includes(i))&&!o.includes("arrow_drop_down")){const E=g.getBoundingClientRect();if(E.width>0&&E.height>0){const V=E.left+E.width/2,I=E.top+E.height/2,A={bubbles:!0,cancelable:!0,clientX:V,clientY:I,button:0};g.dispatchEvent(new PointerEvent("pointerdown",{...A,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mousedown",A)),await m(80),g.dispatchEvent(new PointerEvent("pointerup",{...A,pointerId:1,isPrimary:!0,pointerType:"mouse"})),g.dispatchEvent(new MouseEvent("mouseup",A)),g.dispatchEvent(new MouseEvent("click",A)),n(`✅ เลือก "${o}" สำเร็จ`),F=!0;break}}}return F?(await m(600),!0):(_(`ไม่พบตัวเลือก "${e}" หรือ "${i}" ใน dropdown`),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(300),document.body.click(),!1)}async function pn(t){var E,V,I,A;try{console.clear(),console.log("%c[Netflow AI] 🚀 Automation started — console cleared","color:#00e676;font-weight:bold;font-size:14px"),sessionStorage.removeItem("netflow_last_run"),sessionStorage.setItem("netflow_last_run",new Date().toISOString())}catch{}const e=navigator.userAgent,r=e.match(/Chrome\/(\d+\.\d+\.\d+\.\d+)/),a=r?r[1]:"unknown",i=Qe?"macOS":Je?"Windows":/Linux/i.test(e)?"Linux":/CrOS/i.test(e)?"ChromeOS":"Unknown",p=Qe?((V=(E=e.match(/Mac OS X ([0-9_]+)/))==null?void 0:E[1])==null?void 0:V.replace(/_/g,"."))||"":Je&&((I=e.match(/Windows NT ([0-9.]+)/))==null?void 0:I[1])||"",l=navigator.language||"unknown",c=`${window.innerWidth}x${window.innerHeight}`;n("══════════════════════════════════════════"),n(`🖥️ ระบบ: ${i} ${p} | Chrome ${a}`),n(`🌐 ภาษา: ${l} | หน้าจอ: ${c} | แพลตฟอร์ม: ${ye}`),n("══════════════════════════════════════════");try{Ge(t.theme)}catch{}try{We()}catch(y){console.warn("Overlay show error:",y)}const s=[],d=[];try{C("settings","active");const y=t.orientation||"horizontal",h=t.outputCount||1,x=await cn(y,h);s.push(x?"✅ Settings":"⚠️ Settings"),C("settings",x?"done":"error")}catch(y){_(`ตั้งค่าผิดพลาด: ${y.message}`),s.push("⚠️ Settings"),C("settings","error")}try{const y=t.veoQuality||"fast";await dn(y)?(s.push(`✅ Veo ${y}`),n(`✅ Veo quality: ${y}`)):(s.push("⚠️ Veo quality"),_("ไม่สามารถเลือก Veo quality ได้ — ใช้ค่าเดิม"))}catch(y){_(`Veo quality error: ${y.message}`),s.push("⚠️ Veo quality")}document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(300),document.body.click(),await m(500),n("=== ขั้น 1: อัพโหลดรูปอ้างอิง ===");const w=()=>{const y=document.querySelectorAll("span, div, p, label");for(const h of y){const x=(h.textContent||"").trim();if(/^\d{1,3}%$/.test(x)){if(x==="100%")return null;const T=h.getBoundingClientRect();if(T.width>0&&T.height>0&&T.top>0&&T.top<window.innerHeight)return x}}return null},v=async y=>{n(`รอการอัพโหลด ${y} เสร็จ...`),await m(2e3);const h=Date.now(),x=6e4;let T="",O=Date.now();const k=15e3;for(;Date.now()-h<x;){const $=w();if($){if($!==T)T=$,O=Date.now();else if(Date.now()-O>k){n(`✅ อัพโหลด ${y} — % ค้างที่ ${$} นาน ${k/1e3} วินาที ถือว่าเสร็จ`),await m(1e3);return}n(`กำลังอัพโหลด: ${$} — รอ...`),await m(1500)}else{n(`✅ อัพโหลด ${y} เสร็จ — ไม่พบตัวบอก %`),await m(1e3);return}}_(`⚠️ อัพโหลด ${y} หมดเวลาหลัง ${x/1e3} วินาที — ดำเนินการต่อ`)};if(t.characterImage){C("upload-char","active");try{const y=await Bt(t.characterImage,"character.png");s.push(y?"✅ ตัวละคร":"⚠️ ตัวละคร"),y||d.push("character upload failed"),C("upload-char",y?"done":"error")}catch(y){_(`อัพโหลดตัวละครผิดพลาด: ${y.message}`),s.push("❌ ตัวละคร"),d.push("character upload error"),C("upload-char","error")}await v("character"),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(500)}else we("upload-char");if(t.productImage){C("upload-prod","active"),document.querySelectorAll('input[type="file"]').forEach(y=>{n(`🧹 ลบ file input เก่าออก (name=${y.name||"N/A"})`),y.remove()}),await m(500);try{const y=await Bt(t.productImage,"product.png");s.push(y?"✅ สินค้า":"⚠️ สินค้า"),y||d.push("product upload failed"),C("upload-prod",y?"done":"error")}catch(y){_(`อัพโหลดสินค้าผิดพลาด: ${y.message}`),s.push("❌ สินค้า"),d.push("product upload error"),C("upload-prod","error")}await v("product"),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(500)}else we("upload-prod");n("ปิด dialog ที่เปิดอยู่..."),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(800),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(800);const S=w();S&&(n(`⚠️ อัพโหลดยังแสดง ${S} — รอเพิ่มเติม...`),await v("final")),n("อัพโหลดทั้งหมดเสร็จ — ไปต่อที่ Prompt"),await m(1e3);const F=(t.characterImage?1:0)+(t.productImage?1:0);if(F>0){let y=Be();y<F&&(n(`⏳ เห็นรูปย่อแค่ ${y}/${F} — รอ 3 วินาที...`),await m(3e3),y=Be()),y>=F?n(`✅ ยืนยันรูปย่ออ้างอิง: ${y}/${F}`):_(`⚠️ คาดว่าจะมี ${F} รูปย่อ แต่พบ ${y} — ดำเนินการต่อ`)}if(me()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนวาง Prompt"),d.push("stopped by user");try{Ie(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}n("=== ขั้น 2: วาง Image Prompt ==="),C("img-prompt","active"),await m(1e3);const P=At();P?(await Ae(P,t.imagePrompt),n(`วาง Prompt แล้ว (${t.imagePrompt.length} ตัวอักษร)`),s.push("✅ Prompt"),C("img-prompt","done")):(_("ไม่พบช่องป้อนข้อความ Prompt"),s.push("❌ Prompt"),d.push("prompt input not found"),C("img-prompt","error")),await m(800);const g=new Set;document.querySelectorAll("img").forEach(y=>{y.src&&g.add(y.src)}),n(`บันทึกรูปเดิม: ${g.size} รูปก่อน Generate`),n("=== ขั้น 3: คลิก Generate → ==="),C("img-generate","active"),await m(500);const o=Pt();if(o){const y=o.getBoundingClientRect(),h=y.left+y.width/2,x=y.top+y.height/2,T={bubbles:!0,cancelable:!0,clientX:h,clientY:x,button:0};o.dispatchEvent(new PointerEvent("pointerdown",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mousedown",T)),await m(80),o.dispatchEvent(new PointerEvent("pointerup",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mouseup",T)),o.dispatchEvent(new MouseEvent("click",T)),n("ส่งชุดคลิกเต็มรูปแบบบนปุ่ม Generate แล้ว"),s.push("✅ Generate"),await m(500),o.dispatchEvent(new PointerEvent("pointerdown",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mousedown",T)),await m(80),o.dispatchEvent(new PointerEvent("pointerup",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mouseup",T)),o.dispatchEvent(new MouseEvent("click",T)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate"),C("img-generate","done")}else _("ไม่พบปุ่ม → Generate"),s.push("❌ Generate"),d.push("generate button not found"),C("img-generate","error");n("=== ขั้น 4: รอรูปที่สร้าง + ทำเป็นวิดีโอ ==="),C("img-wait","active");try{n("รอ 15 วินาทีเพื่อเริ่มการสร้าง..."),await m(15e3);const y=()=>{const k=document.querySelectorAll("div, span, p, label, strong, small");for(const $ of k){if($.closest("#netflow-engine-overlay"))continue;const D=($.textContent||"").trim();if(D.length>10)continue;const M=D.match(/(\d{1,3})\s*%/);if(!M)continue;const u=parseInt(M[1],10);if(u<1||u>100)continue;const b=$.getBoundingClientRect();if(!(b.width===0||b.width>150)&&!(b.top<0||b.top>window.innerHeight))return u}return null};n("ค้นหารูปที่สร้างใหม่ (ไม่ใช่รูปเดิม)...");let h=null,x=-1,T=0;const O=Date.now();for(;!h&&Date.now()-O<18e4;){const k=document.querySelectorAll("img");for(const $ of k){if(g.has($.src)||!($.alt||"").toLowerCase().includes("generated"))continue;const M=$.getBoundingClientRect();if(M.width>120&&M.height>120&&M.top>0&&M.top<window.innerHeight*.85){const u=$.closest("div");if(u){h=u,n(`พบรูป AI จาก alt="${$.alt}": ${$.src.substring(0,80)}...`);break}}}if(!h)for(const $ of k){if(g.has($.src))continue;const D=$.closest("div"),M=(D==null?void 0:D.textContent)||"";if(M.includes("product.png")||M.includes("character.png")||M.includes(".png")||M.includes(".jpg"))continue;const u=$.getBoundingClientRect();if(u.width>120&&u.height>120&&u.top>0&&u.top<window.innerHeight*.85){const b=$.closest("div");if(b){h=b,n(`พบรูปใหม่ (สำรอง): ${$.src.substring(0,80)}...`);break}}}if(!h){if(me()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอรูป");break}const $=It();if($){_(`❌ สร้างรูปล้มเหลว: ${$}`),d.push(`image gen failed: ${$}`),C("img-wait","error");break}const D=y();D!==null?(D!==x&&(n(`🖼️ ความคืบหน้ารูปภาพ: ${D}%`),x=D,C("img-wait","active",D)),T=Date.now()):x>30&&Math.floor((Date.now()-T)/1e3)>=3&&n(`🖼️ % หายที่ ${x}% — รูปน่าจะเสร็จแล้ว`),document.hidden&&x>0&&Date.now()-T>1e4&&await $e(),await m(3e3)}}if(!h)_("หมดเวลารอรูปที่สร้าง"),s.push("⚠️ Wait Image"),C("img-wait","error");else{n("พบรูปที่สร้างแล้ว"),s.push("✅ Image Found"),C("img-wait","done",100);const k=h.getBoundingClientRect(),$=k.left+k.width/2,D=k.top+k.height/2,M={bubbles:!0,cancelable:!0,clientX:$,clientY:D};h.dispatchEvent(new PointerEvent("pointerenter",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),h.dispatchEvent(new MouseEvent("mouseenter",M)),h.dispatchEvent(new PointerEvent("pointerover",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),h.dispatchEvent(new MouseEvent("mouseover",M)),h.dispatchEvent(new PointerEvent("pointermove",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),h.dispatchEvent(new MouseEvent("mousemove",M)),n("ส่งเหตุการณ์ hover บนรูปแล้ว"),await m(1500);let u=null;for(const b of["more_vert","more_horiz","more"]){const R=qe(b);for(const G of R){const B=G.getBoundingClientRect();if(B.top>=k.top-20&&B.top<=k.bottom&&B.right>=k.right-150&&B.right<=k.right+20){u=G;break}}if(u)break}if(!u){const b=document.querySelectorAll("button");for(const R of b){const G=R.getBoundingClientRect();if(G.width<50&&G.height<50&&G.top>=k.top-10&&G.top<=k.top+60&&G.left>=k.right-80){const B=R.querySelectorAll("i");for(const U of B)if((((A=U.textContent)==null?void 0:A.trim())||"").includes("more")){u=R;break}if(u)break;const N=R.getAttribute("aria-label")||"";if(N.includes("เพิ่มเติม")||N.includes("more")){u=R;break}}}}if(!u)_("ไม่พบปุ่ม 3 จุดบนรูปที่สร้าง"),s.push("⚠️ 3-dots");else{const b=u.getBoundingClientRect(),R=b.left+b.width/2,G=b.top+b.height/2,B={bubbles:!0,cancelable:!0,clientX:R,clientY:G,button:0};u.dispatchEvent(new PointerEvent("pointerdown",{...B,pointerId:1,isPrimary:!0,pointerType:"mouse"})),u.dispatchEvent(new MouseEvent("mousedown",B)),await m(80),u.dispatchEvent(new PointerEvent("pointerup",{...B,pointerId:1,isPrimary:!0,pointerType:"mouse"})),u.dispatchEvent(new MouseEvent("mouseup",B)),u.dispatchEvent(new MouseEvent("click",B)),n("คลิกปุ่ม 3 จุดแล้ว"),await m(1500);let N=null;const U=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button']");for(const z of U){const q=(z.textContent||"").trim();if(q.includes("ทำให้เป็นภาพเคลื่อนไหว")||q.includes("Animate")||q.includes("animate")){N=z;break}}if(!N)_("ไม่พบเมนู 'ทำให้เป็นภาพเคลื่อนไหว'"),s.push("⚠️ Animate");else{const z=N.getBoundingClientRect(),q=z.left+z.width/2,X=z.top+z.height/2,L={bubbles:!0,cancelable:!0,clientX:q,clientY:X,button:0};N.dispatchEvent(new PointerEvent("pointerdown",{...L,pointerId:1,isPrimary:!0,pointerType:"mouse"})),N.dispatchEvent(new MouseEvent("mousedown",L)),await m(80),N.dispatchEvent(new PointerEvent("pointerup",{...L,pointerId:1,isPrimary:!0,pointerType:"mouse"})),N.dispatchEvent(new MouseEvent("mouseup",L)),N.dispatchEvent(new MouseEvent("click",L)),n("✅ คลิก 'ทำให้เป็นภาพเคลื่อนไหว' — สลับเป็นโหมดวิดีโอแล้ว"),s.push("✅ Animate"),C("animate","done"),await m(3e3)}}}}catch(y){_(`ขั้น 4 ผิดพลาด: ${y.message}`),s.push("⚠️ Animate")}if(me()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนขั้นวิดีโอ"),d.push("stopped by user");try{Ie(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}if(t.videoPrompt){n("=== ขั้น 5: วาง Video Prompt + สร้างวิดีโอ ==="),C("vid-prompt","active");try{n("รอ UI โหมดวิดีโอ..."),await m(3e3);let y=!1;const h=document.querySelectorAll("button, span, div");for(const k of h){const $=(k.textContent||"").trim(),D=k.getBoundingClientRect();if(($==="วิดีโอ"||$==="Video"||$.includes("วิดีโอ"))&&D.bottom>window.innerHeight*.7){y=!0,n("ยืนยัน: อยู่ในโหมดวิดีโอแล้ว");break}}y||n("ไม่พบตัวบอกโหมดวิดีโอ — ดำเนินการต่อ (อาจอยู่ในโหมดวิดีโอหลัง Animate)");let x=!1;if(document.hidden){n("🔄 Tab ซ่อนอยู่ — สลับมาค้างเพื่อวาง prompt + กด Generate");try{await new Promise(k=>chrome.runtime.sendMessage({type:"FOCUS_TAB"},()=>k())),x=!0,await m(1500)}catch{n("⚠️ FOCUS_TAB ล้มเหลว — ลองวางต่อ")}}await m(1e3);const T=At();if(T){await Ae(T,t.videoPrompt);const k=(T.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(k.length<20){if(n(`⚠️ Prompt ไม่ถูกวาง (ได้ ${k.length} ตัวอักษร) — ลองวางใหม่`),document.hidden)try{await new Promise(D=>chrome.runtime.sendMessage({type:"FOCUS_TAB"},()=>D())),x=!0,await m(1500)}catch{}T.focus(),await m(500),await Ae(T,t.videoPrompt);const $=(T.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();$.length<20?(_(`❌ วาง Video Prompt ไม่สำเร็จแม้ลองซ้ำ (ได้ ${$.length} ตัวอักษร)`),s.push("❌ Video Prompt"),d.push("video prompt paste failed after retry"),C("vid-prompt","error")):(n(`วาง Video Prompt สำเร็จหลังลองใหม่ (${$.length} ตัวอักษร)`),s.push("✅ Video Prompt"),C("vid-prompt","done"))}else n(`วาง Video Prompt แล้ว (${k.length} ตัวอักษร)`),s.push("✅ Video Prompt"),C("vid-prompt","done")}else _("ไม่พบช่อง Prompt สำหรับ Video Prompt"),s.push("❌ Video Prompt"),d.push("video prompt input not found"),C("vid-prompt","error");await m(1e3),C("vid-generate","active");const O=Pt();if(O){const k=O.getBoundingClientRect(),$=k.left+k.width/2,D=k.top+k.height/2,M={bubbles:!0,cancelable:!0,clientX:$,clientY:D,button:0};O.dispatchEvent(new PointerEvent("pointerdown",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),O.dispatchEvent(new MouseEvent("mousedown",M)),await m(80),O.dispatchEvent(new PointerEvent("pointerup",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),O.dispatchEvent(new MouseEvent("mouseup",M)),O.dispatchEvent(new MouseEvent("click",M)),n("✅ คลิก Generate สำหรับวิดีโอ — เริ่มสร้างวิดีโอ!"),s.push("✅ Video Generate"),C("vid-generate","done"),await m(500),O.dispatchEvent(new PointerEvent("pointerdown",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),O.dispatchEvent(new MouseEvent("mousedown",M)),await m(80),O.dispatchEvent(new PointerEvent("pointerup",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),O.dispatchEvent(new MouseEvent("mouseup",M)),O.dispatchEvent(new MouseEvent("click",M)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate วิดีโอ")}else _("ไม่พบปุ่ม Generate สำหรับวิดีโอ"),s.push("❌ Video Generate"),d.push("video generate button not found"),C("vid-generate","error");if(x){await m(2e3);try{chrome.runtime.sendMessage({type:"UNFOCUS_TAB"})}catch{}n("🔄 คืน tab เดิม — วิดีโอกำลังสร้างเบื้องหลัง")}}catch(y){_(`ขั้น 5 ผิดพลาด: ${y.message}`),s.push("⚠️ Video Gen"),d.push(`video gen error: ${y.message}`)}}else n("ไม่มี Video Prompt — ข้ามขั้นสร้างวิดีโอ"),we("animate"),we("vid-prompt"),we("vid-generate"),we("vid-wait");if(t.videoPrompt){C("vid-wait","active");const y=t.sceneCount||1,h=t.videoScenePrompts||[t.videoPrompt];if(y>1)try{Kt(y)}catch{}n(`=== ขั้น 6: รอวิดีโอ + ${y>1?`ต่อ ${y} ฉาก`:"ดาวน์โหลด"} ===`);const x=()=>{const k=document.querySelectorAll("div, span, p, label, strong, small");for(const $ of k){if($.closest("#netflow-engine-overlay"))continue;const D=($.textContent||"").trim();if(D.length>10)continue;const M=D.match(/(\d{1,3})\s*%/);if(!M)continue;const u=parseInt(M[1],10);if(u<1||u>100)continue;const b=$.getBoundingClientRect();if(!(b.width===0||b.width>150)&&!(b.top<0||b.top>window.innerHeight))return u}return null},T=async(k=6e5)=>{n("รอการสร้างวิดีโอ..."),C("vid-wait","active"),await m(5e3);const $=()=>{const L=document.querySelectorAll("div, span, p, label, strong, small");let j=0;for(const se of L){if(se.closest("#netflow-engine-overlay"))continue;const H=(se.textContent||"").trim();if(H.includes("%")&&H.length<15){const ie=se.tagName.toLowerCase(),ae=se.className&&typeof se.className=="string"?se.className.split(/\s+/).slice(0,2).join(" "):"",ee=se.getBoundingClientRect();if(n(`  🔍 "${H}" ใน <${ie}.${ae}> ที่ (${ee.left.toFixed(0)},${ee.top.toFixed(0)}) w=${ee.width.toFixed(0)}`),j++,j>=5)break}}j===0&&n("  🔍 ไม่พบ element ที่มีข้อความ '%'")},D=et();n(D?"📍 การ์ดวิดีโอมีอยู่แล้วตั้งแต่เริ่ม":"⏳ ยังไม่มีการ์ดวิดีโอ — จะติดตามความคืบหน้า %"),n("🔍 สแกนข้อความ % เพื่อตรวจสอบ:"),$();const M=Date.now();let u=-1,b=0,R=!1;for(;Date.now()-M<k;){const L=x();if(L!==null){if(L!==u&&(n(`ความคืบหน้าวิดีโอ: ${L}%`),u=L,C("vid-wait","active",L)),b=Date.now(),L>=100){n("✅ ตรวจพบ 100%!"),R=!0;break}}else if(u>30){const j=Math.floor((Date.now()-b)/1e3);if(j>=5){n(`✅ % หายไปที่ ${u}% (หาย ${j} วินาที) — วิดีโอเสร็จ!`),R=!0;break}n(`⏳ % หายที่ ${u}% — ยืนยันใน ${5-j} วินาที...`)}else{const j=Math.floor((Date.now()-M)/1e3);j%15<3&&n(`⏳ รอ... (${j} วินาที) ไม่พบ %`)}if(!R&&u>0&&et(!0)&&!D){n(`✅ การ์ดวิดีโอปรากฏขึ้นที่ ${u}% — วิดีโอเสร็จ!`),R=!0;break}if(me())return n("⛔ ผู้ใช้สั่งหยุดระหว่างรอวิดีโอ"),null;if(u<1){const j=It();if(j)return _(`❌ สร้างวิดีโอล้มเหลว: ${j}`),null}document.hidden&&u>0&&Date.now()-b>1e4&&await $e(),document.hidden&&u<1&&Date.now()-M>3e4&&await $e(),await m(3e3)}const G=et();if(!G)return n("❌ ไม่พบการ์ดวิดีโอที่จะคลิก"),C("vid-wait","error"),null;const B=G;R?(C("vid-wait","done",100),n("รอ 4 วินาทีก่อนคลิก..."),await m(4e3)):n("⚠️ หมดเวลา — ลองคลิกการ์ดวิดีโอต่อ");const N=B.getBoundingClientRect();let U=N.left+N.width/2,z=N.top+N.height/2,q=B;const X=B.querySelector("video, img, canvas");if(X){const L=X.getBoundingClientRect();L.width>50&&L.height>50&&(U=L.left+L.width/2,z=L.top+L.height/2,q=X,n(`🎯 พบรูปย่อ <${X.tagName.toLowerCase()}> ในการ์ดที่ (${U.toFixed(0)},${z.toFixed(0)}) ${L.width.toFixed(0)}x${L.height.toFixed(0)}`))}else z=N.top+N.height*.3,n(`🎯 ไม่พบรูปย่อย่อย — คลิกส่วนบน 1/3 ที่ (${U.toFixed(0)},${z.toFixed(0)})`);n(`🖱️ ชี้เมาส์การ์ดวิดีโอ 4 วินาที ที่ (${U.toFixed(0)}, ${z.toFixed(0)})...`),en(q);for(let L=0;L<8;L++){const j={bubbles:!0,cancelable:!0,clientX:U+L%2,clientY:z};q.dispatchEvent(new PointerEvent("pointermove",{...j,pointerId:1,isPrimary:!0,pointerType:"mouse"})),q.dispatchEvent(new MouseEvent("mousemove",j)),await m(500)}try{chrome.storage.local.set({[ce()]:{timestamp:Date.now(),action:"mute_video",sceneCount:y,scenePrompts:h,theme:t.theme}}),n(`💾 บันทึก pending action: mute_video (${y} ฉาก, ${h.length} prompts, theme: ${t.theme})`)}catch(L){n(`⚠️ ไม่สามารถบันทึก pending action: ${L.message}`)}return n("คลิกการ์ดวิดีโอเพื่อเข้าหน้ารายละเอียด..."),await O(q),n("✅ คลิกการ์ดวิดีโอเสร็จ"),B},O=async k=>{const $=k.getBoundingClientRect(),D=$.left+$.width/2,M=$.top+$.height/2,u={bubbles:!0,cancelable:!0,clientX:D,clientY:M,button:0};k.dispatchEvent(new PointerEvent("pointerdown",{...u,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mousedown",u)),await m(80),k.dispatchEvent(new PointerEvent("pointerup",{...u,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mouseup",u)),k.dispatchEvent(new MouseEvent("click",u)),await m(50),k.click(),n("คลิกการ์ดวิดีโอแล้ว"),await m(2e3)};try{if(!await T())_("หมดเวลารอการสร้างวิดีโอ"),s.push("⚠️ Video Wait"),C("vid-wait","error");else{s.push("✅ Video Complete"),C("vid-wait","done",100),n("✅ คลิกเข้าหน้ารายละเอียดวิดีโอแล้ว — รอ mute จาก pending action"),await m(3e3);const $=await new Promise(D=>{chrome.storage.local.get(ce(),M=>{if(chrome.runtime.lastError){D(null);return}D((M==null?void 0:M[ce()])||null)})});$&&!$._claimed&&(n("🔄 สคริปต์ยังทำงานอยู่หลังคลิกการ์ด (SPA navigation) — เรียก pending action โดยตรง"),chrome.storage.local.remove(ce()),$.action==="mute_video"?await Rt($.sceneCount||1,$.scenePrompts||[],$.theme):$.action==="wait_scene_gen_and_download"&&await Dt($.sceneCount||2,$.currentScene||2,$.theme,$.scenePrompts||[]))}}catch(k){_(`ขั้น 6 ผิดพลาด: ${k.message}`),s.push("⚠️ Step6"),d.push(`step 6: ${k.message}`)}}const f=d.length===0;try{Ie(f?5e3:8e3)}catch(y){console.warn("Overlay complete error:",y)}return{success:f,message:f?`สำเร็จ! ${s.join(" → ")}`:`บางขั้นตอนมีปัญหา: ${s.join(" → ")} | ${d.join(", ")}`,step:f?"done":"partial"}}async function Rt(t,e=[],r){var V;n("═══ Auto Mute: ปิดเสียงวิดีโอ ═══");try{r&&Ge(r)}catch{}try{We(t)}catch(I){n(`⚠️ showOverlay error: ${I.message}`)}try{const I=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(const A of I)C(A,"done");t>=2&&C("scene2-prompt","active"),n(`✅ overlay restored: ${I.length} steps done, sceneCount=${t}`)}catch(I){n(`⚠️ overlay restore error: ${I.message}`)}await m(1500);const a=(()=>{for(const I of document.querySelectorAll("button")){const A=I.querySelectorAll("i");for(const h of A){const x=(h.textContent||"").trim();if(x==="volume_up"||x==="volume_off"||x==="volume_mute"){const T=I.getBoundingClientRect();if(T.width>0&&T.height>0)return I}}const y=(I.getAttribute("aria-label")||"").toLowerCase();if(y.includes("mute")||y.includes("ปิดเสียง")){const h=I.getBoundingClientRect();if(h.width>0&&h.height>0)return I}}return null})();a?(a.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม");let i=null;if(t>=2){n(`═══ ${t} ฉาก — เริ่มต่อฉาก ═══`),await m(2e3);for(let u=2;u<=t;u++){const b=e[u-1];if(!b){_(`ไม่พบ prompt สำหรับฉากที่ ${u}`);continue}n(`── ฉากที่ ${u}/${t}: วาง prompt + generate ──`);let R=null;const G=Date.now();for(;!R&&Date.now()-G<1e4;){const H=document.querySelectorAll("[data-slate-editor='true']");if(H.length>0&&(R=H[H.length-1]),!R){const ie=document.querySelectorAll("[role='textbox'][contenteditable='true']");ie.length>0&&(R=ie[ie.length-1])}R||await m(1e3)}if(!R){_("ไม่พบช่อง prompt (Slate editor)");return}n(`พบ Slate editor: <${R.tagName.toLowerCase()}> ${R.className.substring(0,40)}`),await Ae(R,b),n(`วาง prompt ฉาก ${u} (${b.length} ตัวอักษร) ✅`);try{C(`scene${u}-prompt`,"done"),C(`scene${u}-gen`,"active")}catch{}await m(1e3);const B=R.getBoundingClientRect();let N=null,U=1/0;for(const H of document.querySelectorAll("button")){if(H.disabled)continue;const ie=H.querySelectorAll("i");let ae=!1;for(const Ee of ie)if((Ee.textContent||"").trim()==="arrow_forward"){ae=!0;break}if(!ae)continue;const ee=H.getBoundingClientRect();if(ee.width<=0||ee.height<=0)continue;const Re=Math.abs(ee.top-B.top)+Math.abs(ee.right-B.right);Re<U&&(U=Re,N=H)}if(!N)for(const H of document.querySelectorAll("button")){const ie=H.querySelectorAll("i");for(const ae of ie)if((ae.textContent||"").trim()==="arrow_forward"){const ee=H.getBoundingClientRect();if(ee.width>0&&ee.height>0){N=H;break}}if(N)break}if(!N){_("ไม่พบปุ่ม Generate/Send");return}await new Promise(H=>{chrome.storage.local.set({[ce()]:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:r,sceneCount:t,currentScene:u,scenePrompts:e}},()=>H())}),n(`💾 บันทึก pending action: wait_scene_gen_and_download (ฉาก ${u}/${t})`),await Z(N),n(`คลิก Generate ฉาก ${u} ✅`);try{C(`scene${u}-gen`,"done"),C(`scene${u}-wait`,"active")}catch{}n(`── รอวิดีโอฉาก ${u} gen เสร็จ ──`),await m(5e3);let z=0,q=0;const X=Date.now(),L=6e5,j=5e3;let se=!1;for(;Date.now()-X<L;){let H=null;const ie=document.querySelectorAll("div, span, p, label, strong, small");for(const ae of ie){if(ae.closest("#netflow-engine-overlay"))continue;const Re=(ae.textContent||"").trim().match(/^(\d{1,3})%$/);if(Re){const Ee=ae.getBoundingClientRect();if(Ee.width>0&&Ee.height>0&&Ee.width<120&&Ee.height<60){H=parseInt(Re[1],10);break}}}if(H!==null){if(H!==z){n(`🎬 ฉาก ${u} ความคืบหน้า: ${H}%`),z=H;try{C(`scene${u}-wait`,"active",H)}catch{}}q=0}else if(z>0){if(q===0)q=Date.now(),n(`🔍 ฉาก ${u}: % หายไป (จาก ${z}%) — กำลังยืนยัน...`);else if(Date.now()-q>=j){n(`✅ ฉาก ${u}: % หายไป ${j/1e3} วินาที — เจนเสร็จ!`),se=!0;break}}if(me()){n("⛔ ผู้ใช้สั่งหยุด");return}document.hidden&&z>0&&q===0&&await $e(),await m(2e3)}se||_(`ฉาก ${u} หมดเวลา`),n(`✅ ฉาก ${u} เสร็จแล้ว`);try{C(`scene${u}-wait`,"done",100)}catch{}chrome.storage.local.remove(ce()),n("🗑️ ลบ pending action (tracking เสร็จแล้วบนหน้านี้)"),await m(2e3)}n("── เริ่มดาวน์โหลด Full Video ──");try{C("download","active")}catch{}let I=!1;if(document.hidden){n("🔄 Tab ซ่อนอยู่ — สลับมาค้างเพื่อคลิกเมนูดาวน์โหลด (Radix UI)");try{await new Promise(u=>chrome.runtime.sendMessage({type:"FOCUS_TAB"},()=>u())),I=!0,await m(1500)}catch{}}await m(2e3);const A=Date.now();let y=null;const h=Date.now();for(;!y&&Date.now()-h<1e4;){for(const u of document.querySelectorAll("button")){const b=u.querySelector("i");if(b&&(b.textContent||"").trim()==="download"){const R=u.getBoundingClientRect();if(R.width>0&&R.height>0){y=u;break}}}y||await m(1e3)}if(!y){if(_("ไม่พบปุ่มดาวน์โหลด"),I)try{chrome.runtime.sendMessage({type:"UNFOCUS_TAB"})}catch{}return}await Z(y),n("คลิกดาวน์โหลดแล้ว ✅");try{C("download","done"),C("upscale","active")}catch{}await m(1500);let x=null;for(let u=0;u<3&&!x;u++){u>0&&n(`🔄 ลองหา 720p ครั้งที่ ${u+1}...`);let b=null;const R=Date.now();for(;!b&&Date.now()-R<5e3;){for(const z of document.querySelectorAll("[role='menuitem']"))if((z.textContent||"").trim().includes("Full Video")&&z.querySelector("i")){const X=z.getBoundingClientRect();if(X.width>0&&X.height>0){b=z;break}}b||await m(500)}if(!b){_("ไม่พบ Full Video");continue}const G=b.getBoundingClientRect(),B=G.left+G.width/2,N=G.top+G.height/2;b.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:B,clientY:N})),b.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:B,clientY:N})),b.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:B,clientY:N})),await Z(b),n("คลิก/hover Full Video ✅"),await m(2e3);const U=Date.now();for(;!x&&Date.now()-U<8e3;){for(const z of document.querySelectorAll("button[role='menuitem']")){const q=z.querySelectorAll("span");for(const X of q)if((X.textContent||"").trim()==="720p"){const L=z.getBoundingClientRect();if(L.width>0&&L.height>0){x=z;break}}if(x)break}x||(b.isConnected&&(b.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:B,clientY:N})),b.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:B+20,clientY:N}))),await m(500))}}if(!x){if(_("ไม่พบ 720p"),I)try{chrome.runtime.sendMessage({type:"UNFOCUS_TAB"})}catch{}return}if(await Z(x),n("คลิก 720p ✅"),I){try{chrome.runtime.sendMessage({type:"UNFOCUS_TAB"})}catch{}n("🔄 คืน tab เดิม — ดาวน์โหลดสั่งงานเสร็จแล้ว (รอไฟล์โหลดเบื้องหลัง)")}n("⏳ รอระบบเตรียมไฟล์ Full Video (Rendering)...");const T=Date.now();let O=!1,k=!1;for(;Date.now()-T<3e5;){for(const u of document.querySelectorAll("div[data-title] div, div[data-content] div")){const b=(u.textContent||"").trim();if(b==="Download complete!"||b==="ดาวน์โหลดเสร็จ"){n("✅ เตรียมไฟล์เสร็จสิ้น! (toast)"),O=!0;break}(b.includes("Downloading your extended video")||b.includes("กำลังดาวน์โหลด"))&&(k||(k=!0,n("⏳ กำลังเตรียมไฟล์วิดีโอรวม...")))}if(O)break;if(k){let u=!1;for(const b of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((b.textContent||"").trim().includes("Downloading")){u=!0;break}if(!u){n("✅ เตรียมไฟล์เสร็จสิ้น (toast หายไป)"),O=!0;break}}if(me()){n("⛔ ผู้ใช้สั่งหยุดระหว่างเตรียมไฟล์");return}await m(2e3)}if(!O){_("เตรียมไฟล์หมดเวลา");return}try{C("upscale","done",100),C("open","active")}catch{}n("⬇️ รอ Chrome ดาวน์โหลดไฟล์ลงเครื่อง..."),await m(5e3);let $=!1;const D=Date.now();for(;Date.now()-D<6e4&&!$;){try{await new Promise(u=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:A},b=>{chrome.runtime.lastError?_(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):b!=null&&b.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${b.message}`),$=!0,b.downloadUrl&&(i=b.downloadUrl,n(`[TikTok] จะใช้ download URL: ${b.downloadUrl.substring(0,80)}...`))):n(`⏳ กำลังดาวน์โหลดไฟล์ลงเครื่อง... (${Math.round((Date.now()-D)/1e3)}s)`),u()})})}catch(u){_(`ตรวจสอบผิดพลาด: ${u.message}`)}$||await m(3e3)}$||_("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const M=await je();i||(i=M);try{C("open","done"),Ie(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น ═══"),Ke(i),Xe(2e3);return}n("═══ 1 ฉาก — เริ่มดาวน์โหลด ═══"),await m(2e3);const p=(I,A="button, [role='menuitem'], [role='option'], li, span, div[role='button']")=>{for(const y of document.querySelectorAll(A)){const h=(y.textContent||"").trim();if(h.includes(I)&&h.length<100){const x=y.getBoundingClientRect();if(x.width>0&&x.height>0&&x.top>=0)return y}}return null};n("── ค้นหาปุ่มดาวน์โหลด ──");let l=null;const c=Date.now();for(;!l&&Date.now()-c<1e4;){for(const I of document.querySelectorAll("button, [role='button']")){const A=(I.textContent||"").trim(),y=A.toLowerCase();if((y.includes("download")||y.includes("ดาวน์โหลด"))&&A.length<80){const h=I.getBoundingClientRect();if(h.width>0&&h.height>0){l=I;break}}}if(!l)for(const I of document.querySelectorAll("button")){const A=(I.getAttribute("aria-label")||"").toLowerCase();if(A.includes("download")||A.includes("ดาวน์")){const y=I.getBoundingClientRect();if(y.width>0&&y.height>0){l=I;break}}}l||(n(`รอปุ่มดาวน์โหลด... (${document.querySelectorAll("button").length} ปุ่ม)`),await m(1e3))}if(!l){_("ไม่พบปุ่มดาวน์โหลด (รอ 10 วินาที)");return}n(`พบปุ่มดาวน์โหลด: "${(l.textContent||"").trim().substring(0,40)}"`),await Z(l),n("คลิกปุ่มดาวน์โหลดแล้ว ✅"),await m(1500);const s=Date.now();let d=null;const w=Date.now();for(;!d&&Date.now()-w<5e3;)d=p("1080p"),d||(n("รอ 1080p..."),await m(500));if(!d){_("ไม่พบ 1080p");return}await Z(d),n("คลิก 1080p Upscaled ✅"),n("รอการอัปสเกลเสร็จ...");const v=Date.now();let S=!1,F=!1,P=0;const g=3e3;for(;Date.now()-v<3e5;){const A=((document.body.innerText||"")+" "+(document.body.textContent||"")).toLowerCase();if(A.includes("upscaling complete")||A.includes("อัปสเกลเสร็จ")){n("✅ Upscaling complete!"),S=!0;break}for(const h of document.querySelectorAll("div, span, p")){const x=(h.textContent||"").trim().toLowerCase();if(x.length<60&&(x.includes("upscaling complete")||x.includes("อัปสเกลเสร็จ"))){n(`✅ Upscaling complete! (element: "${(V=h.textContent)==null?void 0:V.trim()}")`),S=!0;break}}if(S)break;if(A.includes("upscaling your video")||A.includes("กำลังอัปสเกล")){F=!0,P=0;const h=Math.floor((Date.now()-v)/1e3);n(`⏳ กำลังอัปสเกล... (${h} วินาที)`)}else if(F){if(P===0)P=Date.now(),n("🔍 ข้อความ Upscaling หายไป — กำลังยืนยัน...");else if(Date.now()-P>=g){n(`✅ ข้อความ Upscaling หายไป ${g/1e3} วินาที — เสร็จ!`),S=!0;break}}else{const h=Math.floor((Date.now()-v)/1e3);h%10<3&&n(`⏳ รอ Upscale... (${h} วินาที)`)}if(me()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอ Upscale");return}await m(2e3)}if(!S){_("Upscale หมดเวลา — ไฟล์อาจยังอัปสเกลอยู่");return}n("⬇️ รอ Chrome ดาวน์โหลดไฟล์ลงเครื่อง..."),await m(5e3);let o=!1;const f=Date.now();for(;Date.now()-f<6e4&&!o;){try{await new Promise(I=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:s},A=>{chrome.runtime.lastError?_(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):A!=null&&A.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${A.message}`),o=!0,A.downloadUrl&&(i=A.downloadUrl,n(`[TikTok] จะใช้ download URL: ${A.downloadUrl.substring(0,80)}...`))):n(`⏳ กำลังดาวน์โหลดไฟล์ลงเครื่อง... (${Math.round((Date.now()-f)/1e3)}s)`),I()})})}catch(I){_(`ตรวจสอบผิดพลาด: ${I.message}`)}o||await m(3e3)}o||_("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const E=await je();i||(i=E),n("═══ ดาวน์โหลดเสร็จสิ้น ═══"),Ke(i),Xe(2e3)}async function Dt(t=2,e=2,r,a=[]){n(`═══ Pending: รอ scene ${e}/${t} gen เสร็จ + ดาวน์โหลด ═══`);try{r&&Ge(r)}catch{}try{We(t)}catch(h){n(`⚠️ showOverlay error: ${h.message}`)}try{const h=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(let x=2;x<=e;x++)h.push(`scene${x}-prompt`,`scene${x}-gen`),x<e&&h.push(`scene${x}-wait`);for(const x of h)C(x,"done");C(`scene${e}-wait`,"active"),n(`✅ overlay restored: ${h.length} steps done (scene ${e}/${t} navigate)`)}catch(h){n(`⚠️ overlay restore error: ${h.message}`)}await m(2e3);const i=(()=>{for(const h of document.querySelectorAll("button")){const x=h.querySelectorAll("i");for(const T of x){const O=(T.textContent||"").trim();if(O==="volume_up"||O==="volume_off"||O==="volume_mute"){const k=h.getBoundingClientRect();if(k.width>0&&k.height>0)return h}}}return null})();i?(i.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม"),n(`── รอวิดีโอ scene ${e} gen เสร็จ (หลัง page navigate) ──`);let p=0,l=0;const c=Date.now(),s=6e5,d=5e3;let w=!1,v=0;for(;Date.now()-c<s;){let h=null;const x=document.querySelectorAll("div, span, p, label, strong, small");for(const T of x){if(T.closest("#netflow-engine-overlay"))continue;const k=(T.textContent||"").trim().match(/^(\d{1,3})%$/);if(k){const $=T.getBoundingClientRect();if($.width>0&&$.height>0&&$.width<120&&$.height<60){h=parseInt(k[1],10);break}}}if(h!==null){if(v=0,h!==p){n(`🎬 scene ${e} ความคืบหน้า: ${h}%`),p=h;try{C(`scene${e}-wait`,"active",h)}catch{}}l=0}else if(p>0){if(l===0)l=Date.now(),n(`🔍 scene ${e}: % หายไป (จาก ${p}%) — กำลังยืนยัน...`);else if(Date.now()-l>=d){n(`✅ scene ${e}: % หายไป ${d/1e3} วินาที — เจนเสร็จ!`),w=!0;break}}else if(v++,v>=15){const T=document.querySelectorAll("video");let O=!1;for(const k of T)if(k.readyState>=2&&!k.paused&&k.getBoundingClientRect().width>200){O=!0;break}if(O){n(`✅ scene ${e}: พบวิดีโอกำลังเล่น — ถือว่า gen เสร็จแล้ว`),w=!0;break}if(v>=30){n(`✅ scene ${e}: ไม่พบ % มานาน 60 วินาที — ถือว่าเสร็จ`),w=!0;break}}document.hidden&&p>0&&l===0&&await $e(),await m(2e3)}w||n(`⚠️ scene ${e} หมดเวลา — ลองต่อไป`);try{C(`scene${e}-wait`,"done",100)}catch{}if(n(`✅ scene ${e} เสร็จ`),e<t&&a.length>0){n(`═══ ยังเหลืออีก ${t-e} ฉาก — ต่อฉากถัดไป ═══`),await m(2e3);for(let h=e+1;h<=t;h++){const x=a[h-1];if(!x){n(`⚠️ ไม่พบ prompt สำหรับฉากที่ ${h} — ข้าม`);continue}n(`── ฉากที่ ${h}/${t}: วาง prompt + generate (pending recovery) ──`);let T=null;const O=Date.now();for(;!T&&Date.now()-O<1e4;){const B=document.querySelectorAll("[data-slate-editor='true']");if(B.length>0&&(T=B[B.length-1]),!T){const N=document.querySelectorAll("[role='textbox'][contenteditable='true']");N.length>0&&(T=N[N.length-1])}T||await m(1e3)}if(!T){n(`⚠️ ไม่พบ Slate editor สำหรับฉาก ${h}`);break}await Ae(T,x),n(`วาง prompt ฉาก ${h} (${x.length} ตัวอักษร) ✅`);try{C(`scene${h}-prompt`,"done"),C(`scene${h}-gen`,"active")}catch{}await m(1e3);const k=T.getBoundingClientRect();let $=null,D=1/0;for(const B of document.querySelectorAll("button")){if(B.disabled)continue;const N=B.querySelectorAll("i");let U=!1;for(const X of N)if((X.textContent||"").trim()==="arrow_forward"){U=!0;break}if(!U)continue;const z=B.getBoundingClientRect();if(z.width<=0||z.height<=0)continue;const q=Math.abs(z.top-k.top)+Math.abs(z.right-k.right);q<D&&(D=q,$=B)}if(!$)for(const B of document.querySelectorAll("button")){const N=B.querySelectorAll("i");for(const U of N)if((U.textContent||"").trim()==="arrow_forward"){const z=B.getBoundingClientRect();if(z.width>0&&z.height>0){$=B;break}}if($)break}if(!$){n(`⚠️ ไม่พบปุ่ม Generate สำหรับฉาก ${h}`);break}await new Promise(B=>{chrome.storage.local.set({[ce()]:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:r,sceneCount:t,currentScene:h,scenePrompts:a}},()=>B())}),await Z($),n(`คลิก Generate ฉาก ${h} ✅`);try{C(`scene${h}-gen`,"done"),C(`scene${h}-wait`,"active")}catch{}await m(5e3);let M=0,u=0;const b=Date.now();let R=!1,G=0;for(;Date.now()-b<6e5;){let B=null;const N=document.querySelectorAll("div, span, p, label, strong, small");for(const U of N){if(U.closest("#netflow-engine-overlay"))continue;const q=(U.textContent||"").trim().match(/^(\d{1,3})%$/);if(q){const X=U.getBoundingClientRect();if(X.width>0&&X.height>0&&X.width<120&&X.height<60){B=parseInt(q[1],10);break}}}if(B!==null){if(G=0,B!==M){n(`🎬 ฉาก ${h} ความคืบหน้า: ${B}%`),M=B;try{C(`scene${h}-wait`,"active",B)}catch{}}u=0}else if(M>0){if(u===0)u=Date.now();else if(Date.now()-u>=5e3){n(`✅ ฉาก ${h}: เจนเสร็จ!`),R=!0;break}}else if(G++,G>=15){const U=document.querySelectorAll("video");let z=!1;for(const q of U)if(q.readyState>=2&&!q.paused&&q.getBoundingClientRect().width>200){z=!0;break}if(z){n(`✅ ฉาก ${h}: พบวิดีโอเล่นอยู่ — เสร็จ`),R=!0;break}if(G>=30){n(`✅ ฉาก ${h}: ไม่พบ % 60 วินาที — ถือว่าเสร็จ`),R=!0;break}}document.hidden&&M>0&&u===0&&await $e(),await m(2e3)}R||n(`⚠️ ฉาก ${h} หมดเวลา`);try{C(`scene${h}-wait`,"done",100)}catch{}n(`✅ ฉาก ${h} เสร็จแล้ว`),chrome.storage.local.remove(ce()),await m(2e3)}}n("✅ ทุกฉากเสร็จ — เริ่มดาวน์โหลด"),await m(3e3);let S=null;try{C("download","active")}catch{}n("── เริ่มดาวน์โหลด Full Video (หลัง page navigate) ──");const F=Date.now();let P=null;const g=Date.now();for(;!P&&Date.now()-g<1e4;){for(const h of document.querySelectorAll("button")){const x=h.querySelector("i");if(x&&(x.textContent||"").trim()==="download"){const T=h.getBoundingClientRect();if(T.width>0&&T.height>0){P=h;break}}}P||await m(1e3)}if(!P){_("ไม่พบปุ่มดาวน์โหลด");return}await Z(P),n("คลิกดาวน์โหลดแล้ว ✅");try{C("download","done"),C("upscale","active")}catch{}await m(1500);let o=null;for(let h=0;h<3&&!o;h++){h>0&&n(`🔄 ลองหา 720p ครั้งที่ ${h+1}...`);let x=null;const T=Date.now();for(;!x&&Date.now()-T<5e3;){for(const M of document.querySelectorAll("[role='menuitem']"))if((M.textContent||"").trim().includes("Full Video")&&M.querySelector("i")){const b=M.getBoundingClientRect();if(b.width>0&&b.height>0){x=M;break}}x||await m(500)}if(!x){_("ไม่พบ Full Video");continue}const O=x.getBoundingClientRect(),k=O.left+O.width/2,$=O.top+O.height/2;x.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:k,clientY:$})),x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:k,clientY:$})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:k,clientY:$})),await Z(x),n("คลิก/hover Full Video ✅"),await m(2e3);const D=Date.now();for(;!o&&Date.now()-D<8e3;){for(const M of document.querySelectorAll("button[role='menuitem']")){const u=M.querySelectorAll("span");for(const b of u)if((b.textContent||"").trim()==="720p"){const R=M.getBoundingClientRect();if(R.width>0&&R.height>0){o=M;break}}if(o)break}o||(x.isConnected&&(x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:k,clientY:$})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:k+20,clientY:$}))),await m(500))}}if(!o){_("ไม่พบ 720p");return}await Z(o),n("คลิก 720p ✅"),n("⏳ รอระบบเตรียมไฟล์ Full Video (Rendering)...");const f=Date.now();let E=!1,V=!1;for(;Date.now()-f<3e5;){for(const h of document.querySelectorAll("div[data-title] div, div[data-content] div")){const x=(h.textContent||"").trim();if(x==="Download complete!"||x==="ดาวน์โหลดเสร็จ"){n("✅ เตรียมไฟล์เสร็จสิ้น! (toast)"),E=!0;break}(x.includes("Downloading your extended video")||x.includes("กำลังดาวน์โหลด"))&&(V||(V=!0,n("⏳ กำลังเตรียมไฟล์วิดีโอรวม...")))}if(E)break;if(V){let h=!1;for(const x of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((x.textContent||"").trim().includes("Downloading")){h=!0;break}if(!h){n("✅ เตรียมไฟล์เสร็จสิ้น (toast หายไป)"),E=!0;break}}await m(2e3)}if(!E){_("เตรียมไฟล์หมดเวลา");return}try{C("upscale","done",100),C("open","active")}catch{}n("⬇️ รอ Chrome ดาวน์โหลดไฟล์ลงเครื่อง..."),await m(5e3);let I=!1;const A=Date.now();for(;Date.now()-A<6e4&&!I;){try{await new Promise(h=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:F},x=>{chrome.runtime.lastError?_(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):x!=null&&x.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${x.message}`),I=!0,x.downloadUrl&&(S=x.downloadUrl,n(`[TikTok] จะใช้ download URL: ${x.downloadUrl.substring(0,80)}...`))):n(`⏳ กำลังดาวน์โหลดไฟล์ลงเครื่อง... (${Math.round((Date.now()-A)/1e3)}s)`),h()})})}catch(h){_(`ตรวจสอบผิดพลาด: ${h.message}`)}I||await m(3e3)}I||_("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const y=await je();S||(S=y);try{C("open","done"),Ie(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น (หลัง page navigate) ═══"),Ke(S),Xe(2e3)}async function fn(){try{await Qt;const t=ce();let e=await new Promise(l=>{chrome.storage.local.get(t,c=>{if(chrome.runtime.lastError){l(null);return}l((c==null?void 0:c[t])||null)})});if(!e&&xe){const l="netflow_pending_action";e=await new Promise(c=>{chrome.storage.local.get(l,s=>{if(chrome.runtime.lastError){c(null);return}c((s==null?void 0:s[l])||null)})}),e&&(n("🔄 Pending action found under global key (legacy fallback)"),chrome.storage.local.remove(l))}if(!e||!e.timestamp)return;if(!window.location.href.includes("/edit/")){n("⏭️ pending action พบ แต่ไม่ใช่หน้า video detail — ข้าม");return}if(e._claimed){n("⏭️ pending action ถูก tab อื่น claim แล้ว — ข้าม");return}const a=Date.now()-e.timestamp;if(a>3e5){n("⏰ พบ pending action แต่เก่าเกินไป — ข้าม"),chrome.storage.local.remove(t);return}const i=`${Date.now()}-${Math.random().toString(36).slice(2)}`;if(e._claimed=i,await new Promise(l=>{chrome.storage.local.set({[t]:e},()=>l())}),await m(300),!await new Promise(l=>{chrome.storage.local.get(t,c=>{const s=c==null?void 0:c[t];l((s==null?void 0:s._claimed)===i)})})){n("⏭️ pending action ถูก tab อื่น claim ชนะ — ข้าม");return}chrome.storage.local.remove(t),n(`🔄 ตรวจพบ pending action: ${e.action} (อายุ ${Math.round(a/1e3)} วินาที)`),e.action==="mute_video"?await Rt(e.sceneCount||1,e.scenePrompts||[],e.theme):e.action==="wait_scene_gen_and_download"||e.action==="wait_scene2_gen_and_download"?await Dt(e.sceneCount||2,e.currentScene||2,e.theme,e.scenePrompts||[]):n(`⚠️ ไม่รู้จัก pending action: ${e.action}`)}catch(t){n(`⚠️ checkAndRunPendingAction error: ${t.message}`)}}chrome.runtime.onMessage.addListener((t,e,r)=>{if((t==null?void 0:t.action)==="GENERATE_IMAGE")return window.__NETFLOW_STOP__=!1,n("ได้รับคำสั่ง GENERATE_IMAGE"),r({success:!0,message:"⏳ เริ่มกระบวนการอัตโนมัติแล้ว — ดูผลที่หน้า Google Flow",step:"started"}),pn(t).then(a=>{n(`✅ ระบบอัตโนมัติเสร็จ: ${a.message}`),Ct()}).catch(a=>{if(a instanceof Ze||(a==null?void 0:a.name)==="NetflowAbortError"){n("⛔ Automation หยุดทำงานโดยผู้ใช้");try{Ve("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{kt()}catch{}}else console.error("[Netflow AI] Generate error:",a);Ct()}),!1;if((t==null?void 0:t.action)==="STOP_AUTOMATION")return n("⛔ ได้รับ STOP_AUTOMATION — ตั้งค่าสถานะหยุด"),window.__NETFLOW_STOP__=!0,r({success:!0,message:"Stop signal sent"}),!1;if((t==null?void 0:t.action)==="PING")return r({status:"ready"}),!1;if((t==null?void 0:t.action)==="CLICK_FIRST_IMAGE")return r({success:!0,message:"⏳ กำลังคลิกรูปแรก..."}),(async()=>{n("CLICK_FIRST_IMAGE — ค้นหาการ์ดรูปแรกผ่านไอคอน <i>image</i>..."),await m(500);const a=nn();if(!a){_("ไม่พบการ์ดรูปผ่านไอคอน <i>image</i>");return}const i=a.getBoundingClientRect(),p=i.left+i.width/2,l=i.top+i.height/2;n(`การ์ดรูปที่ (${p.toFixed(0)}, ${l.toFixed(0)}) ${i.width.toFixed(0)}x${i.height.toFixed(0)} — คลิก 2 ครั้ง`);for(let c=0;c<2;c++){const s=document.elementFromPoint(p,l);s?(await Z(s),n(`คลิก ${c+1}/2 บน <${s.tagName.toLowerCase()}>`)):(await Z(a),n(`คลิก ${c+1}/2 บนการ์ด (สำรอง)`)),await m(300)}n("✅ คลิกการ์ดรูป 2 ครั้งเสร็จ")})(),!1}),n("สคริปต์ Google Flow พร้อมแล้ว — รอคำสั่ง"),fn()})();
