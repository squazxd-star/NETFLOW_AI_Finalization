...
@media (max-height: 600px) {
    ...
    `}function Je(){ce||(ce=document.createElement("style"),ce.id="netflow-overlay-styles",ce.textContent=kt(K),document.head.appendChild(ce))}function Qe(t){t.innerHTML="",W.forEach((e,i)=>{const a=document.createElement("div");a.className="nf-proc-row nf-proc-waiting",a.id=`nf-proc-${e.stepId}`,a.innerHTML=`
        ...
        `,t.appendChild(a)})}function Ct(){const t=document.getElementById("nf-terminal");if(!t)return;Qe(t);const e=document.getElementById("nf-step-counter");e&&(e.textContent=`0/${W.length}`)}function Ze(t,e){let s="";for(let P=0;P<20;P++){const k=P/20*Math.PI*2,y=(P+.2)/20*Math.PI*2,h=(P+.5)/20*Math.PI*2,r=(P+.8)/20*Math.PI*2,T=(P+1)/20*Math.PI*2;s+=`${P===0?"M":"L"}${(120+100*Math.cos(k)).toFixed(1)},${(120+100*Math.sin(k)).toFixed(1)} `,s+=`L${(120+100*Math.cos(y)).toFixed(1)},${(120+100*Math.sin(y)).toFixed(1)} `,s+=`L${(120+112*Math.cos(h)).toFixed(1)},${(120+112*Math.sin(h)).toFixed(1)} `,s+=`L${(120+100*Math.cos(r)).toFixed(1)},${(120+100*Math.sin(r)).toFixed(1)} `,s+=`L${(120+100*Math.cos(T)).toFixed(1)},${(120+100*Math.sin(T)).toFixed(1)} `}s+="Z";const l=14,d=72,u=62;let m="";for(let P=0;P<l;P++){const k=P/l*Math.PI*2,y=(P+.25)/l*Math.PI*2,h=(P+.75)/l*Math.PI*2,r=(P+1)/l*Math.PI*2;m+=`${P===0?"M":"L"}${(120+u*Math.cos(k)).toFixed(1)},${(120+u*Math.sin(k)).toFixed(1)} `,m+=`L${(120+d*Math.cos(y)).toFixed(1)},${(120+d*Math.sin(y)).toFixed(1)} `,m+=`L${(120+d*Math.cos(h)).toFixed(1)},${(120+d*Math.sin(h)).toFixed(1)} `,m+=`L${(120+u*Math.cos(r)).toFixed(1)},${(120+u*Math.sin(r)).toFixed(1)} `}return m+="Z",`<svg width="72" height="72" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    </svg>`}function Tt(){const t=document.createElement("div");t.id="netflow-engine-overlay",re=document.createElement("canvas"),re.id="nf-matrix-canvas",t.appendChild(re);const e=document.createElement("div");e.className="nf-pat-plasma",t.appendChild(e);for(let E=1;E<=5;E++){const S=document.createElement("div");S.className=`nf-ambient-orb nf-orb-${E}`,t.appendChild(S)}const i=document.createElement("div");i.className="nf-pat-data",t.appendChild(i);const a=document.createElement("div");a.className="nf-pat-diag-a",t.appendChild(a);const o=document.createElement("div");o.className="nf-pat-diag-b",t.appendChild(o);const c=document.createElement("div");c.className="nf-pat-circuit",t.appendChild(c);const p=document.createElement("div");p.className="nf-pat-honeycomb",t.appendChild(p);const s=document.createElement("div");s.className="nf-pat-binary",t.appendChild(s);const l=document.createElement("div");l.className="nf-pat-crosshatch",t.appendChild(l);const d=document.createElement("div");d.className="nf-pat-diamond",t.appendChild(d);const u=document.createElement("div");u.className="nf-pat-wave-h",t.appendChild(u);const m=document.createElement("div");m.className="nf-pat-radar",t.appendChild(m);const P=document.createElement("div");P.className="nf-pat-ripple-1",t.appendChild(P);const k=document.createElement("div");k.className="nf-pat-ripple-2",t.appendChild(k);const y=document.createElement("div");y.className="nf-pat-techscan",t.appendChild(y);const h=document.createElement("div");h.className="nf-center-glow",t.appendChild(h);const r=document.createElement("div");r.className="nf-pat-noise",t.appendChild(r);const T=document.createElement("div");T.className="nf-crt-scanlines",t.appendChild(T);const z=document.createElement("div");z.className="nf-vignette",t.appendChild(z);for(let E=0;E<3;E++){const S=document.createElement("div");S.className="nf-pulse-ring",t.appendChild(S)}["nf-deco-tl","nf-deco-tr","nf-deco-bl","nf-deco-br"].forEach(E=>{const S=document.createElement("div");S.className=`nf-corner-deco ${E}`,t.appendChild(S)});const X=document.createElement("button");X.className="nf-stop-btn",X.innerHTML='<span class="nf-stop-icon"></span> หยุด',X.onclick=()=>{var E;window.__NETFLOW_STOP__=!0;try{Pe("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{typeof chrome<"u"&&((E=chrome.runtime)!=null&&E.sendMessage)&&chrome.runtime.sendMessage({action:"AUTOMATION_STOPPED"})}catch{}},t.appendChild(X);const R=document.createElement("button");R.className="nf-close-btn",R.textContent="✕ ซ่อน",R.onclick=()=>Oe(),t.appendChild(R);const B=document.createElement("div");B.className="nf-layout";const w=document.createElement("div");w.className="nf-core-monitor",w.id="nf-core-monitor";const f=document.createElement("div");f.className="nf-core-header",f.innerHTML=`
    ...
    `,w.appendChild(f);const v=document.createElement("div");v.className="nf-terminal",v.id="nf-terminal",Qe(v),w.appendChild(v);const C=document.createElement("div");C.className="nf-engine-core",C.id="nf-engine-core";const O=document.createElement("div");O.className="nf-engine-frame",["nf-fc-tl","nf-fc-tr","nf-fc-bl","nf-fc-br"].forEach(E=>{const S=document.createElement("div");S.className=`nf-frame-corner ${E}`,O.appendChild(S)}),C.appendChild(O);const M="http://www.w3.org/2000/svg",$=document.createElementNS(M,"svg");$.setAttribute("class","nf-engine-waves"),$.setAttribute("viewBox","0 0 560 140"),$.setAttribute("preserveAspectRatio","none"),$.id="nf-engine-waves";for(let E=0;E<4;E++){const S=document.createElementNS(M,"path");S.setAttribute("fill","none"),S.setAttribute("stroke-width",E<2?"1.5":"1"),S.setAttribute("stroke",E<2?`rgba(${K.rgb},${.14+E*.1})`:`rgba(${K.accentRgb},${.1+(E-2)*.08})`),S.setAttribute("data-wave-idx",String(E)),$.appendChild(S)}C.appendChild($);const D=document.createElement("div");D.className="nf-engine-brand-inner",D.innerHTML=`
    ...
    `,C.appendChild(D);const b=document.createElement("div");b.className="nf-engine-stats",b.id="nf-engine-stats",b.innerHTML=[["SCENES","nf-stat-scenes","1/1"],["ELAPSED","nf-stat-elapsed","00:00"],["STEP","nf-stat-step","0/0"],["STATUS","nf-stat-status","READY"],["PROGRESS","nf-stat-progress","—"]].map(([E,S,F])=>`<div class="nf-stat-item"><span class="nf-stat-label">${E}</span><span class="nf-stat-val" id="${S}">${F}</span></div>`).join(""),C.appendChild(b),w.appendChild(C),B.appendChild(w);const x=["nf-mod-tl","nf-mod-tr","nf-mod-bl","nf-mod-br"];pe.forEach((E,S)=>{const F=Mt(E);F.classList.add(x[S]),F.id=`nf-mod-${E.id}`,B.appendChild(F)}),t.appendChild(B);for(let E=0;E<30;E++){const S=document.createElement("div");S.className="nf-particle",S.style.left=`${5+Math.random()*90}%`,S.style.bottom=`${Math.random()*40}%`,S.style.animationDuration=`${3+Math.random()*5}s`,S.style.animationDelay=`${Math.random()*4}s`;const F=.3+Math.random()*.4,I=.7+Math.random()*.3;S.style.background=`rgba(${Math.floor(te*I)}, ${Math.floor(ne*I)}, ${Math.floor(oe*I)}, ${F})`,S.style.width=`${1+Math.random()*2}px`,S.style.height=S.style.width,t.appendChild(S)}return t}function Mt(t){const e=document.createElement("div");e.className="nf-module";const i=document.createElement("div");i.className="nf-mod-header",i.innerHTML=`
    ...
    `,e.appendChild(i),t.steps.forEach(o=>{const c=document.createElement("div");c.className="nf-step",c.id=`nf-step-${o.id}`;let p="";o.progress!==void 0&&(p=`
            ...
            ${p}
        `,e.appendChild(c)});const a=document.createElement("div");return a.className="nf-mod-progress",a.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(a),e}function _t(){Ke=Date.now(),Me=setInterval(()=>{const t=Math.floor((Date.now()-Ke)/1e3),e=String(Math.floor(t/60)).padStart(2,"0"),i=String(t%60).padStart(2,"0"),a=document.getElementById("nf-timer");a&&(a.textContent=`${e}:${i}`);const o=document.getElementById("nf-stat-elapsed");o&&(o.textContent=`${e}:${i}`)},1e3)}function et(){Me&&(clearInterval(Me),Me=null)}const St=120,tt=160,nt=.4;let ue=null,ot=0,it=0,at=0,$e=[];function Pt(t,e){$e=[];for(let i=0;i<St;i++){const a=Math.random();let o;a<.22?o=0:a<.4?o=1:a<.55?o=2:a<.68?o=3:a<.84?o=4:o=5;const c=Math.random()*t,p=Math.random()*e,s=50+Math.random()*220,l=Math.random()*Math.PI*2,d=(.003+Math.random()*.008)*(Math.random()>.5?1:-1);$e.push({x:o===0?Math.random()*t:c+Math.cos(l)*s,y:o===0?Math.random()*e:p+Math.sin(l)*s,vx:(Math.random()-.5)*nt,vy:(Math.random()-.5)*nt,radius:1.2+Math.random()*2.5,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03,motion:o,oCx:c,oCy:p,oRadius:s,oAngle:l,oSpeed:d})}}function It(){if(!re)return;const t=re;if(xe=t.getContext("2d"),!xe)return;const e=()=>{t.width=window.innerWidth,t.height=window.innerHeight,$e.length===0&&Pt(t.width,t.height)};e(),window.addEventListener("resize",e);let i=null,a=0,o=0,c=!1;function p(){if(!xe||!re){ve=null;return}if(ve=requestAnimationFrame(p),c=!c,c)return;const s=xe,l=re.width,d=re.height;s.fillStyle=`rgba(${te*.04|0},${ne*.04|0},${oe*.06|0},1)`,s.fillRect(0,0,l,d),(!i||a!==l||o!==d)&&(a=l,o=d,i=s.createRadialGradient(l*.5,d*.5,0,l*.5,d*.5,Math.max(l,d)*.6),i.addColorStop(0,`rgba(${te*.08|0},${ne*.08|0},${oe*.1|0},0.4)`),i.addColorStop(1,"rgba(0,0,0,0)")),s.fillStyle=i,s.fillRect(0,0,l,d);const u=$e,m=u.length,P=tt*tt;for(let h=0;h<m;h++){const r=u[h];if(r.pulsePhase+=r.pulseSpeed,r.motion===0)r.x+=r.vx,r.y+=r.vy,r.x<0?(r.x=0,r.vx=Math.abs(r.vx)*(.8+Math.random()*.4)):r.x>l&&(r.x=l,r.vx=-Math.abs(r.vx)*(.8+Math.random()*.4)),r.y<0?(r.y=0,r.vy=Math.abs(r.vy)*(.8+Math.random()*.4)):r.y>d&&(r.y=d,r.vy=-Math.abs(r.vy)*(.8+Math.random()*.4));else if(r.motion===1)r.oAngle+=r.oSpeed,r.x=r.oCx+Math.cos(r.oAngle)*r.oRadius,r.y=r.oCy+Math.sin(r.oAngle)*r.oRadius,r.oCx+=Math.sin(r.oAngle*.3)*.15,r.oCy+=Math.cos(r.oAngle*.3)*.15;else if(r.motion===2)r.oAngle+=r.oSpeed,r.x=r.oCx+Math.cos(r.oAngle)*r.oRadius,r.y=r.oCy+Math.sin(r.oAngle)*r.oRadius*.5,r.oCx+=Math.sin(r.oAngle*.2)*.1,r.oCy+=Math.cos(r.oAngle*.2)*.1;else if(r.motion===3){r.oAngle+=r.oSpeed;const T=r.oAngle,z=r.oRadius*.7;r.x=r.oCx+z*Math.cos(T),r.y=r.oCy+z*Math.sin(T)*Math.cos(T),r.oCx+=Math.sin(T*.15)*.12,r.oCy+=Math.cos(T*.15)*.12}else if(r.motion===4){r.oAngle+=r.oSpeed*1.2;const T=r.oRadius*(.5+.5*Math.abs(Math.sin(r.oAngle*.15)));r.x=r.oCx+Math.cos(r.oAngle)*T,r.y=r.oCy+Math.sin(r.oAngle)*T,r.oCx+=Math.sin(r.oAngle*.1)*.18,r.oCy+=Math.cos(r.oAngle*.1)*.18}else r.oAngle+=r.oSpeed,r.x+=r.vx*.8,r.y=r.oCy+Math.sin(r.oAngle+r.x*.008)*r.oRadius*.35,r.x<-30?r.x=l+30:r.x>l+30&&(r.x=-30),r.oCy+=Math.sin(r.oAngle*.1)*.08;if(r.motion>0){const T=r.oRadius+50;r.oCx<-T?r.oCx=l+T:r.oCx>l+T&&(r.oCx=-T),r.oCy<-T?r.oCy=d+T:r.oCy>d+T&&(r.oCy=-T)}}s.beginPath(),s.strokeStyle=`rgba(${te},${ne},${oe},0.06)`,s.lineWidth=.4;const k=new Path2D;for(let h=0;h<m;h++){const r=u[h];for(let T=h+1;T<m;T++){const z=u[T],X=r.x-z.x,R=r.y-z.y,B=X*X+R*R;B<P&&(1-B/P<.4?(s.moveTo(r.x,r.y),s.lineTo(z.x,z.y)):(k.moveTo(r.x,r.y),k.lineTo(z.x,z.y)))}}if(s.stroke(),s.strokeStyle=`rgba(${te},${ne},${oe},0.18)`,s.lineWidth=.8,s.stroke(k),!ue||ot!==te||it!==ne||at!==oe){ue=document.createElement("canvas");const h=48;ue.width=h,ue.height=h;const r=ue.getContext("2d"),T=r.createRadialGradient(h/2,h/2,0,h/2,h/2,h/2);T.addColorStop(0,`rgba(${te},${ne},${oe},0.9)`),T.addColorStop(.3,`rgba(${te},${ne},${oe},0.35)`),T.addColorStop(1,`rgba(${te},${ne},${oe},0)`),r.fillStyle=T,r.fillRect(0,0,h,h),ot=te,it=ne,at=oe}const y=ue;for(let h=0;h<m;h++){const r=u[h],T=.6+.4*Math.sin(r.pulsePhase),z=r.radius*5*(.8+T*.4);s.globalAlpha=.5+T*.4,s.drawImage(y,r.x-z/2,r.y-z/2,z,z)}s.globalAlpha=1,s.fillStyle="rgba(255,255,255,0.45)",s.beginPath();for(let h=0;h<m;h++){const r=u[h];if(r.radius>2){const T=.6+.4*Math.sin(r.pulsePhase),z=r.radius*(.8+T*.4)*.35;s.moveTo(r.x+z,r.y),s.arc(r.x,r.y,z,0,Math.PI*2)}}s.fill()}p()}function At(){ve!==null&&(cancelAnimationFrame(ve),ve=null),re=null,xe=null,$e=[]}let Ee=null;const Se=560,Rt=140,rt=Se/2,st=Rt/2,lt=[];for(let t=0;t<=Se;t+=8){const e=Math.abs(t-rt)/rt;lt.push(Math.pow(Math.min(1,e*1.6),.6))}const Bt=[0,1,2,3].map(t=>({amp:10+t*5,freq:(1.2+t*.35)*Math.PI*2/Se,off:t*.6,spd:.7+t*.12}));let De=!1;function ct(){if(we=requestAnimationFrame(ct),De=!De,De)return;if(Re+=.07,!Ee){const e=document.getElementById("nf-engine-waves");if(!e){we=null;return}Ee=Array.from(e.querySelectorAll("path"))}const t=[];for(let e=0;e<Ee.length;e++){const i=Bt[e],a=Re*i.spd+i.off;t.length=0,t.push(`M 0 ${st}`);let o=0;for(let c=0;c<=Se;c+=8){const p=st+i.amp*lt[o++]*Math.sin(c*i.freq+a);t.push(`L${c} ${p*10+.5|0}`)}Ee[e].setAttribute("d",t.join(" "))}}function Dt(){Re=0,ct(),It(),_e=setInterval(()=>{const t=document.getElementById("nf-stat-freq"),e=document.getElementById("nf-stat-lat1"),i=document.getElementById("nf-stat-lat2"),a=document.getElementById("nf-stat-buf");t&&(t.textContent=`${(4.5+Math.random()*.5).toFixed(1)} GHz`),e&&(e.textContent=`${Math.floor(12+Math.random()*10)}ms`),i&&(i.textContent=`${Math.floor(12+Math.random()*10)}ms`),a&&(a.textContent=`${Math.floor(90+Math.random()*9)}%`)},2e3)}function dt(){we!==null&&(cancelAnimationFrame(we),we=null),_e&&(clearInterval(_e),_e=null),Ee=null,At()}function ze(){let t=0;const e=W.filter(d=>d.status!=="skipped").length;for(const d of W){const u=document.getElementById(`nf-proc-${d.stepId}`);if(!u)continue;u.className="nf-proc-row";const m=u.querySelector(".nf-proc-badge");switch(d.status){case"done":u.classList.add("nf-proc-done"),m&&(m.textContent="✅ done"),t++;break;case"active":u.classList.add("nf-proc-active"),m&&(m.textContent=d.progress!==void 0&&d.progress>0?`⏳ ${d.progress}%`:"⏳ active");break;case"error":u.classList.add("nf-proc-error"),m&&(m.textContent="❌ error");break;case"skipped":u.classList.add("nf-proc-skipped"),m&&(m.textContent="— skip");break;default:u.classList.add("nf-proc-waiting"),m&&(m.textContent="(queued)")}}const i=W.findIndex(d=>d.status==="active"),a=i>=0?i+1:t>=e&&e>0?W.length:t,o=document.getElementById("nf-step-counter");o&&(o.textContent=`${a}/${W.length}`);const c=document.querySelector(".nf-core-title-val"),p=document.querySelector(".nf-status-dot");t>=e&&e>0?(c&&(c.textContent="COMPLETE",c.style.color=K.doneHex),p&&(p.style.background=K.doneHex,p.style.boxShadow=`0 0 8px rgba(${K.doneRgb},0.7)`)):W.some(u=>u.status==="error")?(c&&(c.textContent="ERROR",c.style.color="#f87171"),p&&(p.style.background="#ef4444",p.style.boxShadow="0 0 8px rgba(239,68,68,0.7)")):W.some(u=>u.status==="active")&&c&&(c.textContent="ACTIVE",c.style.color=K.hex,c.style.textShadow=`0 0 10px rgba(${K.rgb},0.5)`);const s=document.getElementById("nf-terminal"),l=s==null?void 0:s.querySelector(".nf-proc-active");l&&s&&l.scrollIntoView({behavior:"smooth",block:"center"})}function pt(){J&&J.isConnected||(Je(),J=document.createElement("button"),J.id="nf-toggle-btn",J.className="nf-toggle-visible",J.innerHTML=de?Xe:je,J.title="ซ่อน/แสดง Netflow Overlay",J.onclick=()=>Oe(),document.body.appendChild(J))}function Oe(){U&&(pt(),de?(U.classList.remove("nf-hidden"),U.classList.add("nf-visible"),J&&(J.innerHTML=je),de=!1):(U.classList.remove("nf-visible"),U.classList.add("nf-hidden"),J&&(J.innerHTML=Xe),de=!0))}const ft={red:"themes/theme-red.jpg",yellow:"themes/theme-yellow.jpg",blue:"themes/theme-blue.jpg",purple:"themes/theme-purple.jpg",green:"themes/theme-green.jpg"};function ut(){const t=document.getElementById("nf-core-monitor");if(!t)return;let e=be;if(!e)try{e=localStorage.getItem("netflow_app_theme")||"green"}catch{e="green"}const i=ft[e]||ft.green;let a;try{a=chrome.runtime.getURL(i)}catch{a=`/${i}`}const o=K.rgb;t.style.backgroundImage=["linear-gradient(180deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 45%, rgba(0,0,0,0.90) 100%)",`linear-gradient(180deg, rgba(${o},0.25) 0%, rgba(${o},0.12) 50%, rgba(${o},0.20) 100%)`,`url('${a}')`].join(", "),t.style.backgroundSize="auto, auto, 50%",t.style.backgroundPosition="center, center, center",t.style.backgroundRepeat="no-repeat, no-repeat, no-repeat",t.style.setProperty("--nf-bg-set","1"),t.style.border=`1.5px solid rgba(${o},0.45)`,t.style.boxShadow=`0 0 70px rgba(${o},0.22), 0 0 140px rgba(${o},0.1), inset 0 1px 0 rgba(${o},0.15)`}function Fe(t=1){if(K=Et(),Ye(),U&&U.isConnected){de&&Oe();return}if(U&&!U.isConnected&&(U=null),ce&&(ce.remove(),ce=null),Je(),ye=t,W=Be(t),t>1){const e=pe.find(a=>a.id==="video");if(e){const a=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:"waiting",progress:0}];for(let o=2;o<=t;o++)a.push({id:`scene${o}-prompt`,label:`Scene ${o} Prompt`,status:"waiting"}),a.push({id:`scene${o}-gen`,label:`Scene ${o} Generate`,status:"waiting"}),a.push({id:`scene${o}-wait`,label:`Scene ${o} รอผล`,status:"waiting",progress:0});e.steps=a}const i=pe.find(a=>a.id==="render");if(i){const a=i.steps.find(c=>c.id==="download");a&&(a.label="ดาวน์โหลด 720p");const o=i.steps.find(c=>c.id==="upscale");o&&(o.label="Full Video")}}U=Tt(),U.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;",document.body.appendChild(U),U.classList.add("nf-visible"),de=!1,pt(),_t(),Dt(),requestAnimationFrame(()=>ut())}function gt(){et(),dt(),de=!1,U&&(U.classList.add("nf-fade-out"),setTimeout(()=>{U==null||U.remove(),U=null},500)),J&&(J.remove(),J=null)}const zt={settings:"CONFIG","upload-char":"UPLOAD","upload-prod":"UPLOAD","img-prompt":"PROMPT","img-generate":"GENERATE","img-wait":"IMG WAIT",animate:"ANIMATE","vid-prompt":"VID PROMPT","vid-generate":"VID GEN","vid-wait":"VID WAIT",download:"DOWNLOAD",upscale:"UPSCALE",open:"OPENING"};function Ot(t,e,i){const a=W.findIndex(u=>u.status==="active"),o=W.filter(u=>u.status==="done").length,c=W.length,p=a>=0?a+1:o>=c?c:o,s=document.getElementById("nf-stat-step");s&&(s.textContent=`${p}/${c}`);let l=1;for(const u of W)if(u.status==="active"||u.status==="done")if(u.stepId.startsWith("scene")){const m=u.stepId.match(/^scene(\d+)-/);m&&(l=Math.max(l,parseInt(m[1],10)))}else(u.stepId==="download"||u.stepId==="upscale"||u.stepId==="open")&&(l=ye);const d=document.getElementById("nf-stat-scenes");if(d&&(d.textContent=ye>1?`${l}/${ye}`:"1/1"),e==="active"){const u=document.getElementById("nf-stat-status"),m=zt[t]||t.toUpperCase();u&&(u.textContent=m)}else if(e==="done"&&o>=c){const u=document.getElementById("nf-stat-status");u&&(u.textContent="COMPLETE")}else if(e==="error"){const u=document.getElementById("nf-stat-status");u&&(u.textContent="ERROR")}if(i!==void 0&&i>0){const u=document.getElementById("nf-stat-progress");u&&(u.textContent=`${Math.min(100,i)}%`)}}function _(t,e,i){if(!U)return;for(const o of pe)for(const c of o.steps)c.id===t&&(c.status=e,i!==void 0&&(c.progress=i));for(const o of W)o.stepId===t&&(o.status=e,i!==void 0&&(o.progress=i));const a=document.getElementById(`nf-step-${t}`);if(a&&(a.className="nf-step",e==="active"?a.classList.add("nf-step-active"):e==="done"?a.classList.add("nf-step-done"):e==="error"&&a.classList.add("nf-step-error")),Ot(t,e,i),i!==void 0){const o=document.getElementById(`nf-bar-${t}`);o&&(o.style.width=`${Math.min(100,i)}%`)}Ne(),ze()}function ge(t){_(t,"skipped");const e=document.getElementById(`nf-step-${t}`);e&&(e.style.opacity="0.2")}function ke(t=4e3){et(),dt(),Ne(),ze(),setTimeout(()=>gt(),t)}function Ne(){for(const t of pe){const e=t.steps.filter(l=>l.status!=="skipped").length,i=t.steps.filter(l=>l.status==="done").length,a=t.steps.some(l=>l.status==="active"),o=e>0?Math.round(i/e*100):0,c=document.getElementById(`nf-pct-${t.id}`);c&&(c.textContent=`${o}%`);const p=document.getElementById(`nf-modbar-${t.id}`);p&&(p.style.width=`${o}%`);const s=document.getElementById(`nf-mod-${t.id}`);s&&(s.classList.remove("nf-active","nf-done"),o>=100?s.classList.add("nf-done"):a&&s.classList.add("nf-active"))}}function Ft(t){var a,o,c,p;ye=t;const e=new Map;for(const s of W)e.set(s.stepId,{status:s.status,progress:s.progress});W=Be(t);for(const s of W){const l=e.get(s.stepId);l&&(s.status=l.status,l.progress!==void 0&&(s.progress=l.progress))}if(Ct(),t>1){const s=pe.find(l=>l.id==="video");if(s){const l=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:((a=s.steps.find(d=>d.id==="animate"))==null?void 0:a.status)||"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:((o=s.steps.find(d=>d.id==="vid-prompt"))==null?void 0:o.status)||"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:((c=s.steps.find(d=>d.id==="vid-generate"))==null?void 0:c.status)||"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:((p=s.steps.find(d=>d.id==="vid-wait"))==null?void 0:p.status)||"waiting",progress:0}];for(let d=2;d<=t;d++)l.push({id:`scene${d}-prompt`,label:`Scene ${d} Prompt`,status:"waiting"}),l.push({id:`scene${d}-gen`,label:`Scene ${d} Generate`,status:"waiting"}),l.push({id:`scene${d}-wait`,label:`Scene ${d} รอผล`,status:"waiting",progress:0});s.steps=l,mt(s)}}const i=pe.find(s=>s.id==="render");if(i&&t>1){const s=i.steps.find(d=>d.id==="download");s&&(s.label="ดาวน์โหลด 720p");const l=i.steps.find(d=>d.id==="upscale");l&&(l.label="Full Video"),mt(i)}Ne(),ze()}function mt(t){const e=document.getElementById(`nf-mod-${t.id}`);if(!e)return;e.querySelectorAll(".nf-step, .nf-mod-progress").forEach(o=>o.remove()),t.steps.forEach(o=>{const c=document.createElement("div");c.className="nf-step",c.id=`nf-step-${o.id}`;let p="";o.progress!==void 0&&(p=`
                <div class="nf-progress-bar">
                    <div class="nf-progress-fill" id="nf-bar-${o.id}" style="width: 0%"></div>
                </div>
            `),c.innerHTML=`
            ...
            <span class="nf-step-label">${o.label}</span>
            ${p}
        `,e.appendChild(c)});const a=document.createElement("div");a.className="nf-mod-progress",a.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(a)}function Pe(t){t.replace(/^\[Netflow AI\]\s*/,"")}const n=t=>{console.log(`[Netflow AI] ${t}`);try{Pe(t)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"info",msg:t})}catch{}},A=t=>{console.warn(`[Netflow AI] ${t}`);try{Pe(`⚠️ ${t}`)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"warn",msg:`⚠️ ${t}`})}catch{}};function Le(t=3e3){n(`🔒 จะปิดแท็บ automation ใน ${t/1e3} วินาที...`),setTimeout(()=>{try{chrome.runtime.sendMessage({action:"CLOSE_AUTOMATION_TAB"},e=>{chrome.runtime.lastError?A(`ปิดแท็บไม่ได้: ${chrome.runtime.lastError.message}`):n(`✅ ปิดแท็บแล้ว: ${e==null?void 0:e.message}`)})}catch(e){A(`ปิดแท็บผิดพลาด: ${e.message}`)}},t)}async function Ve(){try{if(await new Promise(o=>{try{chrome.runtime.sendMessage({type:"PEEK_CACHED_VIDEO"},c=>{if(chrome.runtime.lastError){o(!1);return}o(!!(c!=null&&c.cached))})}catch{o(!1)}})){n("[TikTok] ✅ Background มี video cached อยู่แล้ว (จาก download) — ข้าม page capture เพื่อไม่ overwrite");const o=document.querySelectorAll("video");for(const c of o){const p=c.src||c.currentSrc||"";if(p)return p}return null}n("[TikTok] ไม่มี cached video — จะ capture จากหน้า...");const e=document.querySelectorAll("video");let i=null,a=0;for(const o of e){let c=o.src||"";if(!c){const l=o.querySelector("source");l&&(c=l.getAttribute("src")||"")}if(!c&&o.currentSrc&&(c=o.currentSrc),!c)continue;if(Q()){i||(i=c,a=1);continue}const p=o.getBoundingClientRect(),s=p.width*p.height;p.width>50&&s>a&&(a=s,i=c)}if(!i)return n("[TikTok] ไม่พบ video URL บนหน้า"),null;n(`[TikTok] พบ video URL: ${i.substring(0,80)}... (area=${a.toFixed(0)})`);try{n("[TikTok] กำลัง fetch video blob จาก content script (มี auth)...");const o=await fetch(i);if(!o.ok)return n(`[TikTok] fetch failed: HTTP ${o.status}`),await ht(i),i;const c=await o.blob(),p=(c.size/1024/1024).toFixed(1);n(`[TikTok] Video blob fetched: ${p} MB, type: ${c.type}`),c.size<1e5&&n(`[TikTok] ⚠️ Blob เล็กเกินไป (${c.size} bytes) — อาจเป็น thumbnail`);const s=await new Promise((l,d)=>{const u=new FileReader;u.onloadend=()=>l(u.result),u.onerror=()=>d(new Error("FileReader error")),u.readAsDataURL(c)});n(`[TikTok] Data URL พร้อม: ${(s.length/1024/1024).toFixed(1)} MB`),await new Promise(l=>{chrome.runtime.sendMessage({type:"CACHE_VIDEO_DATA",data:s},d=>{chrome.runtime.lastError?n(`[TikTok] CACHE_VIDEO_DATA error: ${chrome.runtime.lastError.message}`):d!=null&&d.success?n("[TikTok] ✅ Video cached in background service worker"):n(`[TikTok] CACHE_VIDEO_DATA failed: ${d==null?void 0:d.error}`),l()})})}catch(o){n(`[TikTok] Content script fetch error: ${o.message}`),await ht(i)}return i}catch(t){return n(`[TikTok] captureVideoUrl error: ${t.message}`),null}}async function ht(t){if(t.startsWith("https://"))try{await new Promise(e=>{chrome.runtime.sendMessage({type:"PRE_FETCH_VIDEO",url:t},i=>{chrome.runtime.lastError?n(`[TikTok] PRE_FETCH_VIDEO error: ${chrome.runtime.lastError.message}`):i!=null&&i.success?n(`[TikTok] Video pre-fetched via background: ${((i.size||0)/1024/1024).toFixed(1)} MB`):n(`[TikTok] PRE_FETCH_VIDEO failed: ${i==null?void 0:i.error}`),e()})})}catch{}}function Ge(t){if(t){if(window.__VIDEO_COMPLETE_SENT__){n("[TikTok] ⚠️ VIDEO_GENERATION_COMPLETE already sent, skipping duplicate");return}window.__VIDEO_COMPLETE_SENT__=!0;try{chrome.runtime.sendMessage({type:"VIDEO_GENERATION_COMPLETE",videoUrl:t,source:"veo"}),n("[TikTok] Sent VIDEO_GENERATION_COMPLETE (source=veo)")}catch{}}}const qe=/Mac|iPhone|iPad|iPod/i.test(navigator.userAgent),He=/Win/i.test(navigator.userAgent),me=qe?"🍎 Mac":He?"🪟 Win":"🐧 Other";n(`สคริปต์โหลดบนหน้า Google Flow แล้ว ${me}`),window.__VIDEO_COMPLETE_SENT__=!1;class Ue extends Error{constructor(){super("AUTOMATION_STOPPED"),this.name="NetflowAbortError"}}const g=t=>new Promise((e,i)=>{if(window.__NETFLOW_STOP__)return i(new Ue);const a=setTimeout(()=>{if(window.__NETFLOW_STOP__)return i(new Ue);e()},t);g._lastId=a});function fe(){return!!window.__NETFLOW_STOP__}const Q=()=>document.hidden;function bt(){var i;const t=["couldn't generate","could not generate","failed to generate","generation failed","ไม่สามารถสร้าง","สร้างไม่สำเร็จ","try again later","ลองอีกครั้งภายหลัง","ลองใหม่อีกครั้ง","something went wrong","เกิดข้อผิดพลาด","safety filter","policy violation","content policy","unable to generate","ไม่สามารถสร้างวิดีโอ","couldn't generate video","couldn't generate image"],e=document.querySelectorAll("div, span, p, h1, h2, h3, li");for(const a of e){if(a.closest("#netflow-engine-overlay"))continue;const o=(a.textContent||"").trim().toLowerCase();if(!(o.length>200||o.length<5)){for(const c of t)if(o.includes(c))return((i=a.textContent)==null?void 0:i.trim())||c}}return null}async function ee(t){if(Q()){t.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0})),t.click();return}const e=t.getBoundingClientRect(),i=e.left+e.width/2,a=e.top+e.height/2,o={bubbles:!0,cancelable:!0,clientX:i,clientY:a,button:0};t.dispatchEvent(new PointerEvent("pointerdown",{...o,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousedown",o)),await g(80),t.dispatchEvent(new PointerEvent("pointerup",{...o,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseup",o)),t.dispatchEvent(new MouseEvent("click",o)),await g(50),t.click()}function Nt(t){const e=t.getBoundingClientRect(),i=e.left+e.width/2,a=e.top+e.height/2,o={bubbles:!0,cancelable:!0,clientX:i,clientY:a};t.dispatchEvent(new PointerEvent("pointerenter",{...o,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseenter",o)),t.dispatchEvent(new PointerEvent("pointerover",{...o,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseover",o)),t.dispatchEvent(new PointerEvent("pointermove",{...o,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousemove",o))}function Lt(t){const e=[],i=document.querySelectorAll("i");for(const a of i){if((a.textContent||"").trim()!==t)continue;let c=a,p=null,s=1/0;for(let l=0;l<20&&c&&(c=c.parentElement,!(!c||c===document.body));l++){if(Q()){l>=3&&c.children.length>0&&!p&&(p=c);continue}const d=c.getBoundingClientRect();if(d.width>100&&d.height>80&&d.width<window.innerWidth*.6&&d.top>=-10&&d.bottom<=window.innerHeight+10){const u=d.width*d.height;u<s&&(p=c,s=u)}}p&&!e.includes(p)&&e.push(p)}return e.sort((a,o)=>{const c=a.getBoundingClientRect(),p=o.getBoundingClientRect();return c.left-p.left}),e}function We(t=!1){const e=[],i=document.querySelectorAll("video");for(const p of i){let s=p.parentElement;for(let l=0;l<10&&s;l++){if(Q()){if(l>=3&&s.children.length>0){e.push({el:s,left:0});break}s=s.parentElement;continue}const d=s.getBoundingClientRect();if(d.width>120&&d.height>80&&d.width<window.innerWidth*.7&&d.top>=-50&&d.left<window.innerWidth*.75){e.push({el:s,left:d.left});break}s=s.parentElement}}const a=document.querySelectorAll("i, span.material-symbols-outlined, span.google-symbols, .google-symbols");for(const p of a){const s=(p.textContent||"").trim();if(s==="play_arrow"||s==="play_circle"||s==="videocam"){let l=p.parentElement;for(let d=0;d<10&&l;d++){if(Q()){if(d>=3&&l.children.length>0){e.push({el:l,left:0});break}l=l.parentElement;continue}const u=l.getBoundingClientRect();if(u.width>120&&u.height>80&&u.width<window.innerWidth*.7&&u.top>=-50&&u.left<window.innerWidth*.75){e.push({el:l,left:u.left});break}l=l.parentElement}}}const o=document.querySelectorAll("img");for(const p of o){const s=(p.alt||"").toLowerCase();if(s.includes("video")||s.includes("วิดีโอ")){let l=p.parentElement;for(let d=0;d<10&&l;d++){if(Q()){if(d>=3&&l.children.length>0){e.push({el:l,left:0});break}l=l.parentElement;continue}const u=l.getBoundingClientRect();if(u.width>120&&u.height>80&&u.width<window.innerWidth*.7&&u.top>=-50&&u.left<window.innerWidth*.75){e.push({el:l,left:u.left});break}l=l.parentElement}}}const c=Array.from(new Set(e.map(p=>p.el))).map(p=>e.find(s=>s.el===p));if(c.sort((p,s)=>p.left-s.left),c.length>0){const p=c[0].el,s=p.getBoundingClientRect();return t||n(`🎬 พบการ์ดวิดีโอที่ (${s.left.toFixed(0)},${s.top.toFixed(0)}) ขนาด ${s.width.toFixed(0)}x${s.height.toFixed(0)}`),p}return t||n("🎬 ไม่พบการ์ดวิดีโอ"),null}function Vt(){const t=Lt("image");if(t.length>0){const i=t[0].getBoundingClientRect();return n(`🖼️ พบการ์ดรูปภาพ ${t.length} ใบ — ใบแรกที่ (${i.left.toFixed(0)},${i.top.toFixed(0)}) ขนาด ${i.width.toFixed(0)}x${i.height.toFixed(0)}`),t[0]}const e=document.querySelectorAll("canvas");for(const i of e){let a=i.parentElement;for(let o=0;o<10&&a;o++){if(Q()){if(o>=3&&a.children.length>0)return n("🖼️ พบการ์ดรูปภาพจาก <canvas> (minimized mode)"),a;a=a.parentElement;continue}const c=a.getBoundingClientRect();if(c.width>100&&c.height>80&&c.width<window.innerWidth*.6)return n(`🖼️ พบการ์ดรูปภาพจาก <canvas> สำรองที่ (${c.left.toFixed(0)},${c.top.toFixed(0)})`),a;a=a.parentElement}}return n("🖼️ ไม่พบการ์ดรูปภาพ"),null}function Gt(t,e){var s;const[i,a]=t.split(","),o=((s=i.match(/:(.*?);/))==null?void 0:s[1])||"image/png",c=atob(a),p=new Uint8Array(c.length);for(let l=0;l<c.length;l++)p[l]=c.charCodeAt(l);return new File([p],e,{type:o})}function Ce(t){var a;const e=[],i=document.querySelectorAll("i.google-symbols, i[class*='google-symbols'], .material-symbols-outlined, .material-icons");for(const o of i)if(((a=o.textContent)==null?void 0:a.trim())===t){const c=o.closest("button");c&&e.push(c)}return e}function qt(){const t=[...Ce("add"),...Ce("add_2")];if(t.length===0){n("ไม่พบปุ่มเพิ่มจากไอคอน — ลองค้นหาจากข้อความ");const a=document.querySelectorAll("button");for(const o of a){const c=(o.textContent||"").trim();if(c!=="+"&&c!=="add")continue;if(Q())return o;const p=o.getBoundingClientRect();if(p.bottom>window.innerHeight*.7&&p.width<60&&p.height<60)return o}return null}let e=null,i=0;for(const a of t){const o=a.getBoundingClientRect();o.y>i&&(i=o.y,e=a)}return e&&n(`พบปุ่ม "+" ของ Prompt Bar ที่ y=${i.toFixed(0)}`),e}function wt(){for(const a of["arrow_forward","send","arrow_upward","navigate_next","arrow_right"]){const o=Ce(a);let c=null,p=0;for(const s of o){const l=s.getBoundingClientRect();l.y>p&&(p=l.y,c=s)}if(c)return n(`พบปุ่ม Generate จากไอคอน "${a}" ที่ y=${p.toFixed(0)}`),c}const t=document.querySelectorAll("button");let e=null,i=0;for(const a of t){if(Q())break;const o=a.getBoundingClientRect();if(o.bottom>window.innerHeight*.7&&o.right>window.innerWidth*.5){const c=Math.abs(o.width-o.height)<10&&o.width<60,p=o.y+o.x+(c?1e3:0);p>i&&(i=p,e=a)}}if(e)return n("พบปุ่ม Generate จากตำแหน่งขวาล่าง"),e;for(const a of t){const o=(a.getAttribute("aria-label")||"").toLowerCase();if(o.includes("generate")||o.includes("submit")||o.includes("send")||o.includes("สร้าง"))return a}return null}function xt(){const t=document.querySelectorAll("textarea");for(const a of t)if(Q()||a.getBoundingClientRect().bottom>window.innerHeight*.5)return a;const e=document.querySelectorAll('[contenteditable="true"]');for(const a of e)if(Q()||a.getBoundingClientRect().bottom>window.innerHeight*.5)return a;const i=document.querySelectorAll("input[type='text'], input:not([type])");for(const a of i){const o=a.placeholder||"";if(o.includes("สร้าง")||o.includes("prompt")||o.includes("describe"))return a}return t.length>0?t[t.length-1]:null}async function Ie(t,e){var i,a,o,c;t.focus(),await g(300),n("วางข้อความ: วิธี 1 — Slate beforeinput insertFromPaste");try{const p=new DataTransfer;p.setData("text/plain",e),p.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const s=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertFromPaste",dataTransfer:p});t.dispatchEvent(s),n("วางข้อความ: ส่ง beforeinput insertFromPaste แล้ว");const l=new InputEvent("input",{bubbles:!0,inputType:"insertFromPaste",dataTransfer:p});t.dispatchEvent(l),await g(800);const d=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(d.length>20){n(`วางข้อความ: ✅ วิธี 1 สำเร็จ (${d.length} ตัวอักษร)`);return}n(`วางข้อความ: วิธี 1 — ไม่พบข้อความ (ได้ ${d.length} ตัวอักษร)`)}catch(p){n(`วางข้อความ: วิธี 1 ล้มเหลว: ${p.message}`)}n("วางข้อความ: วิธี 2 — Slate beforeinput insertText");try{t.focus(),await g(100);const p=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertText",data:e});t.dispatchEvent(p);const s=new InputEvent("input",{bubbles:!0,inputType:"insertText",data:e});t.dispatchEvent(s),await g(800);const l=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(l.length>20){n(`วางข้อความ: ✅ วิธี 2 สำเร็จ (${l.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 2 — ไม่พบข้อความ")}catch(p){n(`วางข้อความ: วิธี 2 ล้มเหลว: ${p.message}`)}n("วางข้อความ: วิธี 3 — ClipboardEvent paste");try{t.focus(),await g(200);const p=new DataTransfer;p.setData("text/plain",e),p.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const s=new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:p});t.dispatchEvent(s),await g(800);const l=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(l.length>20){n(`วางข้อความ: ✅ วิธี 3 สำเร็จ (${l.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 3 — ไม่พบข้อความ")}catch(p){n(`วางข้อความ: วิธี 3 ล้มเหลว: ${p.message}`)}n("วางข้อความ: วิธี 4 — navigator.clipboard + execCommand paste");try{if((i=navigator.clipboard)!=null&&i.writeText)await navigator.clipboard.writeText(e),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน navigator.clipboard");else{const s=document.createElement("textarea");s.value=e,s.style.cssText="position:fixed;left:-9999px;top:-9999px;opacity:0",document.body.appendChild(s),s.focus(),s.select(),document.execCommand("copy"),document.body.removeChild(s),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน execCommand")}t.focus(),await g(200),document.execCommand("paste"),await g(500);const p=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(p.length>20){n(`วางข้อความ: ✅ วิธี 4 สำเร็จ (${p.length} ตัวอักษร)`);return}}catch(p){n(`วางข้อความ: วิธี 4 ล้มเหลว: ${p.message}`)}n("วางข้อความ: วิธี 5 — React fiber Slate editor");try{const p=Object.keys(t).find(s=>s.startsWith("__reactFiber$")||s.startsWith("__reactInternalInstance$"));if(p){let s=t[p];for(let l=0;l<30&&s;l++){const d=s.memoizedProps,u=s.memoizedState;if((a=d==null?void 0:d.editor)!=null&&a.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber props");const m=d.editor;m.selection,m.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน editor.insertText");return}if((c=(o=u==null?void 0:u.memoizedState)==null?void 0:o.editor)!=null&&c.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber state"),u.memoizedState.editor.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน state editor");return}s=s.return}n("วางข้อความ: พบ Fiber แต่ไม่พบ Slate editor ใน tree")}else n("วางข้อความ: ไม่พบ React fiber บน element")}catch(p){n(`วางข้อความ: วิธี 5 ล้มเหลว: ${p.message}`)}n("วางข้อความ: ⚠️ ลองครบทั้ง 5 วิธีแล้ว — ตรวจสอบผลใน Console")}function Ht(){const t=[],e=document.querySelectorAll('input[type="file"]');for(const i of e)t.push({input:i,origType:"file"}),i.type="text";return t.length>0&&n(`ปิดกั้น file input ${t.length} ตัว (type → text)`),t}function Ut(){const t=HTMLInputElement.prototype.click;return HTMLInputElement.prototype.click=function(){if(this.type==="file"){n(`🚫 บล็อกการเปิด file dialog (${me})`);return}return t.call(this)},n(`🔒 ติดตั้งตัวบล็อก file dialog แล้ว (${me})`),()=>{HTMLInputElement.prototype.click=t,n("🔓 ถอดตัวบล็อก file dialog แล้ว")}}function Wt(t,e,i){var d;const a=document.querySelectorAll('input[type="text"][style*="display: none"], input[type="text"][hidden], input[type="text"]'),o=[...t.map(u=>u.input)];for(const u of a)!o.includes(u)&&u.offsetParent===null&&o.push(u);for(const u of o)u.type="file";n(`คืนค่า input ${o.length} ตัวเป็น type=file`);const c=document.querySelectorAll('input[type="file"]');if(c.length===0)return n(`⚠️ ไม่พบ file input หลังคืนค่า (${me})`),!1;let p;if(i&&i.size>0){const u=Array.from(c).filter(m=>!i.has(m));u.length>0?(p=u[u.length-1],n(`เล็งเป้า file input ใหม่ (${u.length} ใหม่, ${c.length} ทั้งหมด)`)):(p=c[c.length-1],n(`ไม่พบ file input ใหม่ — ใช้ตัวสุดท้ายจาก ${c.length} ตัว`))}else p=c[c.length-1];const s=new DataTransfer;s.items.add(e);try{p.files=s.files,n(`ฉีดไฟล์ผ่าน target.files (${((d=p.files)==null?void 0:d.length)??0} ไฟล์)`)}catch(u){n(`กำหนด target.files ล้มเหลว: ${u.message} — ลอง defineProperty`);try{Object.defineProperty(p,"files",{value:s.files,writable:!0,configurable:!0}),n("ฉีดไฟล์ผ่าน Object.defineProperty")}catch(m){return A(`การฉีดไฟล์ล้มเหลวทั้ง 2 วิธี: ${m.message}`),!1}}const l=p._valueTracker;l&&(l.setValue(""),n("รีเซ็ต React _valueTracker บน file input")),p.dispatchEvent(new Event("change",{bubbles:!0})),p.dispatchEvent(new Event("input",{bubbles:!0}));try{const u=new DataTransfer;u.items.add(e);const m=new DragEvent("drop",{bubbles:!0,cancelable:!0,dataTransfer:u});p.dispatchEvent(m),n("ส่ง drop event บน file input ด้วย")}catch{}return n(`✅ ฉีดไฟล์เสร็จ: ${e.name} (${(e.size/1024).toFixed(1)} KB) → <input> ${me}`),!0}function Te(){let t=0;const e=document.querySelectorAll("img");for(const a of e){if(a.closest("#netflow-engine-overlay")||!a.src)continue;if(Q()){t++;continue}const o=a.getBoundingClientRect();o.bottom>window.innerHeight*.6&&o.width>20&&o.width<200&&o.height>20&&o.height<200&&a.offsetParent!==null&&t++}const i=document.querySelectorAll('[style*="background-image"], [class*="thumb"], [class*="preview"]');for(const a of i){if(a.closest("#netflow-engine-overlay"))continue;if(Q()){t++;continue}const o=a.getBoundingClientRect();o.bottom>window.innerHeight*.6&&o.width>20&&o.width<200&&o.height>20&&o.height<200&&a.offsetParent!==null&&t++}return t}async function vt(t,e){var u;n(`── กำลังอัพโหลด ${e} ไปยัง Prompt Bar ──`);const i=Gt(t,e);n(`ขนาดไฟล์: ${(i.size/1024).toFixed(1)} KB`);const a=Te();n(`รูปย่อปัจจุบันใน Prompt Bar: ${a} รูป`);const o=async(m,P=8e3)=>{const k=Date.now();for(;Date.now()-k<P;){const y=Te();if(y>a)return n(`✅ [${m}] ยืนยัน: รูปย่อเพิ่มจาก ${a} → ${y}`),!0;await g(500)}return n(`⚠️ [${m}] รูปย่อไม่เพิ่ม (ยังคง ${Te()} รูป)`),!1};n("── ขั้น 1: คลิกปุ่ม '+' (สร้าง) ──");const c=qt();if(!c)return A("ไม่พบปุ่ม '+' บน Prompt Bar"),!1;const p=new Set(document.querySelectorAll('input[type="file"]'));n(`file input ที่มีอยู่เดิม: ${p.size} ตัว`);const s=Ut();let l=Ht();const d=new MutationObserver(m=>{for(const P of m)for(const k of P.addedNodes)if(k instanceof HTMLInputElement&&k.type==="file"&&(k.type="text",l.push({input:k,origType:"file"}),n("🎯 Observer ปิดกั้น file input ใหม่")),k instanceof HTMLElement){const y=k.querySelectorAll('input[type="file"]');for(const h of y)h.type="text",l.push({input:h,origType:"file"}),n("🎯 Observer ปิดกั้น file input ซ้อน")}});d.observe(document.body,{childList:!0,subtree:!0});try{c.click(),n("คลิกปุ่ม '+' (สร้าง) แล้ว ✅"),await g(1500),n("── ขั้น 2: คลิกปุ่ม 'อัปโหลดรูปภาพ' ──");let m=!1;const P=Date.now();for(;!m&&Date.now()-P<5e3;){const y=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button']");for(const h of y){if(h===c)continue;const r=h.querySelectorAll("i");for(const T of r){const z=((u=T.textContent)==null?void 0:u.trim())||"";if((z==="upload"||z==="upload_file")&&!Array.from(h.querySelectorAll("i")).map(R=>{var B;return(B=R.textContent)==null?void 0:B.trim()}).includes("drive_folder_upload")){h.click(),m=!0,n(`คลิกปุ่มอัปโหลด (ไอคอน: ${z}) ✅`);break}}if(m)break}if(!m)for(const h of y){if(h===c)continue;const r=h.childNodes.length<=5?(h.textContent||"").trim():"";if(r.length>0&&r.length<40){const T=r.toLowerCase();if(T==="upload"||T==="อัปโหลด"||T==="อัพโหลด"||T.includes("upload image")||T.includes("upload photo")||T.includes("อัปโหลดรูปภาพ")||T.includes("อัพโหลดรูปภาพ")||T.includes("from computer")||T.includes("จากคอมพิวเตอร์")){h.click(),m=!0,n(`คลิกปุ่มอัปโหลด (ข้อความ: "${r}") ✅`);break}}}m||await g(500)}return m?(await g(1e3),n("── ขั้น 3: ฉีดไฟล์ base64 เข้า file input ──"),Wt(l,i,p)?(n(`ฉีดไฟล์ ${e} เสร็จ ✅`),n("── ขั้น 4: ตรวจสอบว่ารูปอัพโหลดเสร็จ ──"),await o("FileInput",1e4)||n("⚠️ ยังไม่พบรูปย่อใหม่ — อาจกำลังอัพโหลด (%)"),!0):(A(`ฉีดไฟล์ ${e} ล้มเหลว`),!1)):(A("ไม่พบปุ่มอัปโหลดในเมนูหลังรอ 5 วินาที"),!1)}finally{d.disconnect(),s();for(const m of l)m.input.type!=="file"&&(m.input.type="file")}}async function Yt(t,e){n("=== ขั้น 0: ตั้งค่า Flow ===");const i=document.querySelectorAll("button");let a=null;for(const k of i){const y=k.textContent||"";if((y.includes("Nano Banana")||y.includes("Imagen")||y.includes("วิดีโอ")||y.includes("รูปภาพ")||y.includes("Image")||y.includes("Video"))&&k.getBoundingClientRect().bottom>window.innerHeight*.7){a=k,n(`พบปุ่มตั้งค่าจากข้อความ: "${y.substring(0,30).trim()}"`);break}}if(!a)for(const k of["crop_16_9","crop_portrait","crop_landscape","crop_3_2","crop_5_4"]){const y=Ce(k);for(const h of y)if(h.getBoundingClientRect().bottom>window.innerHeight*.7){a=h,n(`พบปุ่มตั้งค่าจากไอคอน: ${k}`);break}if(a)break}if(!a)return A("ไม่พบปุ่มตั้งค่า"),!1;const o=a.getBoundingClientRect(),c=o.left+o.width/2,p=o.top+o.height/2,s={bubbles:!0,cancelable:!0,clientX:c,clientY:p,button:0};a.dispatchEvent(new PointerEvent("pointerdown",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",s)),await g(80),a.dispatchEvent(new PointerEvent("pointerup",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",s)),a.dispatchEvent(new MouseEvent("click",s)),n("คลิกปุ่มตั้งค่าแล้ว"),await g(1500);let l=!1,d=null;const u=document.querySelectorAll('.flow_tab_slider_trigger[role="tab"]');for(const k of u){const y=k.getAttribute("aria-controls")||"",h=k.id||"";if(y.toUpperCase().includes("IMAGE")||h.toUpperCase().includes("IMAGE")){d=k,n(`พบแท็บ Image ผ่าน flow_tab_slider_trigger (aria-controls: ${y})`);break}}if(!d)for(const k of document.querySelectorAll('[role="tab"]')){const y=k.id||"";if(y.toUpperCase().includes("TRIGGER-IMAGE")){d=k,n(`พบแท็บ Image ผ่าน id: ${y}`);break}}if(!d)for(const k of document.querySelectorAll("button, [role='menuitem'], [role='option'], [role='tab']")){const y=(k.textContent||"").trim();if((y==="Image"||y.endsWith("Image")||y==="รูปภาพ"||y==="ภาพ")&&!y.includes("Video")&&!y.includes("วิดีโอ")){d=k,n(`พบแท็บ Image ผ่านข้อความ: "${y}"`);break}}if(d){const k=d.getAttribute("data-state")||"",y=d.getAttribute("aria-selected")||"";if(k==="active"||y==="true")l=!0,n("แท็บ Image เปิดอยู่แล้ว — ไม่ต้องคลิก");else{const h=d.getBoundingClientRect(),r={bubbles:!0,cancelable:!0,clientX:h.left+h.width/2,clientY:h.top+h.height/2,button:0};d.dispatchEvent(new PointerEvent("pointerdown",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mousedown",r)),await g(80),d.dispatchEvent(new PointerEvent("pointerup",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mouseup",r)),d.dispatchEvent(new MouseEvent("click",r)),l=!0,n("✅ คลิกแท็บ Image — สลับเป็นโหมดรูปภาพแล้ว"),await g(400)}}l||n("⚠️ ไม่พบปุ่มโหมด Image — อาจอยู่ในโหมดนี้แล้ว");const m=t==="horizontal"?"แนวนอน":"แนวตั้ง";for(const k of document.querySelectorAll("button, [role='tab'], [role='option']")){const y=(k.textContent||"").trim();if(y===m||y.toLowerCase()===(t==="horizontal"?"landscape":"portrait")){const h=k.getBoundingClientRect(),r={bubbles:!0,cancelable:!0,clientX:h.left+h.width/2,clientY:h.top+h.height/2,button:0};k.dispatchEvent(new PointerEvent("pointerdown",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mousedown",r)),await g(80),k.dispatchEvent(new PointerEvent("pointerup",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mouseup",r)),k.dispatchEvent(new MouseEvent("click",r)),n(`เลือกทิศทาง: ${m}`),await g(400);break}}const P=`x${e}`;for(const k of document.querySelectorAll("button, [role='tab'], [role='option']"))if((k.textContent||"").trim()===P){const h=k.getBoundingClientRect(),r={bubbles:!0,cancelable:!0,clientX:h.left+h.width/2,clientY:h.top+h.height/2,button:0};k.dispatchEvent(new PointerEvent("pointerdown",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mousedown",r)),await g(80),k.dispatchEvent(new PointerEvent("pointerup",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mouseup",r)),k.dispatchEvent(new MouseEvent("click",r)),n(`เลือกจำนวน: ${P}`),await g(400);break}return await g(300),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await g(300),a.dispatchEvent(new PointerEvent("pointerdown",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",s)),await g(80),a.dispatchEvent(new PointerEvent("pointerup",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",s)),a.dispatchEvent(new MouseEvent("click",s)),n("ปิดหน้าตั้งค่าแล้ว"),await g(600),!0}async function Xt(t){const e=t==="quality"?"Veo 3.1 - Quality":"Veo 3.1 - Fast";n(`=== เลือกคุณภาพ Veo: ${e} ===`);let i=null;const a=document.querySelectorAll("button");for(const m of a){const P=(m.textContent||"").trim();if(P.includes("Veo 3.1")&&P.includes("arrow_drop_down")){i=m,n(`พบปุ่ม Veo dropdown: "${P.substring(0,40).trim()}"`);break}}if(!i){for(const m of a)if(m.getAttribute("aria-haspopup")==="menu"){const P=(m.textContent||"").trim();if(P.includes("Veo")){i=m,n(`พบปุ่ม Veo dropdown (aria-haspopup): "${P.substring(0,40).trim()}"`);break}}}if(!i)for(const m of a){const P=(m.textContent||"").trim();if(P.includes("Veo 3.1")&&m.getBoundingClientRect().bottom>window.innerHeight*.7){i=m,n(`พบปุ่ม Veo dropdown (bottom area): "${P.substring(0,40).trim()}"`);break}}if(!i)return A("ไม่พบปุ่ม Veo quality dropdown"),!1;if((i.textContent||"").trim().includes(e))return n(`✅ Veo quality เป็น "${e}" อยู่แล้ว — ไม่ต้องเปลี่ยน`),!0;const c=i.getBoundingClientRect(),p=c.left+c.width/2,s=c.top+c.height/2,l={bubbles:!0,cancelable:!0,clientX:p,clientY:s,button:0};i.dispatchEvent(new PointerEvent("pointerdown",{...l,pointerId:1,isPrimary:!0,pointerType:"mouse"})),i.dispatchEvent(new MouseEvent("mousedown",l)),await g(80),i.dispatchEvent(new PointerEvent("pointerup",{...l,pointerId:1,isPrimary:!0,pointerType:"mouse"})),i.dispatchEvent(new MouseEvent("mouseup",l)),i.dispatchEvent(new MouseEvent("click",l)),n("คลิกเปิด Veo quality dropdown"),await g(1e3);let d=!1;const u=document.querySelectorAll("button, [role='menuitem'], [role='option']");for(const m of u){const P=m.querySelectorAll("span");for(const k of P)if((k.textContent||"").trim()===e){const h=m.getBoundingClientRect();if(h.width>0&&h.height>0){const r=h.left+h.width/2,T=h.top+h.height/2,z={bubbles:!0,cancelable:!0,clientX:r,clientY:T,button:0};m.dispatchEvent(new PointerEvent("pointerdown",{...z,pointerId:1,isPrimary:!0,pointerType:"mouse"})),m.dispatchEvent(new MouseEvent("mousedown",z)),await g(80),m.dispatchEvent(new PointerEvent("pointerup",{...z,pointerId:1,isPrimary:!0,pointerType:"mouse"})),m.dispatchEvent(new MouseEvent("mouseup",z)),m.dispatchEvent(new MouseEvent("click",z)),n(`✅ เลือก "${e}" สำเร็จ`),d=!0;break}}if(d)break;if(!d){const k=(m.textContent||"").trim();if(k.includes(e)&&!k.includes("arrow_drop_down")){const y=m.getBoundingClientRect();if(y.width>0&&y.height>0){const h=y.left+y.width/2,r=y.top+y.height/2,T={bubbles:!0,cancelable:!0,clientX:h,clientY:r,button:0};m.dispatchEvent(new PointerEvent("pointerdown",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),m.dispatchEvent(new MouseEvent("mousedown",T)),await g(80),m.dispatchEvent(new PointerEvent("pointerup",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),m.dispatchEvent(new MouseEvent("mouseup",T)),m.dispatchEvent(new MouseEvent("click",T)),n(`✅ เลือก "${e}" สำเร็จ (fallback)`),d=!0;break}}}}return d?(await g(600),!0):(A(`ไม่พบตัวเลือก "${e}" ใน dropdown`),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await g(300),!1)}async function jt(t){var z,X,R,B;try{console.clear(),console.log("%c[Netflow AI] 🚀 Automation started — console cleared","color:#00e676;font-weight:bold;font-size:14px"),sessionStorage.removeItem("netflow_last_run"),sessionStorage.setItem("netflow_last_run",new Date().toISOString())}catch{}const e=navigator.userAgent,i=e.match(/Chrome\/(\d+\.\d+\.\d+\.\d+)/),a=i?i[1]:"unknown",o=qe?"macOS":He?"Windows":/Linux/i.test(e)?"Linux":/CrOS/i.test(e)?"ChromeOS":"Unknown",c=qe?((X=(z=e.match(/Mac OS X ([0-9_]+)/))==null?void 0:z[1])==null?void 0:X.replace(/_/g,"."))||"":He&&((R=e.match(/Windows NT ([0-9.]+)/))==null?void 0:R[1])||"",p=navigator.language||"unknown",s=`${window.innerWidth}x${window.innerHeight}`;n("══════════════════════════════════════════"),n(`🖥️ ระบบ: ${o} ${c} | Chrome ${a}`),n(`🌐 ภาษา: ${p} | หน้าจอ: ${s} | แพลตฟอร์ม: ${me}`),n("══════════════════════════════════════════");try{Ae(t.theme)}catch{}try{Fe()}catch(w){console.warn("Overlay show error:",w)}const l=[],d=[];try{_("settings","active");const w=t.orientation||"horizontal",f=t.outputCount||1,v=await Yt(w,f);l.push(v?"✅ Settings":"⚠️ Settings"),_("settings",v?"done":"error")}catch(w){A(`ตั้งค่าผิดพลาด: ${w.message}`),l.push("⚠️ Settings"),_("settings","error")}try{const w=t.veoQuality||"fast";await Xt(w)?(l.push(`✅ Veo ${w}`),n(`✅ Veo quality: ${w}`)):(l.push("⚠️ Veo quality"),A("ไม่สามารถเลือก Veo quality ได้ — ใช้ค่าเดิม"))}catch(w){A(`Veo quality error: ${w.message}`),l.push("⚠️ Veo quality")}n("=== ขั้น 1: อัพโหลดรูปอ้างอิง ===");const u=()=>{const w=document.querySelectorAll("span, div, p, label");for(const f of w){const v=(f.textContent||"").trim();if(/^\d{1,3}%$/.test(v)){if(v==="100%")return null;const C=f.getBoundingClientRect();if(C.width>0&&C.height>0&&C.top>0&&C.top<window.innerHeight)return v}}return null},m=async w=>{n(`รอการอัพโหลด ${w} เสร็จ...`),await g(2e3);const f=Date.now(),v=6e4;let C="",O=Date.now();const M=15e3;for(;Date.now()-f<v;){const $=u();if($){if($!==C)C=$,O=Date.now();else if(Date.now()-O>M){n(`✅ อัพโหลด ${w} — % ค้างที่ ${$} นาน ${M/1e3} วินาที ถือว่าเสร็จ`),await g(1e3);return}n(`กำลังอัพโหลด: ${$} — รอ...`),await g(1500)}else{n(`✅ อัพโหลด ${w} เสร็จ — ไม่พบตัวบอก %`),await g(1e3);return}}A(`⚠️ อัพโหลด ${w} หมดเวลาหลัง ${v/1e3} วินาที — ดำเนินการต่อ`)};if(t.characterImage){_("upload-char","active");try{const w=await vt(t.characterImage,"character.png");l.push(w?"✅ ตัวละคร":"⚠️ ตัวละคร"),w||d.push("character upload failed"),_("upload-char",w?"done":"error")}catch(w){A(`อัพโหลดตัวละครผิดพลาด: ${w.message}`),l.push("❌ ตัวละคร"),d.push("character upload error"),_("upload-char","error")}await m("character")}else ge("upload-char");if(t.productImage){_("upload-prod","active");try{const w=await vt(t.productImage,"product.png");l.push(w?"✅ สินค้า":"⚠️ สินค้า"),w||d.push("product upload failed"),_("upload-prod",w?"done":"error")}catch(w){A(`อัพโหลดสินค้าผิดพลาด: ${w.message}`),l.push("❌ สินค้า"),d.push("product upload error"),_("upload-prod","error")}await m("product")}else ge("upload-prod");n("ปิด dialog ที่เปิดอยู่..."),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await g(800),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await g(800);const P=u();P&&(n(`⚠️ อัพโหลดยังแสดง ${P} — รอเพิ่มเติม...`),await m("final")),n("อัพโหลดทั้งหมดเสร็จ — ไปต่อที่ Prompt"),await g(1e3);const k=(t.characterImage?1:0)+(t.productImage?1:0);if(k>0){let w=Te();w<k&&(n(`⏳ เห็นรูปย่อแค่ ${w}/${k} — รอ 3 วินาที...`),await g(3e3),w=Te()),w>=k?n(`✅ ยืนยันรูปย่ออ้างอิง: ${w}/${k}`):A(`⚠️ คาดว่าจะมี ${k} รูปย่อ แต่พบ ${w} — ดำเนินการต่อ`)}if(fe()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนวาง Prompt"),d.push("stopped by user");try{ke(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}n("=== ขั้น 2: วาง Image Prompt ==="),_("img-prompt","active"),await g(1e3);const y=xt();y?(await Ie(y,t.imagePrompt),n(`วาง Prompt แล้ว (${t.imagePrompt.length} ตัวอักษร)`),l.push("✅ Prompt"),_("img-prompt","done")):(A("ไม่พบช่องป้อนข้อความ Prompt"),l.push("❌ Prompt"),d.push("prompt input not found"),_("img-prompt","error")),await g(800);const h=new Set;document.querySelectorAll("img").forEach(w=>{w.src&&h.add(w.src)}),n(`บันทึกรูปเดิม: ${h.size} รูปก่อน Generate`),n("=== ขั้น 3: คลิก Generate → ==="),_("img-generate","active"),await g(500);const r=wt();if(r){const w=r.getBoundingClientRect(),f=w.left+w.width/2,v=w.top+w.height/2,C={bubbles:!0,cancelable:!0,clientX:f,clientY:v,button:0};r.dispatchEvent(new PointerEvent("pointerdown",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),r.dispatchEvent(new MouseEvent("mousedown",C)),await g(80),r.dispatchEvent(new PointerEvent("pointerup",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),r.dispatchEvent(new MouseEvent("mouseup",C)),r.dispatchEvent(new MouseEvent("click",C)),n("ส่งชุดคลิกเต็มรูปแบบบนปุ่ม Generate แล้ว"),l.push("✅ Generate"),await g(500),r.dispatchEvent(new PointerEvent("pointerdown",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),r.dispatchEvent(new MouseEvent("mousedown",C)),await g(80),r.dispatchEvent(new PointerEvent("pointerup",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),r.dispatchEvent(new MouseEvent("mouseup",C)),r.dispatchEvent(new MouseEvent("click",C)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate"),_("img-generate","done")}else A("ไม่พบปุ่ม → Generate"),l.push("❌ Generate"),d.push("generate button not found"),_("img-generate","error");n("=== ขั้น 4: รอรูปที่สร้าง + ทำเป็นวิดีโอ ==="),_("img-wait","active");try{n("รอ 15 วินาทีเพื่อเริ่มการสร้าง..."),await g(15e3);const w=()=>{const M=document.querySelectorAll("div, span, p, label, strong, small");for(const $ of M){if($.closest("#netflow-engine-overlay"))continue;const D=($.textContent||"").trim();if(D.length>10)continue;const b=D.match(/(\d{1,3})\s*%/);if(!b)continue;const x=parseInt(b[1],10);if(x<1||x>100)continue;const E=$.getBoundingClientRect();if(!(E.width===0||E.width>150)&&!(E.top<0||E.top>window.innerHeight))return x}return null};n("ค้นหารูปที่สร้างใหม่ (ไม่ใช่รูปเดิม)...");let f=null,v=-1,C=0;const O=Date.now();for(;!f&&Date.now()-O<18e4;){const M=document.querySelectorAll("img");for(const $ of M){if(h.has($.src)||!($.alt||"").toLowerCase().includes("generated"))continue;const b=$.getBoundingClientRect();if(b.width>120&&b.height>120&&b.top>0&&b.top<window.innerHeight*.85){const x=$.closest("div");if(x){f=x,n(`พบรูป AI จาก alt="${$.alt}": ${$.src.substring(0,80)}...`);break}}}if(!f)for(const $ of M){if(h.has($.src))continue;const D=$.closest("div"),b=(D==null?void 0:D.textContent)||"";if(b.includes("product.png")||b.includes("character.png")||b.includes(".png")||b.includes(".jpg"))continue;const x=$.getBoundingClientRect();if(x.width>120&&x.height>120&&x.top>0&&x.top<window.innerHeight*.85){const E=$.closest("div");if(E){f=E,n(`พบรูปใหม่ (สำรอง): ${$.src.substring(0,80)}...`);break}}}if(!f){if(fe()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอรูป");break}const $=bt();if($){A(`❌ สร้างรูปล้มเหลว: ${$}`),d.push(`image gen failed: ${$}`),_("img-wait","error");break}const D=w();D!==null?(D!==v&&(n(`🖼️ ความคืบหน้ารูปภาพ: ${D}%`),v=D,_("img-wait","active",D)),C=Date.now()):v>30&&Math.floor((Date.now()-C)/1e3)>=3&&n(`🖼️ % หายที่ ${v}% — รูปน่าจะเสร็จแล้ว`),await g(3e3)}}if(!f)A("หมดเวลารอรูปที่สร้าง"),l.push("⚠️ Wait Image"),_("img-wait","error");else{n("พบรูปที่สร้างแล้ว"),l.push("✅ Image Found"),_("img-wait","done",100);const M=f.getBoundingClientRect(),$=M.left+M.width/2,D=M.top+M.height/2,b={bubbles:!0,cancelable:!0,clientX:$,clientY:D};f.dispatchEvent(new PointerEvent("pointerenter",{...b,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mouseenter",b)),f.dispatchEvent(new PointerEvent("pointerover",{...b,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mouseover",b)),f.dispatchEvent(new PointerEvent("pointermove",{...b,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mousemove",b)),n("ส่งเหตุการณ์ hover บนรูปแล้ว"),await g(1500);let x=null;for(const E of["more_vert","more_horiz","more"]){const S=Ce(E);for(const F of S){const I=F.getBoundingClientRect();if(I.top>=M.top-20&&I.top<=M.bottom&&I.right>=M.right-150&&I.right<=M.right+20){x=F;break}}if(x)break}if(!x){const E=document.querySelectorAll("button");for(const S of E){const F=S.getBoundingClientRect();if(F.width<50&&F.height<50&&F.top>=M.top-10&&F.top<=M.top+60&&F.left>=M.right-80){const I=S.querySelectorAll("i");for(const N of I)if((((B=N.textContent)==null?void 0:B.trim())||"").includes("more")){x=S;break}if(x)break;const V=S.getAttribute("aria-label")||"";if(V.includes("เพิ่มเติม")||V.includes("more")){x=S;break}}}}if(!x)A("ไม่พบปุ่ม 3 จุดบนรูปที่สร้าง"),l.push("⚠️ 3-dots");else{const E=x.getBoundingClientRect(),S=E.left+E.width/2,F=E.top+E.height/2,I={bubbles:!0,cancelable:!0,clientX:S,clientY:F,button:0};x.dispatchEvent(new PointerEvent("pointerdown",{...I,pointerId:1,isPrimary:!0,pointerType:"mouse"})),x.dispatchEvent(new MouseEvent("mousedown",I)),await g(80),x.dispatchEvent(new PointerEvent("pointerup",{...I,pointerId:1,isPrimary:!0,pointerType:"mouse"})),x.dispatchEvent(new MouseEvent("mouseup",I)),x.dispatchEvent(new MouseEvent("click",I)),n("คลิกปุ่ม 3 จุดแล้ว"),await g(1500);let V=null;const N=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button']");for(const L of N){const H=(L.textContent||"").trim();if(H.includes("ทำให้เป็นภาพเคลื่อนไหว")||H.includes("Animate")||H.includes("animate")){V=L;break}}if(!V)A("ไม่พบเมนู 'ทำให้เป็นภาพเคลื่อนไหว'"),l.push("⚠️ Animate");else{const L=V.getBoundingClientRect(),H=L.left+L.width/2,j=L.top+L.height/2,G={bubbles:!0,cancelable:!0,clientX:H,clientY:j,button:0};V.dispatchEvent(new PointerEvent("pointerdown",{...G,pointerId:1,isPrimary:!0,pointerType:"mouse"})),V.dispatchEvent(new MouseEvent("mousedown",G)),await g(80),V.dispatchEvent(new PointerEvent("pointerup",{...G,pointerId:1,isPrimary:!0,pointerType:"mouse"})),V.dispatchEvent(new MouseEvent("mouseup",G)),V.dispatchEvent(new MouseEvent("click",G)),n("✅ คลิก 'ทำให้เป็นภาพเคลื่อนไหว' — สลับเป็นโหมดวิดีโอแล้ว"),l.push("✅ Animate"),_("animate","done"),await g(3e3)}}}}catch(w){A(`ขั้น 4 ผิดพลาด: ${w.message}`),l.push("⚠️ Animate")}if(fe()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนขั้นวิดีโอ"),d.push("stopped by user");try{ke(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}if(t.videoPrompt){n("=== ขั้น 5: วาง Video Prompt + สร้างวิดีโอ ==="),_("vid-prompt","active");try{n("รอ UI โหมดวิดีโอ..."),await g(3e3);let w=!1;const f=document.querySelectorAll("button, span, div");for(const O of f){const M=(O.textContent||"").trim(),$=O.getBoundingClientRect();if((M==="วิดีโอ"||M==="Video"||M.includes("วิดีโอ"))&&$.bottom>window.innerHeight*.7){w=!0,n("ยืนยัน: อยู่ในโหมดวิดีโอแล้ว");break}}w||n("ไม่พบตัวบอกโหมดวิดีโอ — ดำเนินการต่อ (อาจอยู่ในโหมดวิดีโอหลัง Animate)"),await g(1e3);const v=xt();v?(await Ie(v,t.videoPrompt),n(`วาง Video Prompt แล้ว (${t.videoPrompt.length} ตัวอักษร)`),l.push("✅ Video Prompt"),_("vid-prompt","done")):(A("ไม่พบช่อง Prompt สำหรับ Video Prompt"),l.push("❌ Video Prompt"),d.push("video prompt input not found"),_("vid-prompt","error")),await g(1e3),_("vid-generate","active");const C=wt();if(C){const O=C.getBoundingClientRect(),M=O.left+O.width/2,$=O.top+O.height/2,D={bubbles:!0,cancelable:!0,clientX:M,clientY:$,button:0};C.dispatchEvent(new PointerEvent("pointerdown",{...D,pointerId:1,isPrimary:!0,pointerType:"mouse"})),C.dispatchEvent(new MouseEvent("mousedown",D)),await g(80),C.dispatchEvent(new PointerEvent("pointerup",{...D,pointerId:1,isPrimary:!0,pointerType:"mouse"})),C.dispatchEvent(new MouseEvent("mouseup",D)),C.dispatchEvent(new MouseEvent("click",D)),n("✅ คลิก Generate สำหรับวิดีโอ — เริ่มสร้างวิดีโอ!"),l.push("✅ Video Generate"),_("vid-generate","done"),await g(500),C.dispatchEvent(new PointerEvent("pointerdown",{...D,pointerId:1,isPrimary:!0,pointerType:"mouse"})),C.dispatchEvent(new MouseEvent("mousedown",D)),await g(80),C.dispatchEvent(new PointerEvent("pointerup",{...D,pointerId:1,isPrimary:!0,pointerType:"mouse"})),C.dispatchEvent(new MouseEvent("mouseup",D)),C.dispatchEvent(new MouseEvent("click",D)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate วิดีโอ")}else A("ไม่พบปุ่ม Generate สำหรับวิดีโอ"),l.push("❌ Video Generate"),d.push("video generate button not found"),_("vid-generate","error")}catch(w){A(`ขั้น 5 ผิดพลาด: ${w.message}`),l.push("⚠️ Video Gen"),d.push(`video gen error: ${w.message}`)}}else n("ไม่มี Video Prompt — ข้ามขั้นสร้างวิดีโอ"),ge("animate"),ge("vid-prompt"),ge("vid-generate"),ge("vid-wait");if(t.videoPrompt){_("vid-wait","active");const w=t.sceneCount||1,f=t.videoScenePrompts||[t.videoPrompt];if(w>1)try{Ft(w)}catch{}n(`=== ขั้น 6: รอวิดีโอ + ${w>1?`ต่อ ${w} ฉาก`:"ดาวน์โหลด"} ===`);const v=()=>{const M=document.querySelectorAll("div, span, p, label, strong, small");for(const $ of M){if($.closest("#netflow-engine-overlay"))continue;const D=($.textContent||"").trim();if(D.length>10)continue;const b=D.match(/(\d{1,3})\s*%/);if(!b)continue;const x=parseInt(b[1],10);if(x<1||x>100)continue;const E=$.getBoundingClientRect();if(!(E.width===0||E.width>150)&&!(E.top<0||E.top>window.innerHeight))return x}return null},C=async(M=6e5)=>{n("รอการสร้างวิดีโอ..."),_("vid-wait","active"),await g(5e3);const $=()=>{const G=document.querySelectorAll("div, span, p, label, strong, small");let Y=0;for(const q of G){if(q.closest("#netflow-engine-overlay"))continue;const Z=(q.textContent||"").trim();if(Z.includes("%")&&Z.length<15){const ie=q.tagName.toLowerCase(),ae=q.className&&typeof q.className=="string"?q.className.split(/\s+/).slice(0,2).join(" "):"",se=q.getBoundingClientRect();if(n(`  🔍 "${Z}" ใน <${ie}.${ae}> ที่ (${se.left.toFixed(0)},${se.top.toFixed(0)}) w=${se.width.toFixed(0)}`),Y++,Y>=5)break}}Y===0&&n("  🔍 ไม่พบ element ที่มีข้อความ '%'")},D=We();n(D?"📍 การ์ดวิดีโอมีอยู่แล้วตั้งแต่เริ่ม":"⏳ ยังไม่มีการ์ดวิดีโอ — จะติดตามความคืบหน้า %"),n("🔍 สแกนข้อความ % เพื่อตรวจสอบ:"),$();const b=Date.now();let x=-1,E=0,S=!1;for(;Date.now()-b<M;){const G=v();if(G!==null){if(G!==x&&(n(`ความคืบหน้าวิดีโอ: ${G}%`),x=G,_("vid-wait","active",G)),E=Date.now(),G>=100){n("✅ ตรวจพบ 100%!"),S=!0;break}}else if(x>30){const Y=Math.floor((Date.now()-E)/1e3);if(Y>=5){n(`✅ % หายไปที่ ${x}% (หาย ${Y} วินาที) — วิดีโอเสร็จ!`),S=!0;break}n(`⏳ % หายที่ ${x}% — ยืนยันใน ${5-Y} วินาที...`)}else{const Y=Math.floor((Date.now()-b)/1e3);Y%15<3&&n(`⏳ รอ... (${Y} วินาที) ไม่พบ %`)}if(!S&&x>0&&We(!0)&&!D){n(`✅ การ์ดวิดีโอปรากฏขึ้นที่ ${x}% — วิดีโอเสร็จ!`),S=!0;break}if(fe())return n("⛔ ผู้ใช้สั่งหยุดระหว่างรอวิดีโอ"),null;if(x<1){const Y=bt();if(Y)return A(`❌ สร้างวิดีโอล้มเหลว: ${Y}`),null}await g(3e3)}const F=We();if(!F)return n("❌ ไม่พบการ์ดวิดีโอที่จะคลิก"),_("vid-wait","error"),null;const I=F;S?(_("vid-wait","done",100),n("รอ 4 วินาทีก่อนคลิก..."),await g(4e3)):n("⚠️ หมดเวลา — ลองคลิกการ์ดวิดีโอต่อ");const V=I.getBoundingClientRect();let N=V.left+V.width/2,L=V.top+V.height/2,H=I;const j=I.querySelector("video, img, canvas");if(j){const G=j.getBoundingClientRect();G.width>50&&G.height>50&&(N=G.left+G.width/2,L=G.top+G.height/2,H=j,n(`🎯 พบรูปย่อ <${j.tagName.toLowerCase()}> ในการ์ดที่ (${N.toFixed(0)},${L.toFixed(0)}) ${G.width.toFixed(0)}x${G.height.toFixed(0)}`))}else L=V.top+V.height*.3,n(`🎯 ไม่พบรูปย่อย่อย — คลิกส่วนบน 1/3 ที่ (${N.toFixed(0)},${L.toFixed(0)})`);n(`🖱️ ชี้เมาส์การ์ดวิดีโอ 4 วินาที ที่ (${N.toFixed(0)}, ${L.toFixed(0)})...`),Nt(H);for(let G=0;G<8;G++){const Y={bubbles:!0,cancelable:!0,clientX:N+G%2,clientY:L};H.dispatchEvent(new PointerEvent("pointermove",{...Y,pointerId:1,isPrimary:!0,pointerType:"mouse"})),H.dispatchEvent(new MouseEvent("mousemove",Y)),await g(500)}try{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"mute_video",sceneCount:w,scenePrompts:f,theme:t.theme}}),n(`💾 บันทึก pending action: mute_video (${w} ฉาก, ${f.length} prompts, theme: ${t.theme})`)}catch(G){n(`⚠️ ไม่สามารถบันทึก pending action: ${G.message}`)}return n("คลิกการ์ดวิดีโอเพื่อเข้าหน้ารายละเอียด..."),await O(H),n("✅ คลิกการ์ดวิดีโอเสร็จ"),I},O=async M=>{const $=M.getBoundingClientRect(),D=$.left+$.width/2,b=$.top+$.height/2,x={bubbles:!0,cancelable:!0,clientX:D,clientY:b,button:0};M.dispatchEvent(new PointerEvent("pointerdown",{...x,pointerId:1,isPrimary:!0,pointerType:"mouse"})),M.dispatchEvent(new MouseEvent("mousedown",x)),await g(80),M.dispatchEvent(new PointerEvent("pointerup",{...x,pointerId:1,isPrimary:!0,pointerType:"mouse"})),M.dispatchEvent(new MouseEvent("mouseup",x)),M.dispatchEvent(new MouseEvent("click",x)),await g(50),M.click(),n("คลิกการ์ดวิดีโอแล้ว"),await g(2e3)};try{if(!await C())A("หมดเวลารอการสร้างวิดีโอ"),l.push("⚠️ Video Wait"),_("vid-wait","error");else{l.push("✅ Video Complete"),_("vid-wait","done",100),n("✅ คลิกเข้าหน้ารายละเอียดวิดีโอแล้ว — รอ mute จาก pending action"),await g(3e3);const $=await new Promise(D=>{chrome.storage.local.get("netflow_pending_action",b=>{if(chrome.runtime.lastError){D(null);return}D((b==null?void 0:b.netflow_pending_action)||null)})});$&&!$._claimed&&(n("🔄 สคริปต์ยังทำงานอยู่หลังคลิกการ์ด (SPA navigation) — เรียก pending action โดยตรง"),chrome.storage.local.remove("netflow_pending_action"),$.action==="mute_video"?await yt($.sceneCount||1,$.scenePrompts||[],$.theme):$.action==="wait_scene_gen_and_download"&&await $t($.sceneCount||2,$.currentScene||2,$.theme,$.scenePrompts||[]))}}catch(M){A(`ขั้น 6 ผิดพลาด: ${M.message}`),l.push("⚠️ Step6"),d.push(`step 6: ${M.message}`)}}const T=d.length===0;try{ke(T?5e3:8e3)}catch(w){console.warn("Overlay complete error:",w)}return{success:T,message:T?`สำเร็จ! ${l.join(" → ")}`:`บางขั้นตอนมีปัญหา: ${l.join(" → ")} | ${d.join(", ")}`,step:T?"done":"partial"}}async function yt(t,e=[],i){var X;n("═══ Auto Mute: ปิดเสียงวิดีโอ ═══");try{i&&Ae(i)}catch{}try{Fe(t)}catch(R){n(`⚠️ showOverlay error: ${R.message}`)}try{const R=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(const B of R)_(B,"done");t>=2&&_("scene2-prompt","active"),n(`✅ overlay restored: ${R.length} steps done, sceneCount=${t}`)}catch(R){n(`⚠️ overlay restore error: ${R.message}`)}await g(1500);const a=(()=>{for(const R of document.querySelectorAll("button")){const B=R.querySelectorAll("i");for(const f of B){const v=(f.textContent||"").trim();if(v==="volume_up"||v==="volume_off"||v==="volume_mute"){const C=R.getBoundingClientRect();if(C.width>0&&C.height>0)return R}}const w=(R.getAttribute("aria-label")||"").toLowerCase();if(w.includes("mute")||w.includes("ปิดเสียง")){const f=R.getBoundingClientRect();if(f.width>0&&f.height>0)return R}}return null})();a?(a.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม");let o=null;if(t>=2){n(`═══ ${t} ฉาก — เริ่มต่อฉาก ═══`),await g(2e3);for(let b=2;b<=t;b++){const x=e[b-1];if(!x){A(`ไม่พบ prompt สำหรับฉากที่ ${b}`);continue}n(`── ฉากที่ ${b}/${t}: วาง prompt + generate ──`);let E=null;const S=Date.now();for(;!E&&Date.now()-S<1e4;){const q=document.querySelectorAll("[data-slate-editor='true']");if(q.length>0&&(E=q[q.length-1]),!E){const Z=document.querySelectorAll("[role='textbox'][contenteditable='true']");Z.length>0&&(E=Z[Z.length-1])}E||await g(1e3)}if(!E){A("ไม่พบช่อง prompt (Slate editor)");return}n(`พบ Slate editor: <${E.tagName.toLowerCase()}> ${E.className.substring(0,40)}`),await Ie(E,x),n(`วาง prompt ฉาก ${b} (${x.length} ตัวอักษร) ✅`);try{_(`scene${b}-prompt`,"done"),_(`scene${b}-gen`,"active")}catch{}await g(1e3);const F=E.getBoundingClientRect();let I=null,V=1/0;for(const q of document.querySelectorAll("button")){if(q.disabled)continue;const Z=q.querySelectorAll("i");let ie=!1;for(const he of Z)if((he.textContent||"").trim()==="arrow_forward"){ie=!0;break}if(!ie)continue;const ae=q.getBoundingClientRect();if(ae.width<=0||ae.height<=0)continue;const se=Math.abs(ae.top-F.top)+Math.abs(ae.right-F.right);se<V&&(V=se,I=q)}if(!I)for(const q of document.querySelectorAll("button")){const Z=q.querySelectorAll("i");for(const ie of Z)if((ie.textContent||"").trim()==="arrow_forward"){const ae=q.getBoundingClientRect();if(ae.width>0&&ae.height>0){I=q;break}}if(I)break}if(!I){A("ไม่พบปุ่ม Generate/Send");return}await new Promise(q=>{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:i,sceneCount:t,currentScene:b,scenePrompts:e}},()=>q())}),n(`💾 บันทึก pending action: wait_scene_gen_and_download (ฉาก ${b}/${t})`),await ee(I),n(`คลิก Generate ฉาก ${b} ✅`);try{_(`scene${b}-gen`,"done"),_(`scene${b}-wait`,"active")}catch{}n(`── รอวิดีโอฉาก ${b} gen เสร็จ ──`),await g(5e3);let N=0,L=0;const H=Date.now(),j=6e5,G=5e3;let Y=!1;for(;Date.now()-H<j;){let q=null;const Z=document.querySelectorAll("div, span, p, label, strong, small");for(const ie of Z){if(ie.closest("#netflow-engine-overlay"))continue;const se=(ie.textContent||"").trim().match(/^(\d{1,3})%$/);if(se){const he=ie.getBoundingClientRect();if(he.width>0&&he.height>0&&he.width<120&&he.height<60){q=parseInt(se[1],10);break}}}if(q!==null){if(q!==N){n(`🎬 ฉาก ${b} ความคืบหน้า: ${q}%`),N=q;try{_(`scene${b}-wait`,"active",q)}catch{}}L=0}else if(N>0){if(L===0)L=Date.now(),n(`🔍 ฉาก ${b}: % หายไป (จาก ${N}%) — กำลังยืนยัน...`);else if(Date.now()-L>=G){n(`✅ ฉาก ${b}: % หายไป ${G/1e3} วินาที — เจนเสร็จ!`),Y=!0;break}}if(fe()){n("⛔ ผู้ใช้สั่งหยุด");return}await g(2e3)}Y||A(`ฉาก ${b} หมดเวลา`),n(`✅ ฉาก ${b} เสร็จแล้ว`);try{_(`scene${b}-wait`,"done",100)}catch{}chrome.storage.local.remove("netflow_pending_action"),n("🗑️ ลบ pending action (tracking เสร็จแล้วบนหน้านี้)"),await g(2e3)}n("── เริ่มดาวน์โหลด Full Video ──");try{_("download","active")}catch{}await g(2e3);const R=Date.now();let B=null;const w=Date.now();for(;!B&&Date.now()-w<1e4;){for(const b of document.querySelectorAll("button")){const x=b.querySelector("i");if(x&&(x.textContent||"").trim()==="download"){const E=b.getBoundingClientRect();if(E.width>0&&E.height>0){B=b;break}}}B||await g(1e3)}if(!B){A("ไม่พบปุ่มดาวน์โหลด");return}await ee(B),n("คลิกดาวน์โหลดแล้ว ✅");try{_("download","done"),_("upscale","active")}catch{}await g(1500);let f=null;for(let b=0;b<3&&!f;b++){b>0&&n(`🔄 ลองหา 720p ครั้งที่ ${b+1}...`);let x=null;const E=Date.now();for(;!x&&Date.now()-E<5e3;){for(const N of document.querySelectorAll("[role='menuitem']"))if((N.textContent||"").trim().includes("Full Video")&&N.querySelector("i")){const H=N.getBoundingClientRect();if(H.width>0&&H.height>0){x=N;break}}x||await g(500)}if(!x){A("ไม่พบ Full Video");continue}const S=x.getBoundingClientRect(),F=S.left+S.width/2,I=S.top+S.height/2;x.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:F,clientY:I})),x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:F,clientY:I})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:F,clientY:I})),await ee(x),n("คลิก/hover Full Video ✅"),await g(2e3);const V=Date.now();for(;!f&&Date.now()-V<8e3;){for(const N of document.querySelectorAll("button[role='menuitem']")){const L=N.querySelectorAll("span");for(const H of L)if((H.textContent||"").trim()==="720p"){const j=N.getBoundingClientRect();if(j.width>0&&j.height>0){f=N;break}}if(f)break}f||(x.isConnected&&(x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:F,clientY:I})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:F+20,clientY:I}))),await g(500))}}if(!f){A("ไม่พบ 720p");return}await ee(f),n("คลิก 720p ✅"),n("รอดาวน์โหลดเสร็จ...");const v=Date.now();let C=!1,O=!1;for(;Date.now()-v<3e5;){for(const b of document.querySelectorAll("div[data-title] div, div[data-content] div")){const x=(b.textContent||"").trim();if(x==="Download complete!"||x==="ดาวน์โหลดเสร็จ"){n("✅ Download complete! (toast)"),C=!0;break}(x.includes("Downloading your extended video")||x.includes("กำลังดาวน์โหลด"))&&(O||(O=!0,n("⏳ กำลังดาวน์โหลด...")))}if(C)break;if(O){let b=!1;for(const x of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((x.textContent||"").trim().includes("Downloading")){b=!0;break}if(!b){n("✅ ดาวน์โหลดเสร็จ (toast หายไป)"),C=!0;break}}if(fe()){n("⛔ ผู้ใช้สั่งหยุดระหว่างดาวน์โหลด");return}await g(2e3)}if(!C){A("ดาวน์โหลดหมดเวลา");return}try{_("upscale","done",100),_("open","active")}catch{}n("รอไฟล์ดาวน์โหลดพร้อม..."),await g(5e3);let M=!1;const $=Date.now();for(;Date.now()-$<6e4&&!M;){try{await new Promise(b=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:R},x=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):x!=null&&x.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${x.message}`),M=!0,x.downloadUrl&&(o=x.downloadUrl,n(`[TikTok] จะใช้ download URL: ${x.downloadUrl.substring(0,80)}...`))):n(`ดาวน์โหลดยังไม่พร้อม: ${x==null?void 0:x.message}`),b()})})}catch(b){A(`ตรวจสอบผิดพลาด: ${b.message}`)}M||await g(3e3)}M||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const D=await Ve();o||(o=D);try{_("open","done"),ke(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น ═══"),Ge(o),Le(2e3);return}n("═══ 1 ฉาก — เริ่มดาวน์โหลด ═══"),await g(2e3);const c=(R,B="button, [role='menuitem'], [role='option'], li, span, div[role='button']")=>{for(const w of document.querySelectorAll(B)){const f=(w.textContent||"").trim();if(f.includes(R)&&f.length<100){const v=w.getBoundingClientRect();if(v.width>0&&v.height>0&&v.top>=0)return w}}return null};n("── ค้นหาปุ่มดาวน์โหลด ──");let p=null;const s=Date.now();for(;!p&&Date.now()-s<1e4;){for(const R of document.querySelectorAll("button, [role='button']")){const B=(R.textContent||"").trim(),w=B.toLowerCase();if((w.includes("download")||w.includes("ดาวน์โหลด"))&&B.length<80){const f=R.getBoundingClientRect();if(f.width>0&&f.height>0){p=R;break}}}if(!p)for(const R of document.querySelectorAll("button")){const B=(R.getAttribute("aria-label")||"").toLowerCase();if(B.includes("download")||B.includes("ดาวน์")){const w=R.getBoundingClientRect();if(w.width>0&&w.height>0){p=R;break}}}p||(n(`รอปุ่มดาวน์โหลด... (${document.querySelectorAll("button").length} ปุ่ม)`),await g(1e3))}if(!p){A("ไม่พบปุ่มดาวน์โหลด (รอ 10 วินาที)");return}n(`พบปุ่มดาวน์โหลด: "${(p.textContent||"").trim().substring(0,40)}"`),await ee(p),n("คลิกปุ่มดาวน์โหลดแล้ว ✅"),await g(1500);const l=Date.now();let d=null;const u=Date.now();for(;!d&&Date.now()-u<5e3;)d=c("1080p"),d||(n("รอ 1080p..."),await g(500));if(!d){A("ไม่พบ 1080p");return}await ee(d),n("คลิก 1080p Upscaled ✅"),n("รอการอัปสเกลเสร็จ...");const m=Date.now();let P=!1,k=!1,y=0;const h=3e3;for(;Date.now()-m<3e5;){const B=((document.body.innerText||"")+" "+(document.body.textContent||"")).toLowerCase();if(B.includes("upscaling complete")||B.includes("อัปสเกลเสร็จ")){n("✅ Upscaling complete!"),P=!0;break}for(const f of document.querySelectorAll("div, span, p")){const v=(f.textContent||"").trim().toLowerCase();if(v.length<60&&(v.includes("upscaling complete")||v.includes("อัปสเกลเสร็จ"))){n(`✅ Upscaling complete! (element: "${(X=f.textContent)==null?void 0:X.trim()}")`),P=!0;break}}if(P)break;if(B.includes("upscaling your video")||B.includes("กำลังอัปสเกล")){k=!0,y=0;const f=Math.floor((Date.now()-m)/1e3);n(`⏳ กำลังอัปสเกล... (${f} วินาที)`)}else if(k){if(y===0)y=Date.now(),n("🔍 ข้อความ Upscaling หายไป — กำลังยืนยัน...");else if(Date.now()-y>=h){n(`✅ ข้อความ Upscaling หายไป ${h/1e3} วินาที — เสร็จ!`),P=!0;break}}else{const f=Math.floor((Date.now()-m)/1e3);f%10<3&&n(`⏳ รอ Upscale... (${f} วินาที)`)}if(fe()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอ Upscale");return}await g(2e3)}if(!P){A("Upscale หมดเวลา — ไฟล์อาจยังอัปสเกลอยู่");return}n("รอไฟล์ดาวน์โหลดพร้อม..."),await g(5e3);let r=!1;const T=Date.now();for(;Date.now()-T<6e4&&!r;){try{await new Promise(R=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:l},B=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):B!=null&&B.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${B.message}`),r=!0,B.downloadUrl&&(o=B.downloadUrl,n(`[TikTok] จะใช้ download URL: ${B.downloadUrl.substring(0,80)}...`))):n(`ดาวน์โหลดยังไม่พร้อม: ${B==null?void 0:B.message}`),R()})})}catch(R){A(`ตรวจสอบผิดพลาด: ${R.message}`)}r||await g(3e3)}r||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const z=await Ve();o||(o=z),n("═══ ดาวน์โหลดเสร็จสิ้น ═══"),Ge(o),Le(2e3)}async function $t(t=2,e=2,i,a=[]){n(`═══ Pending: รอ scene ${e}/${t} gen เสร็จ + ดาวน์โหลด ═══`);try{i&&Ae(i)}catch{}try{Fe(t)}catch(f){n(`⚠️ showOverlay error: ${f.message}`)}try{const f=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(let v=2;v<=e;v++)f.push(`scene${v}-prompt`,`scene${v}-gen`),v<e&&f.push(`scene${v}-wait`);for(const v of f)_(v,"done");_(`scene${e}-wait`,"active"),n(`✅ overlay restored: ${f.length} steps done (scene ${e}/${t} navigate)`)}catch(f){n(`⚠️ overlay restore error: ${f.message}`)}await g(2e3);const o=(()=>{for(const f of document.querySelectorAll("button")){const v=f.querySelectorAll("i");for(const C of v){const O=(C.textContent||"").trim();if(O==="volume_up"||O==="volume_off"||O==="volume_mute"){const M=f.getBoundingClientRect();if(M.width>0&&M.height>0)return f}}}return null})();o?(o.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม"),n(`── รอวิดีโอ scene ${e} gen เสร็จ (หลัง page navigate) ──`);let c=0,p=0;const s=Date.now(),l=6e5,d=5e3;let u=!1,m=0;for(;Date.now()-s<l;){let f=null;const v=document.querySelectorAll("div, span, p, label, strong, small");for(const C of v){if(C.closest("#netflow-engine-overlay"))continue;const M=(C.textContent||"").trim().match(/^(\d{1,3})%$/);if(M){const $=C.getBoundingClientRect();if($.width>0&&$.height>0&&$.width<120&&$.height<60){f=parseInt(M[1],10);break}}}if(f!==null){if(m=0,f!==c){n(`🎬 scene ${e} ความคืบหน้า: ${f}%`),c=f;try{_(`scene${e}-wait`,"active",f)}catch{}}p=0}else if(c>0){if(p===0)p=Date.now(),n(`🔍 scene ${e}: % หายไป (จาก ${c}%) — กำลังยืนยัน...`);else if(Date.now()-p>=d){n(`✅ scene ${e}: % หายไป ${d/1e3} วินาที — เจนเสร็จ!`),u=!0;break}}else if(m++,m>=15){const C=document.querySelectorAll("video");let O=!1;for(const M of C)if(M.readyState>=2&&!M.paused&&M.getBoundingClientRect().width>200){O=!0;break}if(O){n(`✅ scene ${e}: พบวิดีโอกำลังเล่น — ถือว่า gen เสร็จแล้ว`),u=!0;break}if(m>=30){n(`✅ scene ${e}: ไม่พบ % มานาน 60 วินาที — ถือว่าเสร็จ`),u=!0;break}}await g(2e3)}u||n(`⚠️ scene ${e} หมดเวลา — ลองต่อไป`);try{_(`scene${e}-wait`,"done",100)}catch{}if(n(`✅ scene ${e} เสร็จ`),e<t&&a.length>0){n(`═══ ยังเหลืออีก ${t-e} ฉาก — ต่อฉากถัดไป ═══`),await g(2e3);for(let f=e+1;f<=t;f++){const v=a[f-1];if(!v){n(`⚠️ ไม่พบ prompt สำหรับฉากที่ ${f} — ข้าม`);continue}n(`── ฉากที่ ${f}/${t}: วาง prompt + generate (pending recovery) ──`);let C=null;const O=Date.now();for(;!C&&Date.now()-O<1e4;){const I=document.querySelectorAll("[data-slate-editor='true']");if(I.length>0&&(C=I[I.length-1]),!C){const V=document.querySelectorAll("[role='textbox'][contenteditable='true']");V.length>0&&(C=V[V.length-1])}C||await g(1e3)}if(!C){n(`⚠️ ไม่พบ Slate editor สำหรับฉาก ${f}`);break}await Ie(C,v),n(`วาง prompt ฉาก ${f} (${v.length} ตัวอักษร) ✅`);try{_(`scene${f}-prompt`,"done"),_(`scene${f}-gen`,"active")}catch{}await g(1e3);const M=C.getBoundingClientRect();let $=null,D=1/0;for(const I of document.querySelectorAll("button")){if(I.disabled)continue;const V=I.querySelectorAll("i");let N=!1;for(const j of V)if((j.textContent||"").trim()==="arrow_forward"){N=!0;break}if(!N)continue;const L=I.getBoundingClientRect();if(L.width<=0||L.height<=0)continue;const H=Math.abs(L.top-M.top)+Math.abs(L.right-M.right);H<D&&(D=H,$=I)}if(!$)for(const I of document.querySelectorAll("button")){const V=I.querySelectorAll("i");for(const N of V)if((N.textContent||"").trim()==="arrow_forward"){const L=I.getBoundingClientRect();if(L.width>0&&L.height>0){$=I;break}}if($)break}if(!$){n(`⚠️ ไม่พบปุ่ม Generate สำหรับฉาก ${f}`);break}await new Promise(I=>{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:i,sceneCount:t,currentScene:f,scenePrompts:a}},()=>I())}),await ee($),n(`คลิก Generate ฉาก ${f} ✅`);try{_(`scene${f}-gen`,"done"),_(`scene${f}-wait`,"active")}catch{}await g(5e3);let b=0,x=0;const E=Date.now();let S=!1,F=0;for(;Date.now()-E<6e5;){let I=null;const V=document.querySelectorAll("div, span, p, label, strong, small");for(const N of V){if(N.closest("#netflow-engine-overlay"))continue;const H=(N.textContent||"").trim().match(/^(\d{1,3})%$/);if(H){const j=N.getBoundingClientRect();if(j.width>0&&j.height>0&&j.width<120&&j.height<60){I=parseInt(H[1],10);break}}}if(I!==null){if(F=0,I!==b){n(`🎬 ฉาก ${f} ความคืบหน้า: ${I}%`),b=I;try{_(`scene${f}-wait`,"active",I)}catch{}}x=0}else if(b>0){if(x===0)x=Date.now();else if(Date.now()-x>=5e3){n(`✅ ฉาก ${f}: เจนเสร็จ!`),S=!0;break}}else if(F++,F>=15){const N=document.querySelectorAll("video");let L=!1;for(const H of N)if(H.readyState>=2&&!H.paused&&H.getBoundingClientRect().width>200){L=!0;break}if(L){n(`✅ ฉาก ${f}: พบวิดีโอเล่นอยู่ — เสร็จ`),S=!0;break}if(F>=30){n(`✅ ฉาก ${f}: ไม่พบ % 60 วินาที — ถือว่าเสร็จ`),S=!0;break}}await g(2e3)}S||n(`⚠️ ฉาก ${f} หมดเวลา`);try{_(`scene${f}-wait`,"done",100)}catch{}n(`✅ ฉาก ${f} เสร็จแล้ว`),chrome.storage.local.remove("netflow_pending_action"),await g(2e3)}}n("✅ ทุกฉากเสร็จ — เริ่มดาวน์โหลด"),await g(3e3);let P=null;try{_("download","active")}catch{}n("── เริ่มดาวน์โหลด Full Video (หลัง page navigate) ──");const k=Date.now();let y=null;const h=Date.now();for(;!y&&Date.now()-h<1e4;){for(const f of document.querySelectorAll("button")){const v=f.querySelector("i");if(v&&(v.textContent||"").trim()==="download"){const C=f.getBoundingClientRect();if(C.width>0&&C.height>0){y=f;break}}}y||await g(1e3)}if(!y){A("ไม่พบปุ่มดาวน์โหลด");return}await ee(y),n("คลิกดาวน์โหลดแล้ว ✅");try{_("download","done"),_("upscale","active")}catch{}await g(1500);let r=null;for(let f=0;f<3&&!r;f++){f>0&&n(`🔄 ลองหา 720p ครั้งที่ ${f+1}...`);let v=null;const C=Date.now();for(;!v&&Date.now()-C<5e3;){for(const b of document.querySelectorAll("[role='menuitem']"))if((b.textContent||"").trim().includes("Full Video")&&b.querySelector("i")){const E=b.getBoundingClientRect();if(E.width>0&&E.height>0){v=b;break}}v||await g(500)}if(!v){A("ไม่พบ Full Video");continue}const O=v.getBoundingClientRect(),M=O.left+O.width/2,$=O.top+O.height/2;v.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:M,clientY:$})),v.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:M,clientY:$})),v.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:M,clientY:$})),await ee(v),n("คลิก/hover Full Video ✅"),await g(2e3);const D=Date.now();for(;!r&&Date.now()-D<8e3;){for(const b of document.querySelectorAll("button[role='menuitem']")){const x=b.querySelectorAll("span");for(const E of x)if((E.textContent||"").trim()==="720p"){const S=b.getBoundingClientRect();if(S.width>0&&S.height>0){r=b;break}}if(r)break}r||(v.isConnected&&(v.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:M,clientY:$})),v.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:M+20,clientY:$}))),await g(500))}}if(!r){A("ไม่พบ 720p");return}await ee(r),n("คลิก 720p ✅"),n("รอดาวน์โหลดเสร็จ...");const T=Date.now();let z=!1,X=!1;for(;Date.now()-T<3e5;){for(const f of document.querySelectorAll("div[data-title] div, div[data-content] div")){const v=(f.textContent||"").trim();if(v==="Download complete!"||v==="ดาวน์โหลดเสร็จ"){n("✅ Download complete! (toast)"),z=!0;break}(v.includes("Downloading your extended video")||v.includes("กำลังดาวน์โหลด"))&&(X||(X=!0,n("⏳ กำลังดาวน์โหลด...")))}if(z)break;if(X){let f=!1;for(const v of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((v.textContent||"").trim().includes("Downloading")){f=!0;break}if(!f){n("✅ ดาวน์โหลดเสร็จ (toast หายไป)"),z=!0;break}}await g(2e3)}if(!z){A("ดาวน์โหลดหมดเวลา");return}try{_("upscale","done",100),_("open","active")}catch{}n("รอไฟล์ดาวน์โหลดพร้อม..."),await g(5e3);let R=!1;const B=Date.now();for(;Date.now()-B<6e4&&!R;){try{await new Promise(f=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:k},v=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):v!=null&&v.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${v.message}`),R=!0,v.downloadUrl&&(P=v.downloadUrl,n(`[TikTok] จะใช้ download URL: ${v.downloadUrl.substring(0,80)}...`))):n(`ดาวน์โหลดยังไม่พร้อม: ${v==null?void 0:v.message}`),f()})})}catch(f){A(`ตรวจสอบผิดพลาด: ${f.message}`)}R||await g(3e3)}R||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("[TikTok] กำลัง capture + cache video blob จาก content script...");const w=await Ve();P||(P=w);try{_("open","done"),ke(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น (หลัง page navigate) ═══"),Ge(P),Le(2e3)}async function Kt(){try{const t=await new Promise(c=>{chrome.storage.local.get("netflow_pending_action",p=>{if(chrome.runtime.lastError){c(null);return}c((p==null?void 0:p.netflow_pending_action)||null)})});if(!t||!t.timestamp)return;if(!window.location.href.includes("/edit/")){n("⏭️ pending action พบ แต่ไม่ใช่หน้า video detail — ข้าม");return}if(t._claimed){n("⏭️ pending action ถูก tab อื่น claim แล้ว — ข้าม");return}const i=Date.now()-t.timestamp;if(i>3e5){n("⏰ พบ pending action แต่เก่าเกินไป — ข้าม"),chrome.storage.local.remove("netflow_pending_action");return}const a=`${Date.now()}-${Math.random().toString(36).slice(2)}`;if(t._claimed=a,await new Promise(c=>{chrome.storage.local.set({netflow_pending_action:t},()=>c())}),await g(300),!await new Promise(c=>{chrome.storage.local.get("netflow_pending_action",p=>{const s=p==null?void 0:p.netflow_pending_action;c((s==null?void 0:s._claimed)===a)})})){n("⏭️ pending action ถูก tab อื่น claim ชนะ — ข้าม");return}chrome.storage.local.remove("netflow_pending_action"),n(`🔄 ตรวจพบ pending action: ${t.action} (อายุ ${Math.round(i/1e3)} วินาที)`),t.action==="mute_video"?await yt(t.sceneCount||1,t.scenePrompts||[],t.theme):t.action==="wait_scene_gen_and_download"||t.action==="wait_scene2_gen_and_download"?await $t(t.sceneCount||2,t.currentScene||2,t.theme,t.scenePrompts||[]):n(`⚠️ ไม่รู้จัก pending action: ${t.action}`)}catch(t){n(`⚠️ checkAndRunPendingAction error: ${t.message}`)}}chrome.runtime.onMessage.addListener((t,e,i)=>{if((t==null?void 0:t.action)==="GENERATE_IMAGE")return window.__NETFLOW_STOP__=!1,n("ได้รับคำสั่ง GENERATE_IMAGE"),i({success:!0,message:"⏳ เริ่มกระบวนการอัตโนมัติแล้ว — ดูผลที่หน้า Google Flow",step:"started"}),jt(t).then(a=>n(`✅ ระบบอัตโนมัติเสร็จ: ${a.message}`)).catch(a=>{if(a instanceof Ue||(a==null?void 0:a.name)==="NetflowAbortError"){n("⛔ Automation หยุดทำงานโดยผู้ใช้");try{Pe("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{gt()}catch{}}else console.error("[Netflow AI] Generate error:",a)}),!1;if((t==null?void 0:t.action)==="STOP_AUTOMATION")return n("⛔ ได้รับ STOP_AUTOMATION — ตั้งค่าสถานะหยุด"),window.__NETFLOW_STOP__=!0,i({success:!0,message:"Stop signal sent"}),!1;if((t==null?void 0:t.action)==="PING")return i({status:"ready"}),!1;if((t==null?void 0:t.action)==="CLICK_FIRST_IMAGE")return i({success:!0,message:"⏳ กำลังคลิกรูปแรก..."}),(async()=>{n("CLICK_FIRST_IMAGE — ค้นหาการ์ดรูปแรกผ่านไอคอน <i>image</i>..."),await g(500);const a=Vt();if(!a){A("ไม่พบการ์ดรูปผ่านไอคอน <i>image</i>");return}const o=a.getBoundingClientRect(),c=o.left+o.width/2,p=o.top+o.height/2;n(`การ์ดรูปที่ (${c.toFixed(0)}, ${p.toFixed(0)}) ${o.width.toFixed(0)}x${o.height.toFixed(0)} — คลิก 2 ครั้ง`);for(let s=0;s<2;s++){const l=document.elementFromPoint(c,p);l?(await ee(l),n(`คลิก ${s+1}/2 บน <${l.tagName.toLowerCase()}>`)):(await ee(a),n(`คลิก ${s+1}/2 บนการ์ด (สำรอง)`)),await g(300)}n("✅ คลิกการ์ดรูป 2 ครั้งเสร็จ")})(),!1}),n("สคริปต์ Google Flow พร้อมแล้ว — รอคำสั่ง"),Kt()})();
