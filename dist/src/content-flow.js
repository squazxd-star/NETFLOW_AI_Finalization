...
@media (max-height: 600px) {
    ...
    `}function Ye(){K||(K=document.createElement("style"),K.id="netflow-overlay-styles",K.textContent=Lt(Z),document.head.appendChild(K))}function ct(n){n.innerHTML="",j.forEach((e,s)=>{const r=document.createElement("div");r.className="nf-proc-row nf-proc-waiting",r.id=`nf-proc-${e.stepId}`,r.innerHTML=`
        ...
        `,n.appendChild(r)})}function dt(){const n=document.getElementById("nf-terminal");if(!n)return;ct(n);const e=document.getElementById("nf-step-counter");e&&(e.textContent=`0/${j.length}`)}function pt(n,e){let l="";for(let k=0;k<20;k++){const D=k/20*Math.PI*2,C=(k+.2)/20*Math.PI*2,m=(k+.5)/20*Math.PI*2,o=(k+.8)/20*Math.PI*2,g=(k+1)/20*Math.PI*2;l+=`${k===0?"M":"L"}${(120+100*Math.cos(D)).toFixed(1)},${(120+100*Math.sin(D)).toFixed(1)} `,l+=`L${(120+100*Math.cos(C)).toFixed(1)},${(120+100*Math.sin(C)).toFixed(1)} `,l+=`L${(120+112*Math.cos(m)).toFixed(1)},${(120+112*Math.sin(m)).toFixed(1)} `,l+=`L${(120+100*Math.cos(o)).toFixed(1)},${(120+100*Math.sin(o)).toFixed(1)} `,l+=`L${(120+100*Math.cos(g)).toFixed(1)},${(120+100*Math.sin(g)).toFixed(1)} `}l+="Z";const a=14,p=72,x=62;let w="";for(let k=0;k<a;k++){const D=k/a*Math.PI*2,C=(k+.25)/a*Math.PI*2,m=(k+.75)/a*Math.PI*2,o=(k+1)/a*Math.PI*2;w+=`${k===0?"M":"L"}${(120+x*Math.cos(D)).toFixed(1)},${(120+x*Math.sin(D)).toFixed(1)} `,w+=`L${(120+p*Math.cos(C)).toFixed(1)},${(120+p*Math.sin(C)).toFixed(1)} `,w+=`L${(120+p*Math.cos(m)).toFixed(1)},${(120+p*Math.sin(m)).toFixed(1)} `,w+=`L${(120+x*Math.cos(o)).toFixed(1)},${(120+x*Math.sin(o)).toFixed(1)} `}return w+="Z",`<svg width="72" height="72" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    `,e.appendChild(s),n.steps.forEach(i=>{const d=document.createElement("div");d.className="nf-step",d.id=`nf-step-${i.id}`;let c="";i.progress!==void 0&&(c=`
            ...
            ${c}
        `,e.appendChild(d)});const r=document.createElement("div");return r.className="nf-mod-progress",r.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${n.id}"></div>`,e.appendChild(r),e}function Ht(){lt=Date.now(),Fe=setInterval(()=>{const n=Math.floor((Date.now()-lt)/1e3),e=String(Math.floor(n/60)).padStart(2,"0"),s=String(n%60).padStart(2,"0"),r=document.getElementById("nf-timer");r&&(r.textContent=`${e}:${s}`);const i=document.getElementById("nf-stat-elapsed");i&&(i.textContent=`${e}:${s}`)},1e3)}function ut(){Fe&&(clearInterval(Fe),Fe=null)}const Gt=120,ft=160,gt=.4;let Ee=null,mt=0,ht=0,bt=0,_e=[];function Ut(n,e){_e=[];for(let s=0;s<Gt;s++){const r=Math.random();let i;r<.22?i=0:r<.4?i=1:r<.55?i=2:r<.68?i=3:r<.84?i=4:i=5;const d=Math.random()*n,c=Math.random()*e,l=50+Math.random()*220,a=Math.random()*Math.PI*2,p=(.003+Math.random()*.008)*(Math.random()>.5?1:-1);_e.push({x:i===0?Math.random()*n:d+Math.cos(a)*l,y:i===0?Math.random()*e:c+Math.sin(a)*l,vx:(Math.random()-.5)*gt,vy:(Math.random()-.5)*gt,radius:1.2+Math.random()*2.5,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03,motion:i,oCx:d,oCy:c,oRadius:l,oAngle:a,oSpeed:p})}}function Wt(){if(!pe)return;const n=pe;if(Se=n.getContext("2d"),!Se)return;const e=()=>{n.width=window.innerWidth,n.height=window.innerHeight,_e.length===0&&Ut(n.width,n.height)};e(),window.addEventListener("resize",e);let s=null,r=0,i=0,d=!1;function c(){if(!Se||!pe){Ie=null;return}if(Ie=requestAnimationFrame(c),d=!d,d)return;const l=Se,a=pe.width,p=pe.height;l.fillStyle=`rgba(${ae*.04|0},${re*.04|0},${se*.06|0},1)`,l.fillRect(0,0,a,p),(!s||r!==a||i!==p)&&(r=a,i=p,s=l.createRadialGradient(a*.5,p*.5,0,a*.5,p*.5,Math.max(a,p)*.6),s.addColorStop(0,`rgba(${ae*.08|0},${re*.08|0},${se*.1|0},0.4)`),s.addColorStop(1,"rgba(0,0,0,0)")),l.fillStyle=s,l.fillRect(0,0,a,p);const x=_e,w=x.length,k=ft*ft;for(let m=0;m<w;m++){const o=x[m];if(o.pulsePhase+=o.pulseSpeed,o.motion===0)o.x+=o.vx,o.y+=o.vy,o.x<0?(o.x=0,o.vx=Math.abs(o.vx)*(.8+Math.random()*.4)):o.x>a&&(o.x=a,o.vx=-Math.abs(o.vx)*(.8+Math.random()*.4)),o.y<0?(o.y=0,o.vy=Math.abs(o.vy)*(.8+Math.random()*.4)):o.y>p&&(o.y=p,o.vy=-Math.abs(o.vy)*(.8+Math.random()*.4));else if(o.motion===1)o.oAngle+=o.oSpeed,o.x=o.oCx+Math.cos(o.oAngle)*o.oRadius,o.y=o.oCy+Math.sin(o.oAngle)*o.oRadius,o.oCx+=Math.sin(o.oAngle*.3)*.15,o.oCy+=Math.cos(o.oAngle*.3)*.15;else if(o.motion===2)o.oAngle+=o.oSpeed,o.x=o.oCx+Math.cos(o.oAngle)*o.oRadius,o.y=o.oCy+Math.sin(o.oAngle)*o.oRadius*.5,o.oCx+=Math.sin(o.oAngle*.2)*.1,o.oCy+=Math.cos(o.oAngle*.2)*.1;else if(o.motion===3){o.oAngle+=o.oSpeed;const g=o.oAngle,y=o.oRadius*.7;o.x=o.oCx+y*Math.cos(g),o.y=o.oCy+y*Math.sin(g)*Math.cos(g),o.oCx+=Math.sin(g*.15)*.12,o.oCy+=Math.cos(g*.15)*.12}else if(o.motion===4){o.oAngle+=o.oSpeed*1.2;const g=o.oRadius*(.5+.5*Math.abs(Math.sin(o.oAngle*.15)));o.x=o.oCx+Math.cos(o.oAngle)*g,o.y=o.oCy+Math.sin(o.oAngle)*g,o.oCx+=Math.sin(o.oAngle*.1)*.18,o.oCy+=Math.cos(o.oAngle*.1)*.18}else o.oAngle+=o.oSpeed,o.x+=o.vx*.8,o.y=o.oCy+Math.sin(o.oAngle+o.x*.008)*o.oRadius*.35,o.x<-30?o.x=a+30:o.x>a+30&&(o.x=-30),o.oCy+=Math.sin(o.oAngle*.1)*.08;if(o.motion>0){const g=o.oRadius+50;o.oCx<-g?o.oCx=a+g:o.oCx>a+g&&(o.oCx=-g),o.oCy<-g?o.oCy=p+g:o.oCy>p+g&&(o.oCy=-g)}}l.beginPath(),l.strokeStyle=`rgba(${ae},${re},${se},0.06)`,l.lineWidth=.4;const D=new Path2D;for(let m=0;m<w;m++){const o=x[m];for(let g=m+1;g<w;g++){const y=x[g],q=o.x-y.x,I=o.y-y.y,_=q*q+I*I;_<k&&(1-_/k<.4?(l.moveTo(o.x,o.y),l.lineTo(y.x,y.y)):(D.moveTo(o.x,o.y),D.lineTo(y.x,y.y)))}}if(l.stroke(),l.strokeStyle=`rgba(${ae},${re},${se},0.18)`,l.lineWidth=.8,l.stroke(D),!Ee||mt!==ae||ht!==re||bt!==se){Ee=document.createElement("canvas");const m=48;Ee.width=m,Ee.height=m;const o=Ee.getContext("2d"),g=o.createRadialGradient(m/2,m/2,0,m/2,m/2,m/2);g.addColorStop(0,`rgba(${ae},${re},${se},0.9)`),g.addColorStop(.3,`rgba(${ae},${re},${se},0.35)`),g.addColorStop(1,`rgba(${ae},${re},${se},0)`),o.fillStyle=g,o.fillRect(0,0,m,m),mt=ae,ht=re,bt=se}const C=Ee;for(let m=0;m<w;m++){const o=x[m],g=.6+.4*Math.sin(o.pulsePhase),y=o.radius*5*(.8+g*.4);l.globalAlpha=.5+g*.4,l.drawImage(C,o.x-y/2,o.y-y/2,y,y)}l.globalAlpha=1,l.fillStyle="rgba(255,255,255,0.45)",l.beginPath();for(let m=0;m<w;m++){const o=x[m];if(o.radius>2){const g=.6+.4*Math.sin(o.pulsePhase),y=o.radius*(.8+g*.4)*.35;l.moveTo(o.x+y,o.y),l.arc(o.x,o.y,y,0,Math.PI*2)}}l.fill()}c()}function Yt(){Ie!==null&&(cancelAnimationFrame(Ie),Ie=null),pe=null,Se=null,_e=[]}let Ae=null;const Le=560,Xt=140,wt=Le/2,xt=Xt/2,yt=[];for(let n=0;n<=Le;n+=8){const e=Math.abs(n-wt)/wt;yt.push(Math.pow(Math.min(1,e*1.6),.6))}const jt=[0,1,2,3].map(n=>({amp:10+n*5,freq:(1.2+n*.35)*Math.PI*2/Le,off:n*.6,spd:.7+n*.12}));let Xe=!1;function vt(){if(Pe=requestAnimationFrame(vt),Xe=!Xe,Xe)return;if(We+=.07,!Ae){const e=document.getElementById("nf-engine-waves");if(!e){Pe=null;return}Ae=Array.from(e.querySelectorAll("path"))}const n=[];for(let e=0;e<Ae.length;e++){const s=jt[e],r=We*s.spd+s.off;n.length=0,n.push(`M 0 ${xt}`);let i=0;for(let d=0;d<=Le;d+=8){const c=xt+s.amp*yt[i++]*Math.sin(d*s.freq+r);n.push(`L${d} ${c*10+.5|0}`)}Ae[e].setAttribute("d",n.join(" "))}}function Kt(){We=0,vt(),Wt(),Ne=setInterval(()=>{const n=document.getElementById("nf-stat-freq"),e=document.getElementById("nf-stat-lat1"),s=document.getElementById("nf-stat-lat2"),r=document.getElementById("nf-stat-buf");n&&(n.textContent=`${(4.5+Math.random()*.5).toFixed(1)} GHz`),e&&(e.textContent=`${Math.floor(12+Math.random()*10)}ms`),s&&(s.textContent=`${Math.floor(12+Math.random()*10)}ms`),r&&(r.textContent=`${Math.floor(90+Math.random()*9)}%`)},2e3)}function $t(){Pe!==null&&(cancelAnimationFrame(Pe),Pe=null),Ne&&(clearInterval(Ne),Ne=null),Ae=null,Yt()}function qe(){let n=0;const e=j.filter(p=>p.status!=="skipped").length;for(const p of j){const x=document.getElementById(`nf-proc-${p.stepId}`);if(!x)continue;x.className="nf-proc-row";const w=x.querySelector(".nf-proc-badge");switch(p.status){case"done":x.classList.add("nf-proc-done"),w&&(w.textContent="✅ done"),n++;break;case"active":x.classList.add("nf-proc-active"),w&&(w.textContent=p.progress!==void 0&&p.progress>0?`⏳ ${p.progress}%`:"⏳ active");break;case"error":x.classList.add("nf-proc-error"),w&&(w.textContent="❌ error");break;case"skipped":x.classList.add("nf-proc-skipped"),w&&(w.textContent="— skip");break;default:x.classList.add("nf-proc-waiting"),w&&(w.textContent="(queued)")}}const s=j.findIndex(p=>p.status==="active"),r=s>=0?s+1:n>=e&&e>0?j.length:n,i=document.getElementById("nf-step-counter");i&&(i.textContent=`${r}/${j.length}`);const d=document.querySelector(".nf-core-title-val"),c=document.querySelector(".nf-status-dot");n>=e&&e>0?(d&&(d.textContent="COMPLETE",d.style.color=Z.doneHex),c&&(c.style.background=Z.doneHex,c.style.boxShadow=`0 0 8px rgba(${Z.doneRgb},0.7)`)):j.some(x=>x.status==="error")?(d&&(d.textContent="ERROR",d.style.color="#f87171"),c&&(c.style.background="#ef4444",c.style.boxShadow="0 0 8px rgba(239,68,68,0.7)")):j.some(x=>x.status==="active")&&d&&(d.textContent="ACTIVE",d.style.color=Z.hex,d.style.textShadow=`0 0 10px rgba(${Z.rgb},0.5)`);const l=document.getElementById("nf-terminal"),a=l==null?void 0:l.querySelector(".nf-proc-active");a&&l&&a.scrollIntoView({behavior:"smooth",block:"center"})}function Et(){Q&&Q.isConnected||(Ye(),Q=document.createElement("button"),Q.id="nf-toggle-btn",Q.className="nf-toggle-visible",Q.innerHTML=he?rt:st,Q.title="ซ่อน/แสดง Netflow Overlay",Q.style.cssText="position:fixed !important;top:20px !important;right:20px !important;z-index:2147483647 !important;width:48px !important;height:48px !important;border-radius:50% !important;border:2px solid rgba(255,255,255,0.5) !important;background:rgba(0,0,0,0.85) !important;color:#fff !important;font-size:23px !important;cursor:pointer !important;display:flex !important;align-items:center !important;justify-content:center !important;pointer-events:auto !important;",Q.onclick=()=>kt(),document.body.appendChild(Q))}function kt(){H&&(Et(),he?(H.classList.remove("nf-hidden"),H.classList.add("nf-visible"),H.style.opacity="1",H.style.pointerEvents="auto",Q&&(Q.innerHTML=st),he=!1):(H.classList.remove("nf-visible"),H.classList.add("nf-hidden"),H.style.opacity="0",H.style.pointerEvents="none",Q&&(Q.innerHTML=rt),he=!0))}const Ct={red:"themes/theme-red.jpg",yellow:"themes/theme-yellow.jpg",blue:"themes/theme-blue.jpg",purple:"themes/theme-purple.jpg",green:"themes/theme-green.jpg"};function Tt(){const n=document.getElementById("nf-core-monitor");if(!n)return;let e=Me;if(!e)try{e=localStorage.getItem("netflow_app_theme")||"green"}catch{e="green"}const s=Ct[e]||Ct.green;let r;try{r=chrome.runtime.getURL(s)}catch{r=`/${s}`}const i=Z.rgb;n.style.backgroundImage=["linear-gradient(180deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 45%, rgba(0,0,0,0.90) 100%)",`linear-gradient(180deg, rgba(${i},0.25) 0%, rgba(${i},0.12) 50%, rgba(${i},0.20) 100%)`,`url('${r}')`].join(", "),n.style.backgroundSize="auto, auto, 50%",n.style.backgroundPosition="center, center, center",n.style.backgroundRepeat="no-repeat, no-repeat, no-repeat",n.style.setProperty("--nf-bg-set","1"),n.style.border=`1.5px solid rgba(${i},0.45)`,n.style.boxShadow=`0 0 70px rgba(${i},0.22), 0 0 140px rgba(${i},0.1), inset 0 1px 0 rgba(${i},0.15)`}function je(n=1){if(Z=zt(),at(),H&&H.isConnected){H.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;background:#0a0a0f !important;overflow:hidden !important;font-family:Inter,system-ui,-apple-system,sans-serif !important;",(!K||!K.isConnected)&&(K=null,Ye()),setTimeout(()=>{if(H)try{K!=null&&K.sheet&&K.sheet.cssRules.length>0&&(H.style.removeProperty("background"),H.style.removeProperty("font-family"),H.style.removeProperty("overflow"))}catch{}},200);for(const e of le)for(const s of e.steps)s.status="waiting",s.progress=s.progress!==void 0?0:void 0;$e=n,j=ze(n),dt();for(const e of le)Ke(e);if(Ve(),qe(),!H.querySelector(".nf-stop-btn")){const e=document.createElement("button");e.className="nf-stop-btn",e.innerHTML='<span class="nf-stop-icon"></span> หยุด',e.style.cssText="position:absolute !important;top:14px !important;right:110px !important;z-index:2147483646 !important;cursor:pointer !important;pointer-events:auto !important;background:rgba(255,60,60,0.08) !important;border:1px solid rgba(255,60,60,0.25) !important;border-radius:8px !important;color:rgba(255,100,100,0.8) !important;font-size:13px !important;padding:6px 14px !important;font-family:inherit !important;display:flex !important;align-items:center !important;gap:6px !important;",e.onclick=()=>{var s;window.__NETFLOW_STOP__=!0;try{De("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{typeof chrome<"u"&&((s=chrome.runtime)!=null&&s.sendMessage)&&chrome.runtime.sendMessage({action:"AUTOMATION_STOPPED"})}catch{}},H.appendChild(e)}he&&kt();return}H&&!H.isConnected&&(H=null),K&&(K.remove(),K=null),Ye();for(const e of le)for(const s of e.steps)s.status="waiting",s.progress=s.progress!==void 0?0:void 0;if($e=n,j=ze(n),n>1){const e=le.find(r=>r.id==="video");if(e){const r=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:"waiting",progress:0}];for(let i=2;i<=n;i++)r.push({id:`scene${i}-prompt`,label:`Scene ${i} Prompt`,status:"waiting"}),r.push({id:`scene${i}-gen`,label:`Scene ${i} Generate`,status:"waiting"}),r.push({id:`scene${i}-wait`,label:`Scene ${i} รอผล`,status:"waiting",progress:0});e.steps=r}const s=le.find(r=>r.id==="render");if(s){const r=s.steps.find(d=>d.id==="download");r&&(r.label="ดาวน์โหลด 720p");const i=s.steps.find(d=>d.id==="upscale");i&&(i.label="Full Video")}}H=qt(),H.style.cssText="position:fixed !important;inset:0 !important;z-index:2147483647 !important;pointer-events:auto !important;opacity:1 !important;background:#0a0a0f !important;overflow:hidden !important;font-family:Inter,system-ui,-apple-system,sans-serif !important;",document.body.appendChild(H),H.classList.add("nf-visible"),he=!1,Et(),Ht(),Kt(),requestAnimationFrame(()=>Tt()),setTimeout(()=>{if(H)try{K!=null&&K.sheet&&K.sheet.cssRules.length>0&&(H.style.removeProperty("background"),H.style.removeProperty("font-family"),H.style.removeProperty("overflow"))}catch{}},200)}function Mt(){ut(),$t(),he=!1,H&&(H.classList.add("nf-fade-out"),setTimeout(()=>{H==null||H.remove(),H=null},500)),Q&&(Q.remove(),Q=null)}const Qt={settings:"SETTINGS","upload-char":"UPLOAD","upload-prod":"UPLOAD","img-prompt":"PROMPT","img-generate":"GENERATE","img-wait":"IMG WAIT",animate:"ANIMATE","vid-prompt":"VID PROMPT","vid-generate":"VID GEN","vid-wait":"VID WAIT",download:"DOWNLOAD",upscale:"UPSCALE",open:"OPENING"};function Jt(n,e,s){const r=j.findIndex(w=>w.status==="active"),i=j.filter(w=>w.status==="done").length,d=j.length,c=r>=0?r+1:i>=d?d:i,l=document.getElementById("nf-stat-step");l&&(l.textContent=`${c}/${d}`);let a=1;for(const w of j)if(w.status==="active"||w.status==="done")if(w.stepId.startsWith("scene")){const k=w.stepId.match(/^scene(\d+)-/);k&&(a=Math.max(a,parseInt(k[1],10)))}else(w.stepId==="download"||w.stepId==="upscale"||w.stepId==="open")&&(a=$e);const p=document.getElementById("nf-stat-scenes");if(p&&(p.textContent=$e>1?`${a}/${$e}`:"1/1"),e==="active"){const w=document.getElementById("nf-stat-status"),k=Qt[n]||n.toUpperCase();w&&(w.textContent=k)}else if(e==="done"&&i>=d){const w=document.getElementById("nf-stat-status");w&&(w.textContent="COMPLETE")}else if(e==="error"){const w=document.getElementById("nf-stat-status");w&&(w.textContent="ERROR")}const x=document.getElementById("nf-stat-progress");x&&(s!==void 0&&s>0?x.textContent=`${Math.min(100,s)}%`:e==="active"&&(x.textContent="—"))}function P(n,e,s){if(!H)return;for(const i of le)for(const d of i.steps)d.id===n&&(d.status=e,s!==void 0&&(d.progress=s));for(const i of j)i.stepId===n&&(i.status=e,s!==void 0&&(i.progress=s));const r=document.getElementById(`nf-step-${n}`);if(r&&(r.className="nf-step",e==="active"?r.classList.add("nf-step-active"):e==="done"?r.classList.add("nf-step-done"):e==="error"&&r.classList.add("nf-step-error")),Jt(n,e,s),s!==void 0){const i=document.getElementById(`nf-bar-${n}`);i&&(i.style.width=`${Math.min(100,s)}%`)}Ve(),qe()}function ke(n){P(n,"skipped");const e=document.getElementById(`nf-step-${n}`);e&&(e.style.opacity="0.2")}function Be(n=4e3){ut(),$t(),Ve(),qe(),setTimeout(()=>Mt(),n)}function Ve(){for(const n of le){const e=n.steps.filter(a=>a.status!=="skipped").length,s=n.steps.filter(a=>a.status==="done").length,r=n.steps.some(a=>a.status==="active"),i=e>0?Math.round(s/e*100):0,d=document.getElementById(`nf-pct-${n.id}`);d&&(d.textContent=`${i}%`);const c=document.getElementById(`nf-modbar-${n.id}`);c&&(c.style.width=`${i}%`);const l=document.getElementById(`nf-mod-${n.id}`);l&&(l.classList.remove("nf-active","nf-done"),i>=100?l.classList.add("nf-done"):r&&l.classList.add("nf-active"))}}function Zt(n){var r,i,d,c;$e=n;const e=new Map;for(const l of j)e.set(l.stepId,{status:l.status,progress:l.progress});j=ze(n);for(const l of j){const a=e.get(l.stepId);a&&(l.status=a.status,a.progress!==void 0&&(l.progress=a.progress))}if(dt(),n>1){const l=le.find(a=>a.id==="video");if(l){const a=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:((r=l.steps.find(p=>p.id==="animate"))==null?void 0:r.status)||"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:((i=l.steps.find(p=>p.id==="vid-prompt"))==null?void 0:i.status)||"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:((d=l.steps.find(p=>p.id==="vid-generate"))==null?void 0:d.status)||"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:((c=l.steps.find(p=>p.id==="vid-wait"))==null?void 0:c.status)||"waiting",progress:0}];for(let p=2;p<=n;p++)a.push({id:`scene${p}-prompt`,label:`Scene ${p} Prompt`,status:"waiting"}),a.push({id:`scene${p}-gen`,label:`Scene ${p} Generate`,status:"waiting"}),a.push({id:`scene${p}-wait`,label:`Scene ${p} รอผล`,status:"waiting",progress:0});l.steps=a,Ke(l)}}const s=le.find(l=>l.id==="render");if(s&&n>1){const l=s.steps.find(p=>p.id==="download");l&&(l.label="ดาวน์โหลด 720p");const a=s.steps.find(p=>p.id==="upscale");a&&(a.label="Full Video"),Ke(s)}Ve(),qe()}function Ke(n){const e=document.getElementById(`nf-mod-${n.id}`);if(!e)return;e.querySelectorAll(".nf-step, .nf-mod-progress").forEach(i=>i.remove()),n.steps.forEach(i=>{const d=document.createElement("div");d.className="nf-step",d.id=`nf-step-${i.id}`;let c="";i.progress!==void 0&&(c=`
                <div class="nf-progress-bar">
                    <div class="nf-progress-fill" id="nf-bar-${i.id}" style="width: 0%"></div>
                </div>
            `),d.innerHTML=`
