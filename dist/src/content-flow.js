...
@media (max-height: 600px) {
    ...
    `,h.appendChild(f);const x=document.createElement("div");x.className="nf-terminal",x.id="nf-terminal",Je(x),h.appendChild(x);const E=document.createElement("div");E.className="nf-engine-core",E.id="nf-engine-core";const N=document.createElement("div");N.className="nf-engine-frame",["nf-fc-tl","nf-fc-tr","nf-fc-bl","nf-fc-br"].forEach(y=>{const _=document.createElement("div");_.className=`nf-frame-corner ${y}`,N.appendChild(_)}),E.appendChild(N);const R="http://www.w3.org/2000/svg",u=document.createElementNS(R,"svg");u.setAttribute("class","nf-engine-waves"),u.setAttribute("viewBox","0 0 560 140"),u.setAttribute("preserveAspectRatio","none"),u.id="nf-engine-waves";for(let y=0;y<4;y++){const _=document.createElementNS(R,"path");_.setAttribute("fill","none"),_.setAttribute("stroke-width",y<2?"1.5":"1"),_.setAttribute("stroke",y<2?`rgba(${J.rgb},${.14+y*.1})`:`rgba(${J.accentRgb},${.1+(y-2)*.08})`),_.setAttribute("data-wave-idx",String(y)),u.appendChild(_)}E.appendChild(u);const v=document.createElement("div");v.className="nf-engine-brand-inner",v.innerHTML=`
    ...
    `,E.appendChild(v);const M=document.createElement("div");M.className="nf-engine-stats",M.id="nf-engine-stats",M.innerHTML=[["SCENES","nf-stat-scenes","1/1"],["ELAPSED","nf-stat-elapsed","00:00"],["STEP","nf-stat-step","0/0"],["STATUS","nf-stat-status","READY"],["PROGRESS","nf-stat-progress","—"]].map(([y,_,z])=>`<div class="nf-stat-item"><span class="nf-stat-label">${y}</span><span class="nf-stat-val" id="${_}">${z}</span></div>`).join(""),E.appendChild(M),h.appendChild(E),V.appendChild(h);const P=["nf-mod-tl","nf-mod-tr","nf-mod-bl","nf-mod-br"];ce.forEach((y,_)=>{const z=Mt(y);z.classList.add(P[_]),z.id=`nf-mod-${y.id}`,V.appendChild(z)}),t.appendChild(V);for(let y=0;y<30;y++){const _=document.createElement("div");_.className="nf-particle",_.style.left=`${5+Math.random()*90}%`,_.style.bottom=`${Math.random()*40}%`,_.style.animationDuration=`${3+Math.random()*5}s`,_.style.animationDelay=`${Math.random()*4}s`;const z=.3+Math.random()*.4,T=.7+Math.random()*.3;_.style.background=`rgba(${Math.floor(ne*T)}, ${Math.floor(oe*T)}, ${Math.floor(ie*T)}, ${z})`,_.style.width=`${1+Math.random()*2}px`,_.style.height=_.style.width,t.appendChild(_)}return t}function Mt(t){const e=document.createElement("div");e.className="nf-module";const i=document.createElement("div");i.className="nf-mod-header",i.innerHTML=`
    ...
    `,e.appendChild(i),t.steps.forEach(r=>{const p=document.createElement("div");p.className="nf-step",p.id=`nf-step-${r.id}`;let c="";r.progress!==void 0&&(c=`
        ...
        `,e.appendChild(p)});const o=document.createElement("div");return o.className="nf-mod-progress",o.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(o),e}function _t(){je=Date.now(),Ce=setInterval(()=>{const t=Math.floor((Date.now()-je)/1e3),e=String(Math.floor(t/60)).padStart(2,"0"),i=String(t%60).padStart(2,"0"),o=document.getElementById("nf-timer");o&&(o.textContent=`${e}:${i}`);const r=document.getElementById("nf-stat-elapsed");r&&(r.textContent=`${e}:${i}`)},1e3)}function Ze(){Ce&&(clearInterval(Ce),Ce=null)}const St=120,et=160,tt=.4;let pe=null,nt=0,ot=0,it=0,ve=[];function Pt(t,e){ve=[];for(let i=0;i<St;i++){const o=Math.random();let r;o<.22?r=0:o<.4?r=1:o<.55?r=2:o<.68?r=3:o<.84?r=4:r=5;const p=Math.random()*t,c=Math.random()*e,s=50+Math.random()*220,l=Math.random()*Math.PI*2,d=(.003+Math.random()*.008)*(Math.random()>.5?1:-1);ve.push({x:r===0?Math.random()*t:p+Math.cos(l)*s,y:r===0?Math.random()*e:c+Math.sin(l)*s,vx:(Math.random()-.5)*tt,vy:(Math.random()-.5)*tt,radius:1.2+Math.random()*2.5,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03,motion:r,oCx:p,oCy:c,oRadius:s,oAngle:l,oSpeed:d})}}function It(){if(!ae)return;const t=ae;if(be=t.getContext("2d"),!be)return;const e=()=>{t.width=window.innerWidth,t.height=window.innerHeight,ve.length===0&&Pt(t.width,t.height)};e(),window.addEventListener("resize",e);let i=null,o=0,r=0,p=!1;function c(){if(!be||!ae){we=null;return}if(we=requestAnimationFrame(c),p=!p,p)return;const s=be,l=ae.width,d=ae.height;s.fillStyle=`rgba(${ne*.04|0},${oe*.04|0},${ie*.06|0},1)`,s.fillRect(0,0,l,d),(!i||o!==l||r!==d)&&(o=l,r=d,i=s.createRadialGradient(l*.5,d*.5,0,l*.5,d*.5,Math.max(l,d)*.6),i.addColorStop(0,`rgba(${ne*.08|0},${oe*.08|0},${ie*.1|0},0.4)`),i.addColorStop(1,"rgba(0,0,0,0)")),s.fillStyle=i,s.fillRect(0,0,l,d);const g=ve,b=g.length,I=et*et;for(let w=0;w<b;w++){const a=g[w];if(a.pulsePhase+=a.pulseSpeed,a.motion===0)a.x+=a.vx,a.y+=a.vy,a.x<0?(a.x=0,a.vx=Math.abs(a.vx)*(.8+Math.random()*.4)):a.x>l&&(a.x=l,a.vx=-Math.abs(a.vx)*(.8+Math.random()*.4)),a.y<0?(a.y=0,a.vy=Math.abs(a.vy)*(.8+Math.random()*.4)):a.y>d&&(a.y=d,a.vy=-Math.abs(a.vy)*(.8+Math.random()*.4));else if(a.motion===1)a.oAngle+=a.oSpeed,a.x=a.oCx+Math.cos(a.oAngle)*a.oRadius,a.y=a.oCy+Math.sin(a.oAngle)*a.oRadius,a.oCx+=Math.sin(a.oAngle*.3)*.15,a.oCy+=Math.cos(a.oAngle*.3)*.15;else if(a.motion===2)a.oAngle+=a.oSpeed,a.x=a.oCx+Math.cos(a.oAngle)*a.oRadius,a.y=a.oCy+Math.sin(a.oAngle)*a.oRadius*.5,a.oCx+=Math.sin(a.oAngle*.2)*.1,a.oCy+=Math.cos(a.oAngle*.2)*.1;else if(a.motion===3){a.oAngle+=a.oSpeed;const C=a.oAngle,F=a.oRadius*.7;a.x=a.oCx+F*Math.cos(C),a.y=a.oCy+F*Math.sin(C)*Math.cos(C),a.oCx+=Math.sin(C*.15)*.12,a.oCy+=Math.cos(C*.15)*.12}else if(a.motion===4){a.oAngle+=a.oSpeed*1.2;const C=a.oRadius*(.5+.5*Math.abs(Math.sin(a.oAngle*.15)));a.x=a.oCx+Math.cos(a.oAngle)*C,a.y=a.oCy+Math.sin(a.oAngle)*C,a.oCx+=Math.sin(a.oAngle*.1)*.18,a.oCy+=Math.cos(a.oAngle*.1)*.18}else a.oAngle+=a.oSpeed,a.x+=a.vx*.8,a.y=a.oCy+Math.sin(a.oAngle+a.x*.008)*a.oRadius*.35,a.x<-30?a.x=l+30:a.x>l+30&&(a.x=-30),a.oCy+=Math.sin(a.oAngle*.1)*.08;if(a.motion>0){const C=a.oRadius+50;a.oCx<-C?a.oCx=l+C:a.oCx>l+C&&(a.oCx=-C),a.oCy<-C?a.oCy=d+C:a.oCy>d+C&&(a.oCy=-C)}}s.beginPath(),s.strokeStyle=`rgba(${ne},${oe},${ie},0.06)`,s.lineWidth=.4;const k=new Path2D;for(let w=0;w<b;w++){const a=g[w];for(let C=w+1;C<b;C++){const F=g[C],D=a.x-F.x,B=a.y-F.y,V=D*D+B*B;V<I&&(1-V/I<.4?(s.moveTo(a.x,a.y),s.lineTo(F.x,F.y)):(k.moveTo(a.x,a.y),k.lineTo(F.x,F.y)))}}if(s.stroke(),s.strokeStyle=`rgba(${ne},${oe},${ie},0.18)`,s.lineWidth=.8,s.stroke(k),!pe||nt!==ne||ot!==oe||it!==ie){pe=document.createElement("canvas");const w=48;pe.width=w,pe.height=w;const a=pe.getContext("2d"),C=a.createRadialGradient(w/2,w/2,0,w/2,w/2,w/2);C.addColorStop(0,`rgba(${ne},${oe},${ie},0.9)`),C.addColorStop(.3,`rgba(${ne},${oe},${ie},0.35)`),C.addColorStop(1,`rgba(${ne},${oe},${ie},0)`),a.fillStyle=C,a.fillRect(0,0,w,w),nt=ne,ot=oe,it=ie}const $=pe;for(let w=0;w<b;w++){const a=g[w],C=.6+.4*Math.sin(a.pulsePhase),F=a.radius*5*(.8+C*.4);s.globalAlpha=.5+C*.4,s.drawImage($,a.x-F/2,a.y-F/2,F,F)}s.globalAlpha=1,s.fillStyle="rgba(255,255,255,0.45)",s.beginPath();for(let w=0;w<b;w++){const a=g[w];if(a.radius>2){const C=.6+.4*Math.sin(a.pulsePhase),F=a.radius*(.8+C*.4)*.35;s.moveTo(a.x+F,a.y),s.arc(a.x,a.y,F,0,Math.PI*2)}}s.fill()}c()}function Tt(){we!==null&&(cancelAnimationFrame(we),we=null),ae=null,be=null,ve=[]}let ye=null;const _e=560,At=140,at=_e/2,rt=At/2,st=[];for(let t=0;t<=_e;t+=8){const e=Math.abs(t-at)/at;st.push(Math.pow(Math.min(1,e*1.6),.6))}const Rt=[0,1,2,3].map(t=>({amp:10+t*5,freq:(1.2+t*.35)*Math.PI*2/_e,off:t*.6,spd:.7+t*.12}));let Be=!1;function lt(){if(he=requestAnimationFrame(lt),Be=!Be,Be)return;if(Ae+=.07,!ye){const e=document.getElementById("nf-engine-waves");if(!e){he=null;return}ye=Array.from(e.querySelectorAll("path"))}const t=[];for(let e=0;e<ye.length;e++){const i=Rt[e],o=Ae*i.spd+i.off;t.length=0,t.push(`M 0 ${rt}`);let r=0;for(let p=0;p<=_e;p+=8){const c=rt+i.amp*st[r++]*Math.sin(p*i.freq+o);t.push(`L${p} ${c*10+.5|0}`)}ye[e].setAttribute("d",t.join(" "))}}function Bt(){Ae=0,lt(),It(),Me=setInterval(()=>{const t=document.getElementById("nf-stat-freq"),e=document.getElementById("nf-stat-lat1"),i=document.getElementById("nf-stat-lat2"),o=document.getElementById("nf-stat-buf");t&&(t.textContent=`${(4.5+Math.random()*.5).toFixed(1)} GHz`),e&&(e.textContent=`${Math.floor(12+Math.random()*10)}ms`),i&&(i.textContent=`${Math.floor(12+Math.random()*10)}ms`),o&&(o.textContent=`${Math.floor(90+Math.random()*9)}%`)},2e3)}function ct(){he!==null&&(cancelAnimationFrame(he),he=null),Me&&(clearInterval(Me),Me=null),ye=null,Tt()}function De(){let t=0;const e=Y.filter(d=>d.status!=="skipped").length;for(const d of Y){const g=document.getElementById(`nf-proc-${d.stepId}`);if(!g)continue;g.className="nf-proc-row";const b=g.querySelector(".nf-proc-badge");switch(d.status){case"done":g.classList.add("nf-proc-done"),b&&(b.textContent="✅ done"),t++;break;case"active":g.classList.add("nf-proc-active"),b&&(b.textContent=d.progress!==void 0&&d.progress>0?`⏳ ${d.progress}%`:"⏳ active");break;case"error":g.classList.add("nf-proc-error"),b&&(b.textContent="❌ error");break;case"skipped":g.classList.add("nf-proc-skipped"),b&&(b.textContent="— skip");break;default:g.classList.add("nf-proc-waiting"),b&&(b.textContent="(queued)")}}const i=Y.findIndex(d=>d.status==="active"),o=i>=0?i+1:t>=e&&e>0?Y.length:t,r=document.getElementById("nf-step-counter");r&&(r.textContent=`${o}/${Y.length}`);const p=document.querySelector(".nf-core-title-val"),c=document.querySelector(".nf-status-dot");t>=e&&e>0?(p&&(p.textContent="COMPLETE",p.style.color=J.doneHex),c&&(c.style.background=J.doneHex,c.style.boxShadow=`0 0 8px rgba(${J.doneRgb},0.7)`)):Y.some(g=>g.status==="error")?(p&&(p.textContent="ERROR",p.style.color="#f87171"),c&&(c.style.background="#ef4444",c.style.boxShadow="0 0 8px rgba(239,68,68,0.7)")):Y.some(g=>g.status==="active")&&p&&(p.textContent="ACTIVE",p.style.color=J.hex,p.style.textShadow=`0 0 10px rgba(${J.rgb},0.5)`);const s=document.getElementById("nf-terminal"),l=s==null?void 0:s.querySelector(".nf-proc-active");l&&s&&l.scrollIntoView({behavior:"smooth",block:"center"})}function dt(){Q&&Q.isConnected||(Ke(),Q=document.createElement("button"),Q.id="nf-toggle-btn",Q.className="nf-toggle-visible",Q.innerHTML=le?Ye:Xe,Q.title="ซ่อน/แสดง Netflow Overlay",Q.onclick=()=>Ne(),document.body.appendChild(Q))}function Ne(){X&&(dt(),le?(X.classList.remove("nf-hidden"),X.classList.add("nf-visible"),Q&&(Q.innerHTML=Xe),le=!1):(X.classList.remove("nf-visible"),X.classList.add("nf-hidden"),Q&&(Q.innerHTML=Ye),le=!0))}const pt={red:"themes/theme-red.jpg",yellow:"themes/theme-yellow.jpg",blue:"themes/theme-blue.jpg",purple:"themes/theme-purple.jpg",green:"themes/theme-green.jpg"};function ft(){const t=document.getElementById("nf-core-monitor");if(!t)return;let e=me;if(!e)try{e=localStorage.getItem("netflow_app_theme")||"green"}catch{e="green"}const i=pt[e]||pt.green;let o;try{o=chrome.runtime.getURL(i)}catch{o=`/${i}`}const r=J.rgb;t.style.backgroundImage=["linear-gradient(180deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 45%, rgba(0,0,0,0.90) 100%)",`linear-gradient(180deg, rgba(${r},0.25) 0%, rgba(${r},0.12) 50%, rgba(${r},0.20) 100%)`,`url('${o}')`].join(", "),t.style.backgroundSize="auto, auto, 50%",t.style.backgroundPosition="center, center, center",t.style.backgroundRepeat="no-repeat, no-repeat, no-repeat",t.style.setProperty("--nf-bg-set","1"),t.style.border=`1.5px solid rgba(${r},0.45)`,t.style.boxShadow=`0 0 70px rgba(${r},0.22), 0 0 140px rgba(${r},0.1), inset 0 1px 0 rgba(${r},0.15)`}function ze(t=1){if(J=$t(),Ue(),X&&X.isConnected){le&&Ne();return}if(X&&!X.isConnected&&(X=null),se&&(se.remove(),se=null),Ke(),xe=t,Y=Re(t),t>1){const e=ce.find(o=>o.id==="video");if(e){const o=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:"waiting",progress:0}];for(let r=2;r<=t;r++)o.push({id:`scene${r}-prompt`,label:`Scene ${r} Prompt`,status:"waiting"}),o.push({id:`scene${r}-gen`,label:`Scene ${r} Generate`,status:"waiting"}),o.push({id:`scene${r}-wait`,label:`Scene ${r} รอผล`,status:"waiting",progress:0});e.steps=o}const i=ce.find(o=>o.id==="render");if(i){const o=i.steps.find(p=>p.id==="download");o&&(o.label="ดาวน์โหลด 720p");const r=i.steps.find(p=>p.id==="upscale");r&&(r.label="Full Video")}}X=Ct(),document.body.appendChild(X),le=!1,dt(),_t(),Bt(),requestAnimationFrame(()=>ft())}function ut(){Ze(),ct(),le=!1,X&&(X.classList.add("nf-fade-out"),setTimeout(()=>{X==null||X.remove(),X=null},500)),Q&&(Q.remove(),Q=null)}const Dt={settings:"CONFIG","upload-char":"UPLOAD","upload-prod":"UPLOAD","img-prompt":"PROMPT","img-generate":"GENERATE","img-wait":"IMG WAIT",animate:"ANIMATE","vid-prompt":"VID PROMPT","vid-generate":"VID GEN","vid-wait":"VID WAIT",download:"DOWNLOAD",upscale:"UPSCALE",open:"OPENING"};function Nt(t,e,i){const o=Y.findIndex(g=>g.status==="active"),r=Y.filter(g=>g.status==="done").length,p=Y.length,c=o>=0?o+1:r>=p?p:r,s=document.getElementById("nf-stat-step");s&&(s.textContent=`${c}/${p}`);let l=1;for(const g of Y)if(g.status==="active"||g.status==="done")if(g.stepId.startsWith("scene")){const b=g.stepId.match(/^scene(\d+)-/);b&&(l=Math.max(l,parseInt(b[1],10)))}else(g.stepId==="download"||g.stepId==="upscale"||g.stepId==="open")&&(l=xe);const d=document.getElementById("nf-stat-scenes");if(d&&(d.textContent=xe>1?`${l}/${xe}`:"1/1"),e==="active"){const g=document.getElementById("nf-stat-status"),b=Dt[t]||t.toUpperCase();g&&(g.textContent=b)}else if(e==="done"&&r>=p){const g=document.getElementById("nf-stat-status");g&&(g.textContent="COMPLETE")}else if(e==="error"){const g=document.getElementById("nf-stat-status");g&&(g.textContent="ERROR")}if(i!==void 0&&i>0){const g=document.getElementById("nf-stat-progress");g&&(g.textContent=`${Math.min(100,i)}%`)}}function S(t,e,i){if(!X)return;for(const r of ce)for(const p of r.steps)p.id===t&&(p.status=e,i!==void 0&&(p.progress=i));for(const r of Y)r.stepId===t&&(r.status=e,i!==void 0&&(r.progress=i));const o=document.getElementById(`nf-step-${t}`);if(o&&(o.className="nf-step",e==="active"?o.classList.add("nf-step-active"):e==="done"?o.classList.add("nf-step-done"):e==="error"&&o.classList.add("nf-step-error")),Nt(t,e,i),i!==void 0){const r=document.getElementById(`nf-bar-${t}`);r&&(r.style.width=`${Math.min(100,i)}%`)}Fe(),De()}function fe(t){S(t,"skipped");const e=document.getElementById(`nf-step-${t}`);e&&(e.style.opacity="0.2")}function $e(t=4e3){Ze(),ct(),Fe(),De(),setTimeout(()=>ut(),t)}function Fe(){for(const t of ce){const e=t.steps.filter(l=>l.status!=="skipped").length,i=t.steps.filter(l=>l.status==="done").length,o=t.steps.some(l=>l.status==="active"),r=e>0?Math.round(i/e*100):0,p=document.getElementById(`nf-pct-${t.id}`);p&&(p.textContent=`${r}%`);const c=document.getElementById(`nf-modbar-${t.id}`);c&&(c.style.width=`${r}%`);const s=document.getElementById(`nf-mod-${t.id}`);s&&(s.classList.remove("nf-active","nf-done"),r>=100?s.classList.add("nf-done"):o&&s.classList.add("nf-active"))}}function zt(t){var o,r,p,c;xe=t;const e=new Map;for(const s of Y)e.set(s.stepId,{status:s.status,progress:s.progress});Y=Re(t);for(const s of Y){const l=e.get(s.stepId);l&&(s.status=l.status,l.progress!==void 0&&(s.progress=l.progress))}if(kt(),t>1){const s=ce.find(l=>l.id==="video");if(s){const l=[{id:"animate",label:"สลับเป็นโหมดวิดีโอ",status:((o=s.steps.find(d=>d.id==="animate"))==null?void 0:o.status)||"waiting"},{id:"vid-prompt",label:"Scene 1 Prompt",status:((r=s.steps.find(d=>d.id==="vid-prompt"))==null?void 0:r.status)||"waiting"},{id:"vid-generate",label:"Scene 1 Generate",status:((p=s.steps.find(d=>d.id==="vid-generate"))==null?void 0:p.status)||"waiting"},{id:"vid-wait",label:"Scene 1 รอผล",status:((c=s.steps.find(d=>d.id==="vid-wait"))==null?void 0:c.status)||"waiting",progress:0}];for(let d=2;d<=t;d++)l.push({id:`scene${d}-prompt`,label:`Scene ${d} Prompt`,status:"waiting"}),l.push({id:`scene${d}-gen`,label:`Scene ${d} Generate`,status:"waiting"}),l.push({id:`scene${d}-wait`,label:`Scene ${d} รอผล`,status:"waiting",progress:0});s.steps=l,gt(s)}}const i=ce.find(s=>s.id==="render");if(i&&t>1){const s=i.steps.find(d=>d.id==="download");s&&(s.label="ดาวน์โหลด 720p");const l=i.steps.find(d=>d.id==="upscale");l&&(l.label="Full Video"),gt(i)}Fe(),De()}function gt(t){const e=document.getElementById(`nf-mod-${t.id}`);if(!e)return;e.querySelectorAll(".nf-step, .nf-mod-progress").forEach(r=>r.remove()),t.steps.forEach(r=>{const p=document.createElement("div");p.className="nf-step",p.id=`nf-step-${r.id}`;let c="";r.progress!==void 0&&(c=`
            ...
            <span class="nf-step-label">${r.label}</span>
            ${c}
        `,e.appendChild(p)});const o=document.createElement("div");o.className="nf-mod-progress",o.innerHTML=`<div class="nf-mod-progress-fill" id="nf-modbar-${t.id}"></div>`,e.appendChild(o)}function Se(t){t.replace(/^\[Netflow AI\]\s*/,"")}const n=t=>{console.log(`[Netflow AI] ${t}`);try{Se(t)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"info",msg:t})}catch{}},A=t=>{console.warn(`[Netflow AI] ${t}`);try{Se(`⚠️ ${t}`)}catch{}try{chrome.runtime.sendMessage({action:"FLOW_LOG",level:"warn",msg:`⚠️ ${t}`})}catch{}};function Oe(t=3e3){n(`🔒 จะปิดแท็บ automation ใน ${t/1e3} วินาที...`),setTimeout(()=>{try{chrome.runtime.sendMessage({action:"CLOSE_AUTOMATION_TAB"},e=>{chrome.runtime.lastError?A(`ปิดแท็บไม่ได้: ${chrome.runtime.lastError.message}`):n(`✅ ปิดแท็บแล้ว: ${e==null?void 0:e.message}`)})}catch(e){A(`ปิดแท็บผิดพลาด: ${e.message}`)}},t)}async function mt(){try{const t=document.querySelectorAll("video");let e=null;for(const i of t)if(i.src&&i.src.startsWith("http")&&i.getBoundingClientRect().width>100){e=i.src;break}if(!e){for(const i of t)if(i.src&&i.getBoundingClientRect().width>50){e=i.src;break}}if(!e)return n("[TikTok] ไม่พบ video URL บนหน้า"),null;if(n(`[TikTok] พบ video URL: ${e.substring(0,80)}...`),e.startsWith("https://"))try{await new Promise(i=>{chrome.runtime.sendMessage({type:"PRE_FETCH_VIDEO",url:e},o=>{chrome.runtime.lastError?n(`[TikTok] PRE_FETCH_VIDEO error: ${chrome.runtime.lastError.message}`):o!=null&&o.success?n(`[TikTok] Video pre-fetched: ${((o.size||0)/1024/1024).toFixed(1)} MB`):n(`[TikTok] PRE_FETCH_VIDEO failed: ${o==null?void 0:o.error}`),i()})})}catch{}return e}catch(t){return n(`[TikTok] captureVideoUrl error: ${t.message}`),null}}function Le(t){if(t)try{chrome.runtime.sendMessage({type:"VIDEO_GENERATION_COMPLETE",videoUrl:t,source:"veo"}),n("[TikTok] Sent VIDEO_GENERATION_COMPLETE (source=veo)")}catch{}}const Ge=/Mac|iPhone|iPad|iPod/i.test(navigator.userAgent),qe=/Win/i.test(navigator.userAgent),ue=Ge?"🍎 Mac":qe?"🪟 Win":"🐧 Other";n(`สคริปต์โหลดบนหน้า Google Flow แล้ว ${ue}`);class Ve extends Error{constructor(){super("AUTOMATION_STOPPED"),this.name="NetflowAbortError"}}const m=t=>new Promise((e,i)=>{if(window.__NETFLOW_STOP__)return i(new Ve);const o=setTimeout(()=>{if(window.__NETFLOW_STOP__)return i(new Ve);e()},t);m._lastId=o});function de(){return!!window.__NETFLOW_STOP__}function ht(){var r;const t=["couldn't generate","could not generate","failed to generate","generation failed","ไม่สามารถสร้าง","สร้างไม่สำเร็จ","try again later","ลองอีกครั้งภายหลัง","ลองใหม่อีกครั้ง","something went wrong","เกิดข้อผิดพลาด","safety filter","policy violation","content policy","unable to generate","ไม่สามารถสร้างวิดีโอ","couldn't generate video","couldn't generate image"],e=(document.body.textContent||"").toLowerCase();if(!t.some(p=>e.includes(p)))return null;const o=document.querySelectorAll("span, p, h1, h2, h3, li");for(const p of o){if(p.closest("#netflow-engine-overlay"))continue;const c=(p.textContent||"").trim().toLowerCase();if(!(c.length>200||c.length<5)){for(const s of t)if(c.includes(s))return((r=p.textContent)==null?void 0:r.trim())||s}}return null}async function ee(t){const e=t.getBoundingClientRect(),i=e.left+e.width/2,o=e.top+e.height/2,r={bubbles:!0,cancelable:!0,clientX:i,clientY:o,button:0};t.dispatchEvent(new PointerEvent("pointerdown",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousedown",r)),await m(80),t.dispatchEvent(new PointerEvent("pointerup",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseup",r)),t.dispatchEvent(new MouseEvent("click",r)),await m(50),t.click()}function Ft(t){const e=t.getBoundingClientRect(),i=e.left+e.width/2,o=e.top+e.height/2,r={bubbles:!0,cancelable:!0,clientX:i,clientY:o};t.dispatchEvent(new PointerEvent("pointerenter",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseenter",r)),t.dispatchEvent(new PointerEvent("pointerover",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mouseover",r)),t.dispatchEvent(new PointerEvent("pointermove",{...r,pointerId:1,isPrimary:!0,pointerType:"mouse"})),t.dispatchEvent(new MouseEvent("mousemove",r))}function Ot(t){const e=[],i=document.querySelectorAll("i");for(const o of i){if((o.textContent||"").trim()!==t)continue;let p=o,c=null,s=1/0;for(let l=0;l<20&&p&&(p=p.parentElement,!(!p||p===document.body));l++){const d=p.getBoundingClientRect();if(d.width>100&&d.height>80&&d.width<window.innerWidth*.6&&d.top>=-10&&d.bottom<=window.innerHeight+10){const g=d.width*d.height;g<s&&(c=p,s=g)}}c&&!e.includes(c)&&e.push(c)}return e.sort((o,r)=>{const p=o.getBoundingClientRect(),c=r.getBoundingClientRect();return p.left-c.left}),e}function He(t=!1){const e=[],i=document.querySelectorAll("video");for(const c of i){let s=c.parentElement;for(let l=0;l<10&&s;l++){const d=s.getBoundingClientRect();if(d.width>120&&d.height>80&&d.width<window.innerWidth*.7&&d.top>=-50&&d.left<window.innerWidth*.75){e.push({el:s,left:d.left});break}s=s.parentElement}}const o=document.querySelectorAll("i, span.material-symbols-outlined, span.google-symbols, .google-symbols");for(const c of o){const s=(c.textContent||"").trim();if(s==="play_arrow"||s==="play_circle"||s==="videocam"){let l=c.parentElement;for(let d=0;d<10&&l;d++){const g=l.getBoundingClientRect();if(g.width>120&&g.height>80&&g.width<window.innerWidth*.7&&g.top>=-50&&g.left<window.innerWidth*.75){e.push({el:l,left:g.left});break}l=l.parentElement}}}const r=document.querySelectorAll("img");for(const c of r){const s=(c.alt||"").toLowerCase();if(s.includes("video")||s.includes("วิดีโอ")){let l=c.parentElement;for(let d=0;d<10&&l;d++){const g=l.getBoundingClientRect();if(g.width>120&&g.height>80&&g.width<window.innerWidth*.7&&g.top>=-50&&g.left<window.innerWidth*.75){e.push({el:l,left:g.left});break}l=l.parentElement}}}const p=Array.from(new Set(e.map(c=>c.el))).map(c=>e.find(s=>s.el===c));if(p.sort((c,s)=>c.left-s.left),p.length>0){const c=p[0].el,s=c.getBoundingClientRect();return t||n(`🎬 พบการ์ดวิดีโอที่ (${s.left.toFixed(0)},${s.top.toFixed(0)}) ขนาด ${s.width.toFixed(0)}x${s.height.toFixed(0)}`),c}return t||n("🎬 ไม่พบการ์ดวิดีโอ"),null}function Lt(){const t=Ot("image");if(t.length>0){const i=t[0].getBoundingClientRect();return n(`🖼️ พบการ์ดรูปภาพ ${t.length} ใบ — ใบแรกที่ (${i.left.toFixed(0)},${i.top.toFixed(0)}) ขนาด ${i.width.toFixed(0)}x${i.height.toFixed(0)}`),t[0]}const e=document.querySelectorAll("canvas");for(const i of e){let o=i.parentElement;for(let r=0;r<10&&o;r++){const p=o.getBoundingClientRect();if(p.width>100&&p.height>80&&p.width<window.innerWidth*.6)return n(`🖼️ พบการ์ดรูปภาพจาก <canvas> สำรองที่ (${p.left.toFixed(0)},${p.top.toFixed(0)})`),o;o=o.parentElement}}return n("🖼️ ไม่พบการ์ดรูปภาพ"),null}function Gt(t,e){var s;const[i,o]=t.split(","),r=((s=i.match(/:(.*?);/))==null?void 0:s[1])||"image/png",p=atob(o),c=new Uint8Array(p.length);for(let l=0;l<p.length;l++)c[l]=p.charCodeAt(l);return new File([c],e,{type:r})}function Ee(t){var o;const e=[],i=document.querySelectorAll("i.google-symbols, i[class*='google-symbols'], .material-symbols-outlined, .material-icons");for(const r of i)if(((o=r.textContent)==null?void 0:o.trim())===t){const p=r.closest("button");p&&e.push(p)}return e}function qt(){const t=[...Ee("add"),...Ee("add_2")];if(t.length===0){n("ไม่พบปุ่มเพิ่มจากไอคอน — ลองค้นหาจากข้อความ");const o=document.querySelectorAll("button");for(const r of o){const p=r.getBoundingClientRect();if(p.bottom>window.innerHeight*.7&&p.width<60&&p.height<60){const c=(r.textContent||"").trim();if(c==="+"||c==="add")return r}}return null}let e=null,i=0;for(const o of t){const r=o.getBoundingClientRect();r.y>i&&(i=r.y,e=o)}return e&&n(`พบปุ่ม "+" ของ Prompt Bar ที่ y=${i.toFixed(0)}`),e}function bt(){for(const o of["arrow_forward","send","arrow_upward","navigate_next","arrow_right"]){const r=Ee(o);let p=null,c=0;for(const s of r){const l=s.getBoundingClientRect();l.y>c&&(c=l.y,p=s)}if(p)return n(`พบปุ่ม Generate จากไอคอน "${o}" ที่ y=${c.toFixed(0)}`),p}const t=document.querySelectorAll("button");let e=null,i=0;for(const o of t){const r=o.getBoundingClientRect();if(r.bottom>window.innerHeight*.7&&r.right>window.innerWidth*.5){const p=Math.abs(r.width-r.height)<10&&r.width<60,c=r.y+r.x+(p?1e3:0);c>i&&(i=c,e=o)}}if(e)return n("พบปุ่ม Generate จากตำแหน่งขวาล่าง"),e;for(const o of t){const r=(o.getAttribute("aria-label")||"").toLowerCase();if(r.includes("generate")||r.includes("submit")||r.includes("send")||r.includes("สร้าง"))return o}return null}function wt(){const t=document.querySelectorAll("textarea");for(const o of t)if(o.getBoundingClientRect().bottom>window.innerHeight*.5)return o;const e=document.querySelectorAll('[contenteditable="true"]');for(const o of e)if(o.getBoundingClientRect().bottom>window.innerHeight*.5)return o;const i=document.querySelectorAll("input[type='text'], input:not([type])");for(const o of i){const r=o.placeholder||"";if(r.includes("สร้าง")||r.includes("prompt")||r.includes("describe"))return o}return t.length>0?t[t.length-1]:null}async function Pe(t,e){var i,o,r,p;t.focus(),await m(300),n("วางข้อความ: วิธี 1 — Slate beforeinput insertFromPaste");try{const c=new DataTransfer;c.setData("text/plain",e),c.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const s=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertFromPaste",dataTransfer:c});t.dispatchEvent(s),n("วางข้อความ: ส่ง beforeinput insertFromPaste แล้ว");const l=new InputEvent("input",{bubbles:!0,inputType:"insertFromPaste",dataTransfer:c});t.dispatchEvent(l),await m(800);const d=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(d.length>20){n(`วางข้อความ: ✅ วิธี 1 สำเร็จ (${d.length} ตัวอักษร)`);return}n(`วางข้อความ: วิธี 1 — ไม่พบข้อความ (ได้ ${d.length} ตัวอักษร)`)}catch(c){n(`วางข้อความ: วิธี 1 ล้มเหลว: ${c.message}`)}n("วางข้อความ: วิธี 2 — Slate beforeinput insertText");try{t.focus(),await m(100);const c=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,inputType:"insertText",data:e});t.dispatchEvent(c);const s=new InputEvent("input",{bubbles:!0,inputType:"insertText",data:e});t.dispatchEvent(s),await m(800);const l=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(l.length>20){n(`วางข้อความ: ✅ วิธี 2 สำเร็จ (${l.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 2 — ไม่พบข้อความ")}catch(c){n(`วางข้อความ: วิธี 2 ล้มเหลว: ${c.message}`)}n("วางข้อความ: วิธี 3 — ClipboardEvent paste");try{t.focus(),await m(200);const c=new DataTransfer;c.setData("text/plain",e),c.setData("text/html",`<p>${e.replace(/\n/g,"<br>")}</p>`);const s=new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:c});t.dispatchEvent(s),await m(800);const l=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(l.length>20){n(`วางข้อความ: ✅ วิธี 3 สำเร็จ (${l.length} ตัวอักษร)`);return}n("วางข้อความ: วิธี 3 — ไม่พบข้อความ")}catch(c){n(`วางข้อความ: วิธี 3 ล้มเหลว: ${c.message}`)}n("วางข้อความ: วิธี 4 — navigator.clipboard + execCommand paste");try{if((i=navigator.clipboard)!=null&&i.writeText)await navigator.clipboard.writeText(e),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน navigator.clipboard");else{const s=document.createElement("textarea");s.value=e,s.style.cssText="position:fixed;left:-9999px;top:-9999px;opacity:0",document.body.appendChild(s),s.focus(),s.select(),document.execCommand("copy"),document.body.removeChild(s),n("วางข้อความ: คัดลอกไปคลิปบอร์ดผ่าน execCommand")}t.focus(),await m(200),document.execCommand("paste"),await m(500);const c=(t.textContent||"").replace(/คุณต้องการสร้างอะไร|What do you want to create/gi,"").trim();if(c.length>20){n(`วางข้อความ: ✅ วิธี 4 สำเร็จ (${c.length} ตัวอักษร)`);return}}catch(c){n(`วางข้อความ: วิธี 4 ล้มเหลว: ${c.message}`)}n("วางข้อความ: วิธี 5 — React fiber Slate editor");try{const c=Object.keys(t).find(s=>s.startsWith("__reactFiber$")||s.startsWith("__reactInternalInstance$"));if(c){let s=t[c];for(let l=0;l<30&&s;l++){const d=s.memoizedProps,g=s.memoizedState;if((o=d==null?void 0:d.editor)!=null&&o.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber props");const b=d.editor;b.selection,b.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน editor.insertText");return}if((p=(r=g==null?void 0:g.memoizedState)==null?void 0:r.editor)!=null&&p.insertText){n("วางข้อความ: พบ Slate editor ผ่าน fiber state"),g.memoizedState.editor.insertText(e),n("วางข้อความ: ✅ วิธี 5 — แทรกผ่าน state editor");return}s=s.return}n("วางข้อความ: พบ Fiber แต่ไม่พบ Slate editor ใน tree")}else n("วางข้อความ: ไม่พบ React fiber บน element")}catch(c){n(`วางข้อความ: วิธี 5 ล้มเหลว: ${c.message}`)}n("วางข้อความ: ⚠️ ลองครบทั้ง 5 วิธีแล้ว — ตรวจสอบผลใน Console")}function Vt(){const t=[],e=document.querySelectorAll('input[type="file"]');for(const i of e)t.push({input:i,origType:"file"}),i.type="text";return t.length>0&&n(`ปิดกั้น file input ${t.length} ตัว (type → text)`),t}function Ht(){const t=HTMLInputElement.prototype.click;return HTMLInputElement.prototype.click=function(){if(this.type==="file"){n(`🚫 บล็อกการเปิด file dialog (${ue})`);return}return t.call(this)},n(`🔒 ติดตั้งตัวบล็อก file dialog แล้ว (${ue})`),()=>{HTMLInputElement.prototype.click=t,n("🔓 ถอดตัวบล็อก file dialog แล้ว")}}function Wt(t,e,i){var d;const o=document.querySelectorAll('input[type="text"][style*="display: none"], input[type="text"][hidden], input[type="text"]'),r=[...t.map(g=>g.input)];for(const g of o)!r.includes(g)&&g.offsetParent===null&&r.push(g);for(const g of r)g.type="file";n(`คืนค่า input ${r.length} ตัวเป็น type=file`);const p=document.querySelectorAll('input[type="file"]');if(p.length===0)return n(`⚠️ ไม่พบ file input หลังคืนค่า (${ue})`),!1;let c;if(i&&i.size>0){const g=Array.from(p).filter(b=>!i.has(b));g.length>0?(c=g[g.length-1],n(`เล็งเป้า file input ใหม่ (${g.length} ใหม่, ${p.length} ทั้งหมด)`)):(c=p[p.length-1],n(`ไม่พบ file input ใหม่ — ใช้ตัวสุดท้ายจาก ${p.length} ตัว`))}else c=p[p.length-1];const s=new DataTransfer;s.items.add(e);try{c.files=s.files,n(`ฉีดไฟล์ผ่าน target.files (${((d=c.files)==null?void 0:d.length)??0} ไฟล์)`)}catch(g){n(`กำหนด target.files ล้มเหลว: ${g.message} — ลอง defineProperty`);try{Object.defineProperty(c,"files",{value:s.files,writable:!0,configurable:!0}),n("ฉีดไฟล์ผ่าน Object.defineProperty")}catch(b){return A(`การฉีดไฟล์ล้มเหลวทั้ง 2 วิธี: ${b.message}`),!1}}const l=c._valueTracker;l&&(l.setValue(""),n("รีเซ็ต React _valueTracker บน file input")),c.dispatchEvent(new Event("change",{bubbles:!0})),c.dispatchEvent(new Event("input",{bubbles:!0}));try{const g=new DataTransfer;g.items.add(e);const b=new DragEvent("drop",{bubbles:!0,cancelable:!0,dataTransfer:g});c.dispatchEvent(b),n("ส่ง drop event บน file input ด้วย")}catch{}return n(`✅ ฉีดไฟล์เสร็จ: ${e.name} (${(e.size/1024).toFixed(1)} KB) → <input> ${ue}`),!0}function ke(){let t=0;const e=document.querySelectorAll("img");for(const o of e){if(o.closest("#netflow-engine-overlay"))continue;const r=o.getBoundingClientRect();r.bottom>window.innerHeight*.6&&r.width>20&&r.width<200&&r.height>20&&r.height<200&&o.src&&o.offsetParent!==null&&t++}const i=document.querySelectorAll('[style*="background-image"], [class*="thumb"], [class*="preview"]');for(const o of i){if(o.closest("#netflow-engine-overlay"))continue;const r=o.getBoundingClientRect();r.bottom>window.innerHeight*.6&&r.width>20&&r.width<200&&r.height>20&&r.height<200&&o.offsetParent!==null&&t++}return t}async function xt(t,e){var g;n(`── กำลังอัพโหลด ${e} ไปยัง Prompt Bar ──`);const i=Gt(t,e);n(`ขนาดไฟล์: ${(i.size/1024).toFixed(1)} KB`);const o=ke();n(`รูปย่อปัจจุบันใน Prompt Bar: ${o} รูป`);const r=async(b,I=8e3)=>{const k=Date.now();for(;Date.now()-k<I;){const $=ke();if($>o)return n(`✅ [${b}] ยืนยัน: รูปย่อเพิ่มจาก ${o} → ${$}`),!0;await m(500)}return n(`⚠️ [${b}] รูปย่อไม่เพิ่ม (ยังคง ${ke()} รูป)`),!1};n("── ขั้น 1: คลิกปุ่ม '+' (สร้าง) ──");const p=qt();if(!p)return A("ไม่พบปุ่ม '+' บน Prompt Bar"),!1;const c=new Set(document.querySelectorAll('input[type="file"]'));n(`file input ที่มีอยู่เดิม: ${c.size} ตัว`);const s=Ht();let l=Vt();const d=new MutationObserver(b=>{for(const I of b)for(const k of I.addedNodes)if(k instanceof HTMLInputElement&&k.type==="file"&&(k.type="text",l.push({input:k,origType:"file"}),n("🎯 Observer ปิดกั้น file input ใหม่")),k instanceof HTMLElement){const $=k.querySelectorAll('input[type="file"]');for(const w of $)w.type="text",l.push({input:w,origType:"file"}),n("🎯 Observer ปิดกั้น file input ซ้อน")}});d.observe(document.body,{childList:!0,subtree:!0});try{p.click(),n("คลิกปุ่ม '+' (สร้าง) แล้ว ✅"),await m(1500),n("── ขั้น 2: คลิกปุ่ม 'อัปโหลดรูปภาพ' ──");let b=!1;const I=Date.now();for(;!b&&Date.now()-I<5e3;){const $=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button']");for(const w of $){if(w===p)continue;const a=w.querySelectorAll("i");for(const C of a){const F=((g=C.textContent)==null?void 0:g.trim())||"";if((F==="upload"||F==="upload_file")&&!Array.from(w.querySelectorAll("i")).map(B=>{var V;return(V=B.textContent)==null?void 0:V.trim()}).includes("drive_folder_upload")){w.click(),b=!0,n(`คลิกปุ่มอัปโหลด (ไอคอน: ${F}) ✅`);break}}if(b)break}if(!b)for(const w of $){if(w===p)continue;const a=w.childNodes.length<=5?(w.textContent||"").trim():"";if(a.length>0&&a.length<40){const C=a.toLowerCase();if(C==="upload"||C==="อัปโหลด"||C==="อัพโหลด"||C.includes("upload image")||C.includes("upload photo")||C.includes("อัปโหลดรูปภาพ")||C.includes("อัพโหลดรูปภาพ")||C.includes("from computer")||C.includes("จากคอมพิวเตอร์")){w.click(),b=!0,n(`คลิกปุ่มอัปโหลด (ข้อความ: "${a}") ✅`);break}}}b||await m(500)}return b?(await m(1e3),n("── ขั้น 3: ฉีดไฟล์ base64 เข้า file input ──"),Wt(l,i,c)?(n(`ฉีดไฟล์ ${e} เสร็จ ✅`),n("── ขั้น 4: ตรวจสอบว่ารูปอัพโหลดเสร็จ ──"),await r("FileInput",1e4)||n("⚠️ ยังไม่พบรูปย่อใหม่ — อาจกำลังอัพโหลด (%)"),!0):(A(`ฉีดไฟล์ ${e} ล้มเหลว`),!1)):(A("ไม่พบปุ่มอัปโหลดในเมนูหลังรอ 5 วินาที"),!1)}finally{d.disconnect(),s();for(const b of l)b.input.type!=="file"&&(b.input.type="file")}}async function Ut(t,e){n("=== ขั้น 0: ตั้งค่า Flow ===");const i=document.querySelectorAll("button");let o=null;for(const k of i){const $=k.textContent||"";if(($.includes("Nano Banana")||$.includes("Imagen")||$.includes("วิดีโอ")||$.includes("รูปภาพ")||$.includes("Image")||$.includes("Video"))&&k.getBoundingClientRect().bottom>window.innerHeight*.7){o=k,n(`พบปุ่มตั้งค่าจากข้อความ: "${$.substring(0,30).trim()}"`);break}}if(!o)for(const k of["crop_16_9","crop_portrait","crop_landscape","crop_3_2","crop_5_4"]){const $=Ee(k);for(const w of $)if(w.getBoundingClientRect().bottom>window.innerHeight*.7){o=w,n(`พบปุ่มตั้งค่าจากไอคอน: ${k}`);break}if(o)break}if(!o)return A("ไม่พบปุ่มตั้งค่า"),!1;const r=o.getBoundingClientRect(),p=r.left+r.width/2,c=r.top+r.height/2,s={bubbles:!0,cancelable:!0,clientX:p,clientY:c,button:0};o.dispatchEvent(new PointerEvent("pointerdown",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mousedown",s)),await m(80),o.dispatchEvent(new PointerEvent("pointerup",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mouseup",s)),o.dispatchEvent(new MouseEvent("click",s)),n("คลิกปุ่มตั้งค่าแล้ว"),await m(1500);let l=!1,d=null;const g=document.querySelectorAll('.flow_tab_slider_trigger[role="tab"]');for(const k of g){const $=k.getAttribute("aria-controls")||"",w=k.id||"";if($.toUpperCase().includes("IMAGE")||w.toUpperCase().includes("IMAGE")){d=k,n(`พบแท็บ Image ผ่าน flow_tab_slider_trigger (aria-controls: ${$})`);break}}if(!d)for(const k of document.querySelectorAll('[role="tab"]')){const $=k.id||"";if($.toUpperCase().includes("TRIGGER-IMAGE")){d=k,n(`พบแท็บ Image ผ่าน id: ${$}`);break}}if(!d)for(const k of document.querySelectorAll("button, [role='menuitem'], [role='option'], [role='tab']")){const $=(k.textContent||"").trim();if(($==="Image"||$.endsWith("Image")||$==="รูปภาพ"||$==="ภาพ")&&!$.includes("Video")&&!$.includes("วิดีโอ")){d=k,n(`พบแท็บ Image ผ่านข้อความ: "${$}"`);break}}if(d){const k=d.getAttribute("data-state")||"",$=d.getAttribute("aria-selected")||"";if(k==="active"||$==="true")l=!0,n("แท็บ Image เปิดอยู่แล้ว — ไม่ต้องคลิก");else{const w=d.getBoundingClientRect(),a={bubbles:!0,cancelable:!0,clientX:w.left+w.width/2,clientY:w.top+w.height/2,button:0};d.dispatchEvent(new PointerEvent("pointerdown",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mousedown",a)),await m(80),d.dispatchEvent(new PointerEvent("pointerup",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),d.dispatchEvent(new MouseEvent("mouseup",a)),d.dispatchEvent(new MouseEvent("click",a)),l=!0,n("✅ คลิกแท็บ Image — สลับเป็นโหมดรูปภาพแล้ว"),await m(400)}}l||n("⚠️ ไม่พบปุ่มโหมด Image — อาจอยู่ในโหมดนี้แล้ว");const b=t==="horizontal"?"แนวนอน":"แนวตั้ง";for(const k of document.querySelectorAll("button, [role='tab'], [role='option']")){const $=(k.textContent||"").trim();if($===b||$.toLowerCase()===(t==="horizontal"?"landscape":"portrait")){const w=k.getBoundingClientRect(),a={bubbles:!0,cancelable:!0,clientX:w.left+w.width/2,clientY:w.top+w.height/2,button:0};k.dispatchEvent(new PointerEvent("pointerdown",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mousedown",a)),await m(80),k.dispatchEvent(new PointerEvent("pointerup",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mouseup",a)),k.dispatchEvent(new MouseEvent("click",a)),n(`เลือกทิศทาง: ${b}`),await m(400);break}}const I=`x${e}`;for(const k of document.querySelectorAll("button, [role='tab'], [role='option']"))if((k.textContent||"").trim()===I){const w=k.getBoundingClientRect(),a={bubbles:!0,cancelable:!0,clientX:w.left+w.width/2,clientY:w.top+w.height/2,button:0};k.dispatchEvent(new PointerEvent("pointerdown",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mousedown",a)),await m(80),k.dispatchEvent(new PointerEvent("pointerup",{...a,pointerId:1,isPrimary:!0,pointerType:"mouse"})),k.dispatchEvent(new MouseEvent("mouseup",a)),k.dispatchEvent(new MouseEvent("click",a)),n(`เลือกจำนวน: ${I}`),await m(400);break}return await m(300),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(300),o.dispatchEvent(new PointerEvent("pointerdown",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mousedown",s)),await m(80),o.dispatchEvent(new PointerEvent("pointerup",{...s,pointerId:1,isPrimary:!0,pointerType:"mouse"})),o.dispatchEvent(new MouseEvent("mouseup",s)),o.dispatchEvent(new MouseEvent("click",s)),n("ปิดหน้าตั้งค่าแล้ว"),await m(600),!0}async function Yt(t){const e=t==="quality"?"Veo 3.1 - Quality":"Veo 3.1 - Fast";n(`=== เลือกคุณภาพ Veo: ${e} ===`);let i=null;const o=document.querySelectorAll("button");for(const b of o){const I=(b.textContent||"").trim();if(I.includes("Veo 3.1")&&I.includes("arrow_drop_down")){i=b,n(`พบปุ่ม Veo dropdown: "${I.substring(0,40).trim()}"`);break}}if(!i){for(const b of o)if(b.getAttribute("aria-haspopup")==="menu"){const I=(b.textContent||"").trim();if(I.includes("Veo")){i=b,n(`พบปุ่ม Veo dropdown (aria-haspopup): "${I.substring(0,40).trim()}"`);break}}}if(!i)for(const b of o){const I=(b.textContent||"").trim();if(I.includes("Veo 3.1")&&b.getBoundingClientRect().bottom>window.innerHeight*.7){i=b,n(`พบปุ่ม Veo dropdown (bottom area): "${I.substring(0,40).trim()}"`);break}}if(!i)return A("ไม่พบปุ่ม Veo quality dropdown"),!1;if((i.textContent||"").trim().includes(e))return n(`✅ Veo quality เป็น "${e}" อยู่แล้ว — ไม่ต้องเปลี่ยน`),!0;const p=i.getBoundingClientRect(),c=p.left+p.width/2,s=p.top+p.height/2,l={bubbles:!0,cancelable:!0,clientX:c,clientY:s,button:0};i.dispatchEvent(new PointerEvent("pointerdown",{...l,pointerId:1,isPrimary:!0,pointerType:"mouse"})),i.dispatchEvent(new MouseEvent("mousedown",l)),await m(80),i.dispatchEvent(new PointerEvent("pointerup",{...l,pointerId:1,isPrimary:!0,pointerType:"mouse"})),i.dispatchEvent(new MouseEvent("mouseup",l)),i.dispatchEvent(new MouseEvent("click",l)),n("คลิกเปิด Veo quality dropdown"),await m(1e3);let d=!1;const g=document.querySelectorAll("button, [role='menuitem'], [role='option']");for(const b of g){const I=b.querySelectorAll("span");for(const k of I)if((k.textContent||"").trim()===e){const w=b.getBoundingClientRect();if(w.width>0&&w.height>0){const a=w.left+w.width/2,C=w.top+w.height/2,F={bubbles:!0,cancelable:!0,clientX:a,clientY:C,button:0};b.dispatchEvent(new PointerEvent("pointerdown",{...F,pointerId:1,isPrimary:!0,pointerType:"mouse"})),b.dispatchEvent(new MouseEvent("mousedown",F)),await m(80),b.dispatchEvent(new PointerEvent("pointerup",{...F,pointerId:1,isPrimary:!0,pointerType:"mouse"})),b.dispatchEvent(new MouseEvent("mouseup",F)),b.dispatchEvent(new MouseEvent("click",F)),n(`✅ เลือก "${e}" สำเร็จ`),d=!0;break}}if(d)break;if(!d){const k=(b.textContent||"").trim();if(k.includes(e)&&!k.includes("arrow_drop_down")){const $=b.getBoundingClientRect();if($.width>0&&$.height>0){const w=$.left+$.width/2,a=$.top+$.height/2,C={bubbles:!0,cancelable:!0,clientX:w,clientY:a,button:0};b.dispatchEvent(new PointerEvent("pointerdown",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),b.dispatchEvent(new MouseEvent("mousedown",C)),await m(80),b.dispatchEvent(new PointerEvent("pointerup",{...C,pointerId:1,isPrimary:!0,pointerType:"mouse"})),b.dispatchEvent(new MouseEvent("mouseup",C)),b.dispatchEvent(new MouseEvent("click",C)),n(`✅ เลือก "${e}" สำเร็จ (fallback)`),d=!0;break}}}}return d?(await m(600),!0):(A(`ไม่พบตัวเลือก "${e}" ใน dropdown`),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(300),!1)}async function Xt(t){var F,D,B,V;try{console.clear(),console.log("%c[Netflow AI] 🚀 Automation started — console cleared","color:#00e676;font-weight:bold;font-size:14px"),sessionStorage.removeItem("netflow_last_run"),sessionStorage.setItem("netflow_last_run",new Date().toISOString())}catch{}const e=navigator.userAgent,i=e.match(/Chrome\/(\d+\.\d+\.\d+\.\d+)/),o=i?i[1]:"unknown",r=Ge?"macOS":qe?"Windows":/Linux/i.test(e)?"Linux":/CrOS/i.test(e)?"ChromeOS":"Unknown",p=Ge?((D=(F=e.match(/Mac OS X ([0-9_]+)/))==null?void 0:F[1])==null?void 0:D.replace(/_/g,"."))||"":qe&&((B=e.match(/Windows NT ([0-9.]+)/))==null?void 0:B[1])||"",c=navigator.language||"unknown",s=`${window.innerWidth}x${window.innerHeight}`;n("══════════════════════════════════════════"),n(`🖥️ ระบบ: ${r} ${p} | Chrome ${o}`),n(`🌐 ภาษา: ${c} | หน้าจอ: ${s} | แพลตฟอร์ม: ${ue}`),n("══════════════════════════════════════════");try{Te(t.theme)}catch{}try{ze()}catch(h){console.warn("Overlay show error:",h)}const l=[],d=[];try{S("settings","active");const h=t.orientation||"horizontal",f=t.outputCount||1,x=await Ut(h,f);l.push(x?"✅ Settings":"⚠️ Settings"),S("settings",x?"done":"error")}catch(h){A(`ตั้งค่าผิดพลาด: ${h.message}`),l.push("⚠️ Settings"),S("settings","error")}try{const h=t.veoQuality||"fast";await Yt(h)?(l.push(`✅ Veo ${h}`),n(`✅ Veo quality: ${h}`)):(l.push("⚠️ Veo quality"),A("ไม่สามารถเลือก Veo quality ได้ — ใช้ค่าเดิม"))}catch(h){A(`Veo quality error: ${h.message}`),l.push("⚠️ Veo quality")}n("=== ขั้น 1: อัพโหลดรูปอ้างอิง ===");const g=()=>{const h=document.querySelectorAll("span, small, label");for(const f of h){if(f.closest("#netflow-engine-overlay"))continue;const x=(f.textContent||"").trim();if(x.length>5||!/^\d{1,3}%$/.test(x))continue;if(x==="100%")return null;const E=f.getBoundingClientRect();if(E.width>0&&E.height>0&&E.width<80&&E.height<40&&E.top>window.innerHeight*.5&&E.top<window.innerHeight)return x}return null},b=async h=>{n(`รอการอัพโหลด ${h} เสร็จ...`),await m(2e3);const f=Date.now(),x=6e4;let E="",N=Date.now();const R=15e3;for(;Date.now()-f<x;){const u=g();if(u){if(u!==E)E=u,N=Date.now();else if(Date.now()-N>R){n(`✅ อัพโหลด ${h} — % ค้างที่ ${u} นาน ${R/1e3} วินาที ถือว่าเสร็จ`),await m(1e3);return}n(`กำลังอัพโหลด: ${u} — รอ...`),await m(1500)}else{n(`✅ อัพโหลด ${h} เสร็จ — ไม่พบตัวบอก %`),await m(1e3);return}}A(`⚠️ อัพโหลด ${h} หมดเวลาหลัง ${x/1e3} วินาที — ดำเนินการต่อ`)};if(t.characterImage){S("upload-char","active");try{const h=await xt(t.characterImage,"character.png");l.push(h?"✅ ตัวละคร":"⚠️ ตัวละคร"),h||d.push("character upload failed"),S("upload-char",h?"done":"error")}catch(h){A(`อัพโหลดตัวละครผิดพลาด: ${h.message}`),l.push("❌ ตัวละคร"),d.push("character upload error"),S("upload-char","error")}await b("character")}else fe("upload-char");if(t.productImage){S("upload-prod","active");try{const h=await xt(t.productImage,"product.png");l.push(h?"✅ สินค้า":"⚠️ สินค้า"),h||d.push("product upload failed"),S("upload-prod",h?"done":"error")}catch(h){A(`อัพโหลดสินค้าผิดพลาด: ${h.message}`),l.push("❌ สินค้า"),d.push("product upload error"),S("upload-prod","error")}await b("product")}else fe("upload-prod");n("ปิด dialog ที่เปิดอยู่..."),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(800),document.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",bubbles:!0})),await m(800);const I=g();I&&(n(`⚠️ อัพโหลดยังแสดง ${I} — รอเพิ่มเติม...`),await b("final")),n("อัพโหลดทั้งหมดเสร็จ — ไปต่อที่ Prompt"),await m(1e3);const k=(t.characterImage?1:0)+(t.productImage?1:0);if(k>0){let h=ke();h<k&&(n(`⏳ เห็นรูปย่อแค่ ${h}/${k} — รอ 3 วินาที...`),await m(3e3),h=ke()),h>=k?n(`✅ ยืนยันรูปย่ออ้างอิง: ${h}/${k}`):A(`⚠️ คาดว่าจะมี ${k} รูปย่อ แต่พบ ${h} — ดำเนินการต่อ`)}if(de()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนวาง Prompt"),d.push("stopped by user");try{$e(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}n("=== ขั้น 2: วาง Image Prompt ==="),S("img-prompt","active"),await m(1e3);const $=wt();$?(await Pe($,t.imagePrompt),n(`วาง Prompt แล้ว (${t.imagePrompt.length} ตัวอักษร)`),l.push("✅ Prompt"),S("img-prompt","done")):(A("ไม่พบช่องป้อนข้อความ Prompt"),l.push("❌ Prompt"),d.push("prompt input not found"),S("img-prompt","error")),await m(800);const w=new Set;document.querySelectorAll("img").forEach(h=>{h.src&&w.add(h.src)}),n(`บันทึกรูปเดิม: ${w.size} รูปก่อน Generate`),n("=== ขั้น 3: รอ 5 วินาทีก่อนคลิก Generate → ==="),S("img-generate","active"),await m(5e3);const a=bt();if(a){const h=a.getBoundingClientRect(),f=h.left+h.width/2,x=h.top+h.height/2,E={bubbles:!0,cancelable:!0,clientX:f,clientY:x,button:0};a.dispatchEvent(new PointerEvent("pointerdown",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",E)),await m(80),a.dispatchEvent(new PointerEvent("pointerup",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",E)),a.dispatchEvent(new MouseEvent("click",E)),n("ส่งชุดคลิกเต็มรูปแบบบนปุ่ม Generate แล้ว"),l.push("✅ Generate"),await m(500),a.dispatchEvent(new PointerEvent("pointerdown",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mousedown",E)),await m(80),a.dispatchEvent(new PointerEvent("pointerup",{...E,pointerId:1,isPrimary:!0,pointerType:"mouse"})),a.dispatchEvent(new MouseEvent("mouseup",E)),a.dispatchEvent(new MouseEvent("click",E)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate"),S("img-generate","done")}else A("ไม่พบปุ่ม → Generate"),l.push("❌ Generate"),d.push("generate button not found"),S("img-generate","error");n("=== ขั้น 4: รอรูปที่สร้าง + ทำเป็นวิดีโอ ==="),S("img-wait","active");try{n("รอ 15 วินาทีเพื่อเริ่มการสร้าง..."),await m(15e3);const h=()=>{const R=document.querySelectorAll("div, span, p, label, strong, small");for(const u of R){if(u.closest("#netflow-engine-overlay"))continue;const v=(u.textContent||"").trim();if(v.length>10)continue;const M=v.match(/(\d{1,3})\s*%/);if(!M)continue;const P=parseInt(M[1],10);if(P<1||P>100)continue;const y=u.getBoundingClientRect();if(!(y.width===0||y.width>150)&&!(y.top<0||y.top>window.innerHeight))return P}return null};n("ค้นหารูปที่สร้างใหม่ (ไม่ใช่รูปเดิม)...");let f=null,x=-1,E=0;const N=Date.now();for(;!f&&Date.now()-N<18e4;){const R=document.querySelectorAll("img");for(const u of R){if(w.has(u.src)||!(u.alt||"").toLowerCase().includes("generated"))continue;const M=u.getBoundingClientRect();if(M.width>120&&M.height>120&&M.top>0&&M.top<window.innerHeight*.85){const P=u.closest("div");if(P){f=P,n(`พบรูป AI จาก alt="${u.alt}": ${u.src.substring(0,80)}...`);break}}}if(!f)for(const u of R){if(w.has(u.src))continue;const v=u.closest("div"),M=(v==null?void 0:v.textContent)||"";if(M.includes("product.png")||M.includes("character.png")||M.includes(".png")||M.includes(".jpg"))continue;const P=u.getBoundingClientRect();if(P.width>120&&P.height>120&&P.top>0&&P.top<window.innerHeight*.85){const y=u.closest("div");if(y){f=y,n(`พบรูปใหม่ (สำรอง): ${u.src.substring(0,80)}...`);break}}}if(!f){if(de()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอรูป");break}const u=ht();if(u){A(`❌ สร้างรูปล้มเหลว: ${u}`),d.push(`image gen failed: ${u}`),S("img-wait","error");break}const v=h();v!==null?(v!==x&&(n(`🖼️ ความคืบหน้ารูปภาพ: ${v}%`),x=v,S("img-wait","active",v)),E=Date.now()):x>30&&Math.floor((Date.now()-E)/1e3)>=3&&n(`🖼️ % หายที่ ${x}% — รูปน่าจะเสร็จแล้ว`),await m(3e3)}}if(!f)A("หมดเวลารอรูปที่สร้าง"),l.push("⚠️ Wait Image"),S("img-wait","error");else{n("พบรูปที่สร้างแล้ว"),l.push("✅ Image Found"),S("img-wait","done",100);const R=f.getBoundingClientRect(),u=R.left+R.width/2,v=R.top+R.height/2,M={bubbles:!0,cancelable:!0,clientX:u,clientY:v};f.dispatchEvent(new PointerEvent("pointerenter",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mouseenter",M)),f.dispatchEvent(new PointerEvent("pointerover",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mouseover",M)),f.dispatchEvent(new PointerEvent("pointermove",{...M,pointerId:1,isPrimary:!0,pointerType:"mouse"})),f.dispatchEvent(new MouseEvent("mousemove",M)),n("ส่งเหตุการณ์ hover บนรูปแล้ว"),await m(1500);let P=null;for(const y of["more_vert","more_horiz","more"]){const _=Ee(y);for(const z of _){const T=z.getBoundingClientRect();if(T.top>=R.top-20&&T.top<=R.bottom&&T.right>=R.right-150&&T.right<=R.right+20){P=z;break}}if(P)break}if(!P){const y=document.querySelectorAll("button");for(const _ of y){const z=_.getBoundingClientRect();if(z.width<50&&z.height<50&&z.top>=R.top-10&&z.top<=R.top+60&&z.left>=R.right-80){const T=_.querySelectorAll("i");for(const H of T)if((((V=H.textContent)==null?void 0:V.trim())||"").includes("more")){P=_;break}if(P)break;const G=_.getAttribute("aria-label")||"";if(G.includes("เพิ่มเติม")||G.includes("more")){P=_;break}}}}if(!P)A("ไม่พบปุ่ม 3 จุดบนรูปที่สร้าง"),l.push("⚠️ 3-dots");else{const y=P.getBoundingClientRect(),_=y.left+y.width/2,z=y.top+y.height/2,T={bubbles:!0,cancelable:!0,clientX:_,clientY:z,button:0};P.dispatchEvent(new PointerEvent("pointerdown",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),P.dispatchEvent(new MouseEvent("mousedown",T)),await m(80),P.dispatchEvent(new PointerEvent("pointerup",{...T,pointerId:1,isPrimary:!0,pointerType:"mouse"})),P.dispatchEvent(new MouseEvent("mouseup",T)),P.dispatchEvent(new MouseEvent("click",T)),n("คลิกปุ่ม 3 จุดแล้ว"),await m(1500);let G=null;const H=document.querySelectorAll("button, [role='menuitem'], [role='option'], li, div[role='button']");for(const q of H){const W=(q.textContent||"").trim();if(W.includes("ทำให้เป็นภาพเคลื่อนไหว")||W.includes("Animate")||W.includes("animate")){G=q;break}}if(!G)A("ไม่พบเมนู 'ทำให้เป็นภาพเคลื่อนไหว'"),l.push("⚠️ Animate");else{const q=G.getBoundingClientRect(),W=q.left+q.width/2,K=q.top+q.height/2,O={bubbles:!0,cancelable:!0,clientX:W,clientY:K,button:0};G.dispatchEvent(new PointerEvent("pointerdown",{...O,pointerId:1,isPrimary:!0,pointerType:"mouse"})),G.dispatchEvent(new MouseEvent("mousedown",O)),await m(80),G.dispatchEvent(new PointerEvent("pointerup",{...O,pointerId:1,isPrimary:!0,pointerType:"mouse"})),G.dispatchEvent(new MouseEvent("mouseup",O)),G.dispatchEvent(new MouseEvent("click",O)),n("✅ คลิก 'ทำให้เป็นภาพเคลื่อนไหว' — สลับเป็นโหมดวิดีโอแล้ว"),l.push("✅ Animate"),S("animate","done"),await m(3e3)}}}}catch(h){A(`ขั้น 4 ผิดพลาด: ${h.message}`),l.push("⚠️ Animate")}if(de()){n("⛔ ผู้ใช้สั่งหยุด — ยกเลิกก่อนขั้นวิดีโอ"),d.push("stopped by user");try{$e(3e3)}catch{}return{success:!1,message:"⛔ หยุดโดยผู้ใช้",step:"stopped"}}if(t.videoPrompt){n("=== ขั้น 5: วาง Video Prompt + สร้างวิดีโอ ==="),S("vid-prompt","active");try{n("รอ UI โหมดวิดีโอ..."),await m(3e3);let h=!1;const f=document.querySelectorAll("button, span, div");for(const N of f){const R=(N.textContent||"").trim(),u=N.getBoundingClientRect();if((R==="วิดีโอ"||R==="Video"||R.includes("วิดีโอ"))&&u.bottom>window.innerHeight*.7){h=!0,n("ยืนยัน: อยู่ในโหมดวิดีโอแล้ว");break}}h||n("ไม่พบตัวบอกโหมดวิดีโอ — ดำเนินการต่อ (อาจอยู่ในโหมดวิดีโอหลัง Animate)"),await m(1e3);const x=wt();x?(await Pe(x,t.videoPrompt),n(`วาง Video Prompt แล้ว (${t.videoPrompt.length} ตัวอักษร)`),l.push("✅ Video Prompt"),S("vid-prompt","done")):(A("ไม่พบช่อง Prompt สำหรับ Video Prompt"),l.push("❌ Video Prompt"),d.push("video prompt input not found"),S("vid-prompt","error")),await m(1e3),S("vid-generate","active");const E=bt();if(E){const N=E.getBoundingClientRect(),R=N.left+N.width/2,u=N.top+N.height/2,v={bubbles:!0,cancelable:!0,clientX:R,clientY:u,button:0};E.dispatchEvent(new PointerEvent("pointerdown",{...v,pointerId:1,isPrimary:!0,pointerType:"mouse"})),E.dispatchEvent(new MouseEvent("mousedown",v)),await m(80),E.dispatchEvent(new PointerEvent("pointerup",{...v,pointerId:1,isPrimary:!0,pointerType:"mouse"})),E.dispatchEvent(new MouseEvent("mouseup",v)),E.dispatchEvent(new MouseEvent("click",v)),n("✅ คลิก Generate สำหรับวิดีโอ — เริ่มสร้างวิดีโอ!"),l.push("✅ Video Generate"),S("vid-generate","done"),await m(500),E.dispatchEvent(new PointerEvent("pointerdown",{...v,pointerId:1,isPrimary:!0,pointerType:"mouse"})),E.dispatchEvent(new MouseEvent("mousedown",v)),await m(80),E.dispatchEvent(new PointerEvent("pointerup",{...v,pointerId:1,isPrimary:!0,pointerType:"mouse"})),E.dispatchEvent(new MouseEvent("mouseup",v)),E.dispatchEvent(new MouseEvent("click",v)),n("ส่งคลิกซ้ำเพื่อความปลอดภัยบนปุ่ม Generate วิดีโอ")}else A("ไม่พบปุ่ม Generate สำหรับวิดีโอ"),l.push("❌ Video Generate"),d.push("video generate button not found"),S("vid-generate","error")}catch(h){A(`ขั้น 5 ผิดพลาด: ${h.message}`),l.push("⚠️ Video Gen"),d.push(`video gen error: ${h.message}`)}}else n("ไม่มี Video Prompt — ข้ามขั้นสร้างวิดีโอ"),fe("animate"),fe("vid-prompt"),fe("vid-generate"),fe("vid-wait");if(t.videoPrompt){S("vid-wait","active");const h=t.sceneCount||1,f=t.videoScenePrompts||[t.videoPrompt];if(h>1)try{zt(h)}catch{}n(`=== ขั้น 6: รอวิดีโอ + ${h>1?`ต่อ ${h} ฉาก`:"ดาวน์โหลด"} ===`);let x=null;const E=()=>{if(x&&x.isConnected&&!x.closest("#netflow-engine-overlay")){const M=(x.textContent||"").trim();if(M.length<=10){const P=M.match(/(\d{1,3})\s*%/);if(P){const y=parseInt(P[1],10);if(y>=1&&y<=100)return y}}x=null}const u=document.querySelectorAll('[role="progressbar"]');for(const M of u){if(M.closest("#netflow-engine-overlay"))continue;const P=M.getAttribute("aria-valuenow");if(P){const y=parseFloat(P);if(y>=1&&y<=100)return y}}const v=document.querySelectorAll("span, small, label, p");for(const M of v){if(M.closest("#netflow-engine-overlay"))continue;const P=(M.textContent||"").trim();if(P.length>10||P.length<2)continue;const y=P.match(/(\d{1,3})\s*%/);if(!y)continue;const _=parseInt(y[1],10);if(_<1||_>100)continue;const z=M.getBoundingClientRect();if(!(z.width===0||z.width>150)&&!(z.top<0||z.top>window.innerHeight))return x=M,_}return null},N=async(u=6e5)=>{n("รอการสร้างวิดีโอ..."),S("vid-wait","active"),await m(5e3);const v=()=>{const L=document.querySelectorAll("div, span, p, label, strong, small");let j=0;for(const U of L){if(U.closest("#netflow-engine-overlay"))continue;const te=(U.textContent||"").trim();if(te.includes("%")&&te.length<15){const ge=U.tagName.toLowerCase(),Ie=U.className&&typeof U.className=="string"?U.className.split(/\s+/).slice(0,2).join(" "):"",We=U.getBoundingClientRect();if(n(`  🔍 "${te}" ใน <${ge}.${Ie}> ที่ (${We.left.toFixed(0)},${We.top.toFixed(0)}) w=${We.width.toFixed(0)}`),j++,j>=5)break}}j===0&&n("  🔍 ไม่พบ element ที่มีข้อความ '%'")},M=He();n(M?"📍 การ์ดวิดีโอมีอยู่แล้วตั้งแต่เริ่ม":"⏳ ยังไม่มีการ์ดวิดีโอ — จะติดตามความคืบหน้า %"),n("🔍 สแกนข้อความ % เพื่อตรวจสอบ:"),v();const P=Date.now();let y=-1,_=0,z=!1,T=0;for(;Date.now()-P<u;){T++;const L=E();if(L!==null){if(L!==y&&(n(`ความคืบหน้าวิดีโอ: ${L}%`),y=L,S("vid-wait","active",L)),_=Date.now(),L>=100){n("✅ ตรวจพบ 100%!"),z=!0;break}}else if(y>0){const U=Math.floor((Date.now()-_)/1e3);if(U>=5){n(`✅ % หายไปที่ ${y}% (หาย ${U} วินาที) — วิดีโอเสร็จ!`),z=!0;break}n(`⏳ % หายที่ ${y}% — ยืนยันใน ${5-U} วินาที...`)}else{const U=Math.floor((Date.now()-P)/1e3);U%15<3&&n(`⏳ รอ... (${U} วินาที) ไม่พบ %`)}const j=Math.floor((Date.now()-P)/1e3);if(!z&&(y>0||j>=30)&&T%5===0){if(He(!0)&&!M){n(`✅ การ์ดวิดีโอปรากฏขึ้น${y>0?`ที่ ${y}%`:" (ไม่พบ %)"} — วิดีโอเสร็จ!`),z=!0;break}if(y<=0){const te=document.querySelectorAll("video");for(const ge of te){const Ie=ge.getBoundingClientRect();if(Ie.width>200&&Ie.height>100&&ge.readyState>=2&&ge.src){n("✅ พบ <video> พร้อมเล่น (ไม่พบ %) — วิดีโอเสร็จ!"),z=!0;break}}if(z)break;if(j>=90){n(`✅ ไม่พบ % มานาน ${j} วินาที — ถือว่าเสร็จ`),z=!0;break}}}if(de())return n("⛔ ผู้ใช้สั่งหยุดระหว่างรอวิดีโอ"),null;if(y<1&&T%5===0){const U=ht();if(U)return A(`❌ สร้างวิดีโอล้มเหลว: ${U}`),null}await m(3e3)}const G=He();if(!G)return n("❌ ไม่พบการ์ดวิดีโอที่จะคลิก"),S("vid-wait","error"),null;const H=G;z?(S("vid-wait","done",100),n("รอ 4 วินาทีก่อนคลิก..."),await m(4e3)):n("⚠️ หมดเวลา — ลองคลิกการ์ดวิดีโอต่อ");const q=H.getBoundingClientRect();let W=q.left+q.width/2,K=q.top+q.height/2,O=H;const Z=H.querySelector("video, img, canvas");if(Z){const L=Z.getBoundingClientRect();L.width>50&&L.height>50&&(W=L.left+L.width/2,K=L.top+L.height/2,O=Z,n(`🎯 พบรูปย่อ <${Z.tagName.toLowerCase()}> ในการ์ดที่ (${W.toFixed(0)},${K.toFixed(0)}) ${L.width.toFixed(0)}x${L.height.toFixed(0)}`))}else K=q.top+q.height*.3,n(`🎯 ไม่พบรูปย่อย่อย — คลิกส่วนบน 1/3 ที่ (${W.toFixed(0)},${K.toFixed(0)})`);n(`🖱️ ชี้เมาส์การ์ดวิดีโอ 4 วินาที ที่ (${W.toFixed(0)}, ${K.toFixed(0)})...`),Ft(O);for(let L=0;L<8;L++){const j={bubbles:!0,cancelable:!0,clientX:W+L%2,clientY:K};O.dispatchEvent(new PointerEvent("pointermove",{...j,pointerId:1,isPrimary:!0,pointerType:"mouse"})),O.dispatchEvent(new MouseEvent("mousemove",j)),await m(500)}try{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"mute_video",sceneCount:h,scenePrompts:f,theme:t.theme}}),n(`💾 บันทึก pending action: mute_video (${h} ฉาก, ${f.length} prompts, theme: ${t.theme})`)}catch(L){n(`⚠️ ไม่สามารถบันทึก pending action: ${L.message}`)}return n("คลิกการ์ดวิดีโอเพื่อเข้าหน้ารายละเอียด..."),await R(O),n("✅ คลิกการ์ดวิดีโอเสร็จ"),H},R=async u=>{const v=u.getBoundingClientRect(),M=v.left+v.width/2,P=v.top+v.height/2,y={bubbles:!0,cancelable:!0,clientX:M,clientY:P,button:0};u.dispatchEvent(new PointerEvent("pointerdown",{...y,pointerId:1,isPrimary:!0,pointerType:"mouse"})),u.dispatchEvent(new MouseEvent("mousedown",y)),await m(80),u.dispatchEvent(new PointerEvent("pointerup",{...y,pointerId:1,isPrimary:!0,pointerType:"mouse"})),u.dispatchEvent(new MouseEvent("mouseup",y)),u.dispatchEvent(new MouseEvent("click",y)),await m(50),u.click(),n("คลิกการ์ดวิดีโอแล้ว"),await m(2e3)};try{if(!await N())A("หมดเวลารอการสร้างวิดีโอ"),l.push("⚠️ Video Wait"),S("vid-wait","error");else{l.push("✅ Video Complete"),S("vid-wait","done",100),n("✅ คลิกเข้าหน้ารายละเอียดวิดีโอแล้ว — รอ mute จาก pending action"),await m(3e3);const v=await new Promise(M=>{chrome.storage.local.get("netflow_pending_action",P=>{if(chrome.runtime.lastError){M(null);return}M((P==null?void 0:P.netflow_pending_action)||null)})});v&&!v._claimed&&(n("🔄 สคริปต์ยังทำงานอยู่หลังคลิกการ์ด (SPA navigation) — เรียก pending action โดยตรง"),chrome.storage.local.remove("netflow_pending_action"),v.action==="mute_video"?await vt(v.sceneCount||1,v.scenePrompts||[],v.theme):v.action==="wait_scene_gen_and_download"&&await yt(v.sceneCount||2,v.currentScene||2,v.theme,v.scenePrompts||[]))}}catch(u){A(`ขั้น 6 ผิดพลาด: ${u.message}`),l.push("⚠️ Step6"),d.push(`step 6: ${u.message}`)}}const C=d.length===0;try{$e(C?5e3:8e3)}catch(h){console.warn("Overlay complete error:",h)}return{success:C,message:C?`สำเร็จ! ${l.join(" → ")}`:`บางขั้นตอนมีปัญหา: ${l.join(" → ")} | ${d.join(", ")}`,step:C?"done":"partial"}}async function vt(t,e=[],i){var F;n("═══ Auto Mute: ปิดเสียงวิดีโอ ═══");try{i&&Te(i)}catch{}try{ze(t)}catch(D){n(`⚠️ showOverlay error: ${D.message}`)}try{const D=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(const B of D)S(B,"done");t>=2&&S("scene2-prompt","active")}catch(D){n(`⚠️ overlay restore error: ${D.message}`)}await m(1500);const o=(()=>{for(const D of document.querySelectorAll("button")){const B=D.querySelectorAll("i");for(const h of B){const f=(h.textContent||"").trim();if(f==="volume_up"||f==="volume_off"||f==="volume_mute"){const x=D.getBoundingClientRect();if(x.width>0&&x.height>0)return D}}const V=(D.getAttribute("aria-label")||"").toLowerCase();if(V.includes("mute")||V.includes("ปิดเสียง")){const h=D.getBoundingClientRect();if(h.width>0&&h.height>0)return D}}return null})();o?(o.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม");const r=await mt();if(t>=2){n(`═══ ${t} ฉาก — เริ่มต่อฉาก ═══`),await m(2e3);for(let u=2;u<=t;u++){const v=e[u-1];if(!v){A(`ไม่พบ prompt สำหรับฉากที่ ${u}`);continue}n(`── ฉากที่ ${u}/${t}: วาง prompt + generate ──`);let M=null;const P=Date.now();for(;!M&&Date.now()-P<1e4;){const O=document.querySelectorAll("[data-slate-editor='true']");if(O.length>0&&(M=O[O.length-1]),!M){const Z=document.querySelectorAll("[role='textbox'][contenteditable='true']");Z.length>0&&(M=Z[Z.length-1])}M||await m(1e3)}if(!M){A("ไม่พบช่อง prompt (Slate editor)");return}n(`พบ Slate editor: <${M.tagName.toLowerCase()}> ${M.className.substring(0,40)}`),await Pe(M,v),n(`วาง prompt ฉาก ${u} (${v.length} ตัวอักษร) ✅`);try{S(`scene${u}-prompt`,"done"),S(`scene${u}-gen`,"active")}catch{}await m(1e3);const y=M.getBoundingClientRect();let _=null,z=1/0;for(const O of document.querySelectorAll("button")){if(O.disabled)continue;const Z=O.querySelectorAll("i");let L=!1;for(const te of Z)if((te.textContent||"").trim()==="arrow_forward"){L=!0;break}if(!L)continue;const j=O.getBoundingClientRect();if(j.width<=0||j.height<=0)continue;const U=Math.abs(j.top-y.top)+Math.abs(j.right-y.right);U<z&&(z=U,_=O)}if(!_)for(const O of document.querySelectorAll("button")){const Z=O.querySelectorAll("i");for(const L of Z)if((L.textContent||"").trim()==="arrow_forward"){const j=O.getBoundingClientRect();if(j.width>0&&j.height>0){_=O;break}}if(_)break}if(!_){A("ไม่พบปุ่ม Generate/Send");return}await new Promise(O=>{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:i,sceneCount:t,currentScene:u,scenePrompts:e}},()=>O())}),n(`💾 บันทึก pending action: wait_scene_gen_and_download (ฉาก ${u}/${t})`),await ee(_),n(`คลิก Generate ฉาก ${u} ✅`);try{S(`scene${u}-gen`,"done"),S(`scene${u}-wait`,"active")}catch{}n(`── รอวิดีโอฉาก ${u} gen เสร็จ ──`),await m(5e3);let T=0,G=0;const H=Date.now(),q=6e5,W=5e3;let K=!1;for(;Date.now()-H<q;){let O=null;const Z=document.querySelectorAll("div, span, p, label, strong, small");for(const L of Z){if(L.closest("#netflow-engine-overlay"))continue;const U=(L.textContent||"").trim().match(/^(\d{1,3})%$/);if(U){const te=L.getBoundingClientRect();if(te.width>0&&te.height>0&&te.width<120&&te.height<60){O=parseInt(U[1],10);break}}}if(O!==null){if(O!==T){n(`🎬 ฉาก ${u} ความคืบหน้า: ${O}%`),T=O;try{S(`scene${u}-wait`,"active",O)}catch{}}G=0}else if(T>0){if(G===0)G=Date.now(),n(`🔍 ฉาก ${u}: % หายไป (จาก ${T}%) — กำลังยืนยัน...`);else if(Date.now()-G>=W){n(`✅ ฉาก ${u}: % หายไป ${W/1e3} วินาที — เจนเสร็จ!`),K=!0;break}}if(de()){n("⛔ ผู้ใช้สั่งหยุด");return}await m(2e3)}K||A(`ฉาก ${u} หมดเวลา`),n(`✅ ฉาก ${u} เสร็จแล้ว`);try{S(`scene${u}-wait`,"done",100)}catch{}chrome.storage.local.remove("netflow_pending_action"),n("🗑️ ลบ pending action (tracking เสร็จแล้วบนหน้านี้)"),await m(2e3)}n("── เริ่มดาวน์โหลด Full Video ──");try{S("download","active")}catch{}await m(2e3);const D=Date.now();let B=null;const V=Date.now();for(;!B&&Date.now()-V<1e4;){for(const u of document.querySelectorAll("button")){const v=u.querySelector("i");if(v&&(v.textContent||"").trim()==="download"){const M=u.getBoundingClientRect();if(M.width>0&&M.height>0){B=u;break}}}B||await m(1e3)}if(!B){A("ไม่พบปุ่มดาวน์โหลด");return}await ee(B),n("คลิกดาวน์โหลดแล้ว ✅");try{S("download","done"),S("upscale","active")}catch{}await m(1500);let h=null;for(let u=0;u<3&&!h;u++){u>0&&n(`🔄 ลองหา 720p ครั้งที่ ${u+1}...`);let v=null;const M=Date.now();for(;!v&&Date.now()-M<5e3;){for(const T of document.querySelectorAll("[role='menuitem']"))if((T.textContent||"").trim().includes("Full Video")&&T.querySelector("i")){const H=T.getBoundingClientRect();if(H.width>0&&H.height>0){v=T;break}}v||await m(500)}if(!v){A("ไม่พบ Full Video");continue}const P=v.getBoundingClientRect(),y=P.left+P.width/2,_=P.top+P.height/2;v.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:y,clientY:_})),v.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:y,clientY:_})),v.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:y,clientY:_})),await ee(v),n("คลิก/hover Full Video ✅"),await m(2e3);const z=Date.now();for(;!h&&Date.now()-z<8e3;){for(const T of document.querySelectorAll("button[role='menuitem']")){const G=T.querySelectorAll("span");for(const H of G)if((H.textContent||"").trim()==="720p"){const q=T.getBoundingClientRect();if(q.width>0&&q.height>0){h=T;break}}if(h)break}h||(v.isConnected&&(v.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:y,clientY:_})),v.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:y+20,clientY:_}))),await m(500))}}if(!h){A("ไม่พบ 720p");return}await ee(h),n("คลิก 720p ✅"),n("รอดาวน์โหลดเสร็จ...");const f=Date.now();let x=!1,E=!1;for(;Date.now()-f<3e5;){for(const u of document.querySelectorAll("div[data-title] div, div[data-content] div")){const v=(u.textContent||"").trim();if(v==="Download complete!"||v==="ดาวน์โหลดเสร็จ"){n("✅ Download complete! (toast)"),x=!0;break}(v.includes("Downloading your extended video")||v.includes("กำลังดาวน์โหลด"))&&(E||(E=!0,n("⏳ กำลังดาวน์โหลด...")))}if(x)break;if(E){let u=!1;for(const v of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((v.textContent||"").trim().includes("Downloading")){u=!0;break}if(!u){n("✅ ดาวน์โหลดเสร็จ (toast หายไป)"),x=!0;break}}if(de()){n("⛔ ผู้ใช้สั่งหยุดระหว่างดาวน์โหลด");return}await m(2e3)}if(!x){A("ดาวน์โหลดหมดเวลา");return}try{S("upscale","done",100),S("open","active")}catch{}n("รอไฟล์ดาวน์โหลดพร้อม..."),await m(5e3);let N=!1;const R=Date.now();for(;Date.now()-R<6e4&&!N;){try{await new Promise(u=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:D},v=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):v!=null&&v.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${v.message}`),N=!0):n(`ดาวน์โหลดยังไม่พร้อม: ${v==null?void 0:v.message}`),u()})})}catch(u){A(`ตรวจสอบผิดพลาด: ${u.message}`)}N||await m(3e3)}N||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้");try{S("open","done"),$e(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น ═══"),Le(r),Oe(2e3);return}n("═══ 1 ฉาก — เริ่มดาวน์โหลด ═══"),await m(2e3);const p=(D,B="button, [role='menuitem'], [role='option'], li, span, div[role='button']")=>{for(const V of document.querySelectorAll(B)){const h=(V.textContent||"").trim();if(h.includes(D)&&h.length<100){const f=V.getBoundingClientRect();if(f.width>0&&f.height>0&&f.top>=0)return V}}return null};n("── ค้นหาปุ่มดาวน์โหลด ──");let c=null;const s=Date.now();for(;!c&&Date.now()-s<1e4;){for(const D of document.querySelectorAll("button, [role='button']")){const B=(D.textContent||"").trim(),V=B.toLowerCase();if((V.includes("download")||V.includes("ดาวน์โหลด"))&&B.length<80){const h=D.getBoundingClientRect();if(h.width>0&&h.height>0){c=D;break}}}if(!c)for(const D of document.querySelectorAll("button")){const B=(D.getAttribute("aria-label")||"").toLowerCase();if(B.includes("download")||B.includes("ดาวน์")){const V=D.getBoundingClientRect();if(V.width>0&&V.height>0){c=D;break}}}c||(n(`รอปุ่มดาวน์โหลด... (${document.querySelectorAll("button").length} ปุ่ม)`),await m(1e3))}if(!c){A("ไม่พบปุ่มดาวน์โหลด (รอ 10 วินาที)");return}n(`พบปุ่มดาวน์โหลด: "${(c.textContent||"").trim().substring(0,40)}"`),await ee(c),n("คลิกปุ่มดาวน์โหลดแล้ว ✅"),await m(1500);const l=Date.now();let d=null;const g=Date.now();for(;!d&&Date.now()-g<5e3;)d=p("1080p"),d||(n("รอ 1080p..."),await m(500));if(!d){A("ไม่พบ 1080p");return}await ee(d),n("คลิก 1080p Upscaled ✅"),n("รอการอัปสเกลเสร็จ...");const b=Date.now();let I=!1,k=!1,$=0;const w=3e3;for(;Date.now()-b<3e5;){const B=((document.body.innerText||"")+" "+(document.body.textContent||"")).toLowerCase();if(B.includes("upscaling complete")||B.includes("อัปสเกลเสร็จ")){n("✅ Upscaling complete!"),I=!0;break}for(const h of document.querySelectorAll("div, span, p")){const f=(h.textContent||"").trim().toLowerCase();if(f.length<60&&(f.includes("upscaling complete")||f.includes("อัปสเกลเสร็จ"))){n(`✅ Upscaling complete! (element: "${(F=h.textContent)==null?void 0:F.trim()}")`),I=!0;break}}if(I)break;if(B.includes("upscaling your video")||B.includes("กำลังอัปสเกล")){k=!0,$=0;const h=Math.floor((Date.now()-b)/1e3);n(`⏳ กำลังอัปสเกล... (${h} วินาที)`)}else if(k){if($===0)$=Date.now(),n("🔍 ข้อความ Upscaling หายไป — กำลังยืนยัน...");else if(Date.now()-$>=w){n(`✅ ข้อความ Upscaling หายไป ${w/1e3} วินาที — เสร็จ!`),I=!0;break}}else{const h=Math.floor((Date.now()-b)/1e3);h%10<3&&n(`⏳ รอ Upscale... (${h} วินาที)`)}if(de()){n("⛔ ผู้ใช้สั่งหยุดระหว่างรอ Upscale");return}await m(2e3)}if(!I){A("Upscale หมดเวลา — ไฟล์อาจยังอัปสเกลอยู่");return}n("รอไฟล์ดาวน์โหลดพร้อม..."),await m(5e3);let a=!1;const C=Date.now();for(;Date.now()-C<6e4&&!a;){try{await new Promise(D=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:l},B=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):B!=null&&B.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${B.message}`),a=!0):n(`ดาวน์โหลดยังไม่พร้อม: ${B==null?void 0:B.message}`),D()})})}catch(D){A(`ตรวจสอบผิดพลาด: ${D.message}`)}a||await m(3e3)}a||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้"),n("═══ ดาวน์โหลดเสร็จสิ้น ═══"),Le(r),Oe(2e3)}async function yt(t=2,e=2,i,o=[]){n(`═══ Pending: รอ scene ${e}/${t} gen เสร็จ + ดาวน์โหลด ═══`);try{i&&Te(i)}catch{}try{ze(t)}catch(f){n(`⚠️ showOverlay error: ${f.message}`)}try{const f=["settings","upload-char","upload-prod","img-prompt","img-generate","img-wait","animate","vid-prompt","vid-generate","vid-wait"];for(let x=2;x<=e;x++)f.push(`scene${x}-prompt`,`scene${x}-gen`),x<e&&f.push(`scene${x}-wait`);for(const x of f)S(x,"done");S(`scene${e}-wait`,"active"),n(`✅ overlay restored: ${f.length} steps done (scene ${e}/${t} navigate)`)}catch(f){n(`⚠️ overlay restore error: ${f.message}`)}await m(2e3);const r=(()=>{for(const f of document.querySelectorAll("button")){const x=f.querySelectorAll("i");for(const E of x){const N=(E.textContent||"").trim();if(N==="volume_up"||N==="volume_off"||N==="volume_mute"){const R=f.getBoundingClientRect();if(R.width>0&&R.height>0)return f}}}return null})();r?(r.click(),n("🔇 คลิกปิดเสียงวิดีโอแล้ว ✅")):n("⚠️ ไม่พบปุ่มปิดเสียง — ข้าม"),n(`── รอวิดีโอ scene ${e} gen เสร็จ (หลัง page navigate) ──`);let p=0,c=0;const s=Date.now(),l=6e5,d=5e3;let g=!1,b=0,I=null;for(;Date.now()-s<l;){let f=null;if(I&&I.isConnected&&!I.closest("#netflow-engine-overlay")){const E=(I.textContent||"").trim().match(/^(\d{1,3})%$/);E?f=parseInt(E[1],10):I=null}if(f===null){const x=document.querySelectorAll('[role="progressbar"]');for(const E of x){if(E.closest("#netflow-engine-overlay"))continue;const N=E.getAttribute("aria-valuenow");if(N){const R=parseFloat(N);if(R>=1&&R<=100){f=R;break}}}}if(f===null){const x=document.querySelectorAll("span, small, label, p");for(const E of x){if(E.closest("#netflow-engine-overlay"))continue;const R=(E.textContent||"").trim().match(/^(\d{1,3})%$/);if(R){const u=E.getBoundingClientRect();if(u.width>0&&u.height>0&&u.width<120&&u.height<60){f=parseInt(R[1],10),I=E;break}}}}if(f!==null){if(b=0,f!==p){n(`🎬 scene ${e} ความคืบหน้า: ${f}%`),p=f;try{S(`scene${e}-wait`,"active",f)}catch{}}c=0}else if(p>0){if(c===0)c=Date.now(),n(`🔍 scene ${e}: % หายไป (จาก ${p}%) — กำลังยืนยัน...`);else if(Date.now()-c>=d){n(`✅ scene ${e}: % หายไป ${d/1e3} วินาที — เจนเสร็จ!`),g=!0;break}}else if(b++,b>=15){const x=document.querySelectorAll("video");let E=!1;for(const N of x)if(N.readyState>=2&&!N.paused&&N.getBoundingClientRect().width>200){E=!0;break}if(E){n(`✅ scene ${e}: พบวิดีโอกำลังเล่น — ถือว่า gen เสร็จแล้ว`),g=!0;break}if(b>=30){n(`✅ scene ${e}: ไม่พบ % มานาน 60 วินาที — ถือว่าเสร็จ`),g=!0;break}}await m(2e3)}g||n(`⚠️ scene ${e} หมดเวลา — ลองต่อไป`);try{S(`scene${e}-wait`,"done",100)}catch{}if(n(`✅ scene ${e} เสร็จ`),e<t&&o.length>0){n(`═══ ยังเหลืออีก ${t-e} ฉาก — ต่อฉากถัดไป ═══`),await m(2e3);for(let f=e+1;f<=t;f++){const x=o[f-1];if(!x){n(`⚠️ ไม่พบ prompt สำหรับฉากที่ ${f} — ข้าม`);continue}n(`── ฉากที่ ${f}/${t}: วาง prompt + generate (pending recovery) ──`);let E=null;const N=Date.now();for(;!E&&Date.now()-N<1e4;){const T=document.querySelectorAll("[data-slate-editor='true']");if(T.length>0&&(E=T[T.length-1]),!E){const G=document.querySelectorAll("[role='textbox'][contenteditable='true']");G.length>0&&(E=G[G.length-1])}E||await m(1e3)}if(!E){n(`⚠️ ไม่พบ Slate editor สำหรับฉาก ${f}`);break}await Pe(E,x),n(`วาง prompt ฉาก ${f} (${x.length} ตัวอักษร) ✅`);try{S(`scene${f}-prompt`,"done"),S(`scene${f}-gen`,"active")}catch{}await m(1e3);const R=E.getBoundingClientRect();let u=null,v=1/0;for(const T of document.querySelectorAll("button")){if(T.disabled)continue;const G=T.querySelectorAll("i");let H=!1;for(const K of G)if((K.textContent||"").trim()==="arrow_forward"){H=!0;break}if(!H)continue;const q=T.getBoundingClientRect();if(q.width<=0||q.height<=0)continue;const W=Math.abs(q.top-R.top)+Math.abs(q.right-R.right);W<v&&(v=W,u=T)}if(!u)for(const T of document.querySelectorAll("button")){const G=T.querySelectorAll("i");for(const H of G)if((H.textContent||"").trim()==="arrow_forward"){const q=T.getBoundingClientRect();if(q.width>0&&q.height>0){u=T;break}}if(u)break}if(!u){n(`⚠️ ไม่พบปุ่ม Generate สำหรับฉาก ${f}`);break}await new Promise(T=>{chrome.storage.local.set({netflow_pending_action:{timestamp:Date.now(),action:"wait_scene_gen_and_download",theme:i,sceneCount:t,currentScene:f,scenePrompts:o}},()=>T())}),await ee(u),n(`คลิก Generate ฉาก ${f} ✅`);try{S(`scene${f}-gen`,"done"),S(`scene${f}-wait`,"active")}catch{}await m(5e3);let M=0,P=0;const y=Date.now();let _=!1,z=0;for(;Date.now()-y<6e5;){let T=null;const G=document.querySelectorAll("div, span, p, label, strong, small");for(const H of G){if(H.closest("#netflow-engine-overlay"))continue;const W=(H.textContent||"").trim().match(/^(\d{1,3})%$/);if(W){const K=H.getBoundingClientRect();if(K.width>0&&K.height>0&&K.width<120&&K.height<60){T=parseInt(W[1],10);break}}}if(T!==null){if(z=0,T!==M){n(`🎬 ฉาก ${f} ความคืบหน้า: ${T}%`),M=T;try{S(`scene${f}-wait`,"active",T)}catch{}}P=0}else if(M>0){if(P===0)P=Date.now();else if(Date.now()-P>=5e3){n(`✅ ฉาก ${f}: เจนเสร็จ!`),_=!0;break}}else if(z++,z>=15){const H=document.querySelectorAll("video");let q=!1;for(const W of H)if(W.readyState>=2&&!W.paused&&W.getBoundingClientRect().width>200){q=!0;break}if(q){n(`✅ ฉาก ${f}: พบวิดีโอเล่นอยู่ — เสร็จ`),_=!0;break}if(z>=30){n(`✅ ฉาก ${f}: ไม่พบ % 60 วินาที — ถือว่าเสร็จ`),_=!0;break}}await m(2e3)}_||n(`⚠️ ฉาก ${f} หมดเวลา`);try{S(`scene${f}-wait`,"done",100)}catch{}n(`✅ ฉาก ${f} เสร็จแล้ว`),chrome.storage.local.remove("netflow_pending_action"),await m(2e3)}}n("✅ ทุกฉากเสร็จ — เริ่มดาวน์โหลด"),await m(3e3);try{S("download","active")}catch{}n("── เริ่มดาวน์โหลด Full Video (หลัง page navigate) ──");const k=Date.now();let $=null;const w=Date.now();for(;!$&&Date.now()-w<1e4;){for(const f of document.querySelectorAll("button")){const x=f.querySelector("i");if(x&&(x.textContent||"").trim()==="download"){const E=f.getBoundingClientRect();if(E.width>0&&E.height>0){$=f;break}}}$||await m(1e3)}if(!$){A("ไม่พบปุ่มดาวน์โหลด");return}await ee($),n("คลิกดาวน์โหลดแล้ว ✅");try{S("download","done"),S("upscale","active")}catch{}await m(1500);let a=null;for(let f=0;f<3&&!a;f++){f>0&&n(`🔄 ลองหา 720p ครั้งที่ ${f+1}...`);let x=null;const E=Date.now();for(;!x&&Date.now()-E<5e3;){for(const M of document.querySelectorAll("[role='menuitem']"))if((M.textContent||"").trim().includes("Full Video")&&M.querySelector("i")){const y=M.getBoundingClientRect();if(y.width>0&&y.height>0){x=M;break}}x||await m(500)}if(!x){A("ไม่พบ Full Video");continue}const N=x.getBoundingClientRect(),R=N.left+N.width/2,u=N.top+N.height/2;x.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0,clientX:R,clientY:u})),x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:R,clientY:u})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:R,clientY:u})),await ee(x),n("คลิก/hover Full Video ✅"),await m(2e3);const v=Date.now();for(;!a&&Date.now()-v<8e3;){for(const M of document.querySelectorAll("button[role='menuitem']")){const P=M.querySelectorAll("span");for(const y of P)if((y.textContent||"").trim()==="720p"){const _=M.getBoundingClientRect();if(_.width>0&&_.height>0){a=M;break}}if(a)break}a||(x.isConnected&&(x.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0,clientX:R,clientY:u})),x.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:R+20,clientY:u}))),await m(500))}}if(!a){A("ไม่พบ 720p");return}await ee(a),n("คลิก 720p ✅"),n("รอดาวน์โหลดเสร็จ...");const C=Date.now();let F=!1,D=!1;for(;Date.now()-C<3e5;){for(const f of document.querySelectorAll("div[data-title] div, div[data-content] div")){const x=(f.textContent||"").trim();if(x==="Download complete!"||x==="ดาวน์โหลดเสร็จ"){n("✅ Download complete! (toast)"),F=!0;break}(x.includes("Downloading your extended video")||x.includes("กำลังดาวน์โหลด"))&&(D||(D=!0,n("⏳ กำลังดาวน์โหลด...")))}if(F)break;if(D){let f=!1;for(const x of document.querySelectorAll("div[data-title] div, div[data-content] div"))if((x.textContent||"").trim().includes("Downloading")){f=!0;break}if(!f){n("✅ ดาวน์โหลดเสร็จ (toast หายไป)"),F=!0;break}}await m(2e3)}if(!F){A("ดาวน์โหลดหมดเวลา");return}try{S("upscale","done",100),S("open","active")}catch{}n("รอไฟล์ดาวน์โหลดพร้อม..."),await m(5e3);let B=!1;const V=Date.now();for(;Date.now()-V<6e4&&!B;){try{await new Promise(f=>{chrome.runtime.sendMessage({action:"OPEN_LATEST_VIDEO",afterTimestamp:k},x=>{chrome.runtime.lastError?A(`ตรวจสอบดาวน์โหลดผิดพลาด: ${chrome.runtime.lastError.message}`):x!=null&&x.success?(n(`✅ เปิดวิดีโอใน Chrome แล้ว: ${x.message}`),B=!0):n(`ดาวน์โหลดยังไม่พร้อม: ${x==null?void 0:x.message}`),f()})})}catch(f){A(`ตรวจสอบผิดพลาด: ${f.message}`)}B||await m(3e3)}B||A("ไม่สามารถหา/เปิดวิดีโอที่ดาวน์โหลดได้");try{S("open","done"),$e(8e3)}catch{}n("═══ ดาวน์โหลด Full Video เสร็จสิ้น (หลัง page navigate) ═══");const h=await mt();Le(h),Oe(2e3)}async function jt(){try{const t=await new Promise(p=>{chrome.storage.local.get("netflow_pending_action",c=>{if(chrome.runtime.lastError){p(null);return}p((c==null?void 0:c.netflow_pending_action)||null)})});if(!t||!t.timestamp)return;if(!window.location.href.includes("/edit/")){n("⏭️ pending action พบ แต่ไม่ใช่หน้า video detail — ข้าม");return}if(t._claimed){n("⏭️ pending action ถูก tab อื่น claim แล้ว — ข้าม");return}const i=Date.now()-t.timestamp;if(i>3e5){n("⏰ พบ pending action แต่เก่าเกินไป — ข้าม"),chrome.storage.local.remove("netflow_pending_action");return}const o=`${Date.now()}-${Math.random().toString(36).slice(2)}`;if(t._claimed=o,await new Promise(p=>{chrome.storage.local.set({netflow_pending_action:t},()=>p())}),await m(300),!await new Promise(p=>{chrome.storage.local.get("netflow_pending_action",c=>{const s=c==null?void 0:c.netflow_pending_action;p((s==null?void 0:s._claimed)===o)})})){n("⏭️ pending action ถูก tab อื่น claim ชนะ — ข้าม");return}chrome.storage.local.remove("netflow_pending_action"),n(`🔄 ตรวจพบ pending action: ${t.action} (อายุ ${Math.round(i/1e3)} วินาที)`),t.action==="mute_video"?await vt(t.sceneCount||1,t.scenePrompts||[],t.theme):t.action==="wait_scene_gen_and_download"||t.action==="wait_scene2_gen_and_download"?await yt(t.sceneCount||2,t.currentScene||2,t.theme,t.scenePrompts||[]):n(`⚠️ ไม่รู้จัก pending action: ${t.action}`)}catch(t){n(`⚠️ checkAndRunPendingAction error: ${t.message}`)}}chrome.runtime.onMessage.addListener((t,e,i)=>{if((t==null?void 0:t.action)==="GENERATE_IMAGE")return window.__NETFLOW_RUNNING__?(n("⚠️ GENERATE_IMAGE ถูกเรียกซ้ำ — ข้าม (มี instance ทำงานอยู่แล้ว)"),i({success:!1,message:"Already running"}),!1):(window.__NETFLOW_RUNNING__=!0,window.__NETFLOW_STOP__=!1,n("ได้รับคำสั่ง GENERATE_IMAGE"),i({success:!0,message:"⏳ เริ่มกระบวนการอัตโนมัติแล้ว — ดูผลที่หน้า Google Flow",step:"started"}),Xt(t).then(o=>n(`✅ ระบบอัตโนมัติเสร็จ: ${o.message}`)).catch(o=>{if(o instanceof Ve||(o==null?void 0:o.name)==="NetflowAbortError"){n("⛔ Automation หยุดทำงานโดยผู้ใช้");try{Se("⛔ ผู้ใช้หยุดการทำงาน")}catch{}try{ut()}catch{}}else console.error("[Netflow AI] Generate error:",o)}).finally(()=>{window.__NETFLOW_RUNNING__=!1}),!1);if((t==null?void 0:t.action)==="STOP_AUTOMATION")return n("⛔ ได้รับ STOP_AUTOMATION — ตั้งค่าสถานะหยุด"),window.__NETFLOW_STOP__=!0,window.__NETFLOW_RUNNING__=!1,i({success:!0,message:"Stop signal sent"}),!1;if((t==null?void 0:t.action)==="PING")return i({status:"ready"}),!1;if((t==null?void 0:t.action)==="CLICK_FIRST_IMAGE")return i({success:!0,message:"⏳ กำลังคลิกรูปแรก..."}),(async()=>{n("CLICK_FIRST_IMAGE — ค้นหาการ์ดรูปแรกผ่านไอคอน <i>image</i>..."),await m(500);const o=Lt();if(!o){A("ไม่พบการ์ดรูปผ่านไอคอน <i>image</i>");return}const r=o.getBoundingClientRect(),p=r.left+r.width/2,c=r.top+r.height/2;n(`การ์ดรูปที่ (${p.toFixed(0)}, ${c.toFixed(0)}) ${r.width.toFixed(0)}x${r.height.toFixed(0)} — คลิก 2 ครั้ง`);for(let s=0;s<2;s++){const l=document.elementFromPoint(p,c);l?(await ee(l),n(`คลิก ${s+1}/2 บน <${l.tagName.toLowerCase()}>`)):(await ee(o),n(`คลิก ${s+1}/2 บนการ์ด (สำรอง)`)),await m(300)}n("✅ คลิกการ์ดรูป 2 ครั้งเสร็จ")})(),!1}),n("สคริปต์ Google Flow พร้อมแล้ว — รอคำสั่ง"),jt()})();
