...
@media (max-height: 600px) {
    ...
    `}function Tt(){W||(W=document.createElement("style"),W.id="netflow-overlay-styles",W.textContent=ce(M),document.head.appendChild(W))}function de(e){e.innerHTML="",A.forEach((t,n)=>{const a=document.createElement("div");a.className="nf-proc-row nf-proc-waiting",a.id=`nf-proc-${t.stepId}`,a.innerHTML=`
